          ...
          <div className="flex flex-col gap-1">
            ...
            {grupos.length === 0 && (
              <p className="text-[10px] text-dim/70">
                Nenhum canal cadastrado — crie um em <LinkAdmin grupo="comunicacao" aba="teams" novaAba /> antes de notificar.
              </p>
            )}
          </div>
