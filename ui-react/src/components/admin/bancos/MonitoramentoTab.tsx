...
// Seção de baixo de Integrações › Bancos & Monitoramento (abas/BancosTab.tsx).
// Até a F2 de docs/spec-admin-reestruturacao.md era a aba própria
// "Monitoramento de tabelas" (abas/MonitoramentoTab.tsx); o conteúdo não mudou.
