...
// Modal + Checkbox nativos (F7). Consumido pelo CreditCardLinkDialogOrq; na
...
interface SendOptionsDialogOrqProps {
  title: string;
  description: string;
  open: boolean;
  onClose: () => void;
...
export default function SendOptionsDialogOrq({ title, description, open, onClose, clientEmail, clientPhone }: SendOptionsDialogOrqProps) {
