...
import ProposalTimelineOrq from "./ProposalTimelineOrq";
import ProposalShareDialogOrq from "./ProposalShareDialogOrq";
import ProposalHistoryDialogOrq from "./ProposalHistoryDialogOrq";
...
interface ProposalDetailDialogOrqProps {
...
export default function ProposalDetailDialogOrq({ proposal, open, onClose }: ProposalDetailDialogOrqProps) {
    ...
    <>
      <Modal open={open} onClose={onClose} title="Resumo do seguro" size="xl">
        <div className="space-y-6">
          ...
          <ProposalTimelineOrq currentStatus={proposal.status} />
