...
// claro+escuro (sem as vars do tema shadcn aposentado).
...
export default function ProposalHistoryDialog({ proposalNumber, open, onClose }: ProposalHistoryDialogProps) {
  return (
