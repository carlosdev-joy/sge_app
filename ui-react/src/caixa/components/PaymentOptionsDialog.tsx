...
// original preservado) e cartão de crédito (CreditCardLinkDialog da F7).
...
export default function PaymentOptionsDialog({ proposal, open, onClose }: PaymentOptionsDialogProps) {
