...
import {
  PROPOSTAS as mockProposals,
  type Proposta,
  type PropostaStatus,
  type DocumentSubStatus as DocumentSubStatusLib,
  type SignedSubStatus as SignedSubStatusLib,
  type RefundSubStatus as RefundSubStatusLib,
  type PaymentSubStatus as PaymentSubStatusLib,
} from "../lib/propostas";
...
// Tipos e dados vêm de lib/propostas — a MESMA base que a Consulta de Proposta
// lê. Antes cada tela tinha o seu mock e buscar aqui um número de lá não
// devolvia nada.
type ProposalStatus = PropostaStatus;
type DocumentSubStatus = DocumentSubStatusLib;
type SignedSubStatus = SignedSubStatusLib;
type RefundSubStatus = RefundSubStatusLib;
type PaymentSubStatus = PaymentSubStatusLib;
