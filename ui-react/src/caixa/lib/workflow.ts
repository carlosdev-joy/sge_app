...
export interface PropostaWorkflow {
  ...
  /** O **PRÊMIO** da proposta, já formatado — a mensalidade do seguro, que é o
   *  valor exibido ao lado do produto no card e na coluna "Prêmio" da busca.
   *  Nas propostas da carga vem de `VLR_PREMIO`.
   *
   *  ⚠️ Não é renda nem capital segurado. As propostas de exemplo traziam
   *  valores na casa dos milhares (R$ 1.750,00 para um seguro de vida), o que
   *  fazia a mesma tela mostrar mensalidade real ao lado de renda inventada.
   *  Corrigido em 2026-09-01: exemplo novo entra com valor de mensalidade, e
   *  `tests/test_caixa_workflow_sequencia.py` reprova o contrário. */
  value: string;
  indicatorId: string;
  agency: string;
  cpf: string;
...
export const propostasWorkflow: PropostaWorkflow[] = [
  ...
  { id: "1", number: "80316460327404", insuredName: "Maria Silva", status: "pending_signature", value: "R$ 89,90", product: "Perda de Renda", region: "Sul", ageRange: "45-60", broker: "Mariana", daysInPending: 5, date: "23/10/2025", indicatorId: "106562-2", agency: "316", cpf: "397.750.878-48", phone: "(11) 98765-4321", email: "maria@example.com" },
  { id: "4", number: "80316460327407", insuredName: "Carlos Oliveira", status: "pending_signature", value: "R$ 129,90", product: "Vida Conforto", region: "Nordeste", ageRange: "25-35", broker: "Carlos", daysInPending: 6, date: "20/10/2025", indicatorId: "106565-5", agency: "313", cpf: "345.678.901-22", phone: "(11) 98765-4324", email: "carlos@example.com" },
  ...
  { id: "12", number: "80316460327415", insuredName: "Pedro Santos", status: "awaiting_payment", value: "R$ 214,90", product: "Vida Multipremiado", region: "Sudeste", ageRange: "30-40", broker: "Pedro", daysInPending: 4, date: "12/10/2025", indicatorId: "106573-3", agency: "305", cpf: "123.456.789-10", phone: "(11) 98765-4332", email: "pedro@example.com", paymentMethod: "debit", pagamentoSubStatus: "payment_cycle" },
  { id: "13", number: "80316460327416", insuredName: "Lucia Oliveira", status: "awaiting_payment", value: "R$ 104,70", product: "Vida Conforto", region: "Norte", ageRange: "45-60", broker: "Lucia", daysInPending: 6, date: "11/10/2025", indicatorId: "106574-4", agency: "304", cpf: "234.567.890-21", phone: "(11) 98765-4333", email: "lucia@example.com", paymentMethod: "boleto", pagamentoSubStatus: "payment_cycle" },
  { id: "13b", number: "80316460327414", insuredName: "Antonio Souza", status: "awaiting_payment", value: "R$ 189,60", product: "Vida Multipremiado", region: "Centro-Oeste", ageRange: "35-50", broker: "Antonio", daysInPending: 3, date: "11/10/2025", indicatorId: "106574-5", agency: "304", cpf: "345.678.901-43", phone: "(11) 98765-4337", email: "antonio@example.com", paymentMethod: "credit", pagamentoSubStatus: "payment_cycle" },
  { id: "15", number: "80316460327418", insuredName: "Adriana Lima", status: "awaiting_payment", value: "R$ 74,50", product: "Perda de Renda", region: "Nordeste", ageRange: "35-50", broker: "Adriana", daysInPending: 0, date: "09/10/2025", indicatorId: "106576-6", agency: "302", cpf: "456.789.012-43", phone: "(11) 98765-4335", email: "adriana@example.com", paymentMethod: "boleto", pagamentoSubStatus: "payment_ended", policy: "12345678" },

  // 3 — Assinada e paga
  { id: "2", number: "80316460327405", insuredName: "João Santos", status: "paid", value: "R$ 246,80", product: "Vida Multipremiado", region: "Sudeste", ageRange: "30-40", broker: "João", daysInPending: 0, date: "22/10/2025", indicatorId: "106563-3", agency: "315", cpf: "123.456.789-00", phone: "(11) 98765-4322", email: "joao@example.com" },
  ...
  { id: "3", number: "80316460327406", insuredName: "Ana Costa", status: "in_analysis", value: "R$ 156,40", product: "Vida Mulher", region: "Sul", ageRange: "50-65", broker: "Ana", daysInPending: 8, date: "21/10/2025", indicatorId: "106564-4", agency: "314", cpf: "234.567.890-11", phone: "(11) 98765-4323", email: "ana@example.com", analiseSubStatus: "incomplete" },
  { id: "9", number: "80316460327412", insuredName: "Juliana Costa", status: "in_analysis", value: "R$ 148,20", product: "Vida Conforto", region: "Nordeste", ageRange: "30-45", broker: "Juliana", daysInPending: 10, date: "15/10/2025", indicatorId: "106570-0", agency: "308", cpf: "890.123.456-77", phone: "(11) 98765-4329", email: "juliana@example.com", analiseSubStatus: "mismatch" },
  { id: "10", number: "80316460327413", insuredName: "Roberto Silva", status: "in_analysis", value: "R$ 132,80", product: "Vida Mulher", region: "Sul", ageRange: "40-55", broker: "Roberto", daysInPending: 7, date: "14/10/2025", indicatorId: "106571-1", agency: "307", cpf: "901.234.567-88", phone: "(11) 98765-4330", email: "roberto@example.com", analiseSubStatus: "no_signature" },
  { id: "11", number: "80316460327414", insuredName: "Carla Mendes", status: "in_analysis", value: "R$ 112,30", product: "Perda de Renda", region: "Centro-Oeste", ageRange: "35-50", broker: "Carla", daysInPending: 12, date: "13/10/2025", indicatorId: "106572-2", agency: "306", cpf: "012.345.678-99", phone: "(11) 98765-4331", email: "carla@example.com", analiseSubStatus: "illegible" },
  { id: "14", number: "80316460327417", insuredName: "Marcos Costa", status: "in_analysis", value: "R$ 178,90", product: "Vida Mulher", region: "Sul", ageRange: "50-65", broker: "Marcos", daysInPending: 5, date: "10/10/2025", indicatorId: "106575-5", agency: "303", cpf: "345.678.901-32", phone: "(11) 98765-4334", email: "marcos@example.com", analiseSubStatus: "dps" },

  // 5 — Emitidas
  { id: "18", number: "80316460327421", insuredName: "Sergio Barbosa", status: "emission_sent", value: "R$ 117,50", product: "Vida Conforto", region: "Sul", ageRange: "40-55", broker: "Sergio", daysInPending: 0, date: "06/10/2025", indicatorId: "106579-9", agency: "299", cpf: "789.012.345-76", phone: "(11) 98765-4339", email: "sergio@example.com", policy: "45678901" },
  ...
  { id: "19", number: "80316460327422", insuredName: "Tatiane Rocha", status: "declined", value: "R$ 141,20", product: "Vida Mulher", region: "Sudeste", ageRange: "30-45", broker: "Tatiane", daysInPending: 3, date: "05/10/2025", indicatorId: "106580-0", agency: "298", cpf: "890.123.456-87", phone: "(11) 98765-4340", email: "tatiane@example.com", declineReason: "Divergência entre a renda declarada e a comprovada. Proposta recusada na análise.", refundSubStatus: "scheduled" },

  // 7 — Devolução de prêmio de propostas rejeitadas
  { id: "5", number: "80316460327408", insuredName: "Fernanda Lima", status: "refund_scheduled", value: "R$ 96,80", product: "Perda de Renda", region: "Centro-Oeste", ageRange: "35-50", broker: "Fernanda", daysInPending: 0, date: "19/10/2025", indicatorId: "106566-6", agency: "312", cpf: "456.789.012-33", phone: "(11) 98765-4325", email: "fernanda@example.com", declineReason: "Renda insuficiente para o valor solicitado. Perfil de risco não compatível com os critérios de aceitação.", refundSubStatus: "scheduled", policy: "34567890" },
  { id: "7", number: "80316460327410", insuredName: "Paula Rodrigues", status: "refund_scheduled", value: "R$ 93,60", product: "Vida Conforto", region: "Norte", ageRange: "40-55", broker: "Paula", daysInPending: 0, date: "17/10/2025", indicatorId: "106568-8", agency: "310", cpf: "678.901.234-55", phone: "(11) 98765-4327", email: "paula@example.com", declineReason: "Histórico de saúde pré-existente incompatível com as condições da apólice. Necessária reavaliação médica.", refundSubStatus: "scheduled", policy: "45678901" },
  { id: "16", number: "80316460327419", insuredName: "Ricardo Santos", status: "refund_scheduled", value: "R$ 119,70", product: "Vida Mulher", region: "Sul", ageRange: "40-55", broker: "Ricardo", daysInPending: 7, date: "08/10/2025", indicatorId: "106577-7", agency: "301", cpf: "567.890.123-54", phone: "(11) 98765-4336", email: "ricardo@example.com", declineReason: "Informações inconsistentes na documentação.", refundSubStatus: "pending_value", policy: "23456789" },

  // 8 — Monitoramento de sensibilização
  { id: "6", number: "80316460327409", insuredName: "Rafael Mendes", status: "sensitization_monitoring", value: "R$ 164,30", product: "Vida Mulher", region: "Sudeste", ageRange: "28-45", broker: "Rafael", daysInPending: 2, date: "18/10/2025", indicatorId: "106567-7", agency: "311", cpf: "567.890.123-44", phone: "(11) 98765-4326", email: "rafael@example.com" },
  { id: "8", number: "80316460327411", insuredName: "Bruno Alves", status: "sensitization_monitoring", value: "R$ 68,40", product: "Perda de Renda", region: "Sul", ageRange: "35-50", broker: "Bruno", daysInPending: 4, date: "16/10/2025", indicatorId: "106569-9", agency: "309", cpf: "789.012.345-66", phone: "(11) 98765-4328", email: "bruno@example.com" },
];
