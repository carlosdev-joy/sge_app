...
- [Spec Notificação por e-mail](orquestra-spec-notificacao-email.md) — ✅ APROVADA 2026-09-10; 🔧 **F1 = PR #388 ABERTA, aguarda autorização de merge**; envio por `sendmail -t -i -f` via SSH no servidor do DataStage; F2 = nó `email`, F3 = Teams em runtime, F4 = docs/smoke
