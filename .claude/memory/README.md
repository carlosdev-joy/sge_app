...
- [Spec E-mail: modelos e navegação do anexo](orquestra-spec-email-modelos-navegacao.md) — ✅ APROVADA (modelo "exigido com escape"); ✅ F1 MERGEADA (PR #393 `35bbe2f`, prévia em iframe isolado); 🔧 **F2 em revisão** (catálogo `etl_email_modelo` + migration 112, 2 rodadas adversariais, smoke 22/22); ⚠️ regra: padronização só vale COM catálogo, e a régua do salvar aceita modelo INATIVO; F3 seletor de arquivo, F4 docs
