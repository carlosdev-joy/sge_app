...
- [Spec Notificação por e-mail](orquestra-spec-notificacao-email.md) — ✅ F1 (#388) e F2 (#389 `0acc4d5`) MERGEADAS, ⏳ deploy conjunto pendente (111 na 6c + restart do worker); 🔧 **F3 = PR #390 ABERTA** (Teams em runtime; exige republicar 1× os pipelines com notificação); F4 = docs/smoke
