...
- [Spec Notificação por e-mail](orquestra-spec-notificacao-email.md) — ✅ **F1 (#388 `2e94d1d`) e F2 (#389 `0acc4d5`) MERGEADAS**, ⏳ deploy conjunto PENDENTE (111 na 6c + restart do worker); 🔧 F3 = Teams em runtime, F4 = docs/smoke; a DAG não embute config
