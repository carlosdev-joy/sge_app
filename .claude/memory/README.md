...
- [Spec Notificação por e-mail](orquestra-spec-notificacao-email.md) — ✅ F1 MERGEADA (PR #388 `2e94d1d`), ⏳ deploy pendente; 🔧 **F2 = PR #389 ABERTA, aguarda autorização**; a DAG NÃO embute config (muda destinatário sem republicar); F3 = Teams em runtime, F4 = docs/smoke
