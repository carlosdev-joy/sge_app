...
- [Spec Notificação por e-mail](orquestra-spec-notificacao-email.md) — ✅ F1 (#388), F2 (#389), F3 (#390) MERGEADAS; 🔧 **F4 = PR #391 ABERTA** (docs + 2 defeitos de código achados pela revisão da DOC) → ao mergear a spec FECHA; ⏳ deploy conjunto: 111 na 6c, restart do worker, recriar API+worker, **regerar as DAGs**
