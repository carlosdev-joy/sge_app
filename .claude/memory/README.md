...
- [Spec Notificação por e-mail](orquestra-spec-notificacao-email.md) — ✅ APROVADA 2026-09-10 (`docs/spec-notificacao-email.md`); 🔧 F1 (migration 111 + Admin › E-mail + envio de teste) em PR na branch `feat/email-f1`; envio por `sendmail -t -i -f` via SSH no servidor do DataStage
