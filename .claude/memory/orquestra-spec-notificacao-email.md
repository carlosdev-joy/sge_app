...
**Spec:** `docs/spec-notificacao-email.md` no repo Orquestra. **Status: APROVADA 2026-09-10 ("aprovado", decisões assumidas de §8 aceitas); 🔧 F1 EM ANDAMENTO na branch `feat/email-f1`.** Origem: documento do usuário `2026-09-10-notificacao-email.md` (enviado pelos Utilitários do DEV para `/dados/bi` do container `orquestra-dev-sshd-amostra`), avaliado contra o código.
