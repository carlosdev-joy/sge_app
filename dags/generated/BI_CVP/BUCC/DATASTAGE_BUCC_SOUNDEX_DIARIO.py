...
# Pipeline: DATASTAGE_BUCC_SOUNDEX_DIARIO | Projeto: BI_CVP | Dominio: BUCC
# =========================
DAG_ID        = "DATASTAGE_BUCC_SOUNDEX_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "BUCC"
PIPELINE_NAME = "DATASTAGE_BUCC_SOUNDEX_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_BUCC_SOUNDEX_DIARIO - BI_CVP / BUCC",
    start_date=pendulum.datetime(2026, 6, 18, tz=LOCAL_TZ),
    schedule="0 1 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'BUCC', 'DATASTAGE', 'SOUNDEX', 'DIARIO'],
) as dag:
    ...
    t_start_SeqCvpBi_BUCC_SOUNDEX = PythonOperator(
        task_id="log_start_SeqCvpBi_BUCC_SOUNDEX",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqCvpBi_BUCC_SOUNDEX", "task_key": "SeqCvpBi_BUCC_SOUNDEX"},
    )

    t_job_SeqCvpBi_BUCC_SOUNDEX = DataStageOperator(
        task_id="SeqCvpBi_BUCC_SOUNDEX",
        project=PROJECT_NAME,
        job_name="SeqCvpBi_BUCC_SOUNDEX",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqCvpBi_BUCC_SOUNDEX = PythonOperator(
        task_id="log_end_SeqCvpBi_BUCC_SOUNDEX",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqCvpBi_BUCC_SOUNDEX", "task_key": "SeqCvpBi_BUCC_SOUNDEX", "upstream_task_id": "SeqCvpBi_BUCC_SOUNDEX"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqCvpBi_BUCC_SOUNDEX >> t_teams_start >> t_job_SeqCvpBi_BUCC_SOUNDEX >> t_end_SeqCvpBi_BUCC_SOUNDEX

    end_tasks = [t_end_SeqCvpBi_BUCC_SOUNDEX]

    [t_end_SeqCvpBi_BUCC_SOUNDEX] >> t_publish_dataset

    [t_end_SeqCvpBi_BUCC_SOUNDEX] >> t_teams_end

    [t_end_SeqCvpBi_BUCC_SOUNDEX] >> t_teams_error
