...
# Pipeline: DATASTAGE_ENVIA_CLIENTES_PF_DIARIO | Projeto: BI_CVP | Dominio: BUCC
# =========================
DAG_ID        = "DATASTAGE_ENVIA_CLIENTES_PF_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "BUCC"
PIPELINE_NAME = "DATASTAGE_ENVIA_CLIENTES_PF_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_ENVIA_CLIENTES_PF_DIARIO - BI_CVP / BUCC",
    start_date=pendulum.datetime(2026, 6, 20, tz=LOCAL_TZ),
    schedule="0 7 * * 1,2,3,4,5,6",
    catchup=False,
    max_active_runs=1,
    ...
    t_start_SEQ_ENVIA_CLIENTES_PF = PythonOperator(
        task_id="log_start_SEQ_ENVIA_CLIENTES_PF",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_ENVIA_CLIENTES_PF", "task_key": "SEQ_ENVIA_CLIENTES_PF"},
    )

    t_job_SEQ_ENVIA_CLIENTES_PF = DataStageOperator(
        task_id="SEQ_ENVIA_CLIENTES_PF",
        project=PROJECT_NAME,
        job_name="SEQ_ENVIA_CLIENTES_PF",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_ENVIA_CLIENTES_PF = PythonOperator(
        task_id="log_end_SEQ_ENVIA_CLIENTES_PF",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_ENVIA_CLIENTES_PF", "task_key": "SEQ_ENVIA_CLIENTES_PF", "upstream_task_id": "SEQ_ENVIA_CLIENTES_PF"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_ENVIA_CLIENTES_PF >> t_job_SEQ_ENVIA_CLIENTES_PF >> t_end_SEQ_ENVIA_CLIENTES_PF

    end_tasks = [t_end_SEQ_ENVIA_CLIENTES_PF]

    [t_end_SEQ_ENVIA_CLIENTES_PF] >> t_publish_dataset

    [t_end_SEQ_ENVIA_CLIENTES_PF] >> t_teams_error
