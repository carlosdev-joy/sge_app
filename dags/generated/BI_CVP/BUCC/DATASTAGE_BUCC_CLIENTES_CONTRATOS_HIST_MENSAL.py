...
# Pipeline: DATASTAGE_BUCC_CLIENTES_CONTRATOS_HIST_MENSAL | Projeto: BI_CVP | Dominio: BUCC
# =========================
DAG_ID        = "DATASTAGE_BUCC_CLIENTES_CONTRATOS_HIST_MENSAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "BUCC"
PIPELINE_NAME = "DATASTAGE_BUCC_CLIENTES_CONTRATOS_HIST_MENSAL"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_BUCC_CLIENTES_CONTRATOS_HIST_MENSAL"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqBiCvp_BaseClientesContratosHist_auto_']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_BUCC_CLIENTES_CONTRATOS_HIST_MENSAL - BI_CVP / BUCC",
    start_date=pendulum.datetime(2026, 6, 5, tz=LOCAL_TZ),
    schedule="0 5 5 * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'BUCC', 'DATASTAGE', 'CLIENTES', 'CONTRATOS', 'HIST', 'MENSAL'],
) as dag:
    ...
    t_start_SeqBiCvp_BaseClientesContratosHist_auto_ = PythonOperator(
        task_id="log_start_SeqBiCvp_BaseClientesContratosHist_auto_",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_BaseClientesContratosHist_auto_", "task_key": "SeqBiCvp_BaseClientesContratosHist_auto_"},
    )

    t_job_SeqBiCvp_BaseClientesContratosHist_auto_ = DataStageOperator(
        task_id="SeqBiCvp_BaseClientesContratosHist_auto_",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_BaseClientesContratosHist_auto_",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_BaseClientesContratosHist_auto_ = PythonOperator(
        task_id="log_end_SeqBiCvp_BaseClientesContratosHist_auto_",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_BaseClientesContratosHist_auto_", "task_key": "SeqBiCvp_BaseClientesContratosHist_auto_", "upstream_task_id": "SeqBiCvp_BaseClientesContratosHist_auto_"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_BaseClientesContratosHist_auto_ >> t_teams_start >> t_job_SeqBiCvp_BaseClientesContratosHist_auto_ >> t_end_SeqBiCvp_BaseClientesContratosHist_auto_

    end_tasks = [t_end_SeqBiCvp_BaseClientesContratosHist_auto_]

    [t_end_SeqBiCvp_BaseClientesContratosHist_auto_] >> t_publish_dataset

    [t_end_SeqBiCvp_BaseClientesContratosHist_auto_] >> t_teams_end

    [t_end_SeqBiCvp_BaseClientesContratosHist_auto_] >> t_teams_error
