...
# Pipeline: DATASTAGE_ENVIA_CLIENTES_PF_SEMANAL | Projeto: BI_CVP | Dominio: BUCC
# =========================
DAG_ID        = "DATASTAGE_ENVIA_CLIENTES_PF_SEMANAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "BUCC"
PIPELINE_NAME = "DATASTAGE_ENVIA_CLIENTES_PF_SEMANAL"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_ENVIA_CLIENTES_PF_SEMANAL"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SEQ_ENVIA_CLIENTES_PF_SEMANAL']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_ENVIA_CLIENTES_PF_SEMANAL - BI_CVP / BUCC",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 8 * * 0",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'BUCC', 'DATASTAGE', 'SEMANAL'],
) as dag:
    ...
    t_start_SEQ_ENVIA_CLIENTES_PF_SEMANAL = PythonOperator(
        task_id="log_start_SEQ_ENVIA_CLIENTES_PF_SEMANAL",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_ENVIA_CLIENTES_PF_SEMANAL", "task_key": "SEQ_ENVIA_CLIENTES_PF_SEMANAL"},
    )

    t_job_SEQ_ENVIA_CLIENTES_PF_SEMANAL = DataStageOperator(
        task_id="SEQ_ENVIA_CLIENTES_PF_SEMANAL",
        project=PROJECT_NAME,
        job_name="SEQ_ENVIA_CLIENTES_PF_SEMANAL",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_ENVIA_CLIENTES_PF_SEMANAL = PythonOperator(
        task_id="log_end_SEQ_ENVIA_CLIENTES_PF_SEMANAL",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_ENVIA_CLIENTES_PF_SEMANAL", "task_key": "SEQ_ENVIA_CLIENTES_PF_SEMANAL", "upstream_task_id": "SEQ_ENVIA_CLIENTES_PF_SEMANAL"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_ENVIA_CLIENTES_PF_SEMANAL >> t_job_SEQ_ENVIA_CLIENTES_PF_SEMANAL >> t_end_SEQ_ENVIA_CLIENTES_PF_SEMANAL

    end_tasks = [t_end_SEQ_ENVIA_CLIENTES_PF_SEMANAL]

    [t_end_SEQ_ENVIA_CLIENTES_PF_SEMANAL] >> t_publish_dataset

    [t_end_SEQ_ENVIA_CLIENTES_PF_SEMANAL] >> t_teams_error
