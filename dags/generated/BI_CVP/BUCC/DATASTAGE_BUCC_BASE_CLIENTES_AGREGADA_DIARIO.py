...
# Pipeline: DATASTAGE_BUCC_BASE_CLIENTES_AGREGADA_DIARIO | Projeto: BI_CVP | Dominio: BUCC
# =========================
DAG_ID        = "DATASTAGE_BUCC_BASE_CLIENTES_AGREGADA_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "BUCC"
PIPELINE_NAME = "DATASTAGE_BUCC_BASE_CLIENTES_AGREGADA_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_BUCC_BASE_CLIENTES_AGREGADA_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqBiCvp_BaseClientesAgregada']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_BUCC_BASE_CLIENTES_AGREGADA_DIARIO - BI_CVP / BUCC",
    start_date=pendulum.datetime(2026, 6, 15, tz=LOCAL_TZ),
    schedule="30 23 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'BUCC', 'DATASTAGE', 'CLIENTES', 'AGREGADA', 'DIARIA'],
) as dag:
    ...
    t_start_SeqBiCvp_BaseClientesAgregada = PythonOperator(
        task_id="log_start_SeqBiCvp_BaseClientesAgregada",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_BaseClientesAgregada", "task_key": "SeqBiCvp_BaseClientesAgregada"},
    )

    t_job_SeqBiCvp_BaseClientesAgregada = DataStageOperator(
        task_id="SeqBiCvp_BaseClientesAgregada",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_BaseClientesAgregada",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_BaseClientesAgregada = PythonOperator(
        task_id="log_end_SeqBiCvp_BaseClientesAgregada",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_BaseClientesAgregada", "task_key": "SeqBiCvp_BaseClientesAgregada", "upstream_task_id": "SeqBiCvp_BaseClientesAgregada"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_BaseClientesAgregada >> t_teams_start >> t_job_SeqBiCvp_BaseClientesAgregada >> t_end_SeqBiCvp_BaseClientesAgregada

    end_tasks = [t_end_SeqBiCvp_BaseClientesAgregada]

    [t_end_SeqBiCvp_BaseClientesAgregada] >> t_publish_dataset

    [t_end_SeqBiCvp_BaseClientesAgregada] >> t_teams_end

    [t_end_SeqBiCvp_BaseClientesAgregada] >> t_teams_error
