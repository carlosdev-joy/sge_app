...
# Pipeline: DATASTAGE_BUCC_CONTRATOS_DIARIO | Projeto: BI_CVP | Dominio: BUCC
# =========================
DAG_ID        = "DATASTAGE_BUCC_CONTRATOS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "BUCC"
PIPELINE_NAME = "DATASTAGE_BUCC_CONTRATOS_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_BUCC_CONTRATOS_DIARIO - BI_CVP / BUCC",
    start_date=pendulum.datetime(2026, 6, 16, tz=LOCAL_TZ),
    schedule="0 20 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'BUCC', 'DATASTAGE', 'CONTRATOS', 'DIARIO'],
) as dag:
    ...
    t_start_SeqBiCvp_BaseContratos_ = PythonOperator(
        task_id="log_start_SeqBiCvp_BaseContratos_",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_BaseContratos_", "task_key": "SeqBiCvp_BaseContratos_"},
    )

    t_job_SeqBiCvp_BaseContratos_ = DataStageOperator(
        task_id="SeqBiCvp_BaseContratos_",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_BaseContratos_",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_BaseContratos_ = PythonOperator(
        task_id="log_end_SeqBiCvp_BaseContratos_",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_BaseContratos_", "task_key": "SeqBiCvp_BaseContratos_", "upstream_task_id": "SeqBiCvp_BaseContratos_"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_BaseContratos_ >> t_teams_start >> t_job_SeqBiCvp_BaseContratos_ >> t_end_SeqBiCvp_BaseContratos_

    end_tasks = [t_end_SeqBiCvp_BaseContratos_]

    [t_end_SeqBiCvp_BaseContratos_] >> t_publish_dataset

    [t_end_SeqBiCvp_BaseContratos_] >> t_teams_end

    [t_end_SeqBiCvp_BaseContratos_] >> t_teams_error
