...
# Pipeline: DATASTAGE_ENVIA_CLIENTES_PJ_DIARIO | Projeto: BI_CVP | Dominio: BUCC
# =========================
DAG_ID        = "DATASTAGE_ENVIA_CLIENTES_PJ_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "BUCC"
PIPELINE_NAME = "DATASTAGE_ENVIA_CLIENTES_PJ_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_ENVIA_CLIENTES_PJ_DIARIO - BI_CVP / BUCC",
    ...
    t_start_SEQ_ENVIA_CLIENTES_PJ = PythonOperator(
        task_id="log_start_SEQ_ENVIA_CLIENTES_PJ",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_ENVIA_CLIENTES_PJ", "task_key": "SEQ_ENVIA_CLIENTES_PJ"},
    )

    t_job_SEQ_ENVIA_CLIENTES_PJ = DataStageOperator(
        task_id="SEQ_ENVIA_CLIENTES_PJ",
        project=PROJECT_NAME,
        job_name="SEQ_ENVIA_CLIENTES_PJ",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_ENVIA_CLIENTES_PJ = PythonOperator(
        task_id="log_end_SEQ_ENVIA_CLIENTES_PJ",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_ENVIA_CLIENTES_PJ", "task_key": "SEQ_ENVIA_CLIENTES_PJ", "upstream_task_id": "SEQ_ENVIA_CLIENTES_PJ"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_ENVIA_CLIENTES_PJ >> t_job_SEQ_ENVIA_CLIENTES_PJ >> t_end_SEQ_ENVIA_CLIENTES_PJ

    end_tasks = [t_end_SEQ_ENVIA_CLIENTES_PJ]

    [t_end_SEQ_ENVIA_CLIENTES_PJ] >> t_publish_dataset

    [t_end_SEQ_ENVIA_CLIENTES_PJ] >> t_teams_error
