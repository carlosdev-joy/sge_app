...
# Pipeline: DATASTAGE_BUCC_CLIENTES_CONTRATOS_DIARIO | Projeto: BI_CVP | Dominio: BUCC
# =========================
DAG_ID        = "DATASTAGE_BUCC_CLIENTES_CONTRATOS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "BUCC"
PIPELINE_NAME = "DATASTAGE_BUCC_CLIENTES_CONTRATOS_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_BUCC_CLIENTES_CONTRATOS_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['BiCvp_BaseUnicaClientes_diaria', 'SeqBiCvp_BaseUnicaClientesContrato_']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_BUCC_CLIENTES_CONTRATOS_DIARIO - BI_CVP / BUCC",
    start_date=pendulum.datetime(2026, 6, 19, tz=LOCAL_TZ),
    schedule="0 20 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'BUCC', 'DATASTAGE', 'CLIENTES', 'CONTRATOS', 'DIARIO'],
) as dag:
    ...
    t_start_BiCvp_BaseUnicaClientes_diaria = PythonOperator(
        task_id='log_start_BiCvp_BaseUnicaClientes_diaria',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_BaseUnicaClientes_diaria', "task_key": 'BiCvp_BaseUnicaClientes_diaria'},
    )

    t_job_BiCvp_BaseUnicaClientes_diaria = DataStageOperator(
        task_id='BiCvp_BaseUnicaClientes_diaria',
        project=PROJECT_NAME,
        job_name='BiCvp_BaseUnicaClientes_diaria',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_BaseUnicaClientes_diaria = PythonOperator(
        task_id='log_end_BiCvp_BaseUnicaClientes_diaria',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_BaseUnicaClientes_diaria', "task_key": 'BiCvp_BaseUnicaClientes_diaria', "upstream_task_id": 'BiCvp_BaseUnicaClientes_diaria'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SeqBiCvp_BaseUnicaClientesContrato_ = PythonOperator(
        task_id='log_start_SeqBiCvp_BaseUnicaClientesContrato_',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqBiCvp_BaseUnicaClientesContrato_', "task_key": 'SeqBiCvp_BaseUnicaClientesContrato_'},
    )

    t_job_SeqBiCvp_BaseUnicaClientesContrato_ = DataStageOperator(
        task_id='SeqBiCvp_BaseUnicaClientesContrato_',
        project=PROJECT_NAME,
        job_name='SeqBiCvp_BaseUnicaClientesContrato_',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_BaseUnicaClientesContrato_ = PythonOperator(
        task_id='log_end_SeqBiCvp_BaseUnicaClientesContrato_',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqBiCvp_BaseUnicaClientesContrato_', "task_key": 'SeqBiCvp_BaseUnicaClientesContrato_', "upstream_task_id": 'SeqBiCvp_BaseUnicaClientesContrato_'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_BiCvp_BaseUnicaClientes_diaria >> t_teams_start >> t_job_BiCvp_BaseUnicaClientes_diaria >> t_end_BiCvp_BaseUnicaClientes_diaria

    t_check_agenda >> t_start_SeqBiCvp_BaseUnicaClientesContrato_ >> t_job_SeqBiCvp_BaseUnicaClientesContrato_ >> t_end_SeqBiCvp_BaseUnicaClientesContrato_

    end_tasks = [t_end_BiCvp_BaseUnicaClientes_diaria, t_end_SeqBiCvp_BaseUnicaClientesContrato_]

    [t_end_BiCvp_BaseUnicaClientes_diaria, t_end_SeqBiCvp_BaseUnicaClientesContrato_] >> t_publish_dataset

    [t_end_BiCvp_BaseUnicaClientes_diaria, t_end_SeqBiCvp_BaseUnicaClientesContrato_] >> t_teams_end

    [t_end_BiCvp_BaseUnicaClientes_diaria, t_end_SeqBiCvp_BaseUnicaClientesContrato_] >> t_teams_error
