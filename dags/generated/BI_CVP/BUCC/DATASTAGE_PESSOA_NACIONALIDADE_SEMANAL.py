...
# Pipeline: DATASTAGE_PESSOA_NACIONALIDADE_SEMANAL | Projeto: BI_CVP | Dominio: BUCC
# =========================
DAG_ID        = "DATASTAGE_PESSOA_NACIONALIDADE_SEMANAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "BUCC"
PIPELINE_NAME = "DATASTAGE_PESSOA_NACIONALIDADE_SEMANAL"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_PESSOA_NACIONALIDADE_SEMANAL"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqBiCvp_PessoaNacionalidade']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_PESSOA_NACIONALIDADE_SEMANAL - BI_CVP / BUCC",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 2 * * 0",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'BUCC', 'DATASTAGE', 'NACIONALIDADE', 'SEMANAL'],
) as dag:
    ...
    t_start_SeqBiCvp_PessoaNacionalidade = PythonOperator(
        task_id="log_start_SeqBiCvp_PessoaNacionalidade",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_PessoaNacionalidade", "task_key": "SeqBiCvp_PessoaNacionalidade"},
    )

    t_job_SeqBiCvp_PessoaNacionalidade = DataStageOperator(
        task_id="SeqBiCvp_PessoaNacionalidade",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_PessoaNacionalidade",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_PessoaNacionalidade = PythonOperator(
        task_id="log_end_SeqBiCvp_PessoaNacionalidade",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_PessoaNacionalidade", "task_key": "SeqBiCvp_PessoaNacionalidade", "upstream_task_id": "SeqBiCvp_PessoaNacionalidade"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_PessoaNacionalidade >> t_job_SeqBiCvp_PessoaNacionalidade >> t_end_SeqBiCvp_PessoaNacionalidade

    end_tasks = [t_end_SeqBiCvp_PessoaNacionalidade]

    [t_end_SeqBiCvp_PessoaNacionalidade] >> t_publish_dataset

    [t_end_SeqBiCvp_PessoaNacionalidade] >> t_teams_error
