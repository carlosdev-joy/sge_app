...
# Pipeline: DATASTAGE_BUCC_NOME_SOCIAL_DIARIO | Projeto: BI_CVP | Dominio: BUCC
# =========================
DAG_ID        = "DATASTAGE_BUCC_NOME_SOCIAL_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "BUCC"
PIPELINE_NAME = "DATASTAGE_BUCC_NOME_SOCIAL_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_BUCC_NOME_SOCIAL_DIARIO - BI_CVP / BUCC",
    start_date=pendulum.datetime(2026, 6, 16, tz=LOCAL_TZ),
    schedule="20 6 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'BUCC', 'DATASTAGE', 'NOME_SOCIAL', 'DIARIO'],
) as dag:
    ...
    t_start_SeqBiCvp_BaseUnicaNomeSocial = PythonOperator(
        task_id="log_start_SeqBiCvp_BaseUnicaNomeSocial",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_BaseUnicaNomeSocial", "task_key": "SeqBiCvp_BaseUnicaNomeSocial"},
    )

    t_job_SeqBiCvp_BaseUnicaNomeSocial = DataStageOperator(
        task_id="SeqBiCvp_BaseUnicaNomeSocial",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_BaseUnicaNomeSocial",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_BaseUnicaNomeSocial = PythonOperator(
        task_id="log_end_SeqBiCvp_BaseUnicaNomeSocial",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_BaseUnicaNomeSocial", "task_key": "SeqBiCvp_BaseUnicaNomeSocial", "upstream_task_id": "SeqBiCvp_BaseUnicaNomeSocial"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_BaseUnicaNomeSocial >> t_teams_start >> t_job_SeqBiCvp_BaseUnicaNomeSocial >> t_end_SeqBiCvp_BaseUnicaNomeSocial

    end_tasks = [t_end_SeqBiCvp_BaseUnicaNomeSocial]

    [t_end_SeqBiCvp_BaseUnicaNomeSocial] >> t_publish_dataset

    [t_end_SeqBiCvp_BaseUnicaNomeSocial] >> t_teams_end

    [t_end_SeqBiCvp_BaseUnicaNomeSocial] >> t_teams_error
