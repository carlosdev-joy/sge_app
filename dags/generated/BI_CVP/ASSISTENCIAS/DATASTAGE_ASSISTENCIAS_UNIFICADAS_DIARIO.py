...
# Pipeline: DATASTAGE_ASSISTENCIAS_UNIFICADAS_DIARIO | Projeto: BI_CVP | Dominio: ASSISTENCIAS
# =========================
DAG_ID        = "DATASTAGE_ASSISTENCIAS_UNIFICADAS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "ASSISTENCIAS"
PIPELINE_NAME = "DATASTAGE_ASSISTENCIAS_UNIFICADAS_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_ASSISTENCIAS_UNIFICADAS_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['BICVP_AssistenciasUnificadas_001', 'BICVP_AssistenciasUnificadas_ext_vida', 'BICVP_AssistenciasUnificadas_002', 'BICVP_AssistenciasUnificadas_003']
FLOW_JOBS     = ['BICVP_AssistenciasUnificadas_001', 'BICVP_AssistenciasUnificadas_ext_vida', 'BICVP_AssistenciasUnificadas_002', 'BICVP_AssistenciasUnificadas_003']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_ASSISTENCIAS_UNIFICADAS_DIARIO - BI_CVP / ASSISTENCIAS",
    start_date=pendulum.datetime(2026, 6, 12, tz=LOCAL_TZ),
    schedule="50 21 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'ASSISTENCIAS', 'DATASTAGE'],
) as dag:
    ...
    t_start_BICVP_AssistenciasUnificadas_001 = PythonOperator(
        task_id='log_start_BICVP_AssistenciasUnificadas_001',
        python_callable=log_start,
        op_kwargs={"job_name": 'BICVP_AssistenciasUnificadas_001', "task_key": 'BICVP_AssistenciasUnificadas_001'},
    )

    t_job_BICVP_AssistenciasUnificadas_001 = DataStageOperator(
        task_id='BICVP_AssistenciasUnificadas_001',
        project=PROJECT_NAME,
        job_name='BICVP_AssistenciasUnificadas_001',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BICVP_AssistenciasUnificadas_001 = PythonOperator(
        task_id='log_end_BICVP_AssistenciasUnificadas_001',
        python_callable=log_end,
        op_kwargs={"job_name": 'BICVP_AssistenciasUnificadas_001', "task_key": 'BICVP_AssistenciasUnificadas_001', "upstream_task_id": 'BICVP_AssistenciasUnificadas_001'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BICVP_AssistenciasUnificadas_ext_vida = PythonOperator(
        task_id='log_start_BICVP_AssistenciasUnificadas_ext_vida',
        python_callable=log_start,
        op_kwargs={"job_name": 'BICVP_AssistenciasUnificadas_ext_vida', "task_key": 'BICVP_AssistenciasUnificadas_ext_vida'},
    )

    t_job_BICVP_AssistenciasUnificadas_ext_vida = DataStageOperator(
        task_id='BICVP_AssistenciasUnificadas_ext_vida',
        project=PROJECT_NAME,
        job_name='BICVP_AssistenciasUnificadas_ext_vida',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BICVP_AssistenciasUnificadas_ext_vida = PythonOperator(
        task_id='log_end_BICVP_AssistenciasUnificadas_ext_vida',
        python_callable=log_end,
        op_kwargs={"job_name": 'BICVP_AssistenciasUnificadas_ext_vida', "task_key": 'BICVP_AssistenciasUnificadas_ext_vida', "upstream_task_id": 'BICVP_AssistenciasUnificadas_ext_vida'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BICVP_AssistenciasUnificadas_002 = PythonOperator(
        task_id='log_start_BICVP_AssistenciasUnificadas_002',
        python_callable=log_start,
        op_kwargs={"job_name": 'BICVP_AssistenciasUnificadas_002', "task_key": 'BICVP_AssistenciasUnificadas_002'},
    )

    t_job_BICVP_AssistenciasUnificadas_002 = DataStageOperator(
        task_id='BICVP_AssistenciasUnificadas_002',
        project=PROJECT_NAME,
        job_name='BICVP_AssistenciasUnificadas_002',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BICVP_AssistenciasUnificadas_002 = PythonOperator(
        task_id='log_end_BICVP_AssistenciasUnificadas_002',
        python_callable=log_end,
        op_kwargs={"job_name": 'BICVP_AssistenciasUnificadas_002', "task_key": 'BICVP_AssistenciasUnificadas_002', "upstream_task_id": 'BICVP_AssistenciasUnificadas_002'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BICVP_AssistenciasUnificadas_003 = PythonOperator(
        task_id='log_start_BICVP_AssistenciasUnificadas_003',
        python_callable=log_start,
        op_kwargs={"job_name": 'BICVP_AssistenciasUnificadas_003', "task_key": 'BICVP_AssistenciasUnificadas_003'},
    )

    t_job_BICVP_AssistenciasUnificadas_003 = DataStageOperator(
        task_id='BICVP_AssistenciasUnificadas_003',
        project=PROJECT_NAME,
        job_name='BICVP_AssistenciasUnificadas_003',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BICVP_AssistenciasUnificadas_003 = PythonOperator(
        task_id='log_end_BICVP_AssistenciasUnificadas_003',
        python_callable=log_end,
        op_kwargs={"job_name": 'BICVP_AssistenciasUnificadas_003', "task_key": 'BICVP_AssistenciasUnificadas_003', "upstream_task_id": 'BICVP_AssistenciasUnificadas_003'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_end_BICVP_AssistenciasUnificadas_ext_vida >> t_start_BICVP_AssistenciasUnificadas_001 >> t_job_BICVP_AssistenciasUnificadas_001 >> t_end_BICVP_AssistenciasUnificadas_001

    t_check_agenda >> t_start_BICVP_AssistenciasUnificadas_ext_vida >> t_teams_start >> t_job_BICVP_AssistenciasUnificadas_ext_vida >> t_end_BICVP_AssistenciasUnificadas_ext_vida

    t_end_BICVP_AssistenciasUnificadas_001 >> t_start_BICVP_AssistenciasUnificadas_002 >> t_job_BICVP_AssistenciasUnificadas_002 >> t_end_BICVP_AssistenciasUnificadas_002

    t_end_BICVP_AssistenciasUnificadas_002 >> t_start_BICVP_AssistenciasUnificadas_003 >> t_job_BICVP_AssistenciasUnificadas_003 >> t_end_BICVP_AssistenciasUnificadas_003

    end_tasks = [t_end_BICVP_AssistenciasUnificadas_001, t_end_BICVP_AssistenciasUnificadas_ext_vida, t_end_BICVP_AssistenciasUnificadas_002, t_end_BICVP_AssistenciasUnificadas_003]

    [t_end_BICVP_AssistenciasUnificadas_001, t_end_BICVP_AssistenciasUnificadas_ext_vida, t_end_BICVP_AssistenciasUnificadas_002, t_end_BICVP_AssistenciasUnificadas_003] >> t_publish_dataset

    [t_end_BICVP_AssistenciasUnificadas_001, t_end_BICVP_AssistenciasUnificadas_ext_vida, t_end_BICVP_AssistenciasUnificadas_002, t_end_BICVP_AssistenciasUnificadas_003] >> t_teams_end

    [t_end_BICVP_AssistenciasUnificadas_001, t_end_BICVP_AssistenciasUnificadas_ext_vida, t_end_BICVP_AssistenciasUnificadas_002, t_end_BICVP_AssistenciasUnificadas_003] >> t_teams_error
