...
# Pipeline: datastage_coberturas_unificadas_diario | Projeto: BI_CVP | Dominio: Coberturas
# =========================
DAG_ID        = "datastage_coberturas_unificadas_diario"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "Coberturas"
PIPELINE_NAME = "datastage_coberturas_unificadas_diario"
...
DATASET_URI   = "orq://pipeline/datastage_coberturas_unificadas_diario"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['BiCVP_CoberturasUnificadas_001', 'BiCVP_CoberturasUnificadas_002', 'BiCVP_CoberturasUnificadas_003', 'BiCVP_CoberturasUnificadas_004']
...
with DAG(
    ...
    description="Pipeline datastage_coberturas_unificadas_diario - BI_CVP / Coberturas",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule="0 9 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'Coberturas', 'datastage', 'COBERTURAS'],
) as dag:
    ...
    t_start_BiCVP_CoberturasUnificadas_001 = PythonOperator(
        task_id="log_start_BiCVP_CoberturasUnificadas_001",
        python_callable=log_start,
        op_kwargs={"job_name": "BiCVP_CoberturasUnificadas_001", "task_key": "BiCVP_CoberturasUnificadas_001"},
    )

    t_job_BiCVP_CoberturasUnificadas_001 = DataStageOperator(
        task_id="BiCVP_CoberturasUnificadas_001",
        project=PROJECT_NAME,
        job_name="BiCVP_CoberturasUnificadas_001",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCVP_CoberturasUnificadas_001 = PythonOperator(
        task_id="log_end_BiCVP_CoberturasUnificadas_001",
        python_callable=log_end,
        op_kwargs={"job_name": "BiCVP_CoberturasUnificadas_001", "task_key": "BiCVP_CoberturasUnificadas_001", "upstream_task_id": "BiCVP_CoberturasUnificadas_001"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCVP_CoberturasUnificadas_002 = PythonOperator(
        task_id="log_start_BiCVP_CoberturasUnificadas_002",
        python_callable=log_start,
        op_kwargs={"job_name": "BiCVP_CoberturasUnificadas_002", "task_key": "BiCVP_CoberturasUnificadas_002"},
    )

    t_job_BiCVP_CoberturasUnificadas_002 = DataStageOperator(
        task_id="BiCVP_CoberturasUnificadas_002",
        project=PROJECT_NAME,
        job_name="BiCVP_CoberturasUnificadas_002",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCVP_CoberturasUnificadas_002 = PythonOperator(
        task_id="log_end_BiCVP_CoberturasUnificadas_002",
        python_callable=log_end,
        op_kwargs={"job_name": "BiCVP_CoberturasUnificadas_002", "task_key": "BiCVP_CoberturasUnificadas_002", "upstream_task_id": "BiCVP_CoberturasUnificadas_002"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCVP_CoberturasUnificadas_003 = PythonOperator(
        task_id="log_start_BiCVP_CoberturasUnificadas_003",
        python_callable=log_start,
        op_kwargs={"job_name": "BiCVP_CoberturasUnificadas_003", "task_key": "BiCVP_CoberturasUnificadas_003"},
    )

    t_job_BiCVP_CoberturasUnificadas_003 = DataStageOperator(
        task_id="BiCVP_CoberturasUnificadas_003",
        project=PROJECT_NAME,
        job_name="BiCVP_CoberturasUnificadas_003",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCVP_CoberturasUnificadas_003 = PythonOperator(
        task_id="log_end_BiCVP_CoberturasUnificadas_003",
        python_callable=log_end,
        op_kwargs={"job_name": "BiCVP_CoberturasUnificadas_003", "task_key": "BiCVP_CoberturasUnificadas_003", "upstream_task_id": "BiCVP_CoberturasUnificadas_003"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCVP_CoberturasUnificadas_004 = PythonOperator(
        task_id="log_start_BiCVP_CoberturasUnificadas_004",
        python_callable=log_start,
        op_kwargs={"job_name": "BiCVP_CoberturasUnificadas_004", "task_key": "BiCVP_CoberturasUnificadas_004"},
    )

    t_job_BiCVP_CoberturasUnificadas_004 = DataStageOperator(
        task_id="BiCVP_CoberturasUnificadas_004",
        project=PROJECT_NAME,
        job_name="BiCVP_CoberturasUnificadas_004",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCVP_CoberturasUnificadas_004 = PythonOperator(
        task_id="log_end_BiCVP_CoberturasUnificadas_004",
        python_callable=log_end,
        op_kwargs={"job_name": "BiCVP_CoberturasUnificadas_004", "task_key": "BiCVP_CoberturasUnificadas_004", "upstream_task_id": "BiCVP_CoberturasUnificadas_004"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_BiCVP_CoberturasUnificadas_001 >> t_teams_start >> t_job_BiCVP_CoberturasUnificadas_001 >> t_end_BiCVP_CoberturasUnificadas_001

    t_end_BiCVP_CoberturasUnificadas_001 >> t_start_BiCVP_CoberturasUnificadas_002 >> t_job_BiCVP_CoberturasUnificadas_002 >> t_end_BiCVP_CoberturasUnificadas_002

    t_end_BiCVP_CoberturasUnificadas_002 >> t_start_BiCVP_CoberturasUnificadas_003 >> t_job_BiCVP_CoberturasUnificadas_003 >> t_end_BiCVP_CoberturasUnificadas_003

    t_end_BiCVP_CoberturasUnificadas_003 >> t_start_BiCVP_CoberturasUnificadas_004 >> t_job_BiCVP_CoberturasUnificadas_004 >> t_end_BiCVP_CoberturasUnificadas_004

    end_tasks = [t_end_BiCVP_CoberturasUnificadas_001, t_end_BiCVP_CoberturasUnificadas_002, t_end_BiCVP_CoberturasUnificadas_003, t_end_BiCVP_CoberturasUnificadas_004]

    [t_end_BiCVP_CoberturasUnificadas_001, t_end_BiCVP_CoberturasUnificadas_002, t_end_BiCVP_CoberturasUnificadas_003, t_end_BiCVP_CoberturasUnificadas_004] >> t_publish_dataset

    [t_end_BiCVP_CoberturasUnificadas_001, t_end_BiCVP_CoberturasUnificadas_002, t_end_BiCVP_CoberturasUnificadas_003, t_end_BiCVP_CoberturasUnificadas_004] >> t_teams_end
