...
# Pipeline: DATASTAGE_ENTRADA_SAIDA_COMERCIAL_SEMANAL | Projeto: BI_CVP | Dominio: COMERCIAL
# =========================
DAG_ID        = "DATASTAGE_ENTRADA_SAIDA_COMERCIAL_SEMANAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "COMERCIAL"
PIPELINE_NAME = "DATASTAGE_ENTRADA_SAIDA_COMERCIAL_SEMANAL"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_ENTRADA_SAIDA_COMERCIAL_SEMANAL"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqCvpBi_EntradaSaidaComercial']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_ENTRADA_SAIDA_COMERCIAL_SEMANAL - BI_CVP / COMERCIAL",
    start_date=pendulum.datetime(2026, 6, 22, tz=LOCAL_TZ),
    schedule="0 6 * * 1",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'COMERCIAL', 'DATASTAGE', 'ENTRADA', 'SAIDA', 'SEMANAL'],
) as dag:
    ...
    t_start_SeqCvpBi_EntradaSaidaComercial = PythonOperator(
        task_id="log_start_SeqCvpBi_EntradaSaidaComercial",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqCvpBi_EntradaSaidaComercial", "task_key": "SeqCvpBi_EntradaSaidaComercial"},
    )

    t_job_SeqCvpBi_EntradaSaidaComercial = DataStageOperator(
        task_id="SeqCvpBi_EntradaSaidaComercial",
        project=PROJECT_NAME,
        job_name="SeqCvpBi_EntradaSaidaComercial",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqCvpBi_EntradaSaidaComercial = PythonOperator(
        task_id="log_end_SeqCvpBi_EntradaSaidaComercial",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqCvpBi_EntradaSaidaComercial", "task_key": "SeqCvpBi_EntradaSaidaComercial", "upstream_task_id": "SeqCvpBi_EntradaSaidaComercial"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqCvpBi_EntradaSaidaComercial >> t_teams_start >> t_job_SeqCvpBi_EntradaSaidaComercial >> t_end_SeqCvpBi_EntradaSaidaComercial

    end_tasks = [t_end_SeqCvpBi_EntradaSaidaComercial]

    [t_end_SeqCvpBi_EntradaSaidaComercial] >> t_publish_dataset

    [t_end_SeqCvpBi_EntradaSaidaComercial] >> t_teams_end

    [t_end_SeqCvpBi_EntradaSaidaComercial] >> t_teams_error
