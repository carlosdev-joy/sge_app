...
# Pipeline: DATASTAGE_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_DIARIO | Projeto: BI_CVP | Dominio: SALES_FORCE_MKT_CLOUD
# =========================
DAG_ID        = "DATASTAGE_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE_MKT_CLOUD"
PIPELINE_NAME = "DATASTAGE_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_DIARIO - BI_CVP / SALES_FORCE_MKT_CLOUD",
    start_date=pendulum.datetime(2026, 6, 20, tz=LOCAL_TZ),
    schedule="0 7 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SALES_FORCE_MKT_CLOUD', 'DATASTAGE', 'SALES_FORCE', 'MKT_CLOUD', 'WHATSAPP', 'DIARIO'],
) as dag:
    ...
    t_start_SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp = PythonOperator(
        task_id="log_start_SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp", "task_key": "SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp"},
    )

    t_job_SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp = DataStageOperator(
        task_id="SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp = PythonOperator(
        task_id="log_end_SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp", "task_key": "SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp", "upstream_task_id": "SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp >> t_job_SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp >> t_end_SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp

    end_tasks = [t_end_SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp]

    [t_end_SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp] >> t_publish_dataset

    [t_end_SeqBiCvp_Sf_MktCloud_Comunicacao_WhatsApp] >> t_teams_error
