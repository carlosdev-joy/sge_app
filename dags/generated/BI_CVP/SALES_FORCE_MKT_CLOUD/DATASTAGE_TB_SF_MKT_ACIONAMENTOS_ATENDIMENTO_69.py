...
# Pipeline: DATASTAGE_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69 | Projeto: BI_CVP | Dominio: SALES_FORCE_MKT_CLOUD
# =========================
DAG_ID        = "DATASTAGE_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE_MKT_CLOUD"
PIPELINE_NAME = "DATASTAGE_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69 - BI_CVP / SALES_FORCE_MKT_CLOUD",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 1 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SALES_FORCE_MKT_CLOUD', 'ACIONAMENTOS', 'MKT_CLOUD', 'SALES_FORCE', 'BUCC'],
) as dag:
    ...
    t_start_SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69 = PythonOperator(
        task_id='log_start_SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69', "task_key": 'SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69'},
    )

    t_job_SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69 = DataStageOperator(
        task_id='SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69',
        project=PROJECT_NAME,
        job_name='SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69 = PythonOperator(
        task_id='log_end_SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69', "task_key": 'SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69', "upstream_task_id": 'SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69 >> t_job_SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69 >> t_end_SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69

    end_tasks = [t_end_SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69]

    [t_end_SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69] >> t_publish_dataset

    [t_end_SeqBiCvp_TB_SF_MKT_ACIONAMENTOS_ATENDIMENTO_69] >> t_teams_error
