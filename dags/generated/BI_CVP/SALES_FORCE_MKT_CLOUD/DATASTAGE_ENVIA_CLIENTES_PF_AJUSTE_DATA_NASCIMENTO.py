...
# Pipeline: DATASTAGE_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO | Projeto: BI_CVP | Dominio: SALES_FORCE_MKT_CLOUD
# =========================
DAG_ID        = "DATASTAGE_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE_MKT_CLOUD"
PIPELINE_NAME = "DATASTAGE_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO - BI_CVP / SALES_FORCE_MKT_CLOUD",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 8 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SALES_FORCE_MKT_CLOUD', 'AJUSTE_DATA_NASCIMENTO', 'SALES_FORCE'],
) as dag:
    ...
    t_start_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO = PythonOperator(
        task_id='log_start_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO',
        python_callable=log_start,
        op_kwargs={"job_name": 'ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO', "task_key": 'ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO'},
    )

    t_job_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO = DataStageOperator(
        task_id='ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO',
        project=PROJECT_NAME,
        job_name='ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO = PythonOperator(
        task_id='log_end_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO',
        python_callable=log_end,
        op_kwargs={"job_name": 'ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO', "task_key": 'ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO', "upstream_task_id": 'ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO >> t_job_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO >> t_end_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO

    end_tasks = [t_end_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO]

    [t_end_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO] >> t_publish_dataset

    [t_end_ENVIA_CLIENTES_PF_AJUSTE_DATA_NASCIMENTO] >> t_teams_error
