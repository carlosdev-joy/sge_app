...
# Pipeline: DATASTAGE_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING | Projeto: BI_CVP | Dominio: SALES_FORCE_MKT_CLOUD
# =========================
DAG_ID        = "DATASTAGE_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE_MKT_CLOUD"
PIPELINE_NAME = "DATASTAGE_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING - BI_CVP / SALES_FORCE_MKT_CLOUD",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 6 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SALES_FORCE_MKT_CLOUD', 'COMUNICACAO', 'TRACKING', 'WHATSAPP', 'MKT_CLOUD', 'SALES_FORCE'],
) as dag:
    ...
    t_start_SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING = PythonOperator(
        task_id='log_start_SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING', "task_key": 'SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING'},
    )

    t_job_SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING = DataStageOperator(
        task_id='SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING',
        project=PROJECT_NAME,
        job_name='SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING = PythonOperator(
        task_id='log_end_SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING', "task_key": 'SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING', "upstream_task_id": 'SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING >> t_job_SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING >> t_end_SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING

    end_tasks = [t_end_SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING]

    [t_end_SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING] >> t_publish_dataset

    [t_end_SeqBiCvp_SF_MKT_CLOUD_COMUNICACAO_WHATSAPP_TRACKING] >> t_teams_error
