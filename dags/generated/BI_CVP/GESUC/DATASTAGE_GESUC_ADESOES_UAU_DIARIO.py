...
# Pipeline: DATASTAGE_GESUC_ADESOES_UAU_DIARIO | Projeto: BI_CVP | Dominio: GESUC
# =========================
DAG_ID        = "DATASTAGE_GESUC_ADESOES_UAU_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "GESUC"
PIPELINE_NAME = "DATASTAGE_GESUC_ADESOES_UAU_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_GESUC_ADESOES_UAU_DIARIO - BI_CVP / GESUC",
    start_date=pendulum.datetime(2026, 6, 16, tz=LOCAL_TZ),
    schedule="0 7 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'GESUC', 'DATASTAGE', 'UAU', 'ADESOES', 'DIARIO'],
) as dag:
    ...
    t_start_Sequence_CvpBi_Programa_UAU = PythonOperator(
        task_id="log_start_Sequence_CvpBi_Programa_UAU",
        python_callable=log_start,
        op_kwargs={"job_name": "Sequence_CvpBi_Programa_UAU", "task_key": "Sequence_CvpBi_Programa_UAU"},
    )

    t_job_Sequence_CvpBi_Programa_UAU = DataStageOperator(
        task_id="Sequence_CvpBi_Programa_UAU",
        project=PROJECT_NAME,
        job_name="Sequence_CvpBi_Programa_UAU",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_Sequence_CvpBi_Programa_UAU = PythonOperator(
        task_id="log_end_Sequence_CvpBi_Programa_UAU",
        python_callable=log_end,
        op_kwargs={"job_name": "Sequence_CvpBi_Programa_UAU", "task_key": "Sequence_CvpBi_Programa_UAU", "upstream_task_id": "Sequence_CvpBi_Programa_UAU"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_Sequence_CvpBi_Programa_UAU >> t_teams_start >> t_job_Sequence_CvpBi_Programa_UAU >> t_end_Sequence_CvpBi_Programa_UAU

    end_tasks = [t_end_Sequence_CvpBi_Programa_UAU]

    [t_end_Sequence_CvpBi_Programa_UAU] >> t_publish_dataset

    [t_end_Sequence_CvpBi_Programa_UAU] >> t_teams_end

    [t_end_Sequence_CvpBi_Programa_UAU] >> t_teams_error
