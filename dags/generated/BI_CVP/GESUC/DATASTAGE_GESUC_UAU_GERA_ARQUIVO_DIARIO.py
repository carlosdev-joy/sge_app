...
# Pipeline: DATASTAGE_GESUC_UAU_GERA_ARQUIVO_DIARIO | Projeto: BI_CVP | Dominio: GESUC
# =========================
DAG_ID        = "DATASTAGE_GESUC_UAU_GERA_ARQUIVO_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "GESUC"
PIPELINE_NAME = "DATASTAGE_GESUC_UAU_GERA_ARQUIVO_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_GESUC_UAU_GERA_ARQUIVO_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['Sequence_CvpBi_Programa_UAU_Arquivos']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_GESUC_UAU_GERA_ARQUIVO_DIARIO - BI_CVP / GESUC",
    start_date=pendulum.datetime(2026, 6, 22, tz=LOCAL_TZ),
    schedule="30 14 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'GESUC', 'DATASTAGE', 'ARQUIVOS', 'UAU', 'DIARIO'],
) as dag:
    ...
    t_start_Sequence_CvpBi_Programa_UAU_Arquivos = PythonOperator(
        task_id='log_start_Sequence_CvpBi_Programa_UAU_Arquivos',
        python_callable=log_start,
        op_kwargs={"job_name": 'Sequence_CvpBi_Programa_UAU_Arquivos', "task_key": 'Sequence_CvpBi_Programa_UAU_Arquivos'},
    )

    t_job_Sequence_CvpBi_Programa_UAU_Arquivos = DataStageOperator(
        task_id='Sequence_CvpBi_Programa_UAU_Arquivos',
        project=PROJECT_NAME,
        job_name='Sequence_CvpBi_Programa_UAU_Arquivos',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_Sequence_CvpBi_Programa_UAU_Arquivos = PythonOperator(
        task_id='log_end_Sequence_CvpBi_Programa_UAU_Arquivos',
        python_callable=log_end,
        op_kwargs={"job_name": 'Sequence_CvpBi_Programa_UAU_Arquivos', "task_key": 'Sequence_CvpBi_Programa_UAU_Arquivos', "upstream_task_id": 'Sequence_CvpBi_Programa_UAU_Arquivos'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_Sequence_CvpBi_Programa_UAU_Arquivos >> t_job_Sequence_CvpBi_Programa_UAU_Arquivos >> t_end_Sequence_CvpBi_Programa_UAU_Arquivos

    end_tasks = [t_end_Sequence_CvpBi_Programa_UAU_Arquivos]

    [t_end_Sequence_CvpBi_Programa_UAU_Arquivos] >> t_publish_dataset

    [t_end_Sequence_CvpBi_Programa_UAU_Arquivos] >> t_teams_error
