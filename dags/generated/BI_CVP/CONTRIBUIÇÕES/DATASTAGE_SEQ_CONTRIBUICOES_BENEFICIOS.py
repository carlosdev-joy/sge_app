...
# Pipeline: DATASTAGE_SEQ_CONTRIBUICOES_BENEFICIOS | Projeto: BI_CVP | Dominio: CONTRIBUIÇÕES
# =========================
DAG_ID        = "DATASTAGE_SEQ_CONTRIBUICOES_BENEFICIOS"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "CONTRIBUIÇÕES"
PIPELINE_NAME = "DATASTAGE_SEQ_CONTRIBUICOES_BENEFICIOS"
...
HORARIOS_ESPECIFICOS = ['09:15']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/DATASTAGE_SEQ_CONTRIBUICOES_BENEFICIOS"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SEQ_CONTRIBUICOES_BENEFICIOS']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SEQ_CONTRIBUICOES_BENEFICIOS - BI_CVP / CONTRIBUIÇÕES",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="15 9 * * 1,2,3,4,5,6",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'CONTRIBUIÇÕES', 'CONTRIBUICOES', 'DIARIO'],
) as dag:
    ...
    t_start_SEQ_CONTRIBUICOES_BENEFICIOS = PythonOperator(
        task_id='log_start_SEQ_CONTRIBUICOES_BENEFICIOS',
        python_callable=log_start,
        op_kwargs={"job_name": 'SEQ_CONTRIBUICOES_BENEFICIOS', "task_key": 'SEQ_CONTRIBUICOES_BENEFICIOS'},
    )

    t_job_SEQ_CONTRIBUICOES_BENEFICIOS = DataStageOperator(
        task_id='SEQ_CONTRIBUICOES_BENEFICIOS',
        project=PROJECT_NAME,
        job_name='SEQ_CONTRIBUICOES_BENEFICIOS',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_CONTRIBUICOES_BENEFICIOS = PythonOperator(
        task_id='log_end_SEQ_CONTRIBUICOES_BENEFICIOS',
        python_callable=log_end,
        op_kwargs={"job_name": 'SEQ_CONTRIBUICOES_BENEFICIOS', "task_key": 'SEQ_CONTRIBUICOES_BENEFICIOS', "upstream_task_id": 'SEQ_CONTRIBUICOES_BENEFICIOS'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_CONTRIBUICOES_BENEFICIOS >> t_job_SEQ_CONTRIBUICOES_BENEFICIOS >> t_end_SEQ_CONTRIBUICOES_BENEFICIOS

    end_tasks = [t_end_SEQ_CONTRIBUICOES_BENEFICIOS]

    [t_end_SEQ_CONTRIBUICOES_BENEFICIOS] >> t_publish_dataset

    [t_end_SEQ_CONTRIBUICOES_BENEFICIOS] >> t_teams_error
