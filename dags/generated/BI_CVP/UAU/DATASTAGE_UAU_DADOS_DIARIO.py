...
# Pipeline: DATASTAGE_UAU_DADOS_DIARIO | Projeto: BI_CVP | Dominio: UAU
# =========================
DAG_ID        = "DATASTAGE_UAU_DADOS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "UAU"
PIPELINE_NAME = "DATASTAGE_UAU_DADOS_DIARIO"
...
HORARIOS_ESPECIFICOS = ['06:00', '12:00', '18:00']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/DATASTAGE_UAU_DADOS_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['CvpBi_TB_UAU_DADOS_SIAS', 'CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS']
FLOW_JOBS     = ['CvpBi_TB_UAU_DADOS_SIAS', 'CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_UAU_DADOS_DIARIO - BI_CVP / UAU",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule="0 6,12,18 * * 0,1,2,3,4,5,6",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'UAU', 'DATASTAGE', 'DIARIO'],
) as dag:
    ...
    t_start_CvpBi_TB_UAU_DADOS_SIAS = PythonOperator(
        task_id='log_start_CvpBi_TB_UAU_DADOS_SIAS',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_TB_UAU_DADOS_SIAS', "task_key": 'CvpBi_TB_UAU_DADOS_SIAS'},
    )

    t_job_CvpBi_TB_UAU_DADOS_SIAS = DataStageOperator(
        task_id='CvpBi_TB_UAU_DADOS_SIAS',
        project=PROJECT_NAME,
        job_name='CvpBi_TB_UAU_DADOS_SIAS',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_TB_UAU_DADOS_SIAS = PythonOperator(
        task_id='log_end_CvpBi_TB_UAU_DADOS_SIAS',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_TB_UAU_DADOS_SIAS', "task_key": 'CvpBi_TB_UAU_DADOS_SIAS', "upstream_task_id": 'CvpBi_TB_UAU_DADOS_SIAS'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS = PythonOperator(
        task_id='log_start_CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS', "task_key": 'CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS'},
    )

    t_job_CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS = DataStageOperator(
        task_id='CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS',
        project=PROJECT_NAME,
        job_name='CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS = PythonOperator(
        task_id='log_end_CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS', "task_key": 'CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS', "upstream_task_id": 'CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_CvpBi_TB_UAU_DADOS_SIAS >> t_job_CvpBi_TB_UAU_DADOS_SIAS >> t_end_CvpBi_TB_UAU_DADOS_SIAS

    t_end_CvpBi_TB_UAU_DADOS_SIAS >> t_start_CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS >> t_job_CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS >> t_end_CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS

    end_tasks = [t_end_CvpBi_TB_UAU_DADOS_SIAS, t_end_CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS]

    [t_end_CvpBi_TB_UAU_DADOS_SIAS, t_end_CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS] >> t_publish_dataset

    [t_end_CvpBi_TB_UAU_DADOS_SIAS, t_end_CvpBi_TB_UAU_DADOS_SIAS_ELEGIVEIS] >> t_teams_error
