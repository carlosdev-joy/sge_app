...
# Pipeline: DATASTAGE_BI_CVP_CONVERSAO_VENDAS | Projeto: BI_CVP | Dominio: VENDAS
# =========================
DAG_ID        = "DATASTAGE_BI_CVP_CONVERSAO_VENDAS"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "VENDAS"
PIPELINE_NAME = "DATASTAGE_BI_CVP_CONVERSAO_VENDAS"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_BI_CVP_CONVERSAO_VENDAS - BI_CVP / VENDAS",
    ...
    t_start_BI_CVP_ConversaoVendas = PythonOperator(
        task_id='log_start_BI_CVP_ConversaoVendas',
        python_callable=log_start,
        op_kwargs={"job_name": 'BI_CVP_ConversaoVendas', "task_key": 'BI_CVP_ConversaoVendas'},
    )

    t_job_BI_CVP_ConversaoVendas = DataStageOperator(
        task_id='BI_CVP_ConversaoVendas',
        project=PROJECT_NAME,
        job_name='BI_CVP_ConversaoVendas',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BI_CVP_ConversaoVendas = PythonOperator(
        task_id='log_end_BI_CVP_ConversaoVendas',
        python_callable=log_end,
        op_kwargs={"job_name": 'BI_CVP_ConversaoVendas', "task_key": 'BI_CVP_ConversaoVendas', "upstream_task_id": 'BI_CVP_ConversaoVendas'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_BI_CVP_ConversaoVendas >> t_job_BI_CVP_ConversaoVendas >> t_end_BI_CVP_ConversaoVendas

    end_tasks = [t_end_BI_CVP_ConversaoVendas]

    [t_end_BI_CVP_ConversaoVendas] >> t_publish_dataset

    [t_end_BI_CVP_ConversaoVendas] >> t_teams_error
