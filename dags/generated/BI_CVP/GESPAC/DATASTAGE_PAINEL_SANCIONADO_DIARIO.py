...
# Pipeline: DATASTAGE_PAINEL_SANCIONADO_DIARIO | Projeto: BI_CVP | Dominio: GESPAC
# =========================
DAG_ID        = "DATASTAGE_PAINEL_SANCIONADO_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "GESPAC"
PIPELINE_NAME = "DATASTAGE_PAINEL_SANCIONADO_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_PAINEL_SANCIONADO_DIARIO - BI_CVP / GESPAC",
    start_date=pendulum.datetime(2026, 6, 16, tz=LOCAL_TZ),
    schedule="0 1 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'GESPAC', 'DATASTAGE', 'SANCIONADO', 'DIARIO'],
) as dag:
    ...
    t_start_Painel_sancionado = PythonOperator(
        task_id="log_start_Painel_sancionado",
        python_callable=log_start,
        op_kwargs={"job_name": "Painel_sancionado", "task_key": "Painel_sancionado"},
    )

    t_job_Painel_sancionado = DataStageOperator(
        task_id="Painel_sancionado",
        project=PROJECT_NAME,
        job_name="Painel_sancionado",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_Painel_sancionado = PythonOperator(
        task_id="log_end_Painel_sancionado",
        python_callable=log_end,
        op_kwargs={"job_name": "Painel_sancionado", "task_key": "Painel_sancionado", "upstream_task_id": "Painel_sancionado"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_Painel_sancionado >> t_teams_start >> t_job_Painel_sancionado >> t_end_Painel_sancionado

    end_tasks = [t_end_Painel_sancionado]

    [t_end_Painel_sancionado] >> t_publish_dataset

    [t_end_Painel_sancionado] >> t_teams_end

    [t_end_Painel_sancionado] >> t_teams_error
