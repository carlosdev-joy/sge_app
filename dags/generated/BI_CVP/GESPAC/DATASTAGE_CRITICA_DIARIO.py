...
# Pipeline: DATASTAGE_CRITICA_DIARIO | Projeto: BI_CVP | Dominio: GESPAC
# =========================
DAG_ID        = "DATASTAGE_CRITICA_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "GESPAC"
PIPELINE_NAME = "DATASTAGE_CRITICA_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_CRITICA_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['BiCvp_Criticas_01_ext_PREST', 'BiCvp_Criticas_01_ext_VIDA', 'BiCvp_Criticas_02_join', 'BiCvp_Criticas_03_car']
FLOW_JOBS     = ['BiCvp_Criticas_01_ext_PREST', 'BiCvp_Criticas_01_ext_VIDA', 'BiCvp_Criticas_02_join', 'BiCvp_Criticas_03_car']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_CRITICA_DIARIO - BI_CVP / GESPAC",
    start_date=pendulum.datetime(2026, 8, 27, tz=LOCAL_TZ),
    schedule="0 15 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'GESPAC', 'DATASTAGE', 'DIARIO', 'CRITICA'],
) as dag:
    ...
    t_start_BiCvp_Criticas_01_ext_PREST = _LogStart(
        task_id='log_start_BiCvp_Criticas_01_ext_PREST',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_Criticas_01_ext_PREST', "task_key": 'BiCvp_Criticas_01_ext_PREST'},
    )

    t_job_BiCvp_Criticas_01_ext_PREST = DataStageOperator(
        task_id='BiCvp_Criticas_01_ext_PREST',
        project=PROJECT_NAME,
        job_name='BiCvp_Criticas_01_ext_PREST',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_Criticas_01_ext_PREST = PythonOperator(
        task_id='log_end_BiCvp_Criticas_01_ext_PREST',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_Criticas_01_ext_PREST', "task_key": 'BiCvp_Criticas_01_ext_PREST', "upstream_task_id": 'BiCvp_Criticas_01_ext_PREST'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_Criticas_01_ext_VIDA = _LogStart(
        task_id='log_start_BiCvp_Criticas_01_ext_VIDA',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_Criticas_01_ext_VIDA', "task_key": 'BiCvp_Criticas_01_ext_VIDA'},
    )

    t_job_BiCvp_Criticas_01_ext_VIDA = DataStageOperator(
        task_id='BiCvp_Criticas_01_ext_VIDA',
        project=PROJECT_NAME,
        job_name='BiCvp_Criticas_01_ext_VIDA',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_Criticas_01_ext_VIDA = PythonOperator(
        task_id='log_end_BiCvp_Criticas_01_ext_VIDA',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_Criticas_01_ext_VIDA', "task_key": 'BiCvp_Criticas_01_ext_VIDA', "upstream_task_id": 'BiCvp_Criticas_01_ext_VIDA'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_Criticas_02_join = _LogStart(
        task_id='log_start_BiCvp_Criticas_02_join',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_Criticas_02_join', "task_key": 'BiCvp_Criticas_02_join'},
    )

    t_job_BiCvp_Criticas_02_join = DataStageOperator(
        task_id='BiCvp_Criticas_02_join',
        project=PROJECT_NAME,
        job_name='BiCvp_Criticas_02_join',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_Criticas_02_join = PythonOperator(
        task_id='log_end_BiCvp_Criticas_02_join',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_Criticas_02_join', "task_key": 'BiCvp_Criticas_02_join', "upstream_task_id": 'BiCvp_Criticas_02_join'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_Criticas_03_car = _LogStart(
        task_id='log_start_BiCvp_Criticas_03_car',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_Criticas_03_car', "task_key": 'BiCvp_Criticas_03_car'},
    )

    t_job_BiCvp_Criticas_03_car = DataStageOperator(
        task_id='BiCvp_Criticas_03_car',
        project=PROJECT_NAME,
        job_name='BiCvp_Criticas_03_car',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_Criticas_03_car = PythonOperator(
        task_id='log_end_BiCvp_Criticas_03_car',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_Criticas_03_car', "task_key": 'BiCvp_Criticas_03_car', "upstream_task_id": 'BiCvp_Criticas_03_car'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_BiCvp_Criticas_01_ext_PREST >> t_job_BiCvp_Criticas_01_ext_PREST >> t_end_BiCvp_Criticas_01_ext_PREST

    t_check_agenda >> t_start_BiCvp_Criticas_01_ext_VIDA >> t_job_BiCvp_Criticas_01_ext_VIDA >> t_end_BiCvp_Criticas_01_ext_VIDA

    [t_end_BiCvp_Criticas_01_ext_VIDA, t_end_BiCvp_Criticas_01_ext_PREST] >> t_start_BiCvp_Criticas_02_join >> t_job_BiCvp_Criticas_02_join >> t_end_BiCvp_Criticas_02_join

    t_end_BiCvp_Criticas_02_join >> t_start_BiCvp_Criticas_03_car >> t_job_BiCvp_Criticas_03_car >> t_end_BiCvp_Criticas_03_car

    end_tasks = [t_end_BiCvp_Criticas_01_ext_PREST, t_end_BiCvp_Criticas_01_ext_VIDA, t_end_BiCvp_Criticas_02_join, t_end_BiCvp_Criticas_03_car]

    [t_end_BiCvp_Criticas_01_ext_PREST, t_end_BiCvp_Criticas_01_ext_VIDA, t_end_BiCvp_Criticas_02_join, t_end_BiCvp_Criticas_03_car] >> t_publish_dataset

    [t_end_BiCvp_Criticas_01_ext_PREST, t_end_BiCvp_Criticas_01_ext_VIDA, t_end_BiCvp_Criticas_02_join, t_end_BiCvp_Criticas_03_car] >> t_teams_error

    [t_end_BiCvp_Criticas_01_ext_PREST, t_end_BiCvp_Criticas_01_ext_VIDA, t_end_BiCvp_Criticas_02_join, t_end_BiCvp_Criticas_03_car] >> t_reg_falha
