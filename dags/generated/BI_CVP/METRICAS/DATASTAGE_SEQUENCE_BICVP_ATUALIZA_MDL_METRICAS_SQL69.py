...
# Pipeline: DATASTAGE_SEQUENCE_BICVP_ATUALIZA_MDL_METRICAS_SQL69 | Projeto: BI_CVP | Dominio: METRICAS
# =========================
DAG_ID        = "DATASTAGE_SEQUENCE_BICVP_ATUALIZA_MDL_METRICAS_SQL69"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "METRICAS"
PIPELINE_NAME = "DATASTAGE_SEQUENCE_BICVP_ATUALIZA_MDL_METRICAS_SQL69"
...
HORARIOS_ESPECIFICOS = ['08:00']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/DATASTAGE_SEQUENCE_BICVP_ATUALIZA_MDL_METRICAS_SQL69"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SEQUENCE_BICVP_ATUALIZA_MDL_METRICAS_SQL69 - BI_CVP / METRICAS",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 8 * * 1,2,3,4,5",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'METRICAS'],
) as dag:
    ...
    t_start_Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69 = PythonOperator(
        task_id='log_start_Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69',
        python_callable=log_start,
        op_kwargs={"job_name": 'Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69', "task_key": 'Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69'},
    )

    t_job_Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69 = DataStageOperator(
        task_id='Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69',
        project=PROJECT_NAME,
        job_name='Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69 = PythonOperator(
        task_id='log_end_Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69',
        python_callable=log_end,
        op_kwargs={"job_name": 'Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69', "task_key": 'Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69', "upstream_task_id": 'Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69 >> t_job_Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69 >> t_end_Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69

    end_tasks = [t_end_Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69]

    [t_end_Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69] >> t_publish_dataset

    [t_end_Sequence_BiCvp_Atualiza_MDL_METRICAS_SQL69] >> t_teams_error
