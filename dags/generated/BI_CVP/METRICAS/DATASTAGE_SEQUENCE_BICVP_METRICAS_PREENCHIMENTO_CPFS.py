...
# Pipeline: DATASTAGE_SEQUENCE_BICVP_METRICAS_PREENCHIMENTO_CPFS | Projeto: BI_CVP | Dominio: METRICAS
# =========================
DAG_ID        = "DATASTAGE_SEQUENCE_BICVP_METRICAS_PREENCHIMENTO_CPFS"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "METRICAS"
PIPELINE_NAME = "DATASTAGE_SEQUENCE_BICVP_METRICAS_PREENCHIMENTO_CPFS"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SEQUENCE_BICVP_METRICAS_PREENCHIMENTO_CPFS"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['Sequence_BiCvp_Metricas_Preenchimento_CPFS']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SEQUENCE_BICVP_METRICAS_PREENCHIMENTO_CPFS - BI_CVP / METRICAS",
    ...
    t_start_Sequence_BiCvp_Metricas_Preenchimento_CPFS = PythonOperator(
        task_id='log_start_Sequence_BiCvp_Metricas_Preenchimento_CPFS',
        python_callable=log_start,
        op_kwargs={"job_name": 'Sequence_BiCvp_Metricas_Preenchimento_CPFS', "task_key": 'Sequence_BiCvp_Metricas_Preenchimento_CPFS'},
    )

    t_job_Sequence_BiCvp_Metricas_Preenchimento_CPFS = DataStageOperator(
        task_id='Sequence_BiCvp_Metricas_Preenchimento_CPFS',
        project=PROJECT_NAME,
        job_name='Sequence_BiCvp_Metricas_Preenchimento_CPFS',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_Sequence_BiCvp_Metricas_Preenchimento_CPFS = PythonOperator(
        task_id='log_end_Sequence_BiCvp_Metricas_Preenchimento_CPFS',
        python_callable=log_end,
        op_kwargs={"job_name": 'Sequence_BiCvp_Metricas_Preenchimento_CPFS', "task_key": 'Sequence_BiCvp_Metricas_Preenchimento_CPFS', "upstream_task_id": 'Sequence_BiCvp_Metricas_Preenchimento_CPFS'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_Sequence_BiCvp_Metricas_Preenchimento_CPFS >> t_job_Sequence_BiCvp_Metricas_Preenchimento_CPFS >> t_end_Sequence_BiCvp_Metricas_Preenchimento_CPFS

    end_tasks = [t_end_Sequence_BiCvp_Metricas_Preenchimento_CPFS]

    [t_end_Sequence_BiCvp_Metricas_Preenchimento_CPFS] >> t_publish_dataset

    [t_end_Sequence_BiCvp_Metricas_Preenchimento_CPFS] >> t_teams_error
