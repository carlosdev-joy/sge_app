...
# Pipeline: DATASTAGE_CLIENTES_METRICAS_SISTEMAS_CVP | Projeto: BI_CVP | Dominio: BASE_UNICA_CLIENTES
# =========================
DAG_ID        = "DATASTAGE_CLIENTES_METRICAS_SISTEMAS_CVP"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "BASE_UNICA_CLIENTES"
PIPELINE_NAME = "DATASTAGE_CLIENTES_METRICAS_SISTEMAS_CVP"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_CLIENTES_METRICAS_SISTEMAS_CVP"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['CLIENTES_METRICAS_SISTEMAS_CVP']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_CLIENTES_METRICAS_SISTEMAS_CVP - BI_CVP / BASE_UNICA_CLIENTES",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 11 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'BASE_UNICA_CLIENTES', 'DIARIO', 'CLIENTES'],
) as dag:
    ...
    t_start_CLIENTES_METRICAS_SISTEMAS_CVP = PythonOperator(
        task_id='log_start_CLIENTES_METRICAS_SISTEMAS_CVP',
        python_callable=log_start,
        op_kwargs={"job_name": 'CLIENTES_METRICAS_SISTEMAS_CVP', "task_key": 'CLIENTES_METRICAS_SISTEMAS_CVP'},
    )

    t_job_CLIENTES_METRICAS_SISTEMAS_CVP = DataStageOperator(
        task_id='CLIENTES_METRICAS_SISTEMAS_CVP',
        project=PROJECT_NAME,
        job_name='CLIENTES_METRICAS_SISTEMAS_CVP',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CLIENTES_METRICAS_SISTEMAS_CVP = PythonOperator(
        task_id='log_end_CLIENTES_METRICAS_SISTEMAS_CVP',
        python_callable=log_end,
        op_kwargs={"job_name": 'CLIENTES_METRICAS_SISTEMAS_CVP', "task_key": 'CLIENTES_METRICAS_SISTEMAS_CVP', "upstream_task_id": 'CLIENTES_METRICAS_SISTEMAS_CVP'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_CLIENTES_METRICAS_SISTEMAS_CVP >> t_job_CLIENTES_METRICAS_SISTEMAS_CVP >> t_end_CLIENTES_METRICAS_SISTEMAS_CVP

    end_tasks = [t_end_CLIENTES_METRICAS_SISTEMAS_CVP]

    [t_end_CLIENTES_METRICAS_SISTEMAS_CVP] >> t_publish_dataset

    [t_end_CLIENTES_METRICAS_SISTEMAS_CVP] >> t_teams_error
