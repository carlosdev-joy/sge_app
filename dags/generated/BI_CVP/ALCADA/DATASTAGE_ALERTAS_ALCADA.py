...
# Pipeline: DATASTAGE_ALERTAS_ALCADA | Projeto: BI_CVP | Dominio: ALCADA
# =========================
DAG_ID        = "DATASTAGE_ALERTAS_ALCADA"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "ALCADA"
PIPELINE_NAME = "DATASTAGE_ALERTAS_ALCADA"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_ALERTAS_ALCADA - BI_CVP / ALCADA",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="30 7 * * 1,2,3,4,5",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'ALCADA', 'ALERTAS'],
) as dag:
    ...
    t_start_SeqCvpBi_Alertas_Alcada = PythonOperator(
        task_id='log_start_SeqCvpBi_Alertas_Alcada',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqCvpBi_Alertas_Alcada', "task_key": 'SeqCvpBi_Alertas_Alcada'},
    )

    t_job_SeqCvpBi_Alertas_Alcada = DataStageOperator(
        task_id='SeqCvpBi_Alertas_Alcada',
        project=PROJECT_NAME,
        job_name='SeqCvpBi_Alertas_Alcada',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqCvpBi_Alertas_Alcada = PythonOperator(
        task_id='log_end_SeqCvpBi_Alertas_Alcada',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqCvpBi_Alertas_Alcada', "task_key": 'SeqCvpBi_Alertas_Alcada', "upstream_task_id": 'SeqCvpBi_Alertas_Alcada'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqCvpBi_Alertas_Alcada >> t_job_SeqCvpBi_Alertas_Alcada >> t_end_SeqCvpBi_Alertas_Alcada

    end_tasks = [t_end_SeqCvpBi_Alertas_Alcada]

    [t_end_SeqCvpBi_Alertas_Alcada] >> t_publish_dataset

    [t_end_SeqCvpBi_Alertas_Alcada] >> t_teams_error
