...
# Pipeline: DATASTAGE_SEQUENCE_EXTRACOES_ML_AUTO | Projeto: BI_CVP | Dominio: ML
# =========================
DAG_ID        = "DATASTAGE_SEQUENCE_EXTRACOES_ML_AUTO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "ML"
PIPELINE_NAME = "DATASTAGE_SEQUENCE_EXTRACOES_ML_AUTO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SEQUENCE_EXTRACOES_ML_AUTO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['Sequence_Extracoes_ML_auto']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SEQUENCE_EXTRACOES_ML_AUTO - BI_CVP / ML",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="55 21 4 * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'ML', 'EXTRACOES'],
) as dag:
    ...
    t_start_Sequence_Extracoes_ML_auto = PythonOperator(
        task_id='log_start_Sequence_Extracoes_ML_auto',
        python_callable=log_start,
        op_kwargs={"job_name": 'Sequence_Extracoes_ML_auto', "task_key": 'Sequence_Extracoes_ML_auto'},
    )

    t_job_Sequence_Extracoes_ML_auto = DataStageOperator(
        task_id='Sequence_Extracoes_ML_auto',
        project=PROJECT_NAME,
        job_name='Sequence_Extracoes_ML_auto',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_Sequence_Extracoes_ML_auto = PythonOperator(
        task_id='log_end_Sequence_Extracoes_ML_auto',
        python_callable=log_end,
        op_kwargs={"job_name": 'Sequence_Extracoes_ML_auto', "task_key": 'Sequence_Extracoes_ML_auto', "upstream_task_id": 'Sequence_Extracoes_ML_auto'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_Sequence_Extracoes_ML_auto >> t_job_Sequence_Extracoes_ML_auto >> t_end_Sequence_Extracoes_ML_auto

    end_tasks = [t_end_Sequence_Extracoes_ML_auto]

    [t_end_Sequence_Extracoes_ML_auto] >> t_publish_dataset

    [t_end_Sequence_Extracoes_ML_auto] >> t_teams_error
