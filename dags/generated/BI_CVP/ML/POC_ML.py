...
from utils.job_operators import PythonScriptOperator
...
# Pipeline: POC_ML | Projeto: BI_CVP | Dominio: ML
# =========================
DAG_ID        = "POC_ML"
...
DATASET_URI   = "orq://pipeline/POC_ML"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['01_ingestion_predict', '07_score', '08_post_process']
FLOW_JOBS     = ['01_ingestion_predict', '07_score', '08_post_process']
...
with DAG(
    ...
    description="Pipeline POC_ML - BI_CVP / ML",
    ...
    t_start_01_ingestion_predict = PythonOperator(
        task_id='log_start_01_ingestion_predict',
        python_callable=log_start,
        op_kwargs={"job_name": '01_ingestion_predict', "task_key": '01_ingestion_predict'},
    )

    t_job_01_ingestion_predict = PythonScriptOperator(
        task_id='01_ingestion_predict',
        ssh_conn_id="ssh_lnxprd021",
        modo='arquivo',
        script_path='/Projetos/BI_CVP/Scripts/MODELOS_AI/churn-model-inadimplencia-vida/src/01_ingestion_predict.py',
        cmd_timeout=None,
        do_xcom_push=True,
    )

    t_end_01_ingestion_predict = PythonOperator(
        task_id='log_end_01_ingestion_predict',
        python_callable=log_end,
        op_kwargs={"job_name": '01_ingestion_predict', "task_key": '01_ingestion_predict', "upstream_task_id": '01_ingestion_predict'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_07_score = PythonOperator(
        task_id='log_start_07_score',
        python_callable=log_start,
        op_kwargs={"job_name": '07_score', "task_key": '07_score'},
    )

    t_job_07_score = PythonScriptOperator(
        task_id='07_score',
        ssh_conn_id="ssh_lnxprd021",
        modo='arquivo',
        script_path='/Projetos/BI_CVP/Scripts/MODELOS_AI/churn-model-inadimplencia-vida/src/07_score.py',
        cmd_timeout=None,
        do_xcom_push=True,
    )

    t_end_07_score = PythonOperator(
        task_id='log_end_07_score',
        python_callable=log_end,
        op_kwargs={"job_name": '07_score', "task_key": '07_score', "upstream_task_id": '07_score'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_08_post_process = PythonOperator(
        task_id='log_start_08_post_process',
        python_callable=log_start,
        op_kwargs={"job_name": '08_post_process', "task_key": '08_post_process'},
    )

    t_job_08_post_process = PythonScriptOperator(
        task_id='08_post_process',
        ssh_conn_id="ssh_lnxprd021",
        modo='arquivo',
        script_path='/Projetos/BI_CVP/Scripts/MODELOS_AI/churn-model-inadimplencia-vida/src/08_post_process.py',
        cmd_timeout=None,
        do_xcom_push=True,
    )

    t_end_08_post_process = PythonOperator(
        task_id='log_end_08_post_process',
        python_callable=log_end,
        op_kwargs={"job_name": '08_post_process', "task_key": '08_post_process', "upstream_task_id": '08_post_process'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_01_ingestion_predict >> t_job_01_ingestion_predict >> t_end_01_ingestion_predict

    t_end_01_ingestion_predict >> t_start_07_score >> t_job_07_score >> t_end_07_score

    t_end_07_score >> t_start_08_post_process >> t_job_08_post_process >> t_end_08_post_process

    end_tasks = [t_end_01_ingestion_predict, t_end_07_score, t_end_08_post_process]

    [t_end_01_ingestion_predict, t_end_07_score, t_end_08_post_process] >> t_publish_dataset

    [t_end_01_ingestion_predict, t_end_07_score, t_end_08_post_process] >> t_reg_falha
