...
# Pipeline: DATASTAGE_ESTUDO_RESGATES | Projeto: BI_CVP | Dominio: ESTUDO_RESGATES
# =========================
DAG_ID        = "DATASTAGE_ESTUDO_RESGATES"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "ESTUDO_RESGATES"
PIPELINE_NAME = "DATASTAGE_ESTUDO_RESGATES"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_ESTUDO_RESGATES - BI_CVP / ESTUDO_RESGATES",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 22 3 * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'ESTUDO_RESGATES', 'MENSAL', 'RESGATES'],
) as dag:
    ...
    t_start_SeqBiCvp_BaseEstudoResgates = PythonOperator(
        task_id='log_start_SeqBiCvp_BaseEstudoResgates',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqBiCvp_BaseEstudoResgates', "task_key": 'SeqBiCvp_BaseEstudoResgates'},
    )

    t_job_SeqBiCvp_BaseEstudoResgates = DataStageOperator(
        task_id='SeqBiCvp_BaseEstudoResgates',
        project=PROJECT_NAME,
        job_name='SeqBiCvp_BaseEstudoResgates',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_BaseEstudoResgates = PythonOperator(
        task_id='log_end_SeqBiCvp_BaseEstudoResgates',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqBiCvp_BaseEstudoResgates', "task_key": 'SeqBiCvp_BaseEstudoResgates', "upstream_task_id": 'SeqBiCvp_BaseEstudoResgates'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_BaseEstudoResgates >> t_job_SeqBiCvp_BaseEstudoResgates >> t_end_SeqBiCvp_BaseEstudoResgates

    end_tasks = [t_end_SeqBiCvp_BaseEstudoResgates]

    [t_end_SeqBiCvp_BaseEstudoResgates] >> t_publish_dataset

    [t_end_SeqBiCvp_BaseEstudoResgates] >> t_teams_error
