...
# Pipeline: DATASTAGE_UNIFICA_SINISTRO_DIARIO | Projeto: BI_CVP | Dominio: SINISTRO
# =========================
DAG_ID        = "DATASTAGE_UNIFICA_SINISTRO_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SINISTRO"
PIPELINE_NAME = "DATASTAGE_UNIFICA_SINISTRO_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_UNIFICA_SINISTRO_DIARIO - BI_CVP / SINISTRO",
    start_date=pendulum.datetime(2026, 6, 17, tz=LOCAL_TZ),
    schedule="0 16 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SINISTRO', 'DATASTAGE', 'DIARIO'],
) as dag:
    ...
    t_start_SEQ_UNIFICA_SINISTRO = PythonOperator(
        task_id="log_start_SEQ_UNIFICA_SINISTRO",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_UNIFICA_SINISTRO", "task_key": "SEQ_UNIFICA_SINISTRO"},
    )

    t_job_SEQ_UNIFICA_SINISTRO = DataStageOperator(
        task_id="SEQ_UNIFICA_SINISTRO",
        project=PROJECT_NAME,
        job_name="SEQ_UNIFICA_SINISTRO",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_UNIFICA_SINISTRO = PythonOperator(
        task_id="log_end_SEQ_UNIFICA_SINISTRO",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_UNIFICA_SINISTRO", "task_key": "SEQ_UNIFICA_SINISTRO", "upstream_task_id": "SEQ_UNIFICA_SINISTRO"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_UNIFICA_SINISTRO >> t_teams_start >> t_job_SEQ_UNIFICA_SINISTRO >> t_end_SEQ_UNIFICA_SINISTRO

    end_tasks = [t_end_SEQ_UNIFICA_SINISTRO]

    [t_end_SEQ_UNIFICA_SINISTRO] >> t_publish_dataset

    [t_end_SEQ_UNIFICA_SINISTRO] >> t_teams_end

    [t_end_SEQ_UNIFICA_SINISTRO] >> t_teams_error
