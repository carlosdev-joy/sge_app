...
# Pipeline: DATASTAGE_SINISTROS_COVID_AUTO | Projeto: BI_CVP | Dominio: SINISTRO
# =========================
DAG_ID        = "DATASTAGE_SINISTROS_COVID_AUTO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SINISTRO"
PIPELINE_NAME = "DATASTAGE_SINISTROS_COVID_AUTO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SINISTROS_COVID_AUTO - BI_CVP / SINISTRO",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="15 12 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SINISTRO', 'SINISTROS', 'COVID'],
) as dag:
    ...
    t_start_SeqBiCvp_SinistrosCovid_Auto = PythonOperator(
        task_id='log_start_SeqBiCvp_SinistrosCovid_Auto',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqBiCvp_SinistrosCovid_Auto', "task_key": 'SeqBiCvp_SinistrosCovid_Auto'},
    )

    t_job_SeqBiCvp_SinistrosCovid_Auto = DataStageOperator(
        task_id='SeqBiCvp_SinistrosCovid_Auto',
        project=PROJECT_NAME,
        job_name='SeqBiCvp_SinistrosCovid_Auto',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_SinistrosCovid_Auto = PythonOperator(
        task_id='log_end_SeqBiCvp_SinistrosCovid_Auto',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqBiCvp_SinistrosCovid_Auto', "task_key": 'SeqBiCvp_SinistrosCovid_Auto', "upstream_task_id": 'SeqBiCvp_SinistrosCovid_Auto'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_SinistrosCovid_Auto >> t_job_SeqBiCvp_SinistrosCovid_Auto >> t_end_SeqBiCvp_SinistrosCovid_Auto

    end_tasks = [t_end_SeqBiCvp_SinistrosCovid_Auto]

    [t_end_SeqBiCvp_SinistrosCovid_Auto] >> t_publish_dataset

    [t_end_SeqBiCvp_SinistrosCovid_Auto] >> t_teams_error
