...
# Pipeline: DATASTAGE_BASE_UNICA_PARCELAS_DIARIO | Projeto: BI_CVP | Dominio: PARCELAS
# =========================
DAG_ID        = "DATASTAGE_BASE_UNICA_PARCELAS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "PARCELAS"
PIPELINE_NAME = "DATASTAGE_BASE_UNICA_PARCELAS_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_BASE_UNICA_PARCELAS_DIARIO - BI_CVP / PARCELAS",
    start_date=pendulum.datetime(2026, 6, 17, tz=LOCAL_TZ),
    schedule="0 4 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'PARCELAS', 'DATASTAGE', 'BASE', 'DIARIO'],
) as dag:
    ...
    t_start_SEQ_UNIFICA_COBRANCA = PythonOperator(
        task_id="log_start_SEQ_UNIFICA_COBRANCA",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_UNIFICA_COBRANCA", "task_key": "SEQ_UNIFICA_COBRANCA"},
    )

    t_job_SEQ_UNIFICA_COBRANCA = DataStageOperator(
        task_id="SEQ_UNIFICA_COBRANCA",
        project=PROJECT_NAME,
        job_name="SEQ_UNIFICA_COBRANCA",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_UNIFICA_COBRANCA = PythonOperator(
        task_id="log_end_SEQ_UNIFICA_COBRANCA",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_UNIFICA_COBRANCA", "task_key": "SEQ_UNIFICA_COBRANCA", "upstream_task_id": "SEQ_UNIFICA_COBRANCA"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_UNIFICA_COBRANCA >> t_teams_start >> t_job_SEQ_UNIFICA_COBRANCA >> t_end_SEQ_UNIFICA_COBRANCA

    end_tasks = [t_end_SEQ_UNIFICA_COBRANCA]

    [t_end_SEQ_UNIFICA_COBRANCA] >> t_publish_dataset

    [t_end_SEQ_UNIFICA_COBRANCA] >> t_teams_end

    [t_end_SEQ_UNIFICA_COBRANCA] >> t_teams_error
