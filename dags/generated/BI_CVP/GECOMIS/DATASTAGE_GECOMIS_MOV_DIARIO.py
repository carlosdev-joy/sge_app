...
# Pipeline: DATASTAGE_GECOMIS_MOV_DIARIO | Projeto: BI_CVP | Dominio: GECOMIS
# =========================
DAG_ID        = "DATASTAGE_GECOMIS_MOV_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "GECOMIS"
PIPELINE_NAME = "DATASTAGE_GECOMIS_MOV_DIARIO"
BASE_LOG_DIR  = "/Projetos/BI_CVP/Logs/Airflow"
LOCAL_TZ      = "America/Sao_Paulo"
TEAMS_WEBHOOK_VAR = "TEAMS_WEBHOOK_URL_CVP"
DS_QUEUE      = 'LowPriorityJobs'
RUNBOOK_MD    = None
CALENDARIO_NOME    = None
SOMENTE_DIAS_UTEIS = False
HORARIOS_ESPECIFICOS = None
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/DATASTAGE_GECOMIS_MOV_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext', 'CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins', 'CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext', 'CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins', 'CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext', 'CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins', 'CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext', 'CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_GECOMIS_MOV_DIARIO - BI_CVP / GECOMIS",
    start_date=pendulum.datetime(2026, 6, 11, tz=LOCAL_TZ),
    schedule="0 8 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'GECOMIS', 'DATASTAGE', 'DEMANDA'],
) as dag:
    ...
    t_start_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext = PythonOperator(
        task_id='log_start_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext', "task_key": 'CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext'},
    )

    t_job_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext = DataStageOperator(
        task_id='CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext',
        project=PROJECT_NAME,
        job_name='CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext = PythonOperator(
        task_id='log_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext', "task_key": 'CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext', "upstream_task_id": 'CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins = PythonOperator(
        task_id='log_start_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins', "task_key": 'CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins'},
    )

    t_job_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins = DataStageOperator(
        task_id='CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins',
        project=PROJECT_NAME,
        job_name='CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins = PythonOperator(
        task_id='log_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins', "task_key": 'CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins', "upstream_task_id": 'CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext = PythonOperator(
        task_id='log_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext', "task_key": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext'},
    )

    t_job_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext = DataStageOperator(
        task_id='CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext',
        project=PROJECT_NAME,
        job_name='CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext = PythonOperator(
        task_id='log_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext', "task_key": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext', "upstream_task_id": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins = PythonOperator(
        task_id='log_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins', "task_key": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins'},
    )

    t_job_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins = DataStageOperator(
        task_id='CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins',
        project=PROJECT_NAME,
        job_name='CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins = PythonOperator(
        task_id='log_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins', "task_key": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins', "upstream_task_id": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext = PythonOperator(
        task_id='log_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext', "task_key": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext'},
    )

    t_job_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext = DataStageOperator(
        task_id='CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext',
        project=PROJECT_NAME,
        job_name='CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext = PythonOperator(
        task_id='log_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext', "task_key": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext', "upstream_task_id": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins = PythonOperator(
        task_id='log_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins', "task_key": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins'},
    )

    t_job_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins = DataStageOperator(
        task_id='CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins',
        project=PROJECT_NAME,
        job_name='CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins = PythonOperator(
        task_id='log_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins', "task_key": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins', "upstream_task_id": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext = PythonOperator(
        task_id='log_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext', "task_key": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext'},
    )

    t_job_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext = DataStageOperator(
        task_id='CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext',
        project=PROJECT_NAME,
        job_name='CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext = PythonOperator(
        task_id='log_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext', "task_key": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext', "upstream_task_id": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins = PythonOperator(
        task_id='log_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins', "task_key": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins'},
    )

    t_job_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins = DataStageOperator(
        task_id='CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins',
        project=PROJECT_NAME,
        job_name='CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins = PythonOperator(
        task_id='log_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins', "task_key": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins', "upstream_task_id": 'CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext >> t_teams_start >> t_job_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext >> t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext

    t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext >> t_start_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins >> t_job_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins >> t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins

    t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins >> t_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext >> t_job_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext >> t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext

    t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext >> t_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins >> t_job_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins >> t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins

    t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins >> t_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext >> t_job_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext >> t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext

    t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext >> t_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins >> t_job_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins >> t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins

    t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins >> t_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext >> t_job_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext >> t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext

    t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext >> t_start_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins >> t_job_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins >> t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins

    end_tasks = [t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext, t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins]

    [t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext, t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins] >> t_publish_dataset

    [t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext, t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins] >> t_teams_end

    [t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_01_ext, t_end_CvpBi_AUTO_105_RITM0062235_GECOMIS_02_ins, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_01_ext, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_APOLICE_02_ins, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_01_ext, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_CCA_02_ins, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_01_ext, t_end_CvpBi_AUTO_105_RITM0063104_GECOMIS_VALIDADOR_02_ins] >> t_teams_error
