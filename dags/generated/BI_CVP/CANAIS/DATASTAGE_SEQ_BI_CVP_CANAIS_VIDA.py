...
# Pipeline: DATASTAGE_SEQ_BI_CVP_CANAIS_VIDA | Projeto: BI_CVP | Dominio: CANAIS
# =========================
DAG_ID        = "DATASTAGE_SEQ_BI_CVP_CANAIS_VIDA"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "CANAIS"
PIPELINE_NAME = "DATASTAGE_SEQ_BI_CVP_CANAIS_VIDA"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SEQ_BI_CVP_CANAIS_VIDA - BI_CVP / CANAIS",
    ...
    t_start_SeqBiCvp_CanaisVida = PythonOperator(
        task_id='log_start_SeqBiCvp_CanaisVida',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqBiCvp_CanaisVida', "task_key": 'SeqBiCvp_CanaisVida'},
    )

    t_job_SeqBiCvp_CanaisVida = DataStageOperator(
        task_id='SeqBiCvp_CanaisVida',
        project=PROJECT_NAME,
        job_name='SeqBiCvp_CanaisVida',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_CanaisVida = PythonOperator(
        task_id='log_end_SeqBiCvp_CanaisVida',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqBiCvp_CanaisVida', "task_key": 'SeqBiCvp_CanaisVida', "upstream_task_id": 'SeqBiCvp_CanaisVida'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_CanaisVida >> t_job_SeqBiCvp_CanaisVida >> t_end_SeqBiCvp_CanaisVida

    end_tasks = [t_end_SeqBiCvp_CanaisVida]

    [t_end_SeqBiCvp_CanaisVida] >> t_publish_dataset

    [t_end_SeqBiCvp_CanaisVida] >> t_teams_error
