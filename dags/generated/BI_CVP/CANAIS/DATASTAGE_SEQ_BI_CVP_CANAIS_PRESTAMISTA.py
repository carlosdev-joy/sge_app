...
# Pipeline: DATASTAGE_SEQ_BI_CVP_CANAIS_PRESTAMISTA | Projeto: BI_CVP | Dominio: CANAIS
# =========================
DAG_ID        = "DATASTAGE_SEQ_BI_CVP_CANAIS_PRESTAMISTA"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "CANAIS"
PIPELINE_NAME = "DATASTAGE_SEQ_BI_CVP_CANAIS_PRESTAMISTA"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SEQ_BI_CVP_CANAIS_PRESTAMISTA"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqBiCvp_CanaisPrestamista']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SEQ_BI_CVP_CANAIS_PRESTAMISTA - BI_CVP / CANAIS",
    ...
    t_start_SeqBiCvp_CanaisPrestamista = PythonOperator(
        task_id='log_start_SeqBiCvp_CanaisPrestamista',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqBiCvp_CanaisPrestamista', "task_key": 'SeqBiCvp_CanaisPrestamista'},
    )

    t_job_SeqBiCvp_CanaisPrestamista = DataStageOperator(
        task_id='SeqBiCvp_CanaisPrestamista',
        project=PROJECT_NAME,
        job_name='SeqBiCvp_CanaisPrestamista',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_CanaisPrestamista = PythonOperator(
        task_id='log_end_SeqBiCvp_CanaisPrestamista',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqBiCvp_CanaisPrestamista', "task_key": 'SeqBiCvp_CanaisPrestamista', "upstream_task_id": 'SeqBiCvp_CanaisPrestamista'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_CanaisPrestamista >> t_job_SeqBiCvp_CanaisPrestamista >> t_end_SeqBiCvp_CanaisPrestamista

    end_tasks = [t_end_SeqBiCvp_CanaisPrestamista]

    [t_end_SeqBiCvp_CanaisPrestamista] >> t_publish_dataset

    [t_end_SeqBiCvp_CanaisPrestamista] >> t_teams_error
