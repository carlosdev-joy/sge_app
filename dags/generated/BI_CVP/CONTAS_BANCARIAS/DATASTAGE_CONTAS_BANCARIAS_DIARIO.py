...
# Pipeline: DATASTAGE_CONTAS_BANCARIAS_DIARIO | Projeto: BI_CVP | Dominio: CONTAS_BANCARIAS
# =========================
DAG_ID        = "DATASTAGE_CONTAS_BANCARIAS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "CONTAS_BANCARIAS"
PIPELINE_NAME = "DATASTAGE_CONTAS_BANCARIAS_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_CONTAS_BANCARIAS_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['BiCVP_ContasBancarias_001', 'BiCVP_ContasBancarias_002', 'BiCVP_ContasBancarias_003']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_CONTAS_BANCARIAS_DIARIO - BI_CVP / CONTAS_BANCARIAS",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule="45 9 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'CONTAS_BANCARIAS', 'DATASTAGE', 'DIARIO', 'CONTAS'],
) as dag:
    ...
    t_start_BiCVP_ContasBancarias_001 = PythonOperator(
        task_id="log_start_BiCVP_ContasBancarias_001",
        python_callable=log_start,
        op_kwargs={"job_name": "BiCVP_ContasBancarias_001", "task_key": "BiCVP_ContasBancarias_001"},
    )

    t_job_BiCVP_ContasBancarias_001 = DataStageOperator(
        task_id="BiCVP_ContasBancarias_001",
        project=PROJECT_NAME,
        job_name="BiCVP_ContasBancarias_001",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCVP_ContasBancarias_001 = PythonOperator(
        task_id="log_end_BiCVP_ContasBancarias_001",
        python_callable=log_end,
        op_kwargs={"job_name": "BiCVP_ContasBancarias_001", "task_key": "BiCVP_ContasBancarias_001", "upstream_task_id": "BiCVP_ContasBancarias_001"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCVP_ContasBancarias_002 = PythonOperator(
        task_id="log_start_BiCVP_ContasBancarias_002",
        python_callable=log_start,
        op_kwargs={"job_name": "BiCVP_ContasBancarias_002", "task_key": "BiCVP_ContasBancarias_002"},
    )

    t_job_BiCVP_ContasBancarias_002 = DataStageOperator(
        task_id="BiCVP_ContasBancarias_002",
        project=PROJECT_NAME,
        job_name="BiCVP_ContasBancarias_002",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCVP_ContasBancarias_002 = PythonOperator(
        task_id="log_end_BiCVP_ContasBancarias_002",
        python_callable=log_end,
        op_kwargs={"job_name": "BiCVP_ContasBancarias_002", "task_key": "BiCVP_ContasBancarias_002", "upstream_task_id": "BiCVP_ContasBancarias_002"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCVP_ContasBancarias_003 = PythonOperator(
        task_id="log_start_BiCVP_ContasBancarias_003",
        python_callable=log_start,
        op_kwargs={"job_name": "BiCVP_ContasBancarias_003", "task_key": "BiCVP_ContasBancarias_003"},
    )

    t_job_BiCVP_ContasBancarias_003 = DataStageOperator(
        task_id="BiCVP_ContasBancarias_003",
        project=PROJECT_NAME,
        job_name="BiCVP_ContasBancarias_003",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCVP_ContasBancarias_003 = PythonOperator(
        task_id="log_end_BiCVP_ContasBancarias_003",
        python_callable=log_end,
        op_kwargs={"job_name": "BiCVP_ContasBancarias_003", "task_key": "BiCVP_ContasBancarias_003", "upstream_task_id": "BiCVP_ContasBancarias_003"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_BiCVP_ContasBancarias_001 >> t_teams_start >> t_job_BiCVP_ContasBancarias_001 >> t_end_BiCVP_ContasBancarias_001

    t_end_BiCVP_ContasBancarias_001 >> t_start_BiCVP_ContasBancarias_002 >> t_job_BiCVP_ContasBancarias_002 >> t_end_BiCVP_ContasBancarias_002

    t_end_BiCVP_ContasBancarias_002 >> t_start_BiCVP_ContasBancarias_003 >> t_job_BiCVP_ContasBancarias_003 >> t_end_BiCVP_ContasBancarias_003

    end_tasks = [t_end_BiCVP_ContasBancarias_001, t_end_BiCVP_ContasBancarias_002, t_end_BiCVP_ContasBancarias_003]

    [t_end_BiCVP_ContasBancarias_001, t_end_BiCVP_ContasBancarias_002, t_end_BiCVP_ContasBancarias_003] >> t_publish_dataset

    [t_end_BiCVP_ContasBancarias_001, t_end_BiCVP_ContasBancarias_002, t_end_BiCVP_ContasBancarias_003] >> t_teams_end

    [t_end_BiCVP_ContasBancarias_001, t_end_BiCVP_ContasBancarias_002, t_end_BiCVP_ContasBancarias_003] >> t_teams_error
