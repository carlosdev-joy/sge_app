...
# Pipeline: DATASTAGE_AUDITORIA_PERMISSOES_ANALITICO_DIARIO | Projeto: BI_CVP | Dominio: AUDITORIA
# =========================
DAG_ID        = "DATASTAGE_AUDITORIA_PERMISSOES_ANALITICO_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "AUDITORIA"
PIPELINE_NAME = "DATASTAGE_AUDITORIA_PERMISSOES_ANALITICO_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_AUDITORIA_PERMISSOES_ANALITICO_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_AUDITORIA_PERMISSOES_ANALITICO_DIARIO - BI_CVP / AUDITORIA",
    start_date=pendulum.datetime(2026, 6, 20, tz=LOCAL_TZ),
    schedule="0 7 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'AUDITORIA', 'DATASTAGE', 'DIARIO'],
) as dag:
    ...
    t_start_Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico = PythonOperator(
        task_id="log_start_Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico",
        python_callable=log_start,
        op_kwargs={"job_name": "Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico", "task_key": "Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico"},
    )

    t_job_Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico = DataStageOperator(
        task_id="Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico",
        project=PROJECT_NAME,
        job_name="Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico = PythonOperator(
        task_id="log_end_Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico",
        python_callable=log_end,
        op_kwargs={"job_name": "Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico", "task_key": "Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico", "upstream_task_id": "Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico >> t_job_Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico >> t_end_Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico

    end_tasks = [t_end_Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico]

    [t_end_Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico] >> t_publish_dataset

    [t_end_Seq_BiCvp_Ins_AuditoriaPermissoes_Analitico] >> t_teams_error
