...
# Pipeline: DATASTAGE_CVP_BI_COBRANCAS | Projeto: BI_CVP | Dominio: COBRANCA
# =========================
DAG_ID        = "DATASTAGE_CVP_BI_COBRANCAS"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "COBRANCA"
PIPELINE_NAME = "DATASTAGE_CVP_BI_COBRANCAS"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_CVP_BI_COBRANCAS"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['Sequence_CvpBi_Cobrancas_RITM0049394']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_CVP_BI_COBRANCAS - BI_CVP / COBRANCA",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 8 * * 1,2,3,4,5",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'COBRANCA', 'GERORJ'],
) as dag:
    ...
    t_start_Sequence_CvpBi_Cobrancas_RITM0049394 = PythonOperator(
        task_id='log_start_Sequence_CvpBi_Cobrancas_RITM0049394',
        python_callable=log_start,
        op_kwargs={"job_name": 'Sequence_CvpBi_Cobrancas_RITM0049394', "task_key": 'Sequence_CvpBi_Cobrancas_RITM0049394'},
    )

    t_job_Sequence_CvpBi_Cobrancas_RITM0049394 = DataStageOperator(
        task_id='Sequence_CvpBi_Cobrancas_RITM0049394',
        project=PROJECT_NAME,
        job_name='Sequence_CvpBi_Cobrancas_RITM0049394',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_Sequence_CvpBi_Cobrancas_RITM0049394 = PythonOperator(
        task_id='log_end_Sequence_CvpBi_Cobrancas_RITM0049394',
        python_callable=log_end,
        op_kwargs={"job_name": 'Sequence_CvpBi_Cobrancas_RITM0049394', "task_key": 'Sequence_CvpBi_Cobrancas_RITM0049394', "upstream_task_id": 'Sequence_CvpBi_Cobrancas_RITM0049394'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_Sequence_CvpBi_Cobrancas_RITM0049394 >> t_job_Sequence_CvpBi_Cobrancas_RITM0049394 >> t_end_Sequence_CvpBi_Cobrancas_RITM0049394

    end_tasks = [t_end_Sequence_CvpBi_Cobrancas_RITM0049394]

    [t_end_Sequence_CvpBi_Cobrancas_RITM0049394] >> t_publish_dataset

    [t_end_Sequence_CvpBi_Cobrancas_RITM0049394] >> t_teams_error
