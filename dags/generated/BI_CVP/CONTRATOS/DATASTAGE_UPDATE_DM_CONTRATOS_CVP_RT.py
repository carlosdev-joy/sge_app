...
# Pipeline: DATASTAGE_UPDATE_DM_CONTRATOS_CVP_RT | Projeto: BI_CVP | Dominio: CONTRATOS
# =========================
DAG_ID        = "DATASTAGE_UPDATE_DM_CONTRATOS_CVP_RT"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "CONTRATOS"
PIPELINE_NAME = "DATASTAGE_UPDATE_DM_CONTRATOS_CVP_RT"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_UPDATE_DM_CONTRATOS_CVP_RT"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['UPDATE_DM_CONTRATOS_CVP_RT']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_UPDATE_DM_CONTRATOS_CVP_RT - BI_CVP / CONTRATOS",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 9 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'CONTRATOS', 'DIARIO'],
) as dag:
    ...
    t_start_UPDATE_DM_CONTRATOS_CVP_RT = PythonOperator(
        task_id='log_start_UPDATE_DM_CONTRATOS_CVP_RT',
        python_callable=log_start,
        op_kwargs={"job_name": 'UPDATE_DM_CONTRATOS_CVP_RT', "task_key": 'UPDATE_DM_CONTRATOS_CVP_RT'},
    )

    t_job_UPDATE_DM_CONTRATOS_CVP_RT = DataStageOperator(
        task_id='UPDATE_DM_CONTRATOS_CVP_RT',
        project=PROJECT_NAME,
        job_name='UPDATE_DM_CONTRATOS_CVP_RT',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_UPDATE_DM_CONTRATOS_CVP_RT = PythonOperator(
        task_id='log_end_UPDATE_DM_CONTRATOS_CVP_RT',
        python_callable=log_end,
        op_kwargs={"job_name": 'UPDATE_DM_CONTRATOS_CVP_RT', "task_key": 'UPDATE_DM_CONTRATOS_CVP_RT', "upstream_task_id": 'UPDATE_DM_CONTRATOS_CVP_RT'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_UPDATE_DM_CONTRATOS_CVP_RT >> t_job_UPDATE_DM_CONTRATOS_CVP_RT >> t_end_UPDATE_DM_CONTRATOS_CVP_RT

    end_tasks = [t_end_UPDATE_DM_CONTRATOS_CVP_RT]

    [t_end_UPDATE_DM_CONTRATOS_CVP_RT] >> t_publish_dataset

    [t_end_UPDATE_DM_CONTRATOS_CVP_RT] >> t_teams_error
