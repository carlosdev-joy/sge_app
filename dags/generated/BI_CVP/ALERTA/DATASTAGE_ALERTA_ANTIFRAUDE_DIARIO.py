...
# Pipeline: DATASTAGE_ALERTA_ANTIFRAUDE_DIARIO | Projeto: BI_CVP | Dominio: ALERTA
# =========================
DAG_ID        = "DATASTAGE_ALERTA_ANTIFRAUDE_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "ALERTA"
PIPELINE_NAME = "DATASTAGE_ALERTA_ANTIFRAUDE_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_ALERTA_ANTIFRAUDE_DIARIO - BI_CVP / ALERTA",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule="0 6 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'ALERTA', 'DATASTAGE', 'ANTIFRAUDE', 'DIARIO'],
) as dag:
    ...
    t_start_SEQ_ALERTA_ANTIFRAUDE = PythonOperator(
        task_id="log_start_SEQ_ALERTA_ANTIFRAUDE",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_ALERTA_ANTIFRAUDE", "task_key": "SEQ_ALERTA_ANTIFRAUDE"},
    )

    t_job_SEQ_ALERTA_ANTIFRAUDE = DataStageOperator(
        task_id="SEQ_ALERTA_ANTIFRAUDE",
        project=PROJECT_NAME,
        job_name="SEQ_ALERTA_ANTIFRAUDE",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_ALERTA_ANTIFRAUDE = PythonOperator(
        task_id="log_end_SEQ_ALERTA_ANTIFRAUDE",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_ALERTA_ANTIFRAUDE", "task_key": "SEQ_ALERTA_ANTIFRAUDE", "upstream_task_id": "SEQ_ALERTA_ANTIFRAUDE"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_ALERTA_ANTIFRAUDE >> t_job_SEQ_ALERTA_ANTIFRAUDE >> t_end_SEQ_ALERTA_ANTIFRAUDE

    end_tasks = [t_end_SEQ_ALERTA_ANTIFRAUDE]

    [t_end_SEQ_ALERTA_ANTIFRAUDE] >> t_publish_dataset

    [t_end_SEQ_ALERTA_ANTIFRAUDE] >> t_teams_error
