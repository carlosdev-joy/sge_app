...
# Pipeline: DATASTAGE_CVP_BI_SEQ_CLASSIFICA_FATO_GERADOR_V2 | Projeto: BI_CVP | Dominio: FATOR_GERADOR
# =========================
DAG_ID        = "DATASTAGE_CVP_BI_SEQ_CLASSIFICA_FATO_GERADOR_V2"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "FATOR_GERADOR"
PIPELINE_NAME = "DATASTAGE_CVP_BI_SEQ_CLASSIFICA_FATO_GERADOR_V2"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_CVP_BI_SEQ_CLASSIFICA_FATO_GERADOR_V2"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['CvpBi_SEQ_ClassificaFatoGerador_V2']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_CVP_BI_SEQ_CLASSIFICA_FATO_GERADOR_V2 - BI_CVP / FATOR_GERADOR",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 8 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'FATOR_GERADOR', 'CLASSIFICACAO'],
) as dag:
    ...
    t_start_CvpBi_SEQ_ClassificaFatoGerador_V2 = PythonOperator(
        task_id='log_start_CvpBi_SEQ_ClassificaFatoGerador_V2',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_SEQ_ClassificaFatoGerador_V2', "task_key": 'CvpBi_SEQ_ClassificaFatoGerador_V2'},
    )

    t_job_CvpBi_SEQ_ClassificaFatoGerador_V2 = DataStageOperator(
        task_id='CvpBi_SEQ_ClassificaFatoGerador_V2',
        project=PROJECT_NAME,
        job_name='CvpBi_SEQ_ClassificaFatoGerador_V2',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_SEQ_ClassificaFatoGerador_V2 = PythonOperator(
        task_id='log_end_CvpBi_SEQ_ClassificaFatoGerador_V2',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_SEQ_ClassificaFatoGerador_V2', "task_key": 'CvpBi_SEQ_ClassificaFatoGerador_V2', "upstream_task_id": 'CvpBi_SEQ_ClassificaFatoGerador_V2'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_CvpBi_SEQ_ClassificaFatoGerador_V2 >> t_job_CvpBi_SEQ_ClassificaFatoGerador_V2 >> t_end_CvpBi_SEQ_ClassificaFatoGerador_V2

    end_tasks = [t_end_CvpBi_SEQ_ClassificaFatoGerador_V2]

    [t_end_CvpBi_SEQ_ClassificaFatoGerador_V2] >> t_publish_dataset

    [t_end_CvpBi_SEQ_ClassificaFatoGerador_V2] >> t_teams_error
