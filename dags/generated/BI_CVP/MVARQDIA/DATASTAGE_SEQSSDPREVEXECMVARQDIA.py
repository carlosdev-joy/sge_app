...
# Pipeline: DATASTAGE_SEQSSDPREVEXECMVARQDIA | Projeto: BI_CVP | Dominio: MVARQDIA
# =========================
DAG_ID        = "DATASTAGE_SEQSSDPREVEXECMVARQDIA"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "MVARQDIA"
PIPELINE_NAME = "DATASTAGE_SEQSSDPREVEXECMVARQDIA"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SEQSSDPREVEXECMVARQDIA - BI_CVP / MVARQDIA",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="30 7 * * 1,2,3,4,5",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'MVARQDIA'],
) as dag:
    ...
    t_start_SeqSsdPrevExecMVARQDIA = PythonOperator(
        task_id='log_start_SeqSsdPrevExecMVARQDIA',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqSsdPrevExecMVARQDIA', "task_key": 'SeqSsdPrevExecMVARQDIA'},
    )

    t_job_SeqSsdPrevExecMVARQDIA = DataStageOperator(
        task_id='SeqSsdPrevExecMVARQDIA',
        project=PROJECT_NAME,
        job_name='SeqSsdPrevExecMVARQDIA',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqSsdPrevExecMVARQDIA = PythonOperator(
        task_id='log_end_SeqSsdPrevExecMVARQDIA',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqSsdPrevExecMVARQDIA', "task_key": 'SeqSsdPrevExecMVARQDIA', "upstream_task_id": 'SeqSsdPrevExecMVARQDIA'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqSsdPrevExecMVARQDIA >> t_job_SeqSsdPrevExecMVARQDIA >> t_end_SeqSsdPrevExecMVARQDIA

    end_tasks = [t_end_SeqSsdPrevExecMVARQDIA]

    [t_end_SeqSsdPrevExecMVARQDIA] >> t_publish_dataset

    [t_end_SeqSsdPrevExecMVARQDIA] >> t_teams_error
