...
# Pipeline: DATASTAGE_PROPOSTAS_PRESTAMISTA_DPS_DIARIO | Projeto: BI_CVP | Dominio: GESVIC
# =========================
DAG_ID        = "DATASTAGE_PROPOSTAS_PRESTAMISTA_DPS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "GESVIC"
PIPELINE_NAME = "DATASTAGE_PROPOSTAS_PRESTAMISTA_DPS_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_PROPOSTAS_PRESTAMISTA_DPS_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['CvpBi_Propostas_Prestamista_01_ext', 'CvpBi_Propostas_Prestamista_01_DPS_ext', 'CvpBi_Propostas_Prestamista_02_join', 'CvpBi_Propostas_Prestamista_03_env']
FLOW_JOBS     = ['CvpBi_Propostas_Prestamista_01_ext', 'CvpBi_Propostas_Prestamista_01_DPS_ext', 'CvpBi_Propostas_Prestamista_02_join', 'CvpBi_Propostas_Prestamista_03_env']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_PROPOSTAS_PRESTAMISTA_DPS_DIARIO - BI_CVP / GESVIC",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule="0 11 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'GESVIC', 'DATASTAGE', 'DIARIO', 'DPS'],
) as dag:
    ...
    t_start_CvpBi_Propostas_Prestamista_01_ext = PythonOperator(
        task_id='log_start_CvpBi_Propostas_Prestamista_01_ext',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_Propostas_Prestamista_01_ext', "task_key": 'CvpBi_Propostas_Prestamista_01_ext'},
    )

    t_job_CvpBi_Propostas_Prestamista_01_ext = DataStageOperator(
        task_id='CvpBi_Propostas_Prestamista_01_ext',
        project=PROJECT_NAME,
        job_name='CvpBi_Propostas_Prestamista_01_ext',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_Propostas_Prestamista_01_ext = PythonOperator(
        task_id='log_end_CvpBi_Propostas_Prestamista_01_ext',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_Propostas_Prestamista_01_ext', "task_key": 'CvpBi_Propostas_Prestamista_01_ext', "upstream_task_id": 'CvpBi_Propostas_Prestamista_01_ext'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_CvpBi_Propostas_Prestamista_01_DPS_ext = PythonOperator(
        task_id='log_start_CvpBi_Propostas_Prestamista_01_DPS_ext',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_Propostas_Prestamista_01_DPS_ext', "task_key": 'CvpBi_Propostas_Prestamista_01_DPS_ext'},
    )

    t_job_CvpBi_Propostas_Prestamista_01_DPS_ext = DataStageOperator(
        task_id='CvpBi_Propostas_Prestamista_01_DPS_ext',
        project=PROJECT_NAME,
        job_name='CvpBi_Propostas_Prestamista_01_DPS_ext',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_Propostas_Prestamista_01_DPS_ext = PythonOperator(
        task_id='log_end_CvpBi_Propostas_Prestamista_01_DPS_ext',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_Propostas_Prestamista_01_DPS_ext', "task_key": 'CvpBi_Propostas_Prestamista_01_DPS_ext', "upstream_task_id": 'CvpBi_Propostas_Prestamista_01_DPS_ext'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_CvpBi_Propostas_Prestamista_02_join = PythonOperator(
        task_id='log_start_CvpBi_Propostas_Prestamista_02_join',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_Propostas_Prestamista_02_join', "task_key": 'CvpBi_Propostas_Prestamista_02_join'},
    )

    t_job_CvpBi_Propostas_Prestamista_02_join = DataStageOperator(
        task_id='CvpBi_Propostas_Prestamista_02_join',
        project=PROJECT_NAME,
        job_name='CvpBi_Propostas_Prestamista_02_join',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_Propostas_Prestamista_02_join = PythonOperator(
        task_id='log_end_CvpBi_Propostas_Prestamista_02_join',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_Propostas_Prestamista_02_join', "task_key": 'CvpBi_Propostas_Prestamista_02_join', "upstream_task_id": 'CvpBi_Propostas_Prestamista_02_join'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_CvpBi_Propostas_Prestamista_03_env = PythonOperator(
        task_id='log_start_CvpBi_Propostas_Prestamista_03_env',
        python_callable=log_start,
        op_kwargs={"job_name": 'CvpBi_Propostas_Prestamista_03_env', "task_key": 'CvpBi_Propostas_Prestamista_03_env'},
    )

    t_job_CvpBi_Propostas_Prestamista_03_env = DataStageOperator(
        task_id='CvpBi_Propostas_Prestamista_03_env',
        project=PROJECT_NAME,
        job_name='CvpBi_Propostas_Prestamista_03_env',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_Propostas_Prestamista_03_env = PythonOperator(
        task_id='log_end_CvpBi_Propostas_Prestamista_03_env',
        python_callable=log_end,
        op_kwargs={"job_name": 'CvpBi_Propostas_Prestamista_03_env', "task_key": 'CvpBi_Propostas_Prestamista_03_env', "upstream_task_id": 'CvpBi_Propostas_Prestamista_03_env'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_CvpBi_Propostas_Prestamista_01_ext >> t_job_CvpBi_Propostas_Prestamista_01_ext >> t_end_CvpBi_Propostas_Prestamista_01_ext

    t_end_CvpBi_Propostas_Prestamista_01_ext >> t_start_CvpBi_Propostas_Prestamista_01_DPS_ext >> t_job_CvpBi_Propostas_Prestamista_01_DPS_ext >> t_end_CvpBi_Propostas_Prestamista_01_DPS_ext

    t_end_CvpBi_Propostas_Prestamista_01_DPS_ext >> t_start_CvpBi_Propostas_Prestamista_02_join >> t_job_CvpBi_Propostas_Prestamista_02_join >> t_end_CvpBi_Propostas_Prestamista_02_join

    t_end_CvpBi_Propostas_Prestamista_02_join >> t_start_CvpBi_Propostas_Prestamista_03_env >> t_job_CvpBi_Propostas_Prestamista_03_env >> t_end_CvpBi_Propostas_Prestamista_03_env

    end_tasks = [t_end_CvpBi_Propostas_Prestamista_01_ext, t_end_CvpBi_Propostas_Prestamista_01_DPS_ext, t_end_CvpBi_Propostas_Prestamista_02_join, t_end_CvpBi_Propostas_Prestamista_03_env]

    [t_end_CvpBi_Propostas_Prestamista_01_ext, t_end_CvpBi_Propostas_Prestamista_01_DPS_ext, t_end_CvpBi_Propostas_Prestamista_02_join, t_end_CvpBi_Propostas_Prestamista_03_env] >> t_publish_dataset

    [t_end_CvpBi_Propostas_Prestamista_01_ext, t_end_CvpBi_Propostas_Prestamista_01_DPS_ext, t_end_CvpBi_Propostas_Prestamista_02_join, t_end_CvpBi_Propostas_Prestamista_03_env] >> t_teams_error
