...
# Pipeline: DATASTAGE_SEQ_COAF_DIARIO | Projeto: BI_CVP | Dominio: COAF
# =========================
DAG_ID        = "DATASTAGE_SEQ_COAF_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "COAF"
PIPELINE_NAME = "DATASTAGE_SEQ_COAF_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SEQ_COAF_DIARIO - BI_CVP / COAF",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="15 6 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'COAF', 'DIARIO'],
) as dag:
    ...
    t_start_SEQ_COAF_DIARIO = PythonOperator(
        task_id='log_start_SEQ_COAF_DIARIO',
        python_callable=log_start,
        op_kwargs={"job_name": 'SEQ_COAF_DIARIO', "task_key": 'SEQ_COAF_DIARIO'},
    )

    t_job_SEQ_COAF_DIARIO = DataStageOperator(
        task_id='SEQ_COAF_DIARIO',
        project=PROJECT_NAME,
        job_name='SEQ_COAF_DIARIO',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_COAF_DIARIO = PythonOperator(
        task_id='log_end_SEQ_COAF_DIARIO',
        python_callable=log_end,
        op_kwargs={"job_name": 'SEQ_COAF_DIARIO', "task_key": 'SEQ_COAF_DIARIO', "upstream_task_id": 'SEQ_COAF_DIARIO'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_COAF_DIARIO >> t_job_SEQ_COAF_DIARIO >> t_end_SEQ_COAF_DIARIO

    end_tasks = [t_end_SEQ_COAF_DIARIO]

    [t_end_SEQ_COAF_DIARIO] >> t_publish_dataset

    [t_end_SEQ_COAF_DIARIO] >> t_teams_error
