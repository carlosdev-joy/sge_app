...
# Pipeline: DATASTAGE_SEQ_AGENCIA_ECONOMIARIO | Projeto: BI_CVP | Dominio: AGENCIA
# =========================
DAG_ID        = "DATASTAGE_SEQ_AGENCIA_ECONOMIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "AGENCIA"
PIPELINE_NAME = "DATASTAGE_SEQ_AGENCIA_ECONOMIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SEQ_AGENCIA_ECONOMIARIO - BI_CVP / AGENCIA",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="15 1 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'AGENCIA', 'AGENCA', 'ECONOMIARIO'],
) as dag:
    ...
    t_start_SEQ_AGENCIA_ECONOMIARIO = PythonOperator(
        task_id='log_start_SEQ_AGENCIA_ECONOMIARIO',
        python_callable=log_start,
        op_kwargs={"job_name": 'SEQ_AGENCIA_ECONOMIARIO', "task_key": 'SEQ_AGENCIA_ECONOMIARIO'},
    )

    t_job_SEQ_AGENCIA_ECONOMIARIO = DataStageOperator(
        task_id='SEQ_AGENCIA_ECONOMIARIO',
        project=PROJECT_NAME,
        job_name='SEQ_AGENCIA_ECONOMIARIO',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_AGENCIA_ECONOMIARIO = PythonOperator(
        task_id='log_end_SEQ_AGENCIA_ECONOMIARIO',
        python_callable=log_end,
        op_kwargs={"job_name": 'SEQ_AGENCIA_ECONOMIARIO', "task_key": 'SEQ_AGENCIA_ECONOMIARIO', "upstream_task_id": 'SEQ_AGENCIA_ECONOMIARIO'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_AGENCIA_ECONOMIARIO >> t_job_SEQ_AGENCIA_ECONOMIARIO >> t_end_SEQ_AGENCIA_ECONOMIARIO

    end_tasks = [t_end_SEQ_AGENCIA_ECONOMIARIO]

    [t_end_SEQ_AGENCIA_ECONOMIARIO] >> t_publish_dataset

    [t_end_SEQ_AGENCIA_ECONOMIARIO] >> t_teams_error
