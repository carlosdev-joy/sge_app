...
# Pipeline: DATASTAGE_GERORJ_COBRANCAS_DIARIO | Projeto: BI_CVP | Dominio: GERORJ
# =========================
DAG_ID        = "DATASTAGE_GERORJ_COBRANCAS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "GERORJ"
PIPELINE_NAME = "DATASTAGE_GERORJ_COBRANCAS_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_GERORJ_COBRANCAS_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['CvpBi_Cobrancas_RITM0049394_01_ext', 'CvpBi_Cobrancas_RITM0049394_02_car']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_GERORJ_COBRANCAS_DIARIO - BI_CVP / GERORJ",
    start_date=pendulum.datetime(2026, 6, 15, tz=LOCAL_TZ),
    schedule="0 7 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'GERORJ', 'DATASTAGE', 'COBRANCAS', 'DIARIO'],
) as dag:
    ...
    t_start_CvpBi_Cobrancas_RITM0049394_01_ext = PythonOperator(
        task_id="log_start_CvpBi_Cobrancas_RITM0049394_01_ext",
        python_callable=log_start,
        op_kwargs={"job_name": "CvpBi_Cobrancas_RITM0049394_01_ext", "task_key": "CvpBi_Cobrancas_RITM0049394_01_ext"},
    )

    t_job_CvpBi_Cobrancas_RITM0049394_01_ext = DataStageOperator(
        task_id="CvpBi_Cobrancas_RITM0049394_01_ext",
        project=PROJECT_NAME,
        job_name="CvpBi_Cobrancas_RITM0049394_01_ext",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_Cobrancas_RITM0049394_01_ext = PythonOperator(
        task_id="log_end_CvpBi_Cobrancas_RITM0049394_01_ext",
        python_callable=log_end,
        op_kwargs={"job_name": "CvpBi_Cobrancas_RITM0049394_01_ext", "task_key": "CvpBi_Cobrancas_RITM0049394_01_ext", "upstream_task_id": "CvpBi_Cobrancas_RITM0049394_01_ext"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_CvpBi_Cobrancas_RITM0049394_02_car = PythonOperator(
        task_id="log_start_CvpBi_Cobrancas_RITM0049394_02_car",
        python_callable=log_start,
        op_kwargs={"job_name": "CvpBi_Cobrancas_RITM0049394_02_car", "task_key": "CvpBi_Cobrancas_RITM0049394_02_car"},
    )

    t_job_CvpBi_Cobrancas_RITM0049394_02_car = DataStageOperator(
        task_id="CvpBi_Cobrancas_RITM0049394_02_car",
        project=PROJECT_NAME,
        job_name="CvpBi_Cobrancas_RITM0049394_02_car",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_CvpBi_Cobrancas_RITM0049394_02_car = PythonOperator(
        task_id="log_end_CvpBi_Cobrancas_RITM0049394_02_car",
        python_callable=log_end,
        op_kwargs={"job_name": "CvpBi_Cobrancas_RITM0049394_02_car", "task_key": "CvpBi_Cobrancas_RITM0049394_02_car", "upstream_task_id": "CvpBi_Cobrancas_RITM0049394_02_car"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_CvpBi_Cobrancas_RITM0049394_01_ext >> t_teams_start >> t_job_CvpBi_Cobrancas_RITM0049394_01_ext >> t_end_CvpBi_Cobrancas_RITM0049394_01_ext

    t_end_CvpBi_Cobrancas_RITM0049394_01_ext >> t_start_CvpBi_Cobrancas_RITM0049394_02_car >> t_job_CvpBi_Cobrancas_RITM0049394_02_car >> t_end_CvpBi_Cobrancas_RITM0049394_02_car

    end_tasks = [t_end_CvpBi_Cobrancas_RITM0049394_01_ext, t_end_CvpBi_Cobrancas_RITM0049394_02_car]

    [t_end_CvpBi_Cobrancas_RITM0049394_01_ext, t_end_CvpBi_Cobrancas_RITM0049394_02_car] >> t_publish_dataset

    [t_end_CvpBi_Cobrancas_RITM0049394_01_ext, t_end_CvpBi_Cobrancas_RITM0049394_02_car] >> t_teams_end

    [t_end_CvpBi_Cobrancas_RITM0049394_01_ext, t_end_CvpBi_Cobrancas_RITM0049394_02_car] >> t_teams_error
