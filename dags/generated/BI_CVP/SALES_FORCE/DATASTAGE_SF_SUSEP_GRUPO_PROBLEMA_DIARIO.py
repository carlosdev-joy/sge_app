...
# Pipeline: DATASTAGE_SF_SUSEP_GRUPO_PROBLEMA_DIARIO | Projeto: BI_CVP | Dominio: SALES_FORCE
# =========================
DAG_ID        = "DATASTAGE_SF_SUSEP_GRUPO_PROBLEMA_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE"
PIPELINE_NAME = "DATASTAGE_SF_SUSEP_GRUPO_PROBLEMA_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SF_SUSEP_GRUPO_PROBLEMA_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SEQ_SF_SUSEP_GRUPO', 'SEQ_SF_SUSEP_PROBLEMA']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SF_SUSEP_GRUPO_PROBLEMA_DIARIO - BI_CVP / SALES_FORCE",
    ...
    t_start_SEQ_SF_SUSEP_GRUPO = PythonOperator(
        task_id="log_start_SEQ_SF_SUSEP_GRUPO",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_SF_SUSEP_GRUPO", "task_key": "SEQ_SF_SUSEP_GRUPO"},
    )

    t_job_SEQ_SF_SUSEP_GRUPO = DataStageOperator(
        task_id="SEQ_SF_SUSEP_GRUPO",
        project=PROJECT_NAME,
        job_name="SEQ_SF_SUSEP_GRUPO",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_SF_SUSEP_GRUPO = PythonOperator(
        task_id="log_end_SEQ_SF_SUSEP_GRUPO",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_SF_SUSEP_GRUPO", "task_key": "SEQ_SF_SUSEP_GRUPO", "upstream_task_id": "SEQ_SF_SUSEP_GRUPO"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SEQ_SF_SUSEP_PROBLEMA = PythonOperator(
        task_id="log_start_SEQ_SF_SUSEP_PROBLEMA",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_SF_SUSEP_PROBLEMA", "task_key": "SEQ_SF_SUSEP_PROBLEMA"},
    )

    t_job_SEQ_SF_SUSEP_PROBLEMA = DataStageOperator(
        task_id="SEQ_SF_SUSEP_PROBLEMA",
        project=PROJECT_NAME,
        job_name="SEQ_SF_SUSEP_PROBLEMA",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_SF_SUSEP_PROBLEMA = PythonOperator(
        task_id="log_end_SEQ_SF_SUSEP_PROBLEMA",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_SF_SUSEP_PROBLEMA", "task_key": "SEQ_SF_SUSEP_PROBLEMA", "upstream_task_id": "SEQ_SF_SUSEP_PROBLEMA"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_SF_SUSEP_GRUPO >> t_job_SEQ_SF_SUSEP_GRUPO >> t_end_SEQ_SF_SUSEP_GRUPO

    t_end_SEQ_SF_SUSEP_GRUPO >> t_start_SEQ_SF_SUSEP_PROBLEMA >> t_job_SEQ_SF_SUSEP_PROBLEMA >> t_end_SEQ_SF_SUSEP_PROBLEMA

    end_tasks = [t_end_SEQ_SF_SUSEP_GRUPO, t_end_SEQ_SF_SUSEP_PROBLEMA]

    [t_end_SEQ_SF_SUSEP_GRUPO, t_end_SEQ_SF_SUSEP_PROBLEMA] >> t_publish_dataset

    [t_end_SEQ_SF_SUSEP_GRUPO, t_end_SEQ_SF_SUSEP_PROBLEMA] >> t_teams_error
