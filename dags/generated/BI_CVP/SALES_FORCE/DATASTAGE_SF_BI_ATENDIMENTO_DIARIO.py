...
# Pipeline: DATASTAGE_SF_BI_ATENDIMENTO_DIARIO | Projeto: BI_CVP | Dominio: SALES_FORCE
# =========================
DAG_ID        = "DATASTAGE_SF_BI_ATENDIMENTO_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE"
PIPELINE_NAME = "DATASTAGE_SF_BI_ATENDIMENTO_DIARIO"
...
HORARIOS_ESPECIFICOS = ['08:35', '11:35', '14:35', '17:35', '20:25']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/DATASTAGE_SF_BI_ATENDIMENTO_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqBiCvp_SalesForce_Atendimento']
FLOW_JOBS     = ['SeqBiCvp_SalesForce_Atendimento']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SF_BI_ATENDIMENTO_DIARIO - BI_CVP / SALES_FORCE",
    start_date=pendulum.datetime(2026, 6, 18, tz=LOCAL_TZ),
    schedule="25,35 8,11,14,17,20 * * 0,1,2,3,4,5,6",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SALES_FORCE', 'DATASTAGE', 'BI', 'ATENDIMENTO', 'DIARIO'],
) as dag:
    ...
    t_start_SeqBiCvp_SalesForce_Atendimento = PythonOperator(
        task_id='log_start_SeqBiCvp_SalesForce_Atendimento',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqBiCvp_SalesForce_Atendimento', "task_key": 'SeqBiCvp_SalesForce_Atendimento'},
    )

    t_job_SeqBiCvp_SalesForce_Atendimento = DataStageOperator(
        task_id='SeqBiCvp_SalesForce_Atendimento',
        project=PROJECT_NAME,
        job_name='SeqBiCvp_SalesForce_Atendimento',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_SalesForce_Atendimento = PythonOperator(
        task_id='log_end_SeqBiCvp_SalesForce_Atendimento',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqBiCvp_SalesForce_Atendimento', "task_key": 'SeqBiCvp_SalesForce_Atendimento', "upstream_task_id": 'SeqBiCvp_SalesForce_Atendimento'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_SalesForce_Atendimento >> t_job_SeqBiCvp_SalesForce_Atendimento >> t_end_SeqBiCvp_SalesForce_Atendimento

    end_tasks = [t_end_SeqBiCvp_SalesForce_Atendimento]

    [t_end_SeqBiCvp_SalesForce_Atendimento] >> t_publish_dataset

    [t_end_SeqBiCvp_SalesForce_Atendimento] >> t_teams_error
