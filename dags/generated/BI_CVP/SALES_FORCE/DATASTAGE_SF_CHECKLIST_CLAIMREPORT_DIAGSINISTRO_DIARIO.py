...
# Pipeline: DATASTAGE_SF_CHECKLIST_CLAIMREPORT_DIAGSINISTRO_DIARIO | Projeto: BI_CVP | Dominio: SALES_FORCE
# =========================
DAG_ID        = "DATASTAGE_SF_CHECKLIST_CLAIMREPORT_DIAGSINISTRO_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE"
PIPELINE_NAME = "DATASTAGE_SF_CHECKLIST_CLAIMREPORT_DIAGSINISTRO_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SF_CHECKLIST_CLAIMREPORT_DIAGSINISTRO_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SEQ_SF_CHECKLIST_C', 'SEQ_SF_CLAIM_REPORT', 'SEQ_SF_DIAGNOSTICOSINISTRO']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SF_CHECKLIST_CLAIMREPORT_DIAGSINISTRO_DIARIO - BI_CVP / SALES_FORCE",
    start_date=pendulum.datetime(2026, 6, 19, tz=LOCAL_TZ),
    schedule="0 7 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SALES_FORCE', 'DATASTAGE', 'DIARIO'],
) as dag:
    ...
    t_start_SEQ_SF_CHECKLIST_C = PythonOperator(
        task_id="log_start_SEQ_SF_CHECKLIST_C",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_SF_CHECKLIST_C", "task_key": "SEQ_SF_CHECKLIST_C"},
    )

    t_job_SEQ_SF_CHECKLIST_C = DataStageOperator(
        task_id="SEQ_SF_CHECKLIST_C",
        project=PROJECT_NAME,
        job_name="SEQ_SF_CHECKLIST_C",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_SF_CHECKLIST_C = PythonOperator(
        task_id="log_end_SEQ_SF_CHECKLIST_C",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_SF_CHECKLIST_C", "task_key": "SEQ_SF_CHECKLIST_C", "upstream_task_id": "SEQ_SF_CHECKLIST_C"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SEQ_SF_CLAIM_REPORT = PythonOperator(
        task_id="log_start_SEQ_SF_CLAIM_REPORT",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_SF_CLAIM_REPORT", "task_key": "SEQ_SF_CLAIM_REPORT"},
    )

    t_job_SEQ_SF_CLAIM_REPORT = DataStageOperator(
        task_id="SEQ_SF_CLAIM_REPORT",
        project=PROJECT_NAME,
        job_name="SEQ_SF_CLAIM_REPORT",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_SF_CLAIM_REPORT = PythonOperator(
        task_id="log_end_SEQ_SF_CLAIM_REPORT",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_SF_CLAIM_REPORT", "task_key": "SEQ_SF_CLAIM_REPORT", "upstream_task_id": "SEQ_SF_CLAIM_REPORT"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SEQ_SF_DIAGNOSTICOSINISTRO = PythonOperator(
        task_id="log_start_SEQ_SF_DIAGNOSTICOSINISTRO",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_SF_DIAGNOSTICOSINISTRO", "task_key": "SEQ_SF_DIAGNOSTICOSINISTRO"},
    )

    t_job_SEQ_SF_DIAGNOSTICOSINISTRO = DataStageOperator(
        task_id="SEQ_SF_DIAGNOSTICOSINISTRO",
        project=PROJECT_NAME,
        job_name="SEQ_SF_DIAGNOSTICOSINISTRO",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_SF_DIAGNOSTICOSINISTRO = PythonOperator(
        task_id="log_end_SEQ_SF_DIAGNOSTICOSINISTRO",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_SF_DIAGNOSTICOSINISTRO", "task_key": "SEQ_SF_DIAGNOSTICOSINISTRO", "upstream_task_id": "SEQ_SF_DIAGNOSTICOSINISTRO"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_SF_CHECKLIST_C >> t_job_SEQ_SF_CHECKLIST_C >> t_end_SEQ_SF_CHECKLIST_C

    t_check_agenda >> t_start_SEQ_SF_CLAIM_REPORT >> t_job_SEQ_SF_CLAIM_REPORT >> t_end_SEQ_SF_CLAIM_REPORT

    t_check_agenda >> t_start_SEQ_SF_DIAGNOSTICOSINISTRO >> t_job_SEQ_SF_DIAGNOSTICOSINISTRO >> t_end_SEQ_SF_DIAGNOSTICOSINISTRO

    end_tasks = [t_end_SEQ_SF_CHECKLIST_C, t_end_SEQ_SF_CLAIM_REPORT, t_end_SEQ_SF_DIAGNOSTICOSINISTRO]

    [t_end_SEQ_SF_CHECKLIST_C, t_end_SEQ_SF_CLAIM_REPORT, t_end_SEQ_SF_DIAGNOSTICOSINISTRO] >> t_publish_dataset

    [t_end_SEQ_SF_CHECKLIST_C, t_end_SEQ_SF_CLAIM_REPORT, t_end_SEQ_SF_DIAGNOSTICOSINISTRO] >> t_teams_error
