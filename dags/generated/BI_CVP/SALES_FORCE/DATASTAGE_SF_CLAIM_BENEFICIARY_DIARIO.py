...
# Pipeline: DATASTAGE_SF_CLAIM_BENEFICIARY_DIARIO | Projeto: BI_CVP | Dominio: SALES_FORCE
# =========================
DAG_ID        = "DATASTAGE_SF_CLAIM_BENEFICIARY_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE"
PIPELINE_NAME = "DATASTAGE_SF_CLAIM_BENEFICIARY_DIARIO"
...
HORARIOS_ESPECIFICOS = ['07:00', '13:00']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/DATASTAGE_SF_CLAIM_BENEFICIARY_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SEQ_SF_CLAIM_BENEFICIARY']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SF_CLAIM_BENEFICIARY_DIARIO - BI_CVP / SALES_FORCE",
    start_date=pendulum.datetime(2026, 6, 19, tz=LOCAL_TZ),
    schedule="0 7,13 * * 0,1,2,3,4,5,6",
    catchup=False,
    max_active_runs=1,
    ...
    t_start_SEQ_SF_CLAIM_BENEFICIARY = PythonOperator(
        task_id="log_start_SEQ_SF_CLAIM_BENEFICIARY",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_SF_CLAIM_BENEFICIARY", "task_key": "SEQ_SF_CLAIM_BENEFICIARY"},
    )

    t_job_SEQ_SF_CLAIM_BENEFICIARY = DataStageOperator(
        task_id="SEQ_SF_CLAIM_BENEFICIARY",
        project=PROJECT_NAME,
        job_name="SEQ_SF_CLAIM_BENEFICIARY",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_SF_CLAIM_BENEFICIARY = PythonOperator(
        task_id="log_end_SEQ_SF_CLAIM_BENEFICIARY",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_SF_CLAIM_BENEFICIARY", "task_key": "SEQ_SF_CLAIM_BENEFICIARY", "upstream_task_id": "SEQ_SF_CLAIM_BENEFICIARY"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_SF_CLAIM_BENEFICIARY >> t_job_SEQ_SF_CLAIM_BENEFICIARY >> t_end_SEQ_SF_CLAIM_BENEFICIARY

    end_tasks = [t_end_SEQ_SF_CLAIM_BENEFICIARY]

    [t_end_SEQ_SF_CLAIM_BENEFICIARY] >> t_publish_dataset

    [t_end_SEQ_SF_CLAIM_BENEFICIARY] >> t_teams_error
