...
# Pipeline: DATASTAGE_SF_BI_RECLAMACOES_SUSEP_SEMANAL | Projeto: BI_CVP | Dominio: SALES_FORCE
# =========================
DAG_ID        = "DATASTAGE_SF_BI_RECLAMACOES_SUSEP_SEMANAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE"
PIPELINE_NAME = "DATASTAGE_SF_BI_RECLAMACOES_SUSEP_SEMANAL"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SF_BI_RECLAMACOES_SUSEP_SEMANAL"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqBiCvp_SalesForce_ReclamacoesSusep']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SF_BI_RECLAMACOES_SUSEP_SEMANAL - BI_CVP / SALES_FORCE",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 8 * * 0",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SALES_FORCE', 'DATASTAGE', 'BI', 'RELCAMACOES', 'SUSEP', 'SEMANAL'],
) as dag:
    ...
    t_start_SeqBiCvp_SalesForce_ReclamacoesSusep = PythonOperator(
        task_id="log_start_SeqBiCvp_SalesForce_ReclamacoesSusep",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_SalesForce_ReclamacoesSusep", "task_key": "SeqBiCvp_SalesForce_ReclamacoesSusep"},
    )

    t_job_SeqBiCvp_SalesForce_ReclamacoesSusep = DataStageOperator(
        task_id="SeqBiCvp_SalesForce_ReclamacoesSusep",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_SalesForce_ReclamacoesSusep",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_SalesForce_ReclamacoesSusep = PythonOperator(
        task_id="log_end_SeqBiCvp_SalesForce_ReclamacoesSusep",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_SalesForce_ReclamacoesSusep", "task_key": "SeqBiCvp_SalesForce_ReclamacoesSusep", "upstream_task_id": "SeqBiCvp_SalesForce_ReclamacoesSusep"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_SalesForce_ReclamacoesSusep >> t_job_SeqBiCvp_SalesForce_ReclamacoesSusep >> t_end_SeqBiCvp_SalesForce_ReclamacoesSusep

    end_tasks = [t_end_SeqBiCvp_SalesForce_ReclamacoesSusep]

    [t_end_SeqBiCvp_SalesForce_ReclamacoesSusep] >> t_publish_dataset

    [t_end_SeqBiCvp_SalesForce_ReclamacoesSusep] >> t_teams_error
