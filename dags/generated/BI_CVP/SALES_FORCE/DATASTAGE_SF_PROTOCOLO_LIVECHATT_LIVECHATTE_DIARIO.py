...
# Pipeline: DATASTAGE_SF_PROTOCOLO_LIVECHATT_LIVECHATTE_DIARIO | Projeto: BI_CVP | Dominio: SALES_FORCE
# =========================
DAG_ID        = "DATASTAGE_SF_PROTOCOLO_LIVECHATT_LIVECHATTE_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE"
PIPELINE_NAME = "DATASTAGE_SF_PROTOCOLO_LIVECHATT_LIVECHATTE_DIARIO"
...
HORARIOS_ESPECIFICOS = ['09:00', '12:00', '16:00']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/DATASTAGE_SF_PROTOCOLO_LIVECHATT_LIVECHATTE_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SEQ_SF_LIVECHATTRANSCRIPT', 'SEQ_SF_LIVECHATTRANSCRIPTEVENT', 'SEQ_SF_PROTOCOLO']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SF_PROTOCOLO_LIVECHATT_LIVECHATTE_DIARIO - BI_CVP / SALES_FORCE",
    start_date=pendulum.datetime(2026, 6, 18, tz=LOCAL_TZ),
    schedule="0 9,12,16 * * 0,1,2,3,4,5,6",
    catchup=False,
    max_active_runs=1,
    ...
    t_check_agenda >> t_start_SEQ_SF_LIVECHATTRANSCRIPT >> t_job_SEQ_SF_LIVECHATTRANSCRIPT >> t_end_SEQ_SF_LIVECHATTRANSCRIPT

    t_check_agenda >> t_start_SEQ_SF_LIVECHATTRANSCRIPTEVENT >> t_job_SEQ_SF_LIVECHATTRANSCRIPTEVENT >> t_end_SEQ_SF_LIVECHATTRANSCRIPTEVENT

    t_check_agenda >> t_start_SEQ_SF_PROTOCOLO >> t_job_SEQ_SF_PROTOCOLO >> t_end_SEQ_SF_PROTOCOLO

    end_tasks = [t_end_SEQ_SF_LIVECHATTRANSCRIPT, t_end_SEQ_SF_LIVECHATTRANSCRIPTEVENT, t_end_SEQ_SF_PROTOCOLO]

    [t_end_SEQ_SF_LIVECHATTRANSCRIPT, t_end_SEQ_SF_LIVECHATTRANSCRIPTEVENT, t_end_SEQ_SF_PROTOCOLO] >> t_publish_dataset

    [t_end_SEQ_SF_LIVECHATTRANSCRIPT, t_end_SEQ_SF_LIVECHATTRANSCRIPTEVENT, t_end_SEQ_SF_PROTOCOLO] >> t_teams_error
