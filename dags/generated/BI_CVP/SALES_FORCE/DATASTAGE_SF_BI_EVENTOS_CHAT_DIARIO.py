...
# Pipeline: DATASTAGE_SF_BI_EVENTOS_CHAT_DIARIO | Projeto: BI_CVP | Dominio: SALES_FORCE
# =========================
DAG_ID        = "DATASTAGE_SF_BI_EVENTOS_CHAT_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE"
PIPELINE_NAME = "DATASTAGE_SF_BI_EVENTOS_CHAT_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SF_BI_EVENTOS_CHAT_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqBiCvp_SalesForce_EventosChat']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SF_BI_EVENTOS_CHAT_DIARIO - BI_CVP / SALES_FORCE",
    start_date=pendulum.datetime(2026, 6, 19, tz=LOCAL_TZ),
    schedule="0 7 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SALES_FORCE', 'DATASTAGE', 'EVENTOS', 'CHAT', 'BI', 'DIARIO'],
) as dag:
    ...
    t_start_SeqBiCvp_SalesForce_EventosChat = PythonOperator(
        task_id="log_start_SeqBiCvp_SalesForce_EventosChat",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_SalesForce_EventosChat", "task_key": "SeqBiCvp_SalesForce_EventosChat"},
    )

    t_job_SeqBiCvp_SalesForce_EventosChat = DataStageOperator(
        task_id="SeqBiCvp_SalesForce_EventosChat",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_SalesForce_EventosChat",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_SalesForce_EventosChat = PythonOperator(
        task_id="log_end_SeqBiCvp_SalesForce_EventosChat",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_SalesForce_EventosChat", "task_key": "SeqBiCvp_SalesForce_EventosChat", "upstream_task_id": "SeqBiCvp_SalesForce_EventosChat"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_SalesForce_EventosChat >> t_job_SeqBiCvp_SalesForce_EventosChat >> t_end_SeqBiCvp_SalesForce_EventosChat

    end_tasks = [t_end_SeqBiCvp_SalesForce_EventosChat]

    [t_end_SeqBiCvp_SalesForce_EventosChat] >> t_publish_dataset

    [t_end_SeqBiCvp_SalesForce_EventosChat] >> t_teams_error
