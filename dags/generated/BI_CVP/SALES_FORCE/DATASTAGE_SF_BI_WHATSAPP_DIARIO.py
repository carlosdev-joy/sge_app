...
# Pipeline: DATASTAGE_SF_BI_WHATSAPP_DIARIO | Projeto: BI_CVP | Dominio: SALES_FORCE
# =========================
DAG_ID        = "DATASTAGE_SF_BI_WHATSAPP_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE"
PIPELINE_NAME = "DATASTAGE_SF_BI_WHATSAPP_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SF_BI_WHATSAPP_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['BiCvp_SalesForce_Whatsapp_01_ext_Protocolo', 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging', 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent', 'BiCvp_SalesForce_Whatsapp_02_join', 'BiCvp_SalesForce_Whatsapp_03_car', 'BiCvp_SalesForce_Whatsapp_04_ins', 'BiCvp_SalesForce_Whatsapp_05_upd']
FLOW_JOBS     = ['BiCvp_SalesForce_Whatsapp_01_ext_Protocolo', 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging', 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent', 'BiCvp_SalesForce_Whatsapp_02_join', 'BiCvp_SalesForce_Whatsapp_03_car', 'BiCvp_SalesForce_Whatsapp_04_ins', 'BiCvp_SalesForce_Whatsapp_05_upd']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SF_BI_WHATSAPP_DIARIO - BI_CVP / SALES_FORCE",
    start_date=pendulum.datetime(2026, 8, 11, tz=LOCAL_TZ),
    schedule="0 17 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SALES_FORCE', 'DATASTAGE', 'DIARIO', 'WHATSAPP'],
) as dag:
    ...
    t_start_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo = _LogStart(
        task_id='log_start_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo', "task_key": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo'},
    )

    t_job_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo = DataStageOperator(
        task_id='BiCvp_SalesForce_Whatsapp_01_ext_Protocolo',
        project=PROJECT_NAME,
        job_name='BiCvp_SalesForce_Whatsapp_01_ext_Protocolo',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo = PythonOperator(
        task_id='log_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo', "task_key": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo', "upstream_task_id": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging = _LogStart(
        task_id='log_start_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging', "task_key": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging'},
    )

    t_job_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging = DataStageOperator(
        task_id='BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging',
        project=PROJECT_NAME,
        job_name='BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging = PythonOperator(
        task_id='log_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging', "task_key": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging', "upstream_task_id": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent = _LogStart(
        task_id='log_start_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent', "task_key": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent'},
    )

    t_job_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent = DataStageOperator(
        task_id='BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent',
        project=PROJECT_NAME,
        job_name='BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent = PythonOperator(
        task_id='log_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent', "task_key": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent', "upstream_task_id": 'BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_SalesForce_Whatsapp_02_join = _LogStart(
        task_id='log_start_BiCvp_SalesForce_Whatsapp_02_join',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_02_join', "task_key": 'BiCvp_SalesForce_Whatsapp_02_join'},
    )

    t_job_BiCvp_SalesForce_Whatsapp_02_join = DataStageOperator(
        task_id='BiCvp_SalesForce_Whatsapp_02_join',
        project=PROJECT_NAME,
        job_name='BiCvp_SalesForce_Whatsapp_02_join',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_SalesForce_Whatsapp_02_join = PythonOperator(
        task_id='log_end_BiCvp_SalesForce_Whatsapp_02_join',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_02_join', "task_key": 'BiCvp_SalesForce_Whatsapp_02_join', "upstream_task_id": 'BiCvp_SalesForce_Whatsapp_02_join'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_SalesForce_Whatsapp_03_car = _LogStart(
        task_id='log_start_BiCvp_SalesForce_Whatsapp_03_car',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_03_car', "task_key": 'BiCvp_SalesForce_Whatsapp_03_car'},
    )

    t_job_BiCvp_SalesForce_Whatsapp_03_car = DataStageOperator(
        task_id='BiCvp_SalesForce_Whatsapp_03_car',
        project=PROJECT_NAME,
        job_name='BiCvp_SalesForce_Whatsapp_03_car',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_SalesForce_Whatsapp_03_car = PythonOperator(
        task_id='log_end_BiCvp_SalesForce_Whatsapp_03_car',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_03_car', "task_key": 'BiCvp_SalesForce_Whatsapp_03_car', "upstream_task_id": 'BiCvp_SalesForce_Whatsapp_03_car'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_SalesForce_Whatsapp_04_ins = _LogStart(
        task_id='log_start_BiCvp_SalesForce_Whatsapp_04_ins',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_04_ins', "task_key": 'BiCvp_SalesForce_Whatsapp_04_ins'},
    )

    t_job_BiCvp_SalesForce_Whatsapp_04_ins = DataStageOperator(
        task_id='BiCvp_SalesForce_Whatsapp_04_ins',
        project=PROJECT_NAME,
        job_name='BiCvp_SalesForce_Whatsapp_04_ins',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_SalesForce_Whatsapp_04_ins = PythonOperator(
        task_id='log_end_BiCvp_SalesForce_Whatsapp_04_ins',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_04_ins', "task_key": 'BiCvp_SalesForce_Whatsapp_04_ins', "upstream_task_id": 'BiCvp_SalesForce_Whatsapp_04_ins'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_SalesForce_Whatsapp_05_upd = _LogStart(
        task_id='log_start_BiCvp_SalesForce_Whatsapp_05_upd',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_05_upd', "task_key": 'BiCvp_SalesForce_Whatsapp_05_upd'},
    )

    t_job_BiCvp_SalesForce_Whatsapp_05_upd = DataStageOperator(
        task_id='BiCvp_SalesForce_Whatsapp_05_upd',
        project=PROJECT_NAME,
        job_name='BiCvp_SalesForce_Whatsapp_05_upd',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_SalesForce_Whatsapp_05_upd = PythonOperator(
        task_id='log_end_BiCvp_SalesForce_Whatsapp_05_upd',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_SalesForce_Whatsapp_05_upd', "task_key": 'BiCvp_SalesForce_Whatsapp_05_upd', "upstream_task_id": 'BiCvp_SalesForce_Whatsapp_05_upd'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo >> t_job_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo >> t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo

    t_check_agenda >> t_start_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging >> t_job_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging >> t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging

    t_check_agenda >> t_start_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent >> t_job_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent >> t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent

    [t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo, t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging, t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent] >> t_start_BiCvp_SalesForce_Whatsapp_02_join >> t_job_BiCvp_SalesForce_Whatsapp_02_join >> t_end_BiCvp_SalesForce_Whatsapp_02_join

    t_end_BiCvp_SalesForce_Whatsapp_02_join >> t_start_BiCvp_SalesForce_Whatsapp_03_car >> t_job_BiCvp_SalesForce_Whatsapp_03_car >> t_end_BiCvp_SalesForce_Whatsapp_03_car

    t_end_BiCvp_SalesForce_Whatsapp_03_car >> t_start_BiCvp_SalesForce_Whatsapp_04_ins >> t_job_BiCvp_SalesForce_Whatsapp_04_ins >> t_end_BiCvp_SalesForce_Whatsapp_04_ins

    t_end_BiCvp_SalesForce_Whatsapp_04_ins >> t_start_BiCvp_SalesForce_Whatsapp_05_upd >> t_job_BiCvp_SalesForce_Whatsapp_05_upd >> t_end_BiCvp_SalesForce_Whatsapp_05_upd

    end_tasks = [t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo, t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging, t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent, t_end_BiCvp_SalesForce_Whatsapp_02_join, t_end_BiCvp_SalesForce_Whatsapp_03_car, t_end_BiCvp_SalesForce_Whatsapp_04_ins, t_end_BiCvp_SalesForce_Whatsapp_05_upd]

    [t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo, t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging, t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent, t_end_BiCvp_SalesForce_Whatsapp_02_join, t_end_BiCvp_SalesForce_Whatsapp_03_car, t_end_BiCvp_SalesForce_Whatsapp_04_ins, t_end_BiCvp_SalesForce_Whatsapp_05_upd] >> t_publish_dataset

    [t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo, t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging, t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent, t_end_BiCvp_SalesForce_Whatsapp_02_join, t_end_BiCvp_SalesForce_Whatsapp_03_car, t_end_BiCvp_SalesForce_Whatsapp_04_ins, t_end_BiCvp_SalesForce_Whatsapp_05_upd] >> t_teams_error

    [t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo, t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging, t_end_BiCvp_SalesForce_Whatsapp_01_ext_Protocolo_Messaging_Agent, t_end_BiCvp_SalesForce_Whatsapp_02_join, t_end_BiCvp_SalesForce_Whatsapp_03_car, t_end_BiCvp_SalesForce_Whatsapp_04_ins, t_end_BiCvp_SalesForce_Whatsapp_05_upd] >> t_reg_falha
