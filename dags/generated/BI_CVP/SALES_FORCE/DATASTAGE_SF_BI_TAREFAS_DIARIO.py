...
# Pipeline: DATASTAGE_SF_BI_TAREFAS_DIARIO | Projeto: BI_CVP | Dominio: SALES_FORCE
# =========================
DAG_ID        = "DATASTAGE_SF_BI_TAREFAS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE"
PIPELINE_NAME = "DATASTAGE_SF_BI_TAREFAS_DIARIO"
...
HORARIOS_ESPECIFICOS = ['08:00', '11:00', '15:00']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/DATASTAGE_SF_BI_TAREFAS_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqBiCvp_SalesForce_Tarefas']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SF_BI_TAREFAS_DIARIO - BI_CVP / SALES_FORCE",
    start_date=pendulum.datetime(2026, 6, 19, tz=LOCAL_TZ),
    schedule="0 8,11,15 * * 1,2,3,4,5",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SALES_FORCE', 'DATASTAGE', 'BI', 'TAREFAS', 'DIARIO'],
) as dag:
    ...
    t_start_SeqBiCvp_SalesForce_Tarefas = PythonOperator(
        task_id="log_start_SeqBiCvp_SalesForce_Tarefas",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_SalesForce_Tarefas", "task_key": "SeqBiCvp_SalesForce_Tarefas"},
    )

    t_job_SeqBiCvp_SalesForce_Tarefas = DataStageOperator(
        task_id="SeqBiCvp_SalesForce_Tarefas",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_SalesForce_Tarefas",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_SalesForce_Tarefas = PythonOperator(
        task_id="log_end_SeqBiCvp_SalesForce_Tarefas",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_SalesForce_Tarefas", "task_key": "SeqBiCvp_SalesForce_Tarefas", "upstream_task_id": "SeqBiCvp_SalesForce_Tarefas"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_SalesForce_Tarefas >> t_job_SeqBiCvp_SalesForce_Tarefas >> t_end_SeqBiCvp_SalesForce_Tarefas

    end_tasks = [t_end_SeqBiCvp_SalesForce_Tarefas]

    [t_end_SeqBiCvp_SalesForce_Tarefas] >> t_publish_dataset

    [t_end_SeqBiCvp_SalesForce_Tarefas] >> t_teams_error
