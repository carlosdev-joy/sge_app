...
# Pipeline: DATASTAGE_SF_RELAT_ACOES_NEGOC_DIARIO | Projeto: BI_CVP | Dominio: SALES_FORCE
# =========================
DAG_ID        = "DATASTAGE_SF_RELAT_ACOES_NEGOC_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SALES_FORCE"
PIPELINE_NAME = "DATASTAGE_SF_RELAT_ACOES_NEGOC_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SF_RELAT_ACOES_NEGOC_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SEQ_SF_RELATORIO_ACOES_NEGOCIAIS']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SF_RELAT_ACOES_NEGOC_DIARIO - BI_CVP / SALES_FORCE",
    ...
    t_start_SEQ_SF_RELATORIO_ACOES_NEGOCIAIS = PythonOperator(
        task_id="log_start_SEQ_SF_RELATORIO_ACOES_NEGOCIAIS",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_SF_RELATORIO_ACOES_NEGOCIAIS", "task_key": "SEQ_SF_RELATORIO_ACOES_NEGOCIAIS"},
    )

    t_job_SEQ_SF_RELATORIO_ACOES_NEGOCIAIS = DataStageOperator(
        task_id="SEQ_SF_RELATORIO_ACOES_NEGOCIAIS",
        project=PROJECT_NAME,
        job_name="SEQ_SF_RELATORIO_ACOES_NEGOCIAIS",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_SF_RELATORIO_ACOES_NEGOCIAIS = PythonOperator(
        task_id="log_end_SEQ_SF_RELATORIO_ACOES_NEGOCIAIS",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_SF_RELATORIO_ACOES_NEGOCIAIS", "task_key": "SEQ_SF_RELATORIO_ACOES_NEGOCIAIS", "upstream_task_id": "SEQ_SF_RELATORIO_ACOES_NEGOCIAIS"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_SF_RELATORIO_ACOES_NEGOCIAIS >> t_job_SEQ_SF_RELATORIO_ACOES_NEGOCIAIS >> t_end_SEQ_SF_RELATORIO_ACOES_NEGOCIAIS

    end_tasks = [t_end_SEQ_SF_RELATORIO_ACOES_NEGOCIAIS]

    [t_end_SEQ_SF_RELATORIO_ACOES_NEGOCIAIS] >> t_publish_dataset

    [t_end_SEQ_SF_RELATORIO_ACOES_NEGOCIAIS] >> t_teams_error
