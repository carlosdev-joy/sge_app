...
# Pipeline: DATASTAGE_COMISSAO_CVP_DIARIO | Projeto: BI_CVP | Dominio: COMISSAO
# =========================
DAG_ID        = "DATASTAGE_COMISSAO_CVP_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "COMISSAO"
PIPELINE_NAME = "DATASTAGE_COMISSAO_CVP_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_COMISSAO_CVP_DIARIO - BI_CVP / COMISSAO",
    ...
    t_start_SeqBiCvp_ComissaoCVP = PythonOperator(
        task_id="log_start_SeqBiCvp_ComissaoCVP",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_ComissaoCVP", "task_key": "SeqBiCvp_ComissaoCVP"},
    )

    t_job_SeqBiCvp_ComissaoCVP = DataStageOperator(
        task_id="SeqBiCvp_ComissaoCVP",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_ComissaoCVP",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_ComissaoCVP = PythonOperator(
        task_id="log_end_SeqBiCvp_ComissaoCVP",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_ComissaoCVP", "task_key": "SeqBiCvp_ComissaoCVP", "upstream_task_id": "SeqBiCvp_ComissaoCVP"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_ComissaoCVP >> t_job_SeqBiCvp_ComissaoCVP >> t_end_SeqBiCvp_ComissaoCVP

    end_tasks = [t_end_SeqBiCvp_ComissaoCVP]

    [t_end_SeqBiCvp_ComissaoCVP] >> t_publish_dataset

    [t_end_SeqBiCvp_ComissaoCVP] >> t_teams_error
