...
# Pipeline: DATASTAGE_COMISSOES_APOLICES_DIARIO | Projeto: BI_CVP | Dominio: COMISSAO
# =========================
DAG_ID        = "DATASTAGE_COMISSOES_APOLICES_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "COMISSAO"
PIPELINE_NAME = "DATASTAGE_COMISSOES_APOLICES_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_COMISSOES_APOLICES_DIARIO - BI_CVP / COMISSAO",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule="0 7 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'COMISSAO', 'DATASTAGE', 'APOLICE', 'DIARIO'],
) as dag:
    ...
    t_start_SEQ_COMISSOES_APOLICES = PythonOperator(
        task_id="log_start_SEQ_COMISSOES_APOLICES",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_COMISSOES_APOLICES", "task_key": "SEQ_COMISSOES_APOLICES"},
    )

    t_job_SEQ_COMISSOES_APOLICES = DataStageOperator(
        task_id="SEQ_COMISSOES_APOLICES",
        project=PROJECT_NAME,
        job_name="SEQ_COMISSOES_APOLICES",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_COMISSOES_APOLICES = PythonOperator(
        task_id="log_end_SEQ_COMISSOES_APOLICES",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_COMISSOES_APOLICES", "task_key": "SEQ_COMISSOES_APOLICES", "upstream_task_id": "SEQ_COMISSOES_APOLICES"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_COMISSOES_APOLICES >> t_job_SEQ_COMISSOES_APOLICES >> t_end_SEQ_COMISSOES_APOLICES

    end_tasks = [t_end_SEQ_COMISSOES_APOLICES]

    [t_end_SEQ_COMISSOES_APOLICES] >> t_publish_dataset

    [t_end_SEQ_COMISSOES_APOLICES] >> t_teams_error
