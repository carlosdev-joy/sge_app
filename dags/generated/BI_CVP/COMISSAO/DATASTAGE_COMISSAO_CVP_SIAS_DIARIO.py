...
# Pipeline: DATASTAGE_COMISSAO_CVP_SIAS_DIARIO | Projeto: BI_CVP | Dominio: COMISSAO
# =========================
DAG_ID        = "DATASTAGE_COMISSAO_CVP_SIAS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "COMISSAO"
PIPELINE_NAME = "DATASTAGE_COMISSAO_CVP_SIAS_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_COMISSAO_CVP_SIAS_DIARIO - BI_CVP / COMISSAO",
    start_date=pendulum.datetime(2026, 6, 20, tz=LOCAL_TZ),
    schedule="10 6 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'COMISSAO', 'DATASTAGE', 'DIARIO'],
) as dag:
    ...
    t_start_SeqBiCvp_ComissaoCVP_SIAS = PythonOperator(
        task_id="log_start_SeqBiCvp_ComissaoCVP_SIAS",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_ComissaoCVP_SIAS", "task_key": "SeqBiCvp_ComissaoCVP_SIAS"},
    )

    t_job_SeqBiCvp_ComissaoCVP_SIAS = DataStageOperator(
        task_id="SeqBiCvp_ComissaoCVP_SIAS",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_ComissaoCVP_SIAS",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_ComissaoCVP_SIAS = PythonOperator(
        task_id="log_end_SeqBiCvp_ComissaoCVP_SIAS",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_ComissaoCVP_SIAS", "task_key": "SeqBiCvp_ComissaoCVP_SIAS", "upstream_task_id": "SeqBiCvp_ComissaoCVP_SIAS"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_ComissaoCVP_SIAS >> t_job_SeqBiCvp_ComissaoCVP_SIAS >> t_end_SeqBiCvp_ComissaoCVP_SIAS

    end_tasks = [t_end_SeqBiCvp_ComissaoCVP_SIAS]

    [t_end_SeqBiCvp_ComissaoCVP_SIAS] >> t_publish_dataset

    [t_end_SeqBiCvp_ComissaoCVP_SIAS] >> t_teams_error
