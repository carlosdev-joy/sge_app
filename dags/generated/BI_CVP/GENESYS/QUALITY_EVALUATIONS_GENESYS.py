...
# Pipeline: QUALITY_EVALUATIONS_GENESYS | Projeto: BI_CVP | Dominio: GENESYS
# =========================
DAG_ID        = "QUALITY_EVALUATIONS_GENESYS"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "GENESYS"
PIPELINE_NAME = "QUALITY_EVALUATIONS_GENESYS"
...
DATASET_URI   = "orq://pipeline/QUALITY_EVALUATIONS_GENESYS"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['BiCvp_QualityEvaluations_01_ext', 'BiCvp_QualityEvaluations_03_ins']
FLOW_JOBS     = ['BiCvp_QualityEvaluations_01_ext', 'BiCvp_QualityEvaluations_03_ins']
...
with DAG(
    ...
    description="Pipeline QUALITY_EVALUATIONS_GENESYS - BI_CVP / GENESYS",
    start_date=pendulum.datetime(2026, 6, 18, tz=LOCAL_TZ),
    schedule="0 4 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'GENESYS', 'QUALITY', 'EVALUATIONS', 'CVP'],
) as dag:
    ...
    t_start_BiCvp_QualityEvaluations_01_ext = _LogStart(
        task_id='log_start_BiCvp_QualityEvaluations_01_ext',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_QualityEvaluations_01_ext', "task_key": 'BiCvp_QualityEvaluations_01_ext'},
    )

    t_job_BiCvp_QualityEvaluations_01_ext = DataStageOperator(
        task_id='BiCvp_QualityEvaluations_01_ext',
        project=PROJECT_NAME,
        job_name='BiCvp_QualityEvaluations_01_ext',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_QualityEvaluations_01_ext = PythonOperator(
        task_id='log_end_BiCvp_QualityEvaluations_01_ext',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_QualityEvaluations_01_ext', "task_key": 'BiCvp_QualityEvaluations_01_ext', "upstream_task_id": 'BiCvp_QualityEvaluations_01_ext'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_QualityEvaluations_03_ins = _LogStart(
        task_id='log_start_BiCvp_QualityEvaluations_03_ins',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_QualityEvaluations_03_ins', "task_key": 'BiCvp_QualityEvaluations_03_ins'},
    )

    t_job_BiCvp_QualityEvaluations_03_ins = DataStageOperator(
        task_id='BiCvp_QualityEvaluations_03_ins',
        project=PROJECT_NAME,
        job_name='BiCvp_QualityEvaluations_03_ins',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_QualityEvaluations_03_ins = PythonOperator(
        task_id='log_end_BiCvp_QualityEvaluations_03_ins',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_QualityEvaluations_03_ins', "task_key": 'BiCvp_QualityEvaluations_03_ins', "upstream_task_id": 'BiCvp_QualityEvaluations_03_ins'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_BiCvp_QualityEvaluations_01_ext >> t_teams_start >> t_job_BiCvp_QualityEvaluations_01_ext >> t_end_BiCvp_QualityEvaluations_01_ext

    t_end_BiCvp_QualityEvaluations_01_ext >> t_start_BiCvp_QualityEvaluations_03_ins >> t_job_BiCvp_QualityEvaluations_03_ins >> t_end_BiCvp_QualityEvaluations_03_ins

    end_tasks = [t_end_BiCvp_QualityEvaluations_01_ext, t_end_BiCvp_QualityEvaluations_03_ins]

    [t_end_BiCvp_QualityEvaluations_01_ext, t_end_BiCvp_QualityEvaluations_03_ins] >> t_publish_dataset

    [t_end_BiCvp_QualityEvaluations_01_ext, t_end_BiCvp_QualityEvaluations_03_ins] >> t_teams_end

    [t_end_BiCvp_QualityEvaluations_01_ext, t_end_BiCvp_QualityEvaluations_03_ins] >> t_reg_falha
