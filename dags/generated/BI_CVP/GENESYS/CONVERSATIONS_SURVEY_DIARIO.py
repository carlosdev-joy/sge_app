...
# Pipeline: CONVERSATIONS_SURVEY_DIARIO | Projeto: BI_CVP | Dominio: GENESYS
# =========================
DAG_ID        = "CONVERSATIONS_SURVEY_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "GENESYS"
PIPELINE_NAME = "CONVERSATIONS_SURVEY_DIARIO"
...
HORARIOS_ESPECIFICOS = ['00:00', '01:00', '02:00', '03:00', '04:00', '05:00', '06:00', '07:00', '08:00', '09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/CONVERSATIONS_SURVEY_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['Sequence_BiCvp_ConversationsSurvey']
...
with DAG(
    ...
    description="Pipeline CONVERSATIONS_SURVEY_DIARIO - BI_CVP / GENESYS",
    ...
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'GENESYS', 'CONVERSATIONS', 'SURVEY', 'DIARO'],
) as dag:
    ...
    t_start_Sequence_BiCvp_ConversationsSurvey = PythonOperator(
        task_id="log_start_Sequence_BiCvp_ConversationsSurvey",
        python_callable=log_start,
        op_kwargs={"job_name": "Sequence_BiCvp_ConversationsSurvey", "task_key": "Sequence_BiCvp_ConversationsSurvey"},
    )

    t_job_Sequence_BiCvp_ConversationsSurvey = DataStageOperator(
        task_id="Sequence_BiCvp_ConversationsSurvey",
        project=PROJECT_NAME,
        job_name="Sequence_BiCvp_ConversationsSurvey",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_Sequence_BiCvp_ConversationsSurvey = PythonOperator(
        task_id="log_end_Sequence_BiCvp_ConversationsSurvey",
        python_callable=log_end,
        op_kwargs={"job_name": "Sequence_BiCvp_ConversationsSurvey", "task_key": "Sequence_BiCvp_ConversationsSurvey", "upstream_task_id": "Sequence_BiCvp_ConversationsSurvey"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_Sequence_BiCvp_ConversationsSurvey >> t_teams_start >> t_job_Sequence_BiCvp_ConversationsSurvey >> t_end_Sequence_BiCvp_ConversationsSurvey

    end_tasks = [t_end_Sequence_BiCvp_ConversationsSurvey]

    [t_end_Sequence_BiCvp_ConversationsSurvey] >> t_publish_dataset

    [t_end_Sequence_BiCvp_ConversationsSurvey] >> t_teams_end

    [t_end_Sequence_BiCvp_ConversationsSurvey] >> t_teams_error
