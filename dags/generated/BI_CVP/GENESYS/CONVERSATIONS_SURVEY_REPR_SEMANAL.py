...
# Pipeline: CONVERSATIONS_SURVEY_REPR_SEMANAL | Projeto: BI_CVP | Dominio: GENESYS
# =========================
DAG_ID        = "CONVERSATIONS_SURVEY_REPR_SEMANAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "GENESYS"
PIPELINE_NAME = "CONVERSATIONS_SURVEY_REPR_SEMANAL"
...
HORARIOS_ESPECIFICOS = ['11:00']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/CONVERSATIONS_SURVEY_REPR_SEMANAL"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal', 'BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal', 'BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal']
...
with DAG(
    ...
    description="Pipeline CONVERSATIONS_SURVEY_REPR_SEMANAL - BI_CVP / GENESYS",
    start_date=pendulum.datetime(2026, 6, 18, tz=LOCAL_TZ),
    schedule="0 11 * * 0",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'GENESYS', 'CONVERSATIONS', 'SURVEY', 'SEMANAL'],
) as dag:
    ...
    t_start_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal = PythonOperator(
        task_id='log_start_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal', "task_key": 'BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal'},
    )

    t_job_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal = DataStageOperator(
        task_id='BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal',
        project=PROJECT_NAME,
        job_name='BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal = PythonOperator(
        task_id='log_end_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal', "task_key": 'BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal', "upstream_task_id": 'BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal = PythonOperator(
        task_id='log_start_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal', "task_key": 'BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal'},
    )

    t_job_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal = DataStageOperator(
        task_id='BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal',
        project=PROJECT_NAME,
        job_name='BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal = PythonOperator(
        task_id='log_end_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal', "task_key": 'BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal', "upstream_task_id": 'BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal = PythonOperator(
        task_id='log_start_BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal', "task_key": 'BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal'},
    )

    t_job_BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal = DataStageOperator(
        task_id='BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal',
        project=PROJECT_NAME,
        job_name='BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal = PythonOperator(
        task_id='log_end_BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal', "task_key": 'BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal', "upstream_task_id": 'BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal >> t_teams_start >> t_job_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal >> t_end_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal

    t_end_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal >> t_start_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal >> t_job_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal >> t_end_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal

    t_end_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal >> t_start_BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal >> t_job_BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal >> t_end_BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal

    end_tasks = [t_end_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal, t_end_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal, t_end_BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal]

    [t_end_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal, t_end_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal, t_end_BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal] >> t_publish_dataset

    [t_end_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal, t_end_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal, t_end_BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal] >> t_teams_end

    [t_end_BiCvp_ConversationsSurvey_01_ReprocessamentoSemanal, t_end_BiCvp_ConversationsSurvey_03_ins_ReprocessamentoSemanal, t_end_BiCvp_ConversationsSurvey_04_atu_ReprocessamentoSemanal] >> t_teams_error
