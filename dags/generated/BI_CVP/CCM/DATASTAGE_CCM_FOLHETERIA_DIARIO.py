...
# Pipeline: DATASTAGE_CCM_FOLHETERIA_DIARIO | Projeto: BI_CVP | Dominio: CCM
# =========================
DAG_ID        = "DATASTAGE_CCM_FOLHETERIA_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "CCM"
PIPELINE_NAME = "DATASTAGE_CCM_FOLHETERIA_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_CCM_FOLHETERIA_DIARIO - BI_CVP / CCM",
    start_date=pendulum.datetime(2026, 6, 20, tz=LOCAL_TZ),
    schedule="0 5 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'CCM', 'DATASTAGE', 'FOLHETERIA'],
) as dag:
    ...
    t_start_SeqBICVPCCMFolheteria_Auto = PythonOperator(
        task_id="log_start_SeqBICVPCCMFolheteria_Auto",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBICVPCCMFolheteria_Auto", "task_key": "SeqBICVPCCMFolheteria_Auto"},
    )

    t_job_SeqBICVPCCMFolheteria_Auto = DataStageOperator(
        task_id="SeqBICVPCCMFolheteria_Auto",
        project=PROJECT_NAME,
        job_name="SeqBICVPCCMFolheteria_Auto",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBICVPCCMFolheteria_Auto = PythonOperator(
        task_id="log_end_SeqBICVPCCMFolheteria_Auto",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBICVPCCMFolheteria_Auto", "task_key": "SeqBICVPCCMFolheteria_Auto", "upstream_task_id": "SeqBICVPCCMFolheteria_Auto"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBICVPCCMFolheteria_Auto >> t_job_SeqBICVPCCMFolheteria_Auto >> t_end_SeqBICVPCCMFolheteria_Auto

    end_tasks = [t_end_SeqBICVPCCMFolheteria_Auto]

    [t_end_SeqBICVPCCMFolheteria_Auto] >> t_publish_dataset

    [t_end_SeqBICVPCCMFolheteria_Auto] >> t_teams_error
