...
# Pipeline: DATASTAGE_ENVIO_VIDA_CCMP_DIARIO | Projeto: BI_CVP | Dominio: CCM
# =========================
DAG_ID        = "DATASTAGE_ENVIO_VIDA_CCMP_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "CCM"
PIPELINE_NAME = "DATASTAGE_ENVIO_VIDA_CCMP_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_ENVIO_VIDA_CCMP_DIARIO - BI_CVP / CCM",
    start_date=pendulum.datetime(2026, 6, 20, tz=LOCAL_TZ),
    schedule="0 10 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'CCM', 'DATASTAGE', 'DIARIO'],
) as dag:
    ...
    t_start_SeqSsdPrs_EnvioVidaCCMP_auto = PythonOperator(
        task_id="log_start_SeqSsdPrs_EnvioVidaCCMP_auto",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqSsdPrs_EnvioVidaCCMP_auto", "task_key": "SeqSsdPrs_EnvioVidaCCMP_auto"},
    )

    t_job_SeqSsdPrs_EnvioVidaCCMP_auto = DataStageOperator(
        task_id="SeqSsdPrs_EnvioVidaCCMP_auto",
        project=PROJECT_NAME,
        job_name="SeqSsdPrs_EnvioVidaCCMP_auto",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqSsdPrs_EnvioVidaCCMP_auto = PythonOperator(
        task_id="log_end_SeqSsdPrs_EnvioVidaCCMP_auto",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqSsdPrs_EnvioVidaCCMP_auto", "task_key": "SeqSsdPrs_EnvioVidaCCMP_auto", "upstream_task_id": "SeqSsdPrs_EnvioVidaCCMP_auto"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqSsdPrs_EnvioVidaCCMP_auto >> t_job_SeqSsdPrs_EnvioVidaCCMP_auto >> t_end_SeqSsdPrs_EnvioVidaCCMP_auto

    end_tasks = [t_end_SeqSsdPrs_EnvioVidaCCMP_auto]

    [t_end_SeqSsdPrs_EnvioVidaCCMP_auto] >> t_publish_dataset

    [t_end_SeqSsdPrs_EnvioVidaCCMP_auto] >> t_teams_error
