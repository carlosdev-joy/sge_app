...
# Pipeline: DATASTAGE_CCM_FOLHETERIA_SEMANAL | Projeto: BI_CVP | Dominio: CCM
# =========================
DAG_ID        = "DATASTAGE_CCM_FOLHETERIA_SEMANAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "CCM"
PIPELINE_NAME = "DATASTAGE_CCM_FOLHETERIA_SEMANAL"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_CCM_FOLHETERIA_SEMANAL - BI_CVP / CCM",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 14 * * 0",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'CCM', 'DATASTAGE', 'FOLHETERIA', 'SEMANAL'],
) as dag:
    ...
    t_start_BI_CVP_CCM_Folheteria_Semanal = PythonOperator(
        task_id="log_start_BI_CVP_CCM_Folheteria_Semanal",
        python_callable=log_start,
        op_kwargs={"job_name": "BI_CVP_CCM_Folheteria_Semanal", "task_key": "BI_CVP_CCM_Folheteria_Semanal"},
    )

    t_job_BI_CVP_CCM_Folheteria_Semanal = DataStageOperator(
        task_id="BI_CVP_CCM_Folheteria_Semanal",
        project=PROJECT_NAME,
        job_name="BI_CVP_CCM_Folheteria_Semanal",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BI_CVP_CCM_Folheteria_Semanal = PythonOperator(
        task_id="log_end_BI_CVP_CCM_Folheteria_Semanal",
        python_callable=log_end,
        op_kwargs={"job_name": "BI_CVP_CCM_Folheteria_Semanal", "task_key": "BI_CVP_CCM_Folheteria_Semanal", "upstream_task_id": "BI_CVP_CCM_Folheteria_Semanal"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_BI_CVP_CCM_Folheteria_Semanal >> t_job_BI_CVP_CCM_Folheteria_Semanal >> t_end_BI_CVP_CCM_Folheteria_Semanal

    end_tasks = [t_end_BI_CVP_CCM_Folheteria_Semanal]

    [t_end_BI_CVP_CCM_Folheteria_Semanal] >> t_publish_dataset

    [t_end_BI_CVP_CCM_Folheteria_Semanal] >> t_teams_error
