...
# Pipeline: DATASTAGE_FLEXIBILIZACAO_COBRANCA | Projeto: BI_CVP | Dominio: PORTAL_ECONOMIARIO
# =========================
DAG_ID        = "DATASTAGE_FLEXIBILIZACAO_COBRANCA"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "PORTAL_ECONOMIARIO"
PIPELINE_NAME = "DATASTAGE_FLEXIBILIZACAO_COBRANCA"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_FLEXIBILIZACAO_COBRANCA"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['BiCvp_BaseCobranca_00_ext_Parcelas_Pagas', 'BiCvp_BaseCobranca_01_ins_Parcelas_Pagas', 'Notifica_Ext_Parcela', 'BiCvp_BaseCobranca_02_ext_Parcelas_Clientes', 'BiCvp_BaseCobranca_03_ins_Parcelas_Clientes']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_FLEXIBILIZACAO_COBRANCA - BI_CVP / PORTAL_ECONOMIARIO",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule="0 9 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'PORTAL_ECONOMIARIO', 'DIARIO'],
) as dag:
    ...
    t_start_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas = PythonOperator(
        task_id='log_start_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_BaseCobranca_00_ext_Parcelas_Pagas', "task_key": 'BiCvp_BaseCobranca_00_ext_Parcelas_Pagas'},
    )

    t_job_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas = DataStageOperator(
        task_id='BiCvp_BaseCobranca_00_ext_Parcelas_Pagas',
        project=PROJECT_NAME,
        job_name='BiCvp_BaseCobranca_00_ext_Parcelas_Pagas',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas = PythonOperator(
        task_id='log_end_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_BaseCobranca_00_ext_Parcelas_Pagas', "task_key": 'BiCvp_BaseCobranca_00_ext_Parcelas_Pagas', "upstream_task_id": 'BiCvp_BaseCobranca_00_ext_Parcelas_Pagas'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas = PythonOperator(
        task_id='log_start_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_BaseCobranca_01_ins_Parcelas_Pagas', "task_key": 'BiCvp_BaseCobranca_01_ins_Parcelas_Pagas'},
    )

    t_job_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas = DataStageOperator(
        task_id='BiCvp_BaseCobranca_01_ins_Parcelas_Pagas',
        project=PROJECT_NAME,
        job_name='BiCvp_BaseCobranca_01_ins_Parcelas_Pagas',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas = PythonOperator(
        task_id='log_end_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_BaseCobranca_01_ins_Parcelas_Pagas', "task_key": 'BiCvp_BaseCobranca_01_ins_Parcelas_Pagas', "upstream_task_id": 'BiCvp_BaseCobranca_01_ins_Parcelas_Pagas'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    def _notify_Notifica_Ext_Parcela(**context):
        _job = 'Notifica_Ext_Parcela'
        _grupo_id = 1
        _template_id = None
        _mensagem = '{job} executado com sucesso. total de {linhas} processadas.'
        _up_jobs = ['BiCvp_BaseCobranca_00_ext_Parcelas_Pagas']
        _exec_id = context.get("ts_nodash")
        _resolve_e_envia_notificacao(_job, _grupo_id, _template_id, _mensagem, _up_jobs, _exec_id, context)
    t_notif_Notifica_Ext_Parcela = PythonOperator(
        task_id='Notifica_Ext_Parcela',
        python_callable=_notify_Notifica_Ext_Parcela,
    )

    t_start_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes = PythonOperator(
        task_id='log_start_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_BaseCobranca_02_ext_Parcelas_Clientes', "task_key": 'BiCvp_BaseCobranca_02_ext_Parcelas_Clientes'},
    )

    t_job_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes = DataStageOperator(
        task_id='BiCvp_BaseCobranca_02_ext_Parcelas_Clientes',
        project=PROJECT_NAME,
        job_name='BiCvp_BaseCobranca_02_ext_Parcelas_Clientes',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes = PythonOperator(
        task_id='log_end_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_BaseCobranca_02_ext_Parcelas_Clientes', "task_key": 'BiCvp_BaseCobranca_02_ext_Parcelas_Clientes', "upstream_task_id": 'BiCvp_BaseCobranca_02_ext_Parcelas_Clientes'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_BiCvp_BaseCobranca_03_ins_Parcelas_Clientes = PythonOperator(
        task_id='log_start_BiCvp_BaseCobranca_03_ins_Parcelas_Clientes',
        python_callable=log_start,
        op_kwargs={"job_name": 'BiCvp_BaseCobranca_03_ins_Parcelas_Clientes', "task_key": 'BiCvp_BaseCobranca_03_ins_Parcelas_Clientes'},
    )

    t_job_BiCvp_BaseCobranca_03_ins_Parcelas_Clientes = DataStageOperator(
        task_id='BiCvp_BaseCobranca_03_ins_Parcelas_Clientes',
        project=PROJECT_NAME,
        job_name='BiCvp_BaseCobranca_03_ins_Parcelas_Clientes',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BiCvp_BaseCobranca_03_ins_Parcelas_Clientes = PythonOperator(
        task_id='log_end_BiCvp_BaseCobranca_03_ins_Parcelas_Clientes',
        python_callable=log_end,
        op_kwargs={"job_name": 'BiCvp_BaseCobranca_03_ins_Parcelas_Clientes', "task_key": 'BiCvp_BaseCobranca_03_ins_Parcelas_Clientes', "upstream_task_id": 'BiCvp_BaseCobranca_03_ins_Parcelas_Clientes'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas >> t_teams_start >> t_job_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas >> t_end_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas

    t_notif_Notifica_Ext_Parcela >> t_start_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas >> t_job_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas >> t_end_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas

    t_end_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas >> t_notif_Notifica_Ext_Parcela

    t_end_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas >> t_start_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes >> t_job_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes >> t_end_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes

    t_end_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes >> t_start_BiCvp_BaseCobranca_03_ins_Parcelas_Clientes >> t_job_BiCvp_BaseCobranca_03_ins_Parcelas_Clientes >> t_end_BiCvp_BaseCobranca_03_ins_Parcelas_Clientes

    end_tasks = [t_end_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas, t_end_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas, t_end_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes, t_end_BiCvp_BaseCobranca_03_ins_Parcelas_Clientes]

    [t_end_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas, t_end_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas, t_end_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes, t_end_BiCvp_BaseCobranca_03_ins_Parcelas_Clientes] >> t_publish_dataset

    [t_end_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas, t_end_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas, t_end_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes, t_end_BiCvp_BaseCobranca_03_ins_Parcelas_Clientes] >> t_teams_end

    [t_end_BiCvp_BaseCobranca_00_ext_Parcelas_Pagas, t_end_BiCvp_BaseCobranca_01_ins_Parcelas_Pagas, t_end_BiCvp_BaseCobranca_02_ext_Parcelas_Clientes, t_end_BiCvp_BaseCobranca_03_ins_Parcelas_Clientes] >> t_teams_error

    t_notif_Notifica_Ext_Parcela >> t_publish_dataset

    t_notif_Notifica_Ext_Parcela >> t_teams_end

    t_notif_Notifica_Ext_Parcela >> t_teams_error
