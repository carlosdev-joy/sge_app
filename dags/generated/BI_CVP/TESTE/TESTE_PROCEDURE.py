...
from utils.job_operators import StoredProcOperator
...
# Pipeline: TESTE_PROCEDURE | Projeto: BI_CVP | Dominio: TESTE
# =========================
DAG_ID        = "TESTE_PROCEDURE"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "TESTE"
PIPELINE_NAME = "TESTE_PROCEDURE"
...
DATASET_URI   = "orq://pipeline/TESTE_PROCEDURE"
...
with DAG(
    ...
    description="Pipeline TESTE_PROCEDURE - BI_CVP / TESTE",
    ...
    t_start_Job_PRocedure = PythonOperator(
        task_id='log_start_Job_PRocedure',
        python_callable=log_start,
        op_kwargs={"job_name": 'Job_PRocedure', "task_key": 'Job_PRocedure'},
    )

    t_job_Job_PRocedure = StoredProcOperator(
        task_id='Job_PRocedure',
        proc='sp_teste_simples',
        mssql_conn_id='SQL14_DMDB41',
        params=[],
    )

    t_end_Job_PRocedure = PythonOperator(
        task_id='log_end_Job_PRocedure',
        python_callable=log_end,
        op_kwargs={"job_name": 'Job_PRocedure', "task_key": 'Job_PRocedure', "upstream_task_id": 'Job_PRocedure'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_Job_PRocedure >> t_teams_start >> t_job_Job_PRocedure >> t_end_Job_PRocedure

    end_tasks = [t_end_Job_PRocedure]

    [t_end_Job_PRocedure] >> t_publish_dataset

    [t_end_Job_PRocedure] >> t_teams_end

    [t_end_Job_PRocedure] >> t_teams_error
