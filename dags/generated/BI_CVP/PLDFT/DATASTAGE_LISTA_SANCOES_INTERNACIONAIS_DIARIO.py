...
# Pipeline: DATASTAGE_LISTA_SANCOES_INTERNACIONAIS_DIARIO | Projeto: BI_CVP | Dominio: PLDFT
# =========================
DAG_ID        = "DATASTAGE_LISTA_SANCOES_INTERNACIONAIS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "PLDFT"
PIPELINE_NAME = "DATASTAGE_LISTA_SANCOES_INTERNACIONAIS_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_LISTA_SANCOES_INTERNACIONAIS_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqCvpBi_SancoesInternacionais_ObtemArquivo']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_LISTA_SANCOES_INTERNACIONAIS_DIARIO - BI_CVP / PLDFT",
    start_date=pendulum.datetime(2026, 6, 14, tz=LOCAL_TZ),
    schedule="15 11 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'PLDFT', 'DATASTAGE', 'LISTA', 'SANCOES_INTERNACIONAIS', 'TERRORISTA', 'DIARIO'],
) as dag:
    ...
    t_start_SeqCvpBi_SancoesInternacionais_ObtemArquivo = PythonOperator(
        task_id="log_start_SeqCvpBi_SancoesInternacionais_ObtemArquivo",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqCvpBi_SancoesInternacionais_ObtemArquivo", "task_key": "SeqCvpBi_SancoesInternacionais_ObtemArquivo"},
    )

    t_job_SeqCvpBi_SancoesInternacionais_ObtemArquivo = DataStageOperator(
        task_id="SeqCvpBi_SancoesInternacionais_ObtemArquivo",
        project=PROJECT_NAME,
        job_name="SeqCvpBi_SancoesInternacionais_ObtemArquivo",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqCvpBi_SancoesInternacionais_ObtemArquivo = PythonOperator(
        task_id="log_end_SeqCvpBi_SancoesInternacionais_ObtemArquivo",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqCvpBi_SancoesInternacionais_ObtemArquivo", "task_key": "SeqCvpBi_SancoesInternacionais_ObtemArquivo", "upstream_task_id": "SeqCvpBi_SancoesInternacionais_ObtemArquivo"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqCvpBi_SancoesInternacionais_ObtemArquivo >> t_teams_start >> t_job_SeqCvpBi_SancoesInternacionais_ObtemArquivo >> t_end_SeqCvpBi_SancoesInternacionais_ObtemArquivo

    end_tasks = [t_end_SeqCvpBi_SancoesInternacionais_ObtemArquivo]

    [t_end_SeqCvpBi_SancoesInternacionais_ObtemArquivo] >> t_publish_dataset

    [t_end_SeqCvpBi_SancoesInternacionais_ObtemArquivo] >> t_teams_end

    [t_end_SeqCvpBi_SancoesInternacionais_ObtemArquivo] >> t_teams_error
