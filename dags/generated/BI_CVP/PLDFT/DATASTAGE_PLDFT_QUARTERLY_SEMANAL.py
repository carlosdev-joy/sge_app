...
# Pipeline: DATASTAGE_PLDFT_QUARTERLY_SEMANAL | Projeto: BI_CVP | Dominio: PLDFT
# =========================
DAG_ID        = "DATASTAGE_PLDFT_QUARTERLY_SEMANAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "PLDFT"
PIPELINE_NAME = "DATASTAGE_PLDFT_QUARTERLY_SEMANAL"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_PLDFT_QUARTERLY_SEMANAL"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_PLDFT_QUARTERLY_SEMANAL - BI_CVP / PLDFT",
    start_date=pendulum.datetime(2026, 6, 22, tz=LOCAL_TZ),
    schedule="0 1 * * 1",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'PLDFT', 'DATASTAGE', 'QUARTERLY', 'SEMANAL'],
) as dag:
    ...
    t_start_SEQ_QUARTERLY = PythonOperator(
        task_id="log_start_SEQ_QUARTERLY",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_QUARTERLY", "task_key": "SEQ_QUARTERLY"},
    )

    t_job_SEQ_QUARTERLY = DataStageOperator(
        task_id="SEQ_QUARTERLY",
        project=PROJECT_NAME,
        job_name="SEQ_QUARTERLY",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_QUARTERLY = PythonOperator(
        task_id="log_end_SEQ_QUARTERLY",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_QUARTERLY", "task_key": "SEQ_QUARTERLY", "upstream_task_id": "SEQ_QUARTERLY"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_QUARTERLY >> t_teams_start >> t_job_SEQ_QUARTERLY >> t_end_SEQ_QUARTERLY

    end_tasks = [t_end_SEQ_QUARTERLY]

    [t_end_SEQ_QUARTERLY] >> t_publish_dataset

    [t_end_SEQ_QUARTERLY] >> t_teams_end

    [t_end_SEQ_QUARTERLY] >> t_teams_error
