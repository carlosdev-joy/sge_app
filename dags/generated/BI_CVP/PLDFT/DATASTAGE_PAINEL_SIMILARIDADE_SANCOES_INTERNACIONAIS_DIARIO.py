...
# Pipeline: DATASTAGE_PAINEL_SIMILARIDADE_SANCOES_INTERNACIONAIS_DIARIO | Projeto: BI_CVP | Dominio: PLDFT
# =========================
DAG_ID        = "DATASTAGE_PAINEL_SIMILARIDADE_SANCOES_INTERNACIONAIS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "PLDFT"
PIPELINE_NAME = "DATASTAGE_PAINEL_SIMILARIDADE_SANCOES_INTERNACIONAIS_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_PAINEL_SIMILARIDADE_SANCOES_INTERNACIONAIS_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqCvpBi_Painel_GESPAC_Sancao_Internacional']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_PAINEL_SIMILARIDADE_SANCOES_INTERNACIONAIS_DIARIO - BI_CVP / PLDFT",
    start_date=pendulum.datetime(2026, 5, 15, tz=LOCAL_TZ),
    schedule="30 5 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'PLDFT', 'DATASTAGE', 'SANCOES_INTERNACIONAIS', 'LISTA', 'TERRORISTA', 'DIARIO'],
) as dag:
    ...
    t_start_SeqCvpBi_Painel_GESPAC_Sancao_Internacional = PythonOperator(
        task_id="log_start_SeqCvpBi_Painel_GESPAC_Sancao_Internacional",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqCvpBi_Painel_GESPAC_Sancao_Internacional", "task_key": "SeqCvpBi_Painel_GESPAC_Sancao_Internacional"},
    )

    t_job_SeqCvpBi_Painel_GESPAC_Sancao_Internacional = DataStageOperator(
        task_id="SeqCvpBi_Painel_GESPAC_Sancao_Internacional",
        project=PROJECT_NAME,
        job_name="SeqCvpBi_Painel_GESPAC_Sancao_Internacional",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqCvpBi_Painel_GESPAC_Sancao_Internacional = PythonOperator(
        task_id="log_end_SeqCvpBi_Painel_GESPAC_Sancao_Internacional",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqCvpBi_Painel_GESPAC_Sancao_Internacional", "task_key": "SeqCvpBi_Painel_GESPAC_Sancao_Internacional", "upstream_task_id": "SeqCvpBi_Painel_GESPAC_Sancao_Internacional"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqCvpBi_Painel_GESPAC_Sancao_Internacional >> t_teams_start >> t_job_SeqCvpBi_Painel_GESPAC_Sancao_Internacional >> t_end_SeqCvpBi_Painel_GESPAC_Sancao_Internacional

    end_tasks = [t_end_SeqCvpBi_Painel_GESPAC_Sancao_Internacional]

    [t_end_SeqCvpBi_Painel_GESPAC_Sancao_Internacional] >> t_publish_dataset

    [t_end_SeqCvpBi_Painel_GESPAC_Sancao_Internacional] >> t_teams_end

    [t_end_SeqCvpBi_Painel_GESPAC_Sancao_Internacional] >> t_teams_error
