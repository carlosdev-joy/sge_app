...
# Pipeline: EVENTS_CATEGORY_ACTION_NAME_D | Projeto: BI_CVP | Dominio: MATOMO
# =========================
DAG_ID        = "EVENTS_CATEGORY_ACTION_NAME_D"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "MATOMO"
PIPELINE_NAME = "EVENTS_CATEGORY_ACTION_NAME_D"
...
HORARIOS_ESPECIFICOS = ['05:00', '06:00']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/EVENTS_CATEGORY_ACTION_NAME_D"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['Sequence_BiCvp_Events_CategoryActionName_D']
...
with DAG(
    ...
    description="Pipeline EVENTS_CATEGORY_ACTION_NAME_D - BI_CVP / MATOMO",
    start_date=pendulum.datetime(2026, 6, 18, tz=LOCAL_TZ),
    schedule="0 5,6 * * 0,1,2,3,4,5,6",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'MATOMO', 'EVENTS', 'CATEGORY', 'NAME_D'],
) as dag:
    ...
    t_start_Sequence_BiCvp_Events_CategoryActionName_D = PythonOperator(
        task_id="log_start_Sequence_BiCvp_Events_CategoryActionName_D",
        python_callable=log_start,
        op_kwargs={"job_name": "Sequence_BiCvp_Events_CategoryActionName_D", "task_key": "Sequence_BiCvp_Events_CategoryActionName_D"},
    )

    t_job_Sequence_BiCvp_Events_CategoryActionName_D = DataStageOperator(
        task_id="Sequence_BiCvp_Events_CategoryActionName_D",
        project=PROJECT_NAME,
        job_name="Sequence_BiCvp_Events_CategoryActionName_D",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
        verbose_log=True,
    )

    t_end_Sequence_BiCvp_Events_CategoryActionName_D = PythonOperator(
        task_id="log_end_Sequence_BiCvp_Events_CategoryActionName_D",
        python_callable=log_end,
        op_kwargs={"job_name": "Sequence_BiCvp_Events_CategoryActionName_D", "task_key": "Sequence_BiCvp_Events_CategoryActionName_D", "upstream_task_id": "Sequence_BiCvp_Events_CategoryActionName_D"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_Sequence_BiCvp_Events_CategoryActionName_D >> t_teams_start >> t_job_Sequence_BiCvp_Events_CategoryActionName_D >> t_end_Sequence_BiCvp_Events_CategoryActionName_D

    end_tasks = [t_end_Sequence_BiCvp_Events_CategoryActionName_D]

    [t_end_Sequence_BiCvp_Events_CategoryActionName_D] >> t_publish_dataset

    [t_end_Sequence_BiCvp_Events_CategoryActionName_D] >> t_teams_end

    [t_end_Sequence_BiCvp_Events_CategoryActionName_D] >> t_teams_error
