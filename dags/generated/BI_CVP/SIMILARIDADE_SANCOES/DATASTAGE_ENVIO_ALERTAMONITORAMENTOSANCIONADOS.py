...
# Pipeline: DATASTAGE_ENVIO_ALERTAMONITORAMENTOSANCIONADOS | Projeto: BI_CVP | Dominio: SIMILARIDADE_SANCOES
# =========================
DAG_ID        = "DATASTAGE_ENVIO_ALERTAMONITORAMENTOSANCIONADOS"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SIMILARIDADE_SANCOES"
PIPELINE_NAME = "DATASTAGE_ENVIO_ALERTAMONITORAMENTOSANCIONADOS"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_ENVIO_ALERTAMONITORAMENTOSANCIONADOS"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqCvpBi_Envio_AlertaMonitoramentoSancionados']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_ENVIO_ALERTAMONITORAMENTOSANCIONADOS - BI_CVP / SIMILARIDADE_SANCOES",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="0 9 1 * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SIMILARIDADE_SANCOES', 'ALERTA', 'SIMILARIDADE', 'SANCOES'],
) as dag:
    ...
    t_start_SeqCvpBi_Envio_AlertaMonitoramentoSancionados = PythonOperator(
        task_id='log_start_SeqCvpBi_Envio_AlertaMonitoramentoSancionados',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqCvpBi_Envio_AlertaMonitoramentoSancionados', "task_key": 'SeqCvpBi_Envio_AlertaMonitoramentoSancionados'},
    )

    t_job_SeqCvpBi_Envio_AlertaMonitoramentoSancionados = DataStageOperator(
        task_id='SeqCvpBi_Envio_AlertaMonitoramentoSancionados',
        project=PROJECT_NAME,
        job_name='SeqCvpBi_Envio_AlertaMonitoramentoSancionados',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqCvpBi_Envio_AlertaMonitoramentoSancionados = PythonOperator(
        task_id='log_end_SeqCvpBi_Envio_AlertaMonitoramentoSancionados',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqCvpBi_Envio_AlertaMonitoramentoSancionados', "task_key": 'SeqCvpBi_Envio_AlertaMonitoramentoSancionados', "upstream_task_id": 'SeqCvpBi_Envio_AlertaMonitoramentoSancionados'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqCvpBi_Envio_AlertaMonitoramentoSancionados >> t_job_SeqCvpBi_Envio_AlertaMonitoramentoSancionados >> t_end_SeqCvpBi_Envio_AlertaMonitoramentoSancionados

    end_tasks = [t_end_SeqCvpBi_Envio_AlertaMonitoramentoSancionados]

    [t_end_SeqCvpBi_Envio_AlertaMonitoramentoSancionados] >> t_publish_dataset

    [t_end_SeqCvpBi_Envio_AlertaMonitoramentoSancionados] >> t_teams_error
