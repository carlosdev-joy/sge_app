...
# Pipeline: DATASTAGE_SIMILARIDADE_SANCOES_INTERNACIONAIS_X_MOTORHOMERO | Projeto: BI_CVP | Dominio: SIMILARIDADE_SANCOES
# =========================
DAG_ID        = "DATASTAGE_SIMILARIDADE_SANCOES_INTERNACIONAIS_X_MOTORHOMERO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SIMILARIDADE_SANCOES"
PIPELINE_NAME = "DATASTAGE_SIMILARIDADE_SANCOES_INTERNACIONAIS_X_MOTORHOMERO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SIMILARIDADE_SANCOES_INTERNACIONAIS_X_MOTORHOMERO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SIMILARIDADE_SANCOES_INTERNACIONAIS_X_MOTORHOMERO - BI_CVP / SIMILARIDADE_SANCOES",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="30 19 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'SIMILARIDADE_SANCOES', 'SIMILARIDADE', 'SANCOES'],
) as dag:
    ...
    t_start_SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero = PythonOperator(
        task_id='log_start_SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero', "task_key": 'SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero'},
    )

    t_job_SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero = DataStageOperator(
        task_id='SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero',
        project=PROJECT_NAME,
        job_name='SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero = PythonOperator(
        task_id='log_end_SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero', "task_key": 'SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero', "upstream_task_id": 'SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero >> t_job_SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero >> t_end_SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero

    end_tasks = [t_end_SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero]

    [t_end_SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero] >> t_publish_dataset

    [t_end_SeqCvpBi_CvpBi_Similaridade_Sancoes_Internacionais_x_MotorHomero] >> t_teams_error
