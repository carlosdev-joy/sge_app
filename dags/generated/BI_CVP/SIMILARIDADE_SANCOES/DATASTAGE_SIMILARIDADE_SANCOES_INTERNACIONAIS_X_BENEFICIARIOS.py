...
# Pipeline: DATASTAGE_SIMILARIDADE_SANCOES_INTERNACIONAIS_X_BENEFICIARIOS | Projeto: BI_CVP | Dominio: SIMILARIDADE_SANCOES
# =========================
DAG_ID        = "DATASTAGE_SIMILARIDADE_SANCOES_INTERNACIONAIS_X_BENEFICIARIOS"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "SIMILARIDADE_SANCOES"
PIPELINE_NAME = "DATASTAGE_SIMILARIDADE_SANCOES_INTERNACIONAIS_X_BENEFICIARIOS"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SIMILARIDADE_SANCOES_INTERNACIONAIS_X_BENEFICIARIOS"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SIMILARIDADE_SANCOES_INTERNACIONAIS_X_BENEFICIARIOS - BI_CVP / SIMILARIDADE_SANCOES",
    ...
    t_start_SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios = PythonOperator(
        task_id='log_start_SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios', "task_key": 'SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios'},
    )

    t_job_SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios = DataStageOperator(
        task_id='SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios',
        project=PROJECT_NAME,
        job_name='SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios = PythonOperator(
        task_id='log_end_SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios', "task_key": 'SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios', "upstream_task_id": 'SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios >> t_job_SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios >> t_end_SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios

    end_tasks = [t_end_SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios]

    [t_end_SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios] >> t_publish_dataset

    [t_end_SeqCvpBi_Similaridade_Sancoes_Internacionais_x_Beneficiarios] >> t_teams_error
