...
# Pipeline: DATASTAGE_SEQ_CVP_BI_FATURAMENTO_CONTABIL_QUERY_GIRON | Projeto: BI_CVP | Dominio: FATURAMENTO
# =========================
DAG_ID        = "DATASTAGE_SEQ_CVP_BI_FATURAMENTO_CONTABIL_QUERY_GIRON"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "FATURAMENTO"
PIPELINE_NAME = "DATASTAGE_SEQ_CVP_BI_FATURAMENTO_CONTABIL_QUERY_GIRON"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_SEQ_CVP_BI_FATURAMENTO_CONTABIL_QUERY_GIRON"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqCvpBi_FaturamentoContabil_QueryGiron']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SEQ_CVP_BI_FATURAMENTO_CONTABIL_QUERY_GIRON - BI_CVP / FATURAMENTO",
    start_date=pendulum.datetime(2026, 6, 21, tz=LOCAL_TZ),
    schedule="45 8 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'FATURAMENTO', 'CONTABIL'],
) as dag:
    ...
    t_start_SeqCvpBi_FaturamentoContabil_QueryGiron = PythonOperator(
        task_id='log_start_SeqCvpBi_FaturamentoContabil_QueryGiron',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqCvpBi_FaturamentoContabil_QueryGiron', "task_key": 'SeqCvpBi_FaturamentoContabil_QueryGiron'},
    )

    t_job_SeqCvpBi_FaturamentoContabil_QueryGiron = DataStageOperator(
        task_id='SeqCvpBi_FaturamentoContabil_QueryGiron',
        project=PROJECT_NAME,
        job_name='SeqCvpBi_FaturamentoContabil_QueryGiron',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqCvpBi_FaturamentoContabil_QueryGiron = PythonOperator(
        task_id='log_end_SeqCvpBi_FaturamentoContabil_QueryGiron',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqCvpBi_FaturamentoContabil_QueryGiron', "task_key": 'SeqCvpBi_FaturamentoContabil_QueryGiron', "upstream_task_id": 'SeqCvpBi_FaturamentoContabil_QueryGiron'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqCvpBi_FaturamentoContabil_QueryGiron >> t_job_SeqCvpBi_FaturamentoContabil_QueryGiron >> t_end_SeqCvpBi_FaturamentoContabil_QueryGiron

    end_tasks = [t_end_SeqCvpBi_FaturamentoContabil_QueryGiron]

    [t_end_SeqCvpBi_FaturamentoContabil_QueryGiron] >> t_publish_dataset

    [t_end_SeqCvpBi_FaturamentoContabil_QueryGiron] >> t_teams_error
