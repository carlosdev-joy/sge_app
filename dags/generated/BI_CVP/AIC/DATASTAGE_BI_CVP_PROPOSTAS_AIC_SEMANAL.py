...
# Pipeline: DATASTAGE_BI_CVP_PROPOSTAS_AIC_SEMANAL | Projeto: BI_CVP | Dominio: AIC
# =========================
DAG_ID        = "DATASTAGE_BI_CVP_PROPOSTAS_AIC_SEMANAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "AIC"
PIPELINE_NAME = "DATASTAGE_BI_CVP_PROPOSTAS_AIC_SEMANAL"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_BI_CVP_PROPOSTAS_AIC_SEMANAL"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['BI_CVP_PropostasAIC_Semanal']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_BI_CVP_PROPOSTAS_AIC_SEMANAL - BI_CVP / AIC",
    start_date=pendulum.datetime(2026, 6, 14, tz=LOCAL_TZ),
    schedule="0 12 * * 0",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'AIC', 'PROPOSTAS'],
) as dag:
    ...
    t_start_BI_CVP_PropostasAIC_Semanal = PythonOperator(
        task_id="log_start_BI_CVP_PropostasAIC_Semanal",
        python_callable=log_start,
        op_kwargs={"job_name": "BI_CVP_PropostasAIC_Semanal", "task_key": "BI_CVP_PropostasAIC_Semanal"},
    )

    t_job_BI_CVP_PropostasAIC_Semanal = DataStageOperator(
        task_id="BI_CVP_PropostasAIC_Semanal",
        project=PROJECT_NAME,
        job_name="BI_CVP_PropostasAIC_Semanal",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_BI_CVP_PropostasAIC_Semanal = PythonOperator(
        task_id="log_end_BI_CVP_PropostasAIC_Semanal",
        python_callable=log_end,
        op_kwargs={"job_name": "BI_CVP_PropostasAIC_Semanal", "task_key": "BI_CVP_PropostasAIC_Semanal", "upstream_task_id": "BI_CVP_PropostasAIC_Semanal"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_BI_CVP_PropostasAIC_Semanal >> t_job_BI_CVP_PropostasAIC_Semanal >> t_end_BI_CVP_PropostasAIC_Semanal

    end_tasks = [t_end_BI_CVP_PropostasAIC_Semanal]

    [t_end_BI_CVP_PropostasAIC_Semanal] >> t_publish_dataset

    [t_end_BI_CVP_PropostasAIC_Semanal] >> t_teams_error
