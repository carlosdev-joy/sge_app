...
# Pipeline: DATASTAGE_PROPOSTA_AIC_DIARIO | Projeto: BI_CVP | Dominio: AIC
# =========================
DAG_ID        = "DATASTAGE_PROPOSTA_AIC_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "AIC"
PIPELINE_NAME = "DATASTAGE_PROPOSTA_AIC_DIARIO"
...
HORARIOS_ESPECIFICOS = ['05:00', '07:00', '09:00', '10:00', '11:00', '12:00', '14:00', '16:00', '18:00', '19:00']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/DATASTAGE_PROPOSTA_AIC_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqBICVPExecPropostaAIC']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_PROPOSTA_AIC_DIARIO - BI_CVP / AIC",
    start_date=pendulum.datetime(2026, 6, 16, tz=LOCAL_TZ),
    schedule="0 5,7,9,10,11,12,14,16,18,19 * * 1,2,3,4,5",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'AIC', 'DATASTAGE', 'PROPOSTA', 'DIARIO'],
) as dag:
    ...
    t_start_SeqBICVPExecPropostaAIC = PythonOperator(
        task_id="log_start_SeqBICVPExecPropostaAIC",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBICVPExecPropostaAIC", "task_key": "SeqBICVPExecPropostaAIC"},
    )

    t_job_SeqBICVPExecPropostaAIC = DataStageOperator(
        task_id="SeqBICVPExecPropostaAIC",
        project=PROJECT_NAME,
        job_name="SeqBICVPExecPropostaAIC",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBICVPExecPropostaAIC = PythonOperator(
        task_id="log_end_SeqBICVPExecPropostaAIC",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBICVPExecPropostaAIC", "task_key": "SeqBICVPExecPropostaAIC", "upstream_task_id": "SeqBICVPExecPropostaAIC"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBICVPExecPropostaAIC >> t_teams_start >> t_job_SeqBICVPExecPropostaAIC >> t_end_SeqBICVPExecPropostaAIC

    end_tasks = [t_end_SeqBICVPExecPropostaAIC]

    [t_end_SeqBICVPExecPropostaAIC] >> t_publish_dataset

    [t_end_SeqBICVPExecPropostaAIC] >> t_teams_end

    [t_end_SeqBICVPExecPropostaAIC] >> t_teams_error
