...
# Pipeline: DATASTAGE_CLASS_RISCO_DIARIO | Projeto: BI_CVP | Dominio: RISCO
# =========================
DAG_ID        = "DATASTAGE_CLASS_RISCO_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "RISCO"
PIPELINE_NAME = "DATASTAGE_CLASS_RISCO_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_CLASS_RISCO_DIARIO - BI_CVP / RISCO",
    ...
    t_start_SeqBiCvp_ClassRisco = PythonOperator(
        task_id="log_start_SeqBiCvp_ClassRisco",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_ClassRisco", "task_key": "SeqBiCvp_ClassRisco"},
    )

    t_job_SeqBiCvp_ClassRisco = DataStageOperator(
        task_id="SeqBiCvp_ClassRisco",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_ClassRisco",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_ClassRisco = PythonOperator(
        task_id="log_end_SeqBiCvp_ClassRisco",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_ClassRisco", "task_key": "SeqBiCvp_ClassRisco", "upstream_task_id": "SeqBiCvp_ClassRisco"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_ClassRisco >> t_job_SeqBiCvp_ClassRisco >> t_end_SeqBiCvp_ClassRisco

    end_tasks = [t_end_SeqBiCvp_ClassRisco]

    [t_end_SeqBiCvp_ClassRisco] >> t_publish_dataset

    [t_end_SeqBiCvp_ClassRisco] >> t_teams_error
