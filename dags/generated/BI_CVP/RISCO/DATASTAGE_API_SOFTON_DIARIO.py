...
# Pipeline: DATASTAGE_API_SOFTON_DIARIO | Projeto: BI_CVP | Dominio: RISCO
# =========================
DAG_ID        = "DATASTAGE_API_SOFTON_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "RISCO"
PIPELINE_NAME = "DATASTAGE_API_SOFTON_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_API_SOFTON_DIARIO - BI_CVP / RISCO",
    start_date=pendulum.datetime(2026, 6, 15, tz=LOCAL_TZ),
    schedule="15 0 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'RISCO', 'DATASTAGE', 'MOTOR', 'DIARIO'],
) as dag:
    ...
    t_start_SeqCvpBi_Consultas_Softon_Dtflex = PythonOperator(
        task_id='log_start_SeqCvpBi_Consultas_Softon_Dtflex',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqCvpBi_Consultas_Softon_Dtflex', "task_key": 'SeqCvpBi_Consultas_Softon_Dtflex'},
    )

    t_job_SeqCvpBi_Consultas_Softon_Dtflex = DataStageOperator(
        task_id='SeqCvpBi_Consultas_Softon_Dtflex',
        project=PROJECT_NAME,
        job_name='SeqCvpBi_Consultas_Softon_Dtflex',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqCvpBi_Consultas_Softon_Dtflex = PythonOperator(
        task_id='log_end_SeqCvpBi_Consultas_Softon_Dtflex',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqCvpBi_Consultas_Softon_Dtflex', "task_key": 'SeqCvpBi_Consultas_Softon_Dtflex', "upstream_task_id": 'SeqCvpBi_Consultas_Softon_Dtflex'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqCvpBi_Consultas_Softon_Dtflex >> t_teams_start >> t_job_SeqCvpBi_Consultas_Softon_Dtflex >> t_end_SeqCvpBi_Consultas_Softon_Dtflex

    end_tasks = [t_end_SeqCvpBi_Consultas_Softon_Dtflex]

    [t_end_SeqCvpBi_Consultas_Softon_Dtflex] >> t_publish_dataset

    [t_end_SeqCvpBi_Consultas_Softon_Dtflex] >> t_teams_end

    [t_end_SeqCvpBi_Consultas_Softon_Dtflex] >> t_teams_error
