...
# Pipeline: DATASTAGE_BENEFICIARIOS_PEP_DIARIO | Projeto: BI_CVP | Dominio: RISCO
# =========================
DAG_ID        = "DATASTAGE_BENEFICIARIOS_PEP_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "RISCO"
PIPELINE_NAME = "DATASTAGE_BENEFICIARIOS_PEP_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_BENEFICIARIOS_PEP_DIARIO - BI_CVP / RISCO",
    start_date=pendulum.datetime(2026, 6, 22, tz=LOCAL_TZ),
    schedule="0 7 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'RISCO', 'DATASTAGE', 'PEP', 'BENEFICIARIOS'],
) as dag:
    ...
    t_start_SeqCvpBi_05_Beneficiarios = PythonOperator(
        task_id="log_start_SeqCvpBi_05_Beneficiarios",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqCvpBi_05_Beneficiarios", "task_key": "SeqCvpBi_05_Beneficiarios"},
    )

    t_job_SeqCvpBi_05_Beneficiarios = DataStageOperator(
        task_id="SeqCvpBi_05_Beneficiarios",
        project=PROJECT_NAME,
        job_name="SeqCvpBi_05_Beneficiarios",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqCvpBi_05_Beneficiarios = PythonOperator(
        task_id="log_end_SeqCvpBi_05_Beneficiarios",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqCvpBi_05_Beneficiarios", "task_key": "SeqCvpBi_05_Beneficiarios", "upstream_task_id": "SeqCvpBi_05_Beneficiarios"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqCvpBi_05_Beneficiarios >> t_job_SeqCvpBi_05_Beneficiarios >> t_end_SeqCvpBi_05_Beneficiarios

    end_tasks = [t_end_SeqCvpBi_05_Beneficiarios]

    [t_end_SeqCvpBi_05_Beneficiarios] >> t_publish_dataset

    [t_end_SeqCvpBi_05_Beneficiarios] >> t_teams_error
