...
# Pipeline: DATASTAGE_PEP_COMPLETA_SEMANAL | Projeto: BI_CVP | Dominio: RISCO
# =========================
DAG_ID        = "DATASTAGE_PEP_COMPLETA_SEMANAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "RISCO"
PIPELINE_NAME = "DATASTAGE_PEP_COMPLETA_SEMANAL"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_PEP_COMPLETA_SEMANAL - BI_CVP / RISCO",
    start_date=pendulum.datetime(2026, 6, 19, tz=LOCAL_TZ),
    schedule="0 16 * * 5",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'RISCO', 'DATASTAGE', 'PEP', 'SEMANAL'],
) as dag:
    ...
    t_start_SeqCvpBi_00_PepsCompleta = PythonOperator(
        task_id="log_start_SeqCvpBi_00_PepsCompleta",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqCvpBi_00_PepsCompleta", "task_key": "SeqCvpBi_00_PepsCompleta"},
    )

    t_job_SeqCvpBi_00_PepsCompleta = DataStageOperator(
        task_id="SeqCvpBi_00_PepsCompleta",
        project=PROJECT_NAME,
        job_name="SeqCvpBi_00_PepsCompleta",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqCvpBi_00_PepsCompleta = PythonOperator(
        task_id="log_end_SeqCvpBi_00_PepsCompleta",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqCvpBi_00_PepsCompleta", "task_key": "SeqCvpBi_00_PepsCompleta", "upstream_task_id": "SeqCvpBi_00_PepsCompleta"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqCvpBi_00_PepsCompleta >> t_job_SeqCvpBi_00_PepsCompleta >> t_end_SeqCvpBi_00_PepsCompleta

    end_tasks = [t_end_SeqCvpBi_00_PepsCompleta]

    [t_end_SeqCvpBi_00_PepsCompleta] >> t_publish_dataset

    [t_end_SeqCvpBi_00_PepsCompleta] >> t_teams_error
