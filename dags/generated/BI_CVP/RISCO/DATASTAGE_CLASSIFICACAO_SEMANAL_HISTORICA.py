...
# Pipeline: DATASTAGE_CLASSIFICACAO_SEMANAL_HISTORICA | Projeto: BI_CVP | Dominio: RISCO
# =========================
DAG_ID        = "DATASTAGE_CLASSIFICACAO_SEMANAL_HISTORICA"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "RISCO"
PIPELINE_NAME = "DATASTAGE_CLASSIFICACAO_SEMANAL_HISTORICA"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_CLASSIFICACAO_SEMANAL_HISTORICA"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_CLASSIFICACAO_SEMANAL_HISTORICA - BI_CVP / RISCO",
    start_date=pendulum.datetime(2026, 6, 19, tz=LOCAL_TZ),
    schedule="0 1 * * 6",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'RISCO', 'DATASTAGE', 'CLASSIFICACAO', 'HISTORICA', 'SEMANAL'],
) as dag:
    ...
    t_start_SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA = PythonOperator(
        task_id="log_start_SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA",
        python_callable=log_start,
        op_kwargs={"job_name": "SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA", "task_key": "SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA"},
    )

    t_job_SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA = DataStageOperator(
        task_id="SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA",
        project=PROJECT_NAME,
        job_name="SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA = PythonOperator(
        task_id="log_end_SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA",
        python_callable=log_end,
        op_kwargs={"job_name": "SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA", "task_key": "SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA", "upstream_task_id": "SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA >> t_job_SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA >> t_end_SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA

    end_tasks = [t_end_SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA]

    [t_end_SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA] >> t_publish_dataset

    [t_end_SEQ_RECLASSIFICACAO_SEMANAL_HISTORICA] >> t_teams_error
