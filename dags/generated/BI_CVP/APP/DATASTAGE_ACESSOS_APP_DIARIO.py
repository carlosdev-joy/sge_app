...
# Pipeline: DATASTAGE_ACESSOS_APP_DIARIO | Projeto: BI_CVP | Dominio: APP
# =========================
DAG_ID        = "DATASTAGE_ACESSOS_APP_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_CVP"
DOMAIN        = "APP"
PIPELINE_NAME = "DATASTAGE_ACESSOS_APP_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_ACESSOS_APP_DIARIO - BI_CVP / APP",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule="0 1 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_CVP', 'APP', 'DATASTAGE', 'ACESSOS', 'DIARIO'],
) as dag:
    ...
    t_start_SeqBiCvp_AcessoApp = PythonOperator(
        task_id="log_start_SeqBiCvp_AcessoApp",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqBiCvp_AcessoApp", "task_key": "SeqBiCvp_AcessoApp"},
    )

    t_job_SeqBiCvp_AcessoApp = DataStageOperator(
        task_id="SeqBiCvp_AcessoApp",
        project=PROJECT_NAME,
        job_name="SeqBiCvp_AcessoApp",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqBiCvp_AcessoApp = PythonOperator(
        task_id="log_end_SeqBiCvp_AcessoApp",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqBiCvp_AcessoApp", "task_key": "SeqBiCvp_AcessoApp", "upstream_task_id": "SeqBiCvp_AcessoApp"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqBiCvp_AcessoApp >> t_teams_start >> t_job_SeqBiCvp_AcessoApp >> t_end_SeqBiCvp_AcessoApp

    end_tasks = [t_end_SeqBiCvp_AcessoApp]

    [t_end_SeqBiCvp_AcessoApp] >> t_publish_dataset

    [t_end_SeqBiCvp_AcessoApp] >> t_teams_end

    [t_end_SeqBiCvp_AcessoApp] >> t_teams_error
