...
# Pipeline: SEQSSDVIDA10COBERTURA | Projeto: BI_VIDA | Dominio: COBERTURAS
# =========================
DAG_ID        = "SEQSSDVIDA10COBERTURA"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "COBERTURAS"
PIPELINE_NAME = "SEQSSDVIDA10COBERTURA"
...
DATASET_URI   = "orq://pipeline/SEQSSDVIDA10COBERTURA"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SsdVidaCobertura06DadosBilhete', 'SsdVidaCobertura07DadosVida', 'SsdVidaCobertura08FatoBilhete', 'SsdVidaCobertura09FatoVida', 'SsdVidaCobertura10LimpaDuplicadosFato']
FLOW_JOBS     = ['SsdVidaCobertura06DadosBilhete', 'SsdVidaCobertura07DadosVida', 'SsdVidaCobertura08FatoBilhete', 'SsdVidaCobertura09FatoVida', 'SsdVidaCobertura10LimpaDuplicadosFato']
RESTRICAO_DIA = None
...
with DAG(
    ...
    description="Pipeline SEQSSDVIDA10COBERTURA - BI_VIDA / COBERTURAS",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule=None,  # dependente: o gatilho e o disparo dos predecessores
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'COBERTURAS', 'VIDA', 'GERAL'],
) as dag:
    ...
    t_start_SsdVidaCobertura06DadosBilhete = _LogStart(
        task_id='log_start_SsdVidaCobertura06DadosBilhete',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaCobertura06DadosBilhete', "task_key": 'SsdVidaCobertura06DadosBilhete'},
    )

    t_job_SsdVidaCobertura06DadosBilhete = DataStageOperator(
        task_id='SsdVidaCobertura06DadosBilhete',
        project=PROJECT_NAME,
        job_name='SsdVidaCobertura06DadosBilhete',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCobertura06DadosBilhete = PythonOperator(
        task_id='log_end_SsdVidaCobertura06DadosBilhete',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaCobertura06DadosBilhete', "task_key": 'SsdVidaCobertura06DadosBilhete', "upstream_task_id": 'SsdVidaCobertura06DadosBilhete'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaCobertura07DadosVida = _LogStart(
        task_id='log_start_SsdVidaCobertura07DadosVida',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaCobertura07DadosVida', "task_key": 'SsdVidaCobertura07DadosVida'},
    )

    t_job_SsdVidaCobertura07DadosVida = DataStageOperator(
        task_id='SsdVidaCobertura07DadosVida',
        project=PROJECT_NAME,
        job_name='SsdVidaCobertura07DadosVida',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCobertura07DadosVida = PythonOperator(
        task_id='log_end_SsdVidaCobertura07DadosVida',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaCobertura07DadosVida', "task_key": 'SsdVidaCobertura07DadosVida', "upstream_task_id": 'SsdVidaCobertura07DadosVida'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaCobertura08FatoBilhete = _LogStart(
        task_id='log_start_SsdVidaCobertura08FatoBilhete',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaCobertura08FatoBilhete', "task_key": 'SsdVidaCobertura08FatoBilhete'},
    )

    t_job_SsdVidaCobertura08FatoBilhete = DataStageOperator(
        task_id='SsdVidaCobertura08FatoBilhete',
        project=PROJECT_NAME,
        job_name='SsdVidaCobertura08FatoBilhete',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCobertura08FatoBilhete = PythonOperator(
        task_id='log_end_SsdVidaCobertura08FatoBilhete',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaCobertura08FatoBilhete', "task_key": 'SsdVidaCobertura08FatoBilhete', "upstream_task_id": 'SsdVidaCobertura08FatoBilhete'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaCobertura09FatoVida = _LogStart(
        task_id='log_start_SsdVidaCobertura09FatoVida',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaCobertura09FatoVida', "task_key": 'SsdVidaCobertura09FatoVida'},
    )

    t_job_SsdVidaCobertura09FatoVida = DataStageOperator(
        task_id='SsdVidaCobertura09FatoVida',
        project=PROJECT_NAME,
        job_name='SsdVidaCobertura09FatoVida',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCobertura09FatoVida = PythonOperator(
        task_id='log_end_SsdVidaCobertura09FatoVida',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaCobertura09FatoVida', "task_key": 'SsdVidaCobertura09FatoVida', "upstream_task_id": 'SsdVidaCobertura09FatoVida'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaCobertura10LimpaDuplicadosFato = _LogStart(
        task_id='log_start_SsdVidaCobertura10LimpaDuplicadosFato',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaCobertura10LimpaDuplicadosFato', "task_key": 'SsdVidaCobertura10LimpaDuplicadosFato'},
    )

    t_job_SsdVidaCobertura10LimpaDuplicadosFato = DataStageOperator(
        task_id='SsdVidaCobertura10LimpaDuplicadosFato',
        project=PROJECT_NAME,
        job_name='SsdVidaCobertura10LimpaDuplicadosFato',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCobertura10LimpaDuplicadosFato = PythonOperator(
        task_id='log_end_SsdVidaCobertura10LimpaDuplicadosFato',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaCobertura10LimpaDuplicadosFato', "task_key": 'SsdVidaCobertura10LimpaDuplicadosFato', "upstream_task_id": 'SsdVidaCobertura10LimpaDuplicadosFato'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SsdVidaCobertura06DadosBilhete >> t_job_SsdVidaCobertura06DadosBilhete >> t_end_SsdVidaCobertura06DadosBilhete

    t_end_SsdVidaCobertura06DadosBilhete >> t_start_SsdVidaCobertura07DadosVida >> t_job_SsdVidaCobertura07DadosVida >> t_end_SsdVidaCobertura07DadosVida

    t_end_SsdVidaCobertura07DadosVida >> t_start_SsdVidaCobertura08FatoBilhete >> t_job_SsdVidaCobertura08FatoBilhete >> t_end_SsdVidaCobertura08FatoBilhete

    t_end_SsdVidaCobertura08FatoBilhete >> t_start_SsdVidaCobertura09FatoVida >> t_job_SsdVidaCobertura09FatoVida >> t_end_SsdVidaCobertura09FatoVida

    t_end_SsdVidaCobertura09FatoVida >> t_start_SsdVidaCobertura10LimpaDuplicadosFato >> t_job_SsdVidaCobertura10LimpaDuplicadosFato >> t_end_SsdVidaCobertura10LimpaDuplicadosFato

    end_tasks = [t_end_SsdVidaCobertura06DadosBilhete, t_end_SsdVidaCobertura07DadosVida, t_end_SsdVidaCobertura08FatoBilhete, t_end_SsdVidaCobertura09FatoVida, t_end_SsdVidaCobertura10LimpaDuplicadosFato]

    [t_end_SsdVidaCobertura06DadosBilhete, t_end_SsdVidaCobertura07DadosVida, t_end_SsdVidaCobertura08FatoBilhete, t_end_SsdVidaCobertura09FatoVida, t_end_SsdVidaCobertura10LimpaDuplicadosFato] >> t_publish_dataset

    [t_end_SsdVidaCobertura06DadosBilhete, t_end_SsdVidaCobertura07DadosVida, t_end_SsdVidaCobertura08FatoBilhete, t_end_SsdVidaCobertura09FatoVida, t_end_SsdVidaCobertura10LimpaDuplicadosFato] >> t_teams_error

    [t_end_SsdVidaCobertura06DadosBilhete, t_end_SsdVidaCobertura07DadosVida, t_end_SsdVidaCobertura08FatoBilhete, t_end_SsdVidaCobertura09FatoVida, t_end_SsdVidaCobertura10LimpaDuplicadosFato] >> t_reg_falha
