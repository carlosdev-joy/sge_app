...
# Pipeline: DATASTAGE_BDPO_DIARIO | Projeto: BI_VIDA | Dominio: BDPO
# =========================
DAG_ID        = "DATASTAGE_BDPO_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "BDPO"
PIPELINE_NAME = "DATASTAGE_BDPO_DIARIO"
...
HORARIOS_ESPECIFICOS = ['06:00']
DATASET_URI   = "orq://pipeline/DATASTAGE_BDPO_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SsdVidaSeqCargaBDPO']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_BDPO_DIARIO - BI_VIDA / BDPO",
    start_date=pendulum.datetime(2026, 6, 15, tz=LOCAL_TZ),
    schedule="0 6 * * 1,2,3,4,5,6",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'BDPO', 'DATASTAGE', 'DIARIO'],
) as dag:
    ...
    t_start_SsdVidaSeqCargaBDPO = PythonOperator(
        task_id="log_start_SsdVidaSeqCargaBDPO",
        python_callable=log_start,
        op_kwargs={"job_name": "SsdVidaSeqCargaBDPO", "task_key": "SsdVidaSeqCargaBDPO"},
    )

    t_job_SsdVidaSeqCargaBDPO = DataStageOperator(
        task_id="SsdVidaSeqCargaBDPO",
        project=PROJECT_NAME,
        job_name="SsdVidaSeqCargaBDPO",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaSeqCargaBDPO = PythonOperator(
        task_id="log_end_SsdVidaSeqCargaBDPO",
        python_callable=log_end,
        op_kwargs={"job_name": "SsdVidaSeqCargaBDPO", "task_key": "SsdVidaSeqCargaBDPO", "upstream_task_id": "SsdVidaSeqCargaBDPO"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SsdVidaSeqCargaBDPO >> t_teams_start >> t_job_SsdVidaSeqCargaBDPO >> t_end_SsdVidaSeqCargaBDPO

    end_tasks = [t_end_SsdVidaSeqCargaBDPO]

    [t_end_SsdVidaSeqCargaBDPO] >> t_publish_dataset

    [t_end_SsdVidaSeqCargaBDPO] >> t_teams_end

    [t_end_SsdVidaSeqCargaBDPO] >> t_teams_error
