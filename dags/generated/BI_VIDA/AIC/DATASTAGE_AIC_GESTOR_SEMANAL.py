...
# Pipeline: DATASTAGE_AIC_GESTOR_SEMANAL | Projeto: BI_VIDA | Dominio: AIC
# =========================
DAG_ID        = "DATASTAGE_AIC_GESTOR_SEMANAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "AIC"
PIPELINE_NAME = "DATASTAGE_AIC_GESTOR_SEMANAL"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_AIC_GESTOR_SEMANAL - BI_VIDA / AIC",
    start_date=pendulum.datetime(2026, 6, 16, tz=LOCAL_TZ),
    schedule="0 14 * * 2,4",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'AIC', 'DATASTAGE', 'GESTOR', 'SEMANAL'],
) as dag:
    ...
    t_start_SsdVidaSeqAICGestor = PythonOperator(
        task_id="log_start_SsdVidaSeqAICGestor",
        python_callable=log_start,
        op_kwargs={"job_name": "SsdVidaSeqAICGestor", "task_key": "SsdVidaSeqAICGestor"},
    )

    t_job_SsdVidaSeqAICGestor = DataStageOperator(
        task_id="SsdVidaSeqAICGestor",
        project=PROJECT_NAME,
        job_name="SsdVidaSeqAICGestor",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaSeqAICGestor = PythonOperator(
        task_id="log_end_SsdVidaSeqAICGestor",
        python_callable=log_end,
        op_kwargs={"job_name": "SsdVidaSeqAICGestor", "task_key": "SsdVidaSeqAICGestor", "upstream_task_id": "SsdVidaSeqAICGestor"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SsdVidaSeqAICGestor >> t_teams_start >> t_job_SsdVidaSeqAICGestor >> t_end_SsdVidaSeqAICGestor

    end_tasks = [t_end_SsdVidaSeqAICGestor]

    [t_end_SsdVidaSeqAICGestor] >> t_publish_dataset

    [t_end_SsdVidaSeqAICGestor] >> t_teams_end

    [t_end_SsdVidaSeqAICGestor] >> t_teams_error
