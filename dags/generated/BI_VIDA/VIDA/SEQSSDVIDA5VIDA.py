...
# Pipeline: SEQSSDVIDA5VIDA | Projeto: BI_VIDA | Dominio: VIDA
# =========================
DAG_ID        = "SEQSSDVIDA5VIDA"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "VIDA"
PIPELINE_NAME = "SEQSSDVIDA5VIDA"
...
DATASET_URI   = "orq://pipeline/SEQSSDVIDA5VIDA"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['Aguarda_Apolice', 'Aguarda_bilhete', 'Aguarda_Carga_Fatos', 'SsdVida03DadosContrato1', 'SsdVida03DadosProposta1', 'SsdVida03DadosProposta2GeraApolice', 'SsdVida03DadosProposta3Apolice', 'SsdVida03DadosProposta4ApoliceDst', 'SsdVida04DadosContrato2', 'SsdVida04DadosProposta2', 'SsdVida05FatoPropostaInsere', 'SsdVida05FatoPropostaUpdate', 'SsdVida06FatoVenda', 'SsdVida09FatoCancelamentoInsert', 'SsdVida09FatoCancelamentoUpdate', 'SsdVida08FatoPessoaContrato', 'SsdVida07FatoContrato']
FLOW_JOBS     = ['SsdVida03DadosContrato1', 'SsdVida03DadosProposta1', 'SsdVida03DadosProposta2GeraApolice', 'SsdVida03DadosProposta3Apolice', 'SsdVida03DadosProposta4ApoliceDst', 'SsdVida04DadosContrato2', 'SsdVida04DadosProposta2', 'SsdVida05FatoPropostaInsere', 'SsdVida05FatoPropostaUpdate', 'SsdVida06FatoVenda', 'SsdVida09FatoCancelamentoInsert', 'SsdVida09FatoCancelamentoUpdate', 'SsdVida08FatoPessoaContrato', 'SsdVida07FatoContrato']
RESTRICAO_DIA = None
...
with DAG(
    ...
    t_wait_Aguarda_Apolice = EmptyOperator(
        task_id='Aguarda_Apolice',
        trigger_rule=TriggerRule.ALL_SUCCESS,
    )

    t_wait_Aguarda_bilhete = EmptyOperator(
        task_id='Aguarda_bilhete',
        trigger_rule=TriggerRule.ALL_SUCCESS,
    )
    ...
    t_start_SsdVida03DadosContrato1 = _LogStart(
        task_id='log_start_SsdVida03DadosContrato1',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida03DadosContrato1', "task_key": 'SsdVida03DadosContrato1'},
    )

    t_job_SsdVida03DadosContrato1 = DataStageOperator(
        task_id='SsdVida03DadosContrato1',
        project=PROJECT_NAME,
        job_name='SsdVida03DadosContrato1',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida03DadosContrato1 = PythonOperator(
        task_id='log_end_SsdVida03DadosContrato1',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida03DadosContrato1', "task_key": 'SsdVida03DadosContrato1', "upstream_task_id": 'SsdVida03DadosContrato1'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida03DadosProposta1 = _LogStart(
        task_id='log_start_SsdVida03DadosProposta1',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida03DadosProposta1', "task_key": 'SsdVida03DadosProposta1'},
    )

    t_job_SsdVida03DadosProposta1 = DataStageOperator(
        task_id='SsdVida03DadosProposta1',
        project=PROJECT_NAME,
        job_name='SsdVida03DadosProposta1',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida03DadosProposta1 = PythonOperator(
        task_id='log_end_SsdVida03DadosProposta1',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida03DadosProposta1', "task_key": 'SsdVida03DadosProposta1', "upstream_task_id": 'SsdVida03DadosProposta1'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida03DadosProposta2GeraApolice = _LogStart(
        task_id='log_start_SsdVida03DadosProposta2GeraApolice',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida03DadosProposta2GeraApolice', "task_key": 'SsdVida03DadosProposta2GeraApolice'},
    )

    t_job_SsdVida03DadosProposta2GeraApolice = DataStageOperator(
        task_id='SsdVida03DadosProposta2GeraApolice',
        project=PROJECT_NAME,
        job_name='SsdVida03DadosProposta2GeraApolice',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida03DadosProposta2GeraApolice = PythonOperator(
        task_id='log_end_SsdVida03DadosProposta2GeraApolice',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida03DadosProposta2GeraApolice', "task_key": 'SsdVida03DadosProposta2GeraApolice', "upstream_task_id": 'SsdVida03DadosProposta2GeraApolice'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida03DadosProposta3Apolice = _LogStart(
        task_id='log_start_SsdVida03DadosProposta3Apolice',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida03DadosProposta3Apolice', "task_key": 'SsdVida03DadosProposta3Apolice'},
    )

    t_job_SsdVida03DadosProposta3Apolice = DataStageOperator(
        task_id='SsdVida03DadosProposta3Apolice',
        project=PROJECT_NAME,
        job_name='SsdVida03DadosProposta3Apolice',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida03DadosProposta3Apolice = PythonOperator(
        task_id='log_end_SsdVida03DadosProposta3Apolice',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida03DadosProposta3Apolice', "task_key": 'SsdVida03DadosProposta3Apolice', "upstream_task_id": 'SsdVida03DadosProposta3Apolice'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida03DadosProposta4ApoliceDst = _LogStart(
        task_id='log_start_SsdVida03DadosProposta4ApoliceDst',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida03DadosProposta4ApoliceDst', "task_key": 'SsdVida03DadosProposta4ApoliceDst'},
    )

    t_job_SsdVida03DadosProposta4ApoliceDst = DataStageOperator(
        task_id='SsdVida03DadosProposta4ApoliceDst',
        project=PROJECT_NAME,
        job_name='SsdVida03DadosProposta4ApoliceDst',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida03DadosProposta4ApoliceDst = PythonOperator(
        task_id='log_end_SsdVida03DadosProposta4ApoliceDst',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida03DadosProposta4ApoliceDst', "task_key": 'SsdVida03DadosProposta4ApoliceDst', "upstream_task_id": 'SsdVida03DadosProposta4ApoliceDst'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida04DadosContrato2 = _LogStart(
        task_id='log_start_SsdVida04DadosContrato2',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida04DadosContrato2', "task_key": 'SsdVida04DadosContrato2'},
    )

    t_job_SsdVida04DadosContrato2 = DataStageOperator(
        task_id='SsdVida04DadosContrato2',
        project=PROJECT_NAME,
        job_name='SsdVida04DadosContrato2',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida04DadosContrato2 = PythonOperator(
        task_id='log_end_SsdVida04DadosContrato2',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida04DadosContrato2', "task_key": 'SsdVida04DadosContrato2', "upstream_task_id": 'SsdVida04DadosContrato2'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida04DadosProposta2 = _LogStart(
        task_id='log_start_SsdVida04DadosProposta2',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida04DadosProposta2', "task_key": 'SsdVida04DadosProposta2'},
    )

    t_job_SsdVida04DadosProposta2 = DataStageOperator(
        task_id='SsdVida04DadosProposta2',
        project=PROJECT_NAME,
        job_name='SsdVida04DadosProposta2',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida04DadosProposta2 = PythonOperator(
        task_id='log_end_SsdVida04DadosProposta2',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida04DadosProposta2', "task_key": 'SsdVida04DadosProposta2', "upstream_task_id": 'SsdVida04DadosProposta2'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida05FatoPropostaInsere = _LogStart(
        task_id='log_start_SsdVida05FatoPropostaInsere',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida05FatoPropostaInsere', "task_key": 'SsdVida05FatoPropostaInsere'},
    )

    t_job_SsdVida05FatoPropostaInsere = DataStageOperator(
        task_id='SsdVida05FatoPropostaInsere',
        project=PROJECT_NAME,
        job_name='SsdVida05FatoPropostaInsere',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida05FatoPropostaInsere = PythonOperator(
        task_id='log_end_SsdVida05FatoPropostaInsere',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida05FatoPropostaInsere', "task_key": 'SsdVida05FatoPropostaInsere', "upstream_task_id": 'SsdVida05FatoPropostaInsere'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida05FatoPropostaUpdate = _LogStart(
        task_id='log_start_SsdVida05FatoPropostaUpdate',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida05FatoPropostaUpdate', "task_key": 'SsdVida05FatoPropostaUpdate'},
    )

    t_job_SsdVida05FatoPropostaUpdate = DataStageOperator(
        task_id='SsdVida05FatoPropostaUpdate',
        project=PROJECT_NAME,
        job_name='SsdVida05FatoPropostaUpdate',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida05FatoPropostaUpdate = PythonOperator(
        task_id='log_end_SsdVida05FatoPropostaUpdate',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida05FatoPropostaUpdate', "task_key": 'SsdVida05FatoPropostaUpdate', "upstream_task_id": 'SsdVida05FatoPropostaUpdate'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida06FatoVenda = _LogStart(
        task_id='log_start_SsdVida06FatoVenda',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida06FatoVenda', "task_key": 'SsdVida06FatoVenda'},
    )

    t_job_SsdVida06FatoVenda = DataStageOperator(
        task_id='SsdVida06FatoVenda',
        project=PROJECT_NAME,
        job_name='SsdVida06FatoVenda',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida06FatoVenda = PythonOperator(
        task_id='log_end_SsdVida06FatoVenda',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida06FatoVenda', "task_key": 'SsdVida06FatoVenda', "upstream_task_id": 'SsdVida06FatoVenda'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida09FatoCancelamentoInsert = _LogStart(
        task_id='log_start_SsdVida09FatoCancelamentoInsert',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida09FatoCancelamentoInsert', "task_key": 'SsdVida09FatoCancelamentoInsert'},
    )

    t_job_SsdVida09FatoCancelamentoInsert = DataStageOperator(
        task_id='SsdVida09FatoCancelamentoInsert',
        project=PROJECT_NAME,
        job_name='SsdVida09FatoCancelamentoInsert',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida09FatoCancelamentoInsert = PythonOperator(
        task_id='log_end_SsdVida09FatoCancelamentoInsert',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida09FatoCancelamentoInsert', "task_key": 'SsdVida09FatoCancelamentoInsert', "upstream_task_id": 'SsdVida09FatoCancelamentoInsert'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida09FatoCancelamentoUpdate = _LogStart(
        task_id='log_start_SsdVida09FatoCancelamentoUpdate',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida09FatoCancelamentoUpdate', "task_key": 'SsdVida09FatoCancelamentoUpdate'},
    )

    t_job_SsdVida09FatoCancelamentoUpdate = DataStageOperator(
        task_id='SsdVida09FatoCancelamentoUpdate',
        project=PROJECT_NAME,
        job_name='SsdVida09FatoCancelamentoUpdate',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida09FatoCancelamentoUpdate = PythonOperator(
        task_id='log_end_SsdVida09FatoCancelamentoUpdate',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida09FatoCancelamentoUpdate', "task_key": 'SsdVida09FatoCancelamentoUpdate', "upstream_task_id": 'SsdVida09FatoCancelamentoUpdate'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida08FatoPessoaContrato = _LogStart(
        task_id='log_start_SsdVida08FatoPessoaContrato',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida08FatoPessoaContrato', "task_key": 'SsdVida08FatoPessoaContrato'},
    )

    t_job_SsdVida08FatoPessoaContrato = DataStageOperator(
        task_id='SsdVida08FatoPessoaContrato',
        project=PROJECT_NAME,
        job_name='SsdVida08FatoPessoaContrato',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida08FatoPessoaContrato = PythonOperator(
        task_id='log_end_SsdVida08FatoPessoaContrato',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida08FatoPessoaContrato', "task_key": 'SsdVida08FatoPessoaContrato', "upstream_task_id": 'SsdVida08FatoPessoaContrato'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida07FatoContrato = _LogStart(
        task_id='log_start_SsdVida07FatoContrato',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida07FatoContrato', "task_key": 'SsdVida07FatoContrato'},
    )

    t_job_SsdVida07FatoContrato = DataStageOperator(
        task_id='SsdVida07FatoContrato',
        project=PROJECT_NAME,
        job_name='SsdVida07FatoContrato',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida07FatoContrato = PythonOperator(
        task_id='log_end_SsdVida07FatoContrato',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida07FatoContrato', "task_key": 'SsdVida07FatoContrato', "upstream_task_id": 'SsdVida07FatoContrato'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    [t_end_SsdVida03DadosContrato1, t_end_SsdVida03DadosProposta4ApoliceDst] >> t_wait_Aguarda_Apolice

    [t_end_SsdVida04DadosContrato2, t_end_SsdVida04DadosProposta2] >> t_wait_Aguarda_bilhete

    [t_end_SsdVida06FatoVenda, t_end_SsdVida05FatoPropostaUpdate, t_end_SsdVida09FatoCancelamentoUpdate, t_end_SsdVida08FatoPessoaContrato, t_end_SsdVida07FatoContrato] >> t_wait_Aguarda_Carga_Fatos

    t_check_agenda >> t_start_SsdVida03DadosContrato1 >> t_job_SsdVida03DadosContrato1 >> t_end_SsdVida03DadosContrato1

    t_check_agenda >> t_start_SsdVida03DadosProposta1 >> t_job_SsdVida03DadosProposta1 >> t_end_SsdVida03DadosProposta1

    t_end_SsdVida03DadosProposta1 >> t_start_SsdVida03DadosProposta2GeraApolice >> t_job_SsdVida03DadosProposta2GeraApolice >> t_end_SsdVida03DadosProposta2GeraApolice

    t_end_SsdVida03DadosProposta2GeraApolice >> t_start_SsdVida03DadosProposta3Apolice >> t_job_SsdVida03DadosProposta3Apolice >> t_end_SsdVida03DadosProposta3Apolice

    t_end_SsdVida03DadosProposta3Apolice >> t_start_SsdVida03DadosProposta4ApoliceDst >> t_job_SsdVida03DadosProposta4ApoliceDst >> t_end_SsdVida03DadosProposta4ApoliceDst

    t_wait_Aguarda_Apolice >> t_start_SsdVida04DadosContrato2 >> t_job_SsdVida04DadosContrato2 >> t_end_SsdVida04DadosContrato2

    t_wait_Aguarda_Apolice >> t_start_SsdVida04DadosProposta2 >> t_job_SsdVida04DadosProposta2 >> t_end_SsdVida04DadosProposta2

    t_wait_Aguarda_bilhete >> t_start_SsdVida05FatoPropostaInsere >> t_job_SsdVida05FatoPropostaInsere >> t_end_SsdVida05FatoPropostaInsere

    t_end_SsdVida05FatoPropostaInsere >> t_start_SsdVida05FatoPropostaUpdate >> t_job_SsdVida05FatoPropostaUpdate >> t_end_SsdVida05FatoPropostaUpdate

    t_wait_Aguarda_bilhete >> t_start_SsdVida06FatoVenda >> t_job_SsdVida06FatoVenda >> t_end_SsdVida06FatoVenda

    t_wait_Aguarda_bilhete >> t_start_SsdVida09FatoCancelamentoInsert >> t_job_SsdVida09FatoCancelamentoInsert >> t_end_SsdVida09FatoCancelamentoInsert

    t_end_SsdVida09FatoCancelamentoInsert >> t_start_SsdVida09FatoCancelamentoUpdate >> t_job_SsdVida09FatoCancelamentoUpdate >> t_end_SsdVida09FatoCancelamentoUpdate

    t_wait_Aguarda_bilhete >> t_start_SsdVida08FatoPessoaContrato >> t_job_SsdVida08FatoPessoaContrato >> t_end_SsdVida08FatoPessoaContrato

    t_wait_Aguarda_bilhete >> t_start_SsdVida07FatoContrato >> t_job_SsdVida07FatoContrato >> t_end_SsdVida07FatoContrato

    end_tasks = [t_end_SsdVida03DadosContrato1, t_end_SsdVida03DadosProposta1, t_end_SsdVida03DadosProposta2GeraApolice, t_end_SsdVida03DadosProposta3Apolice, t_end_SsdVida03DadosProposta4ApoliceDst, t_end_SsdVida04DadosContrato2, t_end_SsdVida04DadosProposta2, t_end_SsdVida05FatoPropostaInsere, t_end_SsdVida05FatoPropostaUpdate, t_end_SsdVida06FatoVenda, t_end_SsdVida09FatoCancelamentoInsert, t_end_SsdVida09FatoCancelamentoUpdate, t_end_SsdVida08FatoPessoaContrato, t_end_SsdVida07FatoContrato]

    [t_end_SsdVida03DadosContrato1, t_end_SsdVida03DadosProposta1, t_end_SsdVida03DadosProposta2GeraApolice, t_end_SsdVida03DadosProposta3Apolice, t_end_SsdVida03DadosProposta4ApoliceDst, t_end_SsdVida04DadosContrato2, t_end_SsdVida04DadosProposta2, t_end_SsdVida05FatoPropostaInsere, t_end_SsdVida05FatoPropostaUpdate, t_end_SsdVida06FatoVenda, t_end_SsdVida09FatoCancelamentoInsert, t_end_SsdVida09FatoCancelamentoUpdate, t_end_SsdVida08FatoPessoaContrato, t_end_SsdVida07FatoContrato] >> t_publish_dataset

    [t_end_SsdVida03DadosContrato1, t_end_SsdVida03DadosProposta1, t_end_SsdVida03DadosProposta2GeraApolice, t_end_SsdVida03DadosProposta3Apolice, t_end_SsdVida03DadosProposta4ApoliceDst, t_end_SsdVida04DadosContrato2, t_end_SsdVida04DadosProposta2, t_end_SsdVida05FatoPropostaInsere, t_end_SsdVida05FatoPropostaUpdate, t_end_SsdVida06FatoVenda, t_end_SsdVida09FatoCancelamentoInsert, t_end_SsdVida09FatoCancelamentoUpdate, t_end_SsdVida08FatoPessoaContrato, t_end_SsdVida07FatoContrato] >> t_teams_error

    [t_end_SsdVida03DadosContrato1, t_end_SsdVida03DadosProposta1, t_end_SsdVida03DadosProposta2GeraApolice, t_end_SsdVida03DadosProposta3Apolice, t_end_SsdVida03DadosProposta4ApoliceDst, t_end_SsdVida04DadosContrato2, t_end_SsdVida04DadosProposta2, t_end_SsdVida05FatoPropostaInsere, t_end_SsdVida05FatoPropostaUpdate, t_end_SsdVida06FatoVenda, t_end_SsdVida09FatoCancelamentoInsert, t_end_SsdVida09FatoCancelamentoUpdate, t_end_SsdVida08FatoPessoaContrato, t_end_SsdVida07FatoContrato] >> t_reg_falha

    t_wait_Aguarda_Apolice >> t_publish_dataset

    t_wait_Aguarda_Apolice >> t_teams_error

    t_wait_Aguarda_Apolice >> t_reg_falha

    t_wait_Aguarda_bilhete >> t_publish_dataset

    t_wait_Aguarda_bilhete >> t_teams_error

    t_wait_Aguarda_bilhete >> t_reg_falha
