...
# Pipeline: DATASTAGE_CRITICA_PROPOSTAS_DIARIO | Projeto: BI_VIDA | Dominio: PROPOSTAS
# =========================
DAG_ID        = "DATASTAGE_CRITICA_PROPOSTAS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "PROPOSTAS"
PIPELINE_NAME = "DATASTAGE_CRITICA_PROPOSTAS_DIARIO"
...
HORARIOS_ESPECIFICOS = ['05:00']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/DATASTAGE_CRITICA_PROPOSTAS_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['JOB_CRITICA_PROPOSTA_FULL_01_NEW', 'JOB_CRITICA_PROPOSTA_FULL_02_NEW', 'JOB_CRITICA_PROPOSTA_FULL_03_NEW', 'JOB_CRITICA_PROPOSTA_FULL_04_NEW']
FLOW_JOBS     = ['JOB_CRITICA_PROPOSTA_FULL_01_NEW', 'JOB_CRITICA_PROPOSTA_FULL_02_NEW', 'JOB_CRITICA_PROPOSTA_FULL_03_NEW', 'JOB_CRITICA_PROPOSTA_FULL_04_NEW']
RESTRICAO_DIA = {'schedule_type': 'custom', 'schedule_dow': 1, 'schedule_dom': 1, 'dias_semana': '1,2,3,4,5,6', 'dias_horarios_mes_dias': None}
...
with DAG(
    ...
    description="Pipeline DATASTAGE_CRITICA_PROPOSTAS_DIARIO - BI_VIDA / PROPOSTAS",
    start_date=pendulum.datetime(2026, 6, 15, tz=LOCAL_TZ),
    schedule=None,  # dependente: o gatilho e o disparo dos predecessores
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'PROPOSTAS', 'DATASTAGE', 'CRITICA', 'DIARIO'],
) as dag:
    ...
    t_start_JOB_CRITICA_PROPOSTA_FULL_01_NEW = _LogStart(
        task_id='log_start_JOB_CRITICA_PROPOSTA_FULL_01_NEW',
        python_callable=log_start,
        op_kwargs={"job_name": 'JOB_CRITICA_PROPOSTA_FULL_01_NEW', "task_key": 'JOB_CRITICA_PROPOSTA_FULL_01_NEW'},
    )

    t_job_JOB_CRITICA_PROPOSTA_FULL_01_NEW = DataStageOperator(
        task_id='JOB_CRITICA_PROPOSTA_FULL_01_NEW',
        project=PROJECT_NAME,
        job_name='JOB_CRITICA_PROPOSTA_FULL_01_NEW',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_JOB_CRITICA_PROPOSTA_FULL_01_NEW = PythonOperator(
        task_id='log_end_JOB_CRITICA_PROPOSTA_FULL_01_NEW',
        python_callable=log_end,
        op_kwargs={"job_name": 'JOB_CRITICA_PROPOSTA_FULL_01_NEW', "task_key": 'JOB_CRITICA_PROPOSTA_FULL_01_NEW', "upstream_task_id": 'JOB_CRITICA_PROPOSTA_FULL_01_NEW'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_JOB_CRITICA_PROPOSTA_FULL_02_NEW = _LogStart(
        task_id='log_start_JOB_CRITICA_PROPOSTA_FULL_02_NEW',
        python_callable=log_start,
        op_kwargs={"job_name": 'JOB_CRITICA_PROPOSTA_FULL_02_NEW', "task_key": 'JOB_CRITICA_PROPOSTA_FULL_02_NEW'},
    )

    t_job_JOB_CRITICA_PROPOSTA_FULL_02_NEW = DataStageOperator(
        task_id='JOB_CRITICA_PROPOSTA_FULL_02_NEW',
        project=PROJECT_NAME,
        job_name='JOB_CRITICA_PROPOSTA_FULL_02_NEW',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_JOB_CRITICA_PROPOSTA_FULL_02_NEW = PythonOperator(
        task_id='log_end_JOB_CRITICA_PROPOSTA_FULL_02_NEW',
        python_callable=log_end,
        op_kwargs={"job_name": 'JOB_CRITICA_PROPOSTA_FULL_02_NEW', "task_key": 'JOB_CRITICA_PROPOSTA_FULL_02_NEW', "upstream_task_id": 'JOB_CRITICA_PROPOSTA_FULL_02_NEW'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_JOB_CRITICA_PROPOSTA_FULL_03_NEW = _LogStart(
        task_id='log_start_JOB_CRITICA_PROPOSTA_FULL_03_NEW',
        python_callable=log_start,
        op_kwargs={"job_name": 'JOB_CRITICA_PROPOSTA_FULL_03_NEW', "task_key": 'JOB_CRITICA_PROPOSTA_FULL_03_NEW'},
    )

    t_job_JOB_CRITICA_PROPOSTA_FULL_03_NEW = DataStageOperator(
        task_id='JOB_CRITICA_PROPOSTA_FULL_03_NEW',
        project=PROJECT_NAME,
        job_name='JOB_CRITICA_PROPOSTA_FULL_03_NEW',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_JOB_CRITICA_PROPOSTA_FULL_03_NEW = PythonOperator(
        task_id='log_end_JOB_CRITICA_PROPOSTA_FULL_03_NEW',
        python_callable=log_end,
        op_kwargs={"job_name": 'JOB_CRITICA_PROPOSTA_FULL_03_NEW', "task_key": 'JOB_CRITICA_PROPOSTA_FULL_03_NEW', "upstream_task_id": 'JOB_CRITICA_PROPOSTA_FULL_03_NEW'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_JOB_CRITICA_PROPOSTA_FULL_04_NEW = _LogStart(
        task_id='log_start_JOB_CRITICA_PROPOSTA_FULL_04_NEW',
        python_callable=log_start,
        op_kwargs={"job_name": 'JOB_CRITICA_PROPOSTA_FULL_04_NEW', "task_key": 'JOB_CRITICA_PROPOSTA_FULL_04_NEW'},
    )

    t_job_JOB_CRITICA_PROPOSTA_FULL_04_NEW = DataStageOperator(
        task_id='JOB_CRITICA_PROPOSTA_FULL_04_NEW',
        project=PROJECT_NAME,
        job_name='JOB_CRITICA_PROPOSTA_FULL_04_NEW',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_JOB_CRITICA_PROPOSTA_FULL_04_NEW = PythonOperator(
        task_id='log_end_JOB_CRITICA_PROPOSTA_FULL_04_NEW',
        python_callable=log_end,
        op_kwargs={"job_name": 'JOB_CRITICA_PROPOSTA_FULL_04_NEW', "task_key": 'JOB_CRITICA_PROPOSTA_FULL_04_NEW', "upstream_task_id": 'JOB_CRITICA_PROPOSTA_FULL_04_NEW'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_JOB_CRITICA_PROPOSTA_FULL_01_NEW >> t_teams_start >> t_job_JOB_CRITICA_PROPOSTA_FULL_01_NEW >> t_end_JOB_CRITICA_PROPOSTA_FULL_01_NEW

    t_end_JOB_CRITICA_PROPOSTA_FULL_01_NEW >> t_start_JOB_CRITICA_PROPOSTA_FULL_02_NEW >> t_job_JOB_CRITICA_PROPOSTA_FULL_02_NEW >> t_end_JOB_CRITICA_PROPOSTA_FULL_02_NEW

    t_end_JOB_CRITICA_PROPOSTA_FULL_02_NEW >> t_start_JOB_CRITICA_PROPOSTA_FULL_03_NEW >> t_job_JOB_CRITICA_PROPOSTA_FULL_03_NEW >> t_end_JOB_CRITICA_PROPOSTA_FULL_03_NEW

    t_end_JOB_CRITICA_PROPOSTA_FULL_03_NEW >> t_start_JOB_CRITICA_PROPOSTA_FULL_04_NEW >> t_job_JOB_CRITICA_PROPOSTA_FULL_04_NEW >> t_end_JOB_CRITICA_PROPOSTA_FULL_04_NEW

    end_tasks = [t_end_JOB_CRITICA_PROPOSTA_FULL_01_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_02_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_03_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_04_NEW]

    [t_end_JOB_CRITICA_PROPOSTA_FULL_01_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_02_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_03_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_04_NEW] >> t_publish_dataset

    [t_end_JOB_CRITICA_PROPOSTA_FULL_01_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_02_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_03_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_04_NEW] >> t_teams_end

    [t_end_JOB_CRITICA_PROPOSTA_FULL_01_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_02_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_03_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_04_NEW] >> t_teams_error

    [t_end_JOB_CRITICA_PROPOSTA_FULL_01_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_02_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_03_NEW, t_end_JOB_CRITICA_PROPOSTA_FULL_04_NEW] >> t_reg_falha
