...
# Pipeline: DATASTAGE_PORTAL_PJ_DIARIO | Projeto: BI_VIDA | Dominio: PORTAL_PJ
# =========================
DAG_ID        = "DATASTAGE_PORTAL_PJ_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "PORTAL_PJ"
PIPELINE_NAME = "DATASTAGE_PORTAL_PJ_DIARIO"
...
HORARIOS_ESPECIFICOS = ['13:05']
DATASET_URI   = "orq://pipeline/DATASTAGE_PORTAL_PJ_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqSsdVidaExecDiariaPortalPJ']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_PORTAL_PJ_DIARIO - BI_VIDA / PORTAL_PJ",
    start_date=pendulum.datetime(2026, 6, 15, tz=LOCAL_TZ),
    schedule="5 13 * * 1,2,3,4,5,6",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'PORTAL_PJ', 'DATASTAGE', 'DIARIO'],
) as dag:
    ...
    t_start_SeqSsdVidaExecDiariaPortalPJ = PythonOperator(
        task_id="log_start_SeqSsdVidaExecDiariaPortalPJ",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqSsdVidaExecDiariaPortalPJ", "task_key": "SeqSsdVidaExecDiariaPortalPJ"},
    )

    t_job_SeqSsdVidaExecDiariaPortalPJ = DataStageOperator(
        task_id="SeqSsdVidaExecDiariaPortalPJ",
        project=PROJECT_NAME,
        job_name="SeqSsdVidaExecDiariaPortalPJ",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqSsdVidaExecDiariaPortalPJ = PythonOperator(
        task_id="log_end_SeqSsdVidaExecDiariaPortalPJ",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqSsdVidaExecDiariaPortalPJ", "task_key": "SeqSsdVidaExecDiariaPortalPJ", "upstream_task_id": "SeqSsdVidaExecDiariaPortalPJ"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqSsdVidaExecDiariaPortalPJ >> t_teams_start >> t_job_SeqSsdVidaExecDiariaPortalPJ >> t_end_SeqSsdVidaExecDiariaPortalPJ

    end_tasks = [t_end_SeqSsdVidaExecDiariaPortalPJ]

    [t_end_SeqSsdVidaExecDiariaPortalPJ] >> t_publish_dataset

    [t_end_SeqSsdVidaExecDiariaPortalPJ] >> t_teams_end

    [t_end_SeqSsdVidaExecDiariaPortalPJ] >> t_teams_error
