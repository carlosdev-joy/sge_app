...
# Pipeline: SEQSSDVIDA2BAIXADADOSFINANCEIROS | Projeto: BI_VIDA | Dominio: FINANCEIROS
# =========================
DAG_ID        = "SEQSSDVIDA2BAIXADADOSFINANCEIROS"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "FINANCEIROS"
PIPELINE_NAME = "SEQSSDVIDA2BAIXADADOSFINANCEIROS"
...
DATASET_URI   = "orq://pipeline/SEQSSDVIDA2BAIXADADOSFINANCEIROS"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SsdVidaFatoFaturamentoBilhete01', 'SsdVidaFatoFaturamentoVida01', 'SSDVidaCobranca01BaixaEndosFin', 'SSDVidaCobranca02BaixaParcelasBilhete', 'SSDVidaCobranca02BaixaOpcaoPagamento', 'SSDVidaCobranca02BaixaParcelasVida', 'SSDVidaCobranca02BaixaMovimentosVida', 'SSDVidaCobranca02BaixaRecebimentosVida']
FLOW_JOBS     = ['SsdVidaFatoFaturamentoBilhete01', 'SsdVidaFatoFaturamentoVida01', 'SSDVidaCobranca01BaixaEndosFin', 'SSDVidaCobranca02BaixaParcelasBilhete', 'SSDVidaCobranca02BaixaOpcaoPagamento', 'SSDVidaCobranca02BaixaParcelasVida', 'SSDVidaCobranca02BaixaMovimentosVida', 'SSDVidaCobranca02BaixaRecebimentosVida']
...
with DAG(
    ...
    description="Pipeline SEQSSDVIDA2BAIXADADOSFINANCEIROS - BI_VIDA / FINANCEIROS",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule="10 1 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'FINANCEIROS', 'VIDA', 'GERAL'],
) as dag:
    ...
    t_start_SSDVidaCobranca01BaixaEndosFin = _LogStart(
        task_id='log_start_SSDVidaCobranca01BaixaEndosFin',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca01BaixaEndosFin', "task_key": 'SSDVidaCobranca01BaixaEndosFin'},
    )

    t_job_SSDVidaCobranca01BaixaEndosFin = DataStageOperator(
        task_id='SSDVidaCobranca01BaixaEndosFin',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca01BaixaEndosFin',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca01BaixaEndosFin = PythonOperator(
        task_id='log_end_SSDVidaCobranca01BaixaEndosFin',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca01BaixaEndosFin', "task_key": 'SSDVidaCobranca01BaixaEndosFin', "upstream_task_id": 'SSDVidaCobranca01BaixaEndosFin'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca02BaixaParcelasBilhete = _LogStart(
        task_id='log_start_SSDVidaCobranca02BaixaParcelasBilhete',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca02BaixaParcelasBilhete', "task_key": 'SSDVidaCobranca02BaixaParcelasBilhete'},
    )

    t_job_SSDVidaCobranca02BaixaParcelasBilhete = DataStageOperator(
        task_id='SSDVidaCobranca02BaixaParcelasBilhete',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca02BaixaParcelasBilhete',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca02BaixaParcelasBilhete = PythonOperator(
        task_id='log_end_SSDVidaCobranca02BaixaParcelasBilhete',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca02BaixaParcelasBilhete', "task_key": 'SSDVidaCobranca02BaixaParcelasBilhete', "upstream_task_id": 'SSDVidaCobranca02BaixaParcelasBilhete'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca02BaixaOpcaoPagamento = _LogStart(
        task_id='log_start_SSDVidaCobranca02BaixaOpcaoPagamento',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca02BaixaOpcaoPagamento', "task_key": 'SSDVidaCobranca02BaixaOpcaoPagamento'},
    )

    t_job_SSDVidaCobranca02BaixaOpcaoPagamento = DataStageOperator(
        task_id='SSDVidaCobranca02BaixaOpcaoPagamento',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca02BaixaOpcaoPagamento',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca02BaixaOpcaoPagamento = PythonOperator(
        task_id='log_end_SSDVidaCobranca02BaixaOpcaoPagamento',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca02BaixaOpcaoPagamento', "task_key": 'SSDVidaCobranca02BaixaOpcaoPagamento', "upstream_task_id": 'SSDVidaCobranca02BaixaOpcaoPagamento'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca02BaixaParcelasVida = _LogStart(
        task_id='log_start_SSDVidaCobranca02BaixaParcelasVida',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca02BaixaParcelasVida', "task_key": 'SSDVidaCobranca02BaixaParcelasVida'},
    )

    t_job_SSDVidaCobranca02BaixaParcelasVida = DataStageOperator(
        task_id='SSDVidaCobranca02BaixaParcelasVida',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca02BaixaParcelasVida',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca02BaixaParcelasVida = PythonOperator(
        task_id='log_end_SSDVidaCobranca02BaixaParcelasVida',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca02BaixaParcelasVida', "task_key": 'SSDVidaCobranca02BaixaParcelasVida', "upstream_task_id": 'SSDVidaCobranca02BaixaParcelasVida'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca02BaixaMovimentosVida = _LogStart(
        task_id='log_start_SSDVidaCobranca02BaixaMovimentosVida',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca02BaixaMovimentosVida', "task_key": 'SSDVidaCobranca02BaixaMovimentosVida'},
    )

    t_job_SSDVidaCobranca02BaixaMovimentosVida = DataStageOperator(
        task_id='SSDVidaCobranca02BaixaMovimentosVida',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca02BaixaMovimentosVida',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca02BaixaMovimentosVida = PythonOperator(
        task_id='log_end_SSDVidaCobranca02BaixaMovimentosVida',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca02BaixaMovimentosVida', "task_key": 'SSDVidaCobranca02BaixaMovimentosVida', "upstream_task_id": 'SSDVidaCobranca02BaixaMovimentosVida'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca02BaixaRecebimentosVida = _LogStart(
        task_id='log_start_SSDVidaCobranca02BaixaRecebimentosVida',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca02BaixaRecebimentosVida', "task_key": 'SSDVidaCobranca02BaixaRecebimentosVida'},
    )

    t_job_SSDVidaCobranca02BaixaRecebimentosVida = DataStageOperator(
        task_id='SSDVidaCobranca02BaixaRecebimentosVida',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca02BaixaRecebimentosVida',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca02BaixaRecebimentosVida = PythonOperator(
        task_id='log_end_SSDVidaCobranca02BaixaRecebimentosVida',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca02BaixaRecebimentosVida', "task_key": 'SSDVidaCobranca02BaixaRecebimentosVida', "upstream_task_id": 'SSDVidaCobranca02BaixaRecebimentosVida'},
        trigger_rule=TriggerRule.ALL_DONE,
    )
    ...
    t_end_SsdVidaFatoFaturamentoBilhete01 >> t_start_SsdVidaFatoFaturamentoVida01 >> t_job_SsdVidaFatoFaturamentoVida01 >> t_end_SsdVidaFatoFaturamentoVida01

    t_end_SsdVidaFatoFaturamentoVida01 >> t_start_SSDVidaCobranca01BaixaEndosFin >> t_job_SSDVidaCobranca01BaixaEndosFin >> t_end_SSDVidaCobranca01BaixaEndosFin

    t_check_agenda >> t_start_SSDVidaCobranca02BaixaParcelasBilhete >> t_job_SSDVidaCobranca02BaixaParcelasBilhete >> t_end_SSDVidaCobranca02BaixaParcelasBilhete

    t_end_SSDVidaCobranca02BaixaParcelasBilhete >> t_start_SSDVidaCobranca02BaixaOpcaoPagamento >> t_job_SSDVidaCobranca02BaixaOpcaoPagamento >> t_end_SSDVidaCobranca02BaixaOpcaoPagamento

    t_check_agenda >> t_start_SSDVidaCobranca02BaixaParcelasVida >> t_job_SSDVidaCobranca02BaixaParcelasVida >> t_end_SSDVidaCobranca02BaixaParcelasVida

    t_end_SSDVidaCobranca02BaixaParcelasVida >> t_start_SSDVidaCobranca02BaixaMovimentosVida >> t_job_SSDVidaCobranca02BaixaMovimentosVida >> t_end_SSDVidaCobranca02BaixaMovimentosVida

    t_check_agenda >> t_start_SSDVidaCobranca02BaixaRecebimentosVida >> t_job_SSDVidaCobranca02BaixaRecebimentosVida >> t_end_SSDVidaCobranca02BaixaRecebimentosVida

    end_tasks = [t_end_SsdVidaFatoFaturamentoBilhete01, t_end_SsdVidaFatoFaturamentoVida01, t_end_SSDVidaCobranca01BaixaEndosFin, t_end_SSDVidaCobranca02BaixaParcelasBilhete, t_end_SSDVidaCobranca02BaixaOpcaoPagamento, t_end_SSDVidaCobranca02BaixaParcelasVida, t_end_SSDVidaCobranca02BaixaMovimentosVida, t_end_SSDVidaCobranca02BaixaRecebimentosVida]

    [t_end_SsdVidaFatoFaturamentoBilhete01, t_end_SsdVidaFatoFaturamentoVida01, t_end_SSDVidaCobranca01BaixaEndosFin, t_end_SSDVidaCobranca02BaixaParcelasBilhete, t_end_SSDVidaCobranca02BaixaOpcaoPagamento, t_end_SSDVidaCobranca02BaixaParcelasVida, t_end_SSDVidaCobranca02BaixaMovimentosVida, t_end_SSDVidaCobranca02BaixaRecebimentosVida] >> t_publish_dataset

    [t_end_SsdVidaFatoFaturamentoBilhete01, t_end_SsdVidaFatoFaturamentoVida01, t_end_SSDVidaCobranca01BaixaEndosFin, t_end_SSDVidaCobranca02BaixaParcelasBilhete, t_end_SSDVidaCobranca02BaixaOpcaoPagamento, t_end_SSDVidaCobranca02BaixaParcelasVida, t_end_SSDVidaCobranca02BaixaMovimentosVida, t_end_SSDVidaCobranca02BaixaRecebimentosVida] >> t_teams_error

    [t_end_SsdVidaFatoFaturamentoBilhete01, t_end_SsdVidaFatoFaturamentoVida01, t_end_SSDVidaCobranca01BaixaEndosFin, t_end_SSDVidaCobranca02BaixaParcelasBilhete, t_end_SSDVidaCobranca02BaixaOpcaoPagamento, t_end_SSDVidaCobranca02BaixaParcelasVida, t_end_SSDVidaCobranca02BaixaMovimentosVida, t_end_SSDVidaCobranca02BaixaRecebimentosVida] >> t_reg_falha
