...
# Pipeline: DATASTAGE_VIDA_GERAL_MENSAL | Projeto: BI_VIDA | Dominio: GERAL
# =========================
DAG_ID        = "DATASTAGE_VIDA_GERAL_MENSAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "GERAL"
PIPELINE_NAME = "DATASTAGE_VIDA_GERAL_MENSAL"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_VIDA_GERAL_MENSAL - BI_VIDA / GERAL",
    start_date=pendulum.datetime(2026, 7, 6, tz=LOCAL_TZ),
    schedule="0 2 6 * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'GERAL', 'DATASTAGE', 'MENSAL'],
) as dag:
    ...
    t_start_SeqSsdVidaGeralMensal = PythonOperator(
        task_id="log_start_SeqSsdVidaGeralMensal",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqSsdVidaGeralMensal", "task_key": "SeqSsdVidaGeralMensal"},
    )

    t_job_SeqSsdVidaGeralMensal = DataStageOperator(
        task_id="SeqSsdVidaGeralMensal",
        project=PROJECT_NAME,
        job_name="SeqSsdVidaGeralMensal",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqSsdVidaGeralMensal = PythonOperator(
        task_id="log_end_SeqSsdVidaGeralMensal",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqSsdVidaGeralMensal", "task_key": "SeqSsdVidaGeralMensal", "upstream_task_id": "SeqSsdVidaGeralMensal"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqSsdVidaGeralMensal >> t_teams_start >> t_job_SeqSsdVidaGeralMensal >> t_end_SeqSsdVidaGeralMensal

    end_tasks = [t_end_SeqSsdVidaGeralMensal]

    [t_end_SeqSsdVidaGeralMensal] >> t_publish_dataset

    [t_end_SeqSsdVidaGeralMensal] >> t_teams_end

    [t_end_SeqSsdVidaGeralMensal] >> t_teams_error
