...
# Pipeline: SEQSSDVIDA8COBRANCA | Projeto: BI_VIDA | Dominio: COBRANCA
# =========================
DAG_ID        = "SEQSSDVIDA8COBRANCA"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "COBRANCA"
PIPELINE_NAME = "SEQSSDVIDA8COBRANCA"
...
DATASET_URI   = "orq://pipeline/SEQSSDVIDA8COBRANCA"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SSDVidaCobranca02Union01', 'Aguarda_Dimensao', 'SSDVidaCobranca02Union02', 'SSDVidaCobranca01DimeEndosFin', 'SsdVidaCobranca03DimeParcelasBilhete', 'SsdVidaCobranca03DimeParcelasVida', 'SSDVidaCobranca04Dados1Bilhete', 'SSDVidaCobranca04Dados1Vida', 'SSDVidaCobranca01BaixaProcessamentoCobranca', 'SSDVidaCobranca04DimeProcessamentoCobranca', 'SSDVidaCobranca05FatoParcelasBilhete', 'SSDVidaCobranca05FatoParcelasVidaInsert', 'SSDVidaCobranca05FatoParcelasVidaUpdate']
FLOW_JOBS     = ['SSDVidaCobranca02Union01', 'SSDVidaCobranca02Union02', 'SSDVidaCobranca01DimeEndosFin', 'SsdVidaCobranca03DimeParcelasBilhete', 'SsdVidaCobranca03DimeParcelasVida', 'SSDVidaCobranca04Dados1Bilhete', 'SSDVidaCobranca04Dados1Vida', 'SSDVidaCobranca01BaixaProcessamentoCobranca', 'SSDVidaCobranca04DimeProcessamentoCobranca', 'SSDVidaCobranca05FatoParcelasBilhete', 'SSDVidaCobranca05FatoParcelasVidaInsert', 'SSDVidaCobranca05FatoParcelasVidaUpdate']
RESTRICAO_DIA = None
...
with DAG(
    ...
    description="Pipeline SEQSSDVIDA8COBRANCA - BI_VIDA / COBRANCA",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule=None,  # dependente: o gatilho e o disparo dos predecessores
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'COBRANCA', 'VIDA', 'GERAL'],
) as dag:
    ...
    t_start_SSDVidaCobranca02Union01 = _LogStart(
        task_id='log_start_SSDVidaCobranca02Union01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca02Union01', "task_key": 'SSDVidaCobranca02Union01'},
    )

    t_job_SSDVidaCobranca02Union01 = DataStageOperator(
        task_id='SSDVidaCobranca02Union01',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca02Union01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca02Union01 = PythonOperator(
        task_id='log_end_SSDVidaCobranca02Union01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca02Union01', "task_key": 'SSDVidaCobranca02Union01', "upstream_task_id": 'SSDVidaCobranca02Union01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_wait_Aguarda_Dimensao = EmptyOperator(
        task_id='Aguarda_Dimensao',
        trigger_rule=TriggerRule.ALL_SUCCESS,
    )

    t_start_SSDVidaCobranca02Union02 = _LogStart(
        task_id='log_start_SSDVidaCobranca02Union02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca02Union02', "task_key": 'SSDVidaCobranca02Union02'},
    )

    t_job_SSDVidaCobranca02Union02 = DataStageOperator(
        task_id='SSDVidaCobranca02Union02',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca02Union02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca02Union02 = PythonOperator(
        task_id='log_end_SSDVidaCobranca02Union02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca02Union02', "task_key": 'SSDVidaCobranca02Union02', "upstream_task_id": 'SSDVidaCobranca02Union02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca01DimeEndosFin = _LogStart(
        task_id='log_start_SSDVidaCobranca01DimeEndosFin',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca01DimeEndosFin', "task_key": 'SSDVidaCobranca01DimeEndosFin'},
    )

    t_job_SSDVidaCobranca01DimeEndosFin = DataStageOperator(
        task_id='SSDVidaCobranca01DimeEndosFin',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca01DimeEndosFin',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca01DimeEndosFin = PythonOperator(
        task_id='log_end_SSDVidaCobranca01DimeEndosFin',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca01DimeEndosFin', "task_key": 'SSDVidaCobranca01DimeEndosFin', "upstream_task_id": 'SSDVidaCobranca01DimeEndosFin'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaCobranca03DimeParcelasBilhete = _LogStart(
        task_id='log_start_SsdVidaCobranca03DimeParcelasBilhete',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaCobranca03DimeParcelasBilhete', "task_key": 'SsdVidaCobranca03DimeParcelasBilhete'},
    )

    t_job_SsdVidaCobranca03DimeParcelasBilhete = DataStageOperator(
        task_id='SsdVidaCobranca03DimeParcelasBilhete',
        project=PROJECT_NAME,
        job_name='SsdVidaCobranca03DimeParcelasBilhete',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCobranca03DimeParcelasBilhete = PythonOperator(
        task_id='log_end_SsdVidaCobranca03DimeParcelasBilhete',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaCobranca03DimeParcelasBilhete', "task_key": 'SsdVidaCobranca03DimeParcelasBilhete', "upstream_task_id": 'SsdVidaCobranca03DimeParcelasBilhete'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaCobranca03DimeParcelasVida = _LogStart(
        task_id='log_start_SsdVidaCobranca03DimeParcelasVida',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaCobranca03DimeParcelasVida', "task_key": 'SsdVidaCobranca03DimeParcelasVida'},
    )

    t_job_SsdVidaCobranca03DimeParcelasVida = DataStageOperator(
        task_id='SsdVidaCobranca03DimeParcelasVida',
        project=PROJECT_NAME,
        job_name='SsdVidaCobranca03DimeParcelasVida',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCobranca03DimeParcelasVida = PythonOperator(
        task_id='log_end_SsdVidaCobranca03DimeParcelasVida',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaCobranca03DimeParcelasVida', "task_key": 'SsdVidaCobranca03DimeParcelasVida', "upstream_task_id": 'SsdVidaCobranca03DimeParcelasVida'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca04Dados1Bilhete = _LogStart(
        task_id='log_start_SSDVidaCobranca04Dados1Bilhete',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca04Dados1Bilhete', "task_key": 'SSDVidaCobranca04Dados1Bilhete'},
    )

    t_job_SSDVidaCobranca04Dados1Bilhete = DataStageOperator(
        task_id='SSDVidaCobranca04Dados1Bilhete',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca04Dados1Bilhete',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca04Dados1Bilhete = PythonOperator(
        task_id='log_end_SSDVidaCobranca04Dados1Bilhete',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca04Dados1Bilhete', "task_key": 'SSDVidaCobranca04Dados1Bilhete', "upstream_task_id": 'SSDVidaCobranca04Dados1Bilhete'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca04Dados1Vida = _LogStart(
        task_id='log_start_SSDVidaCobranca04Dados1Vida',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca04Dados1Vida', "task_key": 'SSDVidaCobranca04Dados1Vida'},
    )

    t_job_SSDVidaCobranca04Dados1Vida = DataStageOperator(
        task_id='SSDVidaCobranca04Dados1Vida',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca04Dados1Vida',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca04Dados1Vida = PythonOperator(
        task_id='log_end_SSDVidaCobranca04Dados1Vida',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca04Dados1Vida', "task_key": 'SSDVidaCobranca04Dados1Vida', "upstream_task_id": 'SSDVidaCobranca04Dados1Vida'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca01BaixaProcessamentoCobranca = _LogStart(
        task_id='log_start_SSDVidaCobranca01BaixaProcessamentoCobranca',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca01BaixaProcessamentoCobranca', "task_key": 'SSDVidaCobranca01BaixaProcessamentoCobranca'},
    )

    t_job_SSDVidaCobranca01BaixaProcessamentoCobranca = DataStageOperator(
        task_id='SSDVidaCobranca01BaixaProcessamentoCobranca',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca01BaixaProcessamentoCobranca',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca01BaixaProcessamentoCobranca = PythonOperator(
        task_id='log_end_SSDVidaCobranca01BaixaProcessamentoCobranca',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca01BaixaProcessamentoCobranca', "task_key": 'SSDVidaCobranca01BaixaProcessamentoCobranca', "upstream_task_id": 'SSDVidaCobranca01BaixaProcessamentoCobranca'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca04DimeProcessamentoCobranca = _LogStart(
        task_id='log_start_SSDVidaCobranca04DimeProcessamentoCobranca',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca04DimeProcessamentoCobranca', "task_key": 'SSDVidaCobranca04DimeProcessamentoCobranca'},
    )

    t_job_SSDVidaCobranca04DimeProcessamentoCobranca = DataStageOperator(
        task_id='SSDVidaCobranca04DimeProcessamentoCobranca',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca04DimeProcessamentoCobranca',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca04DimeProcessamentoCobranca = PythonOperator(
        task_id='log_end_SSDVidaCobranca04DimeProcessamentoCobranca',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca04DimeProcessamentoCobranca', "task_key": 'SSDVidaCobranca04DimeProcessamentoCobranca', "upstream_task_id": 'SSDVidaCobranca04DimeProcessamentoCobranca'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca05FatoParcelasBilhete = _LogStart(
        task_id='log_start_SSDVidaCobranca05FatoParcelasBilhete',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca05FatoParcelasBilhete', "task_key": 'SSDVidaCobranca05FatoParcelasBilhete'},
    )

    t_job_SSDVidaCobranca05FatoParcelasBilhete = DataStageOperator(
        task_id='SSDVidaCobranca05FatoParcelasBilhete',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca05FatoParcelasBilhete',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca05FatoParcelasBilhete = PythonOperator(
        task_id='log_end_SSDVidaCobranca05FatoParcelasBilhete',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca05FatoParcelasBilhete', "task_key": 'SSDVidaCobranca05FatoParcelasBilhete', "upstream_task_id": 'SSDVidaCobranca05FatoParcelasBilhete'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca05FatoParcelasVidaInsert = _LogStart(
        task_id='log_start_SSDVidaCobranca05FatoParcelasVidaInsert',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca05FatoParcelasVidaInsert', "task_key": 'SSDVidaCobranca05FatoParcelasVidaInsert'},
    )

    t_job_SSDVidaCobranca05FatoParcelasVidaInsert = DataStageOperator(
        task_id='SSDVidaCobranca05FatoParcelasVidaInsert',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca05FatoParcelasVidaInsert',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca05FatoParcelasVidaInsert = PythonOperator(
        task_id='log_end_SSDVidaCobranca05FatoParcelasVidaInsert',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca05FatoParcelasVidaInsert', "task_key": 'SSDVidaCobranca05FatoParcelasVidaInsert', "upstream_task_id": 'SSDVidaCobranca05FatoParcelasVidaInsert'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SSDVidaCobranca05FatoParcelasVidaUpdate = _LogStart(
        task_id='log_start_SSDVidaCobranca05FatoParcelasVidaUpdate',
        python_callable=log_start,
        op_kwargs={"job_name": 'SSDVidaCobranca05FatoParcelasVidaUpdate', "task_key": 'SSDVidaCobranca05FatoParcelasVidaUpdate'},
    )

    t_job_SSDVidaCobranca05FatoParcelasVidaUpdate = DataStageOperator(
        task_id='SSDVidaCobranca05FatoParcelasVidaUpdate',
        project=PROJECT_NAME,
        job_name='SSDVidaCobranca05FatoParcelasVidaUpdate',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaCobranca05FatoParcelasVidaUpdate = PythonOperator(
        task_id='log_end_SSDVidaCobranca05FatoParcelasVidaUpdate',
        python_callable=log_end,
        op_kwargs={"job_name": 'SSDVidaCobranca05FatoParcelasVidaUpdate', "task_key": 'SSDVidaCobranca05FatoParcelasVidaUpdate', "upstream_task_id": 'SSDVidaCobranca05FatoParcelasVidaUpdate'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SSDVidaCobranca02Union01 >> t_job_SSDVidaCobranca02Union01 >> t_end_SSDVidaCobranca02Union01

    [t_end_SSDVidaCobranca01DimeEndosFin, t_end_SsdVidaCobranca03DimeParcelasBilhete] >> t_wait_Aguarda_Dimensao

    t_end_SSDVidaCobranca02Union01 >> t_start_SSDVidaCobranca02Union02 >> t_job_SSDVidaCobranca02Union02 >> t_end_SSDVidaCobranca02Union02

    t_end_SSDVidaCobranca02Union02 >> t_start_SSDVidaCobranca01DimeEndosFin >> t_job_SSDVidaCobranca01DimeEndosFin >> t_end_SSDVidaCobranca01DimeEndosFin

    t_end_SSDVidaCobranca02Union02 >> t_start_SsdVidaCobranca03DimeParcelasBilhete >> t_job_SsdVidaCobranca03DimeParcelasBilhete >> t_end_SsdVidaCobranca03DimeParcelasBilhete

    t_wait_Aguarda_Dimensao >> t_start_SsdVidaCobranca03DimeParcelasVida >> t_job_SsdVidaCobranca03DimeParcelasVida >> t_end_SsdVidaCobranca03DimeParcelasVida

    t_end_SsdVidaCobranca03DimeParcelasVida >> t_start_SSDVidaCobranca04Dados1Bilhete >> t_job_SSDVidaCobranca04Dados1Bilhete >> t_end_SSDVidaCobranca04Dados1Bilhete

    t_end_SSDVidaCobranca04Dados1Bilhete >> t_start_SSDVidaCobranca04Dados1Vida >> t_job_SSDVidaCobranca04Dados1Vida >> t_end_SSDVidaCobranca04Dados1Vida

    t_end_SSDVidaCobranca04Dados1Vida >> t_start_SSDVidaCobranca01BaixaProcessamentoCobranca >> t_job_SSDVidaCobranca01BaixaProcessamentoCobranca >> t_end_SSDVidaCobranca01BaixaProcessamentoCobranca

    t_end_SSDVidaCobranca01BaixaProcessamentoCobranca >> t_start_SSDVidaCobranca04DimeProcessamentoCobranca >> t_job_SSDVidaCobranca04DimeProcessamentoCobranca >> t_end_SSDVidaCobranca04DimeProcessamentoCobranca

    t_end_SSDVidaCobranca04DimeProcessamentoCobranca >> t_start_SSDVidaCobranca05FatoParcelasBilhete >> t_job_SSDVidaCobranca05FatoParcelasBilhete >> t_end_SSDVidaCobranca05FatoParcelasBilhete

    t_end_SSDVidaCobranca05FatoParcelasBilhete >> t_start_SSDVidaCobranca05FatoParcelasVidaInsert >> t_job_SSDVidaCobranca05FatoParcelasVidaInsert >> t_end_SSDVidaCobranca05FatoParcelasVidaInsert

    t_end_SSDVidaCobranca05FatoParcelasVidaInsert >> t_start_SSDVidaCobranca05FatoParcelasVidaUpdate >> t_job_SSDVidaCobranca05FatoParcelasVidaUpdate >> t_end_SSDVidaCobranca05FatoParcelasVidaUpdate

    end_tasks = [t_end_SSDVidaCobranca02Union01, t_end_SSDVidaCobranca02Union02, t_end_SSDVidaCobranca01DimeEndosFin, t_end_SsdVidaCobranca03DimeParcelasBilhete, t_end_SsdVidaCobranca03DimeParcelasVida, t_end_SSDVidaCobranca04Dados1Bilhete, t_end_SSDVidaCobranca04Dados1Vida, t_end_SSDVidaCobranca01BaixaProcessamentoCobranca, t_end_SSDVidaCobranca04DimeProcessamentoCobranca, t_end_SSDVidaCobranca05FatoParcelasBilhete, t_end_SSDVidaCobranca05FatoParcelasVidaInsert, t_end_SSDVidaCobranca05FatoParcelasVidaUpdate]

    [t_end_SSDVidaCobranca02Union01, t_end_SSDVidaCobranca02Union02, t_end_SSDVidaCobranca01DimeEndosFin, t_end_SsdVidaCobranca03DimeParcelasBilhete, t_end_SsdVidaCobranca03DimeParcelasVida, t_end_SSDVidaCobranca04Dados1Bilhete, t_end_SSDVidaCobranca04Dados1Vida, t_end_SSDVidaCobranca01BaixaProcessamentoCobranca, t_end_SSDVidaCobranca04DimeProcessamentoCobranca, t_end_SSDVidaCobranca05FatoParcelasBilhete, t_end_SSDVidaCobranca05FatoParcelasVidaInsert, t_end_SSDVidaCobranca05FatoParcelasVidaUpdate] >> t_publish_dataset

    [t_end_SSDVidaCobranca02Union01, t_end_SSDVidaCobranca02Union02, t_end_SSDVidaCobranca01DimeEndosFin, t_end_SsdVidaCobranca03DimeParcelasBilhete, t_end_SsdVidaCobranca03DimeParcelasVida, t_end_SSDVidaCobranca04Dados1Bilhete, t_end_SSDVidaCobranca04Dados1Vida, t_end_SSDVidaCobranca01BaixaProcessamentoCobranca, t_end_SSDVidaCobranca04DimeProcessamentoCobranca, t_end_SSDVidaCobranca05FatoParcelasBilhete, t_end_SSDVidaCobranca05FatoParcelasVidaInsert, t_end_SSDVidaCobranca05FatoParcelasVidaUpdate] >> t_teams_error

    [t_end_SSDVidaCobranca02Union01, t_end_SSDVidaCobranca02Union02, t_end_SSDVidaCobranca01DimeEndosFin, t_end_SsdVidaCobranca03DimeParcelasBilhete, t_end_SsdVidaCobranca03DimeParcelasVida, t_end_SSDVidaCobranca04Dados1Bilhete, t_end_SSDVidaCobranca04Dados1Vida, t_end_SSDVidaCobranca01BaixaProcessamentoCobranca, t_end_SSDVidaCobranca04DimeProcessamentoCobranca, t_end_SSDVidaCobranca05FatoParcelasBilhete, t_end_SSDVidaCobranca05FatoParcelasVidaInsert, t_end_SSDVidaCobranca05FatoParcelasVidaUpdate] >> t_reg_falha

    t_wait_Aguarda_Dimensao >> t_publish_dataset

    t_wait_Aguarda_Dimensao >> t_teams_error

    t_wait_Aguarda_Dimensao >> t_reg_falha
