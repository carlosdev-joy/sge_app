...
# Pipeline: DATASTAGE_CIRCULAR_612_DIARIO | Projeto: BI_VIDA | Dominio: SUSEP
# =========================
DAG_ID        = "DATASTAGE_CIRCULAR_612_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "SUSEP"
PIPELINE_NAME = "DATASTAGE_CIRCULAR_612_DIARIO"
...
HORARIOS_ESPECIFICOS = ['13:00']
DATASET_URI   = "orq://pipeline/DATASTAGE_CIRCULAR_612_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SsdVidaCargaCircular612']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_CIRCULAR_612_DIARIO - BI_VIDA / SUSEP",
    start_date=pendulum.datetime(2026, 6, 15, tz=LOCAL_TZ),
    schedule="0 13 * * 1,2,3,4,5",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'SUSEP', 'DATASTAGE', 'CIRCULAR_612', 'DIARIO'],
) as dag:
    ...
    t_start_SsdVidaCargaCircular612 = PythonOperator(
        task_id="log_start_SsdVidaCargaCircular612",
        python_callable=log_start,
        op_kwargs={"job_name": "SsdVidaCargaCircular612", "task_key": "SsdVidaCargaCircular612"},
    )

    t_job_SsdVidaCargaCircular612 = DataStageOperator(
        task_id="SsdVidaCargaCircular612",
        project=PROJECT_NAME,
        job_name="SsdVidaCargaCircular612",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCargaCircular612 = PythonOperator(
        task_id="log_end_SsdVidaCargaCircular612",
        python_callable=log_end,
        op_kwargs={"job_name": "SsdVidaCargaCircular612", "task_key": "SsdVidaCargaCircular612", "upstream_task_id": "SsdVidaCargaCircular612"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SsdVidaCargaCircular612 >> t_teams_start >> t_job_SsdVidaCargaCircular612 >> t_end_SsdVidaCargaCircular612

    end_tasks = [t_end_SsdVidaCargaCircular612]

    [t_end_SsdVidaCargaCircular612] >> t_publish_dataset

    [t_end_SsdVidaCargaCircular612] >> t_teams_end

    [t_end_SsdVidaCargaCircular612] >> t_teams_error
