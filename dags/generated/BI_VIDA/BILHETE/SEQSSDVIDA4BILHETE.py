...
# Pipeline: SEQSSDVIDA4BILHETE | Projeto: BI_VIDA | Dominio: BILHETE
# =========================
DAG_ID        = "SEQSSDVIDA4BILHETE"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "BILHETE"
PIPELINE_NAME = "SEQSSDVIDA4BILHETE"
...
DATASET_URI   = "orq://pipeline/SEQSSDVIDA4BILHETE"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['Aguarda_carga_fatos', 'SsdVidaBilhete05Dados1', 'SsdVidaBilhete05Dados2', 'SsdVidaBilhete06FatoPropostaInsert', 'SsdVidaBilhete06FatoPropostaUpdate', 'SsdVidaBilhete07FatoVendas', 'SsdVidaBilhete08FatoContrato', 'SsdVidaBilhete09FatoPessoaContrato', 'SsdVidaBilhete10FatoCancelamentoInsert', 'SsdVidaBilhete10FatoCancelamentoUpdate', 'SsdVidaBilhete10FatoCancelamentoDelete']
FLOW_JOBS     = ['SsdVidaBilhete05Dados1', 'SsdVidaBilhete05Dados2', 'SsdVidaBilhete06FatoPropostaInsert', 'SsdVidaBilhete06FatoPropostaUpdate', 'SsdVidaBilhete07FatoVendas', 'SsdVidaBilhete08FatoContrato', 'SsdVidaBilhete09FatoPessoaContrato', 'SsdVidaBilhete10FatoCancelamentoInsert', 'SsdVidaBilhete10FatoCancelamentoUpdate', 'SsdVidaBilhete10FatoCancelamentoDelete']
RESTRICAO_DIA = None
...
with DAG(
    ...
    description="Pipeline SEQSSDVIDA4BILHETE - BI_VIDA / BILHETE",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule=None,  # dependente: o gatilho e o disparo dos predecessores
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'BILHETE', 'VIDA', 'GERAL'],
) as dag:
    ...
    t_start_SsdVidaBilhete05Dados1 = _LogStart(
        task_id='log_start_SsdVidaBilhete05Dados1',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete05Dados1', "task_key": 'SsdVidaBilhete05Dados1'},
    )

    t_job_SsdVidaBilhete05Dados1 = DataStageOperator(
        task_id='SsdVidaBilhete05Dados1',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete05Dados1',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete05Dados1 = PythonOperator(
        task_id='log_end_SsdVidaBilhete05Dados1',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete05Dados1', "task_key": 'SsdVidaBilhete05Dados1', "upstream_task_id": 'SsdVidaBilhete05Dados1'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete05Dados2 = _LogStart(
        task_id='log_start_SsdVidaBilhete05Dados2',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete05Dados2', "task_key": 'SsdVidaBilhete05Dados2'},
    )

    t_job_SsdVidaBilhete05Dados2 = DataStageOperator(
        task_id='SsdVidaBilhete05Dados2',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete05Dados2',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete05Dados2 = PythonOperator(
        task_id='log_end_SsdVidaBilhete05Dados2',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete05Dados2', "task_key": 'SsdVidaBilhete05Dados2', "upstream_task_id": 'SsdVidaBilhete05Dados2'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete06FatoPropostaInsert = _LogStart(
        task_id='log_start_SsdVidaBilhete06FatoPropostaInsert',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete06FatoPropostaInsert', "task_key": 'SsdVidaBilhete06FatoPropostaInsert'},
    )

    t_job_SsdVidaBilhete06FatoPropostaInsert = DataStageOperator(
        task_id='SsdVidaBilhete06FatoPropostaInsert',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete06FatoPropostaInsert',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete06FatoPropostaInsert = PythonOperator(
        task_id='log_end_SsdVidaBilhete06FatoPropostaInsert',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete06FatoPropostaInsert', "task_key": 'SsdVidaBilhete06FatoPropostaInsert', "upstream_task_id": 'SsdVidaBilhete06FatoPropostaInsert'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete06FatoPropostaUpdate = _LogStart(
        task_id='log_start_SsdVidaBilhete06FatoPropostaUpdate',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete06FatoPropostaUpdate', "task_key": 'SsdVidaBilhete06FatoPropostaUpdate'},
    )

    t_job_SsdVidaBilhete06FatoPropostaUpdate = DataStageOperator(
        task_id='SsdVidaBilhete06FatoPropostaUpdate',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete06FatoPropostaUpdate',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete06FatoPropostaUpdate = PythonOperator(
        task_id='log_end_SsdVidaBilhete06FatoPropostaUpdate',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete06FatoPropostaUpdate', "task_key": 'SsdVidaBilhete06FatoPropostaUpdate', "upstream_task_id": 'SsdVidaBilhete06FatoPropostaUpdate'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete07FatoVendas = _LogStart(
        task_id='log_start_SsdVidaBilhete07FatoVendas',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete07FatoVendas', "task_key": 'SsdVidaBilhete07FatoVendas'},
    )

    t_job_SsdVidaBilhete07FatoVendas = DataStageOperator(
        task_id='SsdVidaBilhete07FatoVendas',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete07FatoVendas',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete07FatoVendas = PythonOperator(
        task_id='log_end_SsdVidaBilhete07FatoVendas',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete07FatoVendas', "task_key": 'SsdVidaBilhete07FatoVendas', "upstream_task_id": 'SsdVidaBilhete07FatoVendas'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete08FatoContrato = _LogStart(
        task_id='log_start_SsdVidaBilhete08FatoContrato',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete08FatoContrato', "task_key": 'SsdVidaBilhete08FatoContrato'},
    )

    t_job_SsdVidaBilhete08FatoContrato = DataStageOperator(
        task_id='SsdVidaBilhete08FatoContrato',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete08FatoContrato',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete08FatoContrato = PythonOperator(
        task_id='log_end_SsdVidaBilhete08FatoContrato',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete08FatoContrato', "task_key": 'SsdVidaBilhete08FatoContrato', "upstream_task_id": 'SsdVidaBilhete08FatoContrato'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete09FatoPessoaContrato = _LogStart(
        task_id='log_start_SsdVidaBilhete09FatoPessoaContrato',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete09FatoPessoaContrato', "task_key": 'SsdVidaBilhete09FatoPessoaContrato'},
    )

    t_job_SsdVidaBilhete09FatoPessoaContrato = DataStageOperator(
        task_id='SsdVidaBilhete09FatoPessoaContrato',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete09FatoPessoaContrato',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete09FatoPessoaContrato = PythonOperator(
        task_id='log_end_SsdVidaBilhete09FatoPessoaContrato',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete09FatoPessoaContrato', "task_key": 'SsdVidaBilhete09FatoPessoaContrato', "upstream_task_id": 'SsdVidaBilhete09FatoPessoaContrato'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete10FatoCancelamentoInsert = _LogStart(
        task_id='log_start_SsdVidaBilhete10FatoCancelamentoInsert',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete10FatoCancelamentoInsert', "task_key": 'SsdVidaBilhete10FatoCancelamentoInsert'},
    )

    t_job_SsdVidaBilhete10FatoCancelamentoInsert = DataStageOperator(
        task_id='SsdVidaBilhete10FatoCancelamentoInsert',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete10FatoCancelamentoInsert',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete10FatoCancelamentoInsert = PythonOperator(
        task_id='log_end_SsdVidaBilhete10FatoCancelamentoInsert',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete10FatoCancelamentoInsert', "task_key": 'SsdVidaBilhete10FatoCancelamentoInsert', "upstream_task_id": 'SsdVidaBilhete10FatoCancelamentoInsert'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete10FatoCancelamentoUpdate = _LogStart(
        task_id='log_start_SsdVidaBilhete10FatoCancelamentoUpdate',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete10FatoCancelamentoUpdate', "task_key": 'SsdVidaBilhete10FatoCancelamentoUpdate'},
    )

    t_job_SsdVidaBilhete10FatoCancelamentoUpdate = DataStageOperator(
        task_id='SsdVidaBilhete10FatoCancelamentoUpdate',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete10FatoCancelamentoUpdate',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete10FatoCancelamentoUpdate = PythonOperator(
        task_id='log_end_SsdVidaBilhete10FatoCancelamentoUpdate',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete10FatoCancelamentoUpdate', "task_key": 'SsdVidaBilhete10FatoCancelamentoUpdate', "upstream_task_id": 'SsdVidaBilhete10FatoCancelamentoUpdate'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete10FatoCancelamentoDelete = _LogStart(
        task_id='log_start_SsdVidaBilhete10FatoCancelamentoDelete',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete10FatoCancelamentoDelete', "task_key": 'SsdVidaBilhete10FatoCancelamentoDelete'},
    )

    t_job_SsdVidaBilhete10FatoCancelamentoDelete = DataStageOperator(
        task_id='SsdVidaBilhete10FatoCancelamentoDelete',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete10FatoCancelamentoDelete',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete10FatoCancelamentoDelete = PythonOperator(
        task_id='log_end_SsdVidaBilhete10FatoCancelamentoDelete',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete10FatoCancelamentoDelete', "task_key": 'SsdVidaBilhete10FatoCancelamentoDelete', "upstream_task_id": 'SsdVidaBilhete10FatoCancelamentoDelete'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    [t_end_SsdVidaBilhete06FatoPropostaUpdate, t_end_SsdVidaBilhete10FatoCancelamentoDelete, t_end_SsdVidaBilhete07FatoVendas, t_end_SsdVidaBilhete08FatoContrato, t_end_SsdVidaBilhete09FatoPessoaContrato] >> t_wait_Aguarda_carga_fatos

    t_check_agenda >> t_start_SsdVidaBilhete05Dados1 >> t_job_SsdVidaBilhete05Dados1 >> t_end_SsdVidaBilhete05Dados1

    t_end_SsdVidaBilhete05Dados1 >> t_start_SsdVidaBilhete05Dados2 >> t_job_SsdVidaBilhete05Dados2 >> t_end_SsdVidaBilhete05Dados2

    t_end_SsdVidaBilhete05Dados2 >> t_start_SsdVidaBilhete06FatoPropostaInsert >> t_job_SsdVidaBilhete06FatoPropostaInsert >> t_end_SsdVidaBilhete06FatoPropostaInsert

    t_end_SsdVidaBilhete06FatoPropostaInsert >> t_start_SsdVidaBilhete06FatoPropostaUpdate >> t_job_SsdVidaBilhete06FatoPropostaUpdate >> t_end_SsdVidaBilhete06FatoPropostaUpdate

    t_end_SsdVidaBilhete05Dados2 >> t_start_SsdVidaBilhete07FatoVendas >> t_job_SsdVidaBilhete07FatoVendas >> t_end_SsdVidaBilhete07FatoVendas

    t_end_SsdVidaBilhete05Dados2 >> t_start_SsdVidaBilhete08FatoContrato >> t_job_SsdVidaBilhete08FatoContrato >> t_end_SsdVidaBilhete08FatoContrato

    t_end_SsdVidaBilhete05Dados2 >> t_start_SsdVidaBilhete09FatoPessoaContrato >> t_job_SsdVidaBilhete09FatoPessoaContrato >> t_end_SsdVidaBilhete09FatoPessoaContrato

    t_end_SsdVidaBilhete05Dados2 >> t_start_SsdVidaBilhete10FatoCancelamentoInsert >> t_job_SsdVidaBilhete10FatoCancelamentoInsert >> t_end_SsdVidaBilhete10FatoCancelamentoInsert

    t_end_SsdVidaBilhete10FatoCancelamentoInsert >> t_start_SsdVidaBilhete10FatoCancelamentoUpdate >> t_job_SsdVidaBilhete10FatoCancelamentoUpdate >> t_end_SsdVidaBilhete10FatoCancelamentoUpdate

    t_end_SsdVidaBilhete10FatoCancelamentoUpdate >> t_start_SsdVidaBilhete10FatoCancelamentoDelete >> t_job_SsdVidaBilhete10FatoCancelamentoDelete >> t_end_SsdVidaBilhete10FatoCancelamentoDelete

    end_tasks = [t_end_SsdVidaBilhete05Dados1, t_end_SsdVidaBilhete05Dados2, t_end_SsdVidaBilhete06FatoPropostaInsert, t_end_SsdVidaBilhete06FatoPropostaUpdate, t_end_SsdVidaBilhete07FatoVendas, t_end_SsdVidaBilhete08FatoContrato, t_end_SsdVidaBilhete09FatoPessoaContrato, t_end_SsdVidaBilhete10FatoCancelamentoInsert, t_end_SsdVidaBilhete10FatoCancelamentoUpdate, t_end_SsdVidaBilhete10FatoCancelamentoDelete]

    [t_end_SsdVidaBilhete05Dados1, t_end_SsdVidaBilhete05Dados2, t_end_SsdVidaBilhete06FatoPropostaInsert, t_end_SsdVidaBilhete06FatoPropostaUpdate, t_end_SsdVidaBilhete07FatoVendas, t_end_SsdVidaBilhete08FatoContrato, t_end_SsdVidaBilhete09FatoPessoaContrato, t_end_SsdVidaBilhete10FatoCancelamentoInsert, t_end_SsdVidaBilhete10FatoCancelamentoUpdate, t_end_SsdVidaBilhete10FatoCancelamentoDelete] >> t_publish_dataset

    [t_end_SsdVidaBilhete05Dados1, t_end_SsdVidaBilhete05Dados2, t_end_SsdVidaBilhete06FatoPropostaInsert, t_end_SsdVidaBilhete06FatoPropostaUpdate, t_end_SsdVidaBilhete07FatoVendas, t_end_SsdVidaBilhete08FatoContrato, t_end_SsdVidaBilhete09FatoPessoaContrato, t_end_SsdVidaBilhete10FatoCancelamentoInsert, t_end_SsdVidaBilhete10FatoCancelamentoUpdate, t_end_SsdVidaBilhete10FatoCancelamentoDelete] >> t_teams_error

    [t_end_SsdVidaBilhete05Dados1, t_end_SsdVidaBilhete05Dados2, t_end_SsdVidaBilhete06FatoPropostaInsert, t_end_SsdVidaBilhete06FatoPropostaUpdate, t_end_SsdVidaBilhete07FatoVendas, t_end_SsdVidaBilhete08FatoContrato, t_end_SsdVidaBilhete09FatoPessoaContrato, t_end_SsdVidaBilhete10FatoCancelamentoInsert, t_end_SsdVidaBilhete10FatoCancelamentoUpdate, t_end_SsdVidaBilhete10FatoCancelamentoDelete] >> t_reg_falha
