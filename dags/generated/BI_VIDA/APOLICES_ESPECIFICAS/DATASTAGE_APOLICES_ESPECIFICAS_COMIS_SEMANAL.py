...
# Pipeline: DATASTAGE_APOLICES_ESPECIFICAS_COMIS_SEMANAL | Projeto: BI_VIDA | Dominio: APOLICES_ESPECIFICAS
# =========================
DAG_ID        = "DATASTAGE_APOLICES_ESPECIFICAS_COMIS_SEMANAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "APOLICES_ESPECIFICAS"
PIPELINE_NAME = "DATASTAGE_APOLICES_ESPECIFICAS_COMIS_SEMANAL"
...
HORARIOS_ESPECIFICOS = ['06:05']
DATASET_URI   = "orq://pipeline/DATASTAGE_APOLICES_ESPECIFICAS_COMIS_SEMANAL"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SsdVidaSeqCargaApoliceEspecificaComis']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_APOLICES_ESPECIFICAS_COMIS_SEMANAL - BI_VIDA / APOLICES_ESPECIFICAS",
    start_date=pendulum.datetime(2026, 6, 15, tz=LOCAL_TZ),
    schedule="5 6 * * 1,3,5",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'APOLICES_ESPECIFICAS', 'DATASTAGE', 'SEMANAL'],
) as dag:
    ...
    t_start_SsdVidaSeqCargaApoliceEspecificaComis = PythonOperator(
        task_id="log_start_SsdVidaSeqCargaApoliceEspecificaComis",
        python_callable=log_start,
        op_kwargs={"job_name": "SsdVidaSeqCargaApoliceEspecificaComis", "task_key": "SsdVidaSeqCargaApoliceEspecificaComis"},
    )

    t_job_SsdVidaSeqCargaApoliceEspecificaComis = DataStageOperator(
        task_id="SsdVidaSeqCargaApoliceEspecificaComis",
        project=PROJECT_NAME,
        job_name="SsdVidaSeqCargaApoliceEspecificaComis",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaSeqCargaApoliceEspecificaComis = PythonOperator(
        task_id="log_end_SsdVidaSeqCargaApoliceEspecificaComis",
        python_callable=log_end,
        op_kwargs={"job_name": "SsdVidaSeqCargaApoliceEspecificaComis", "task_key": "SsdVidaSeqCargaApoliceEspecificaComis", "upstream_task_id": "SsdVidaSeqCargaApoliceEspecificaComis"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SsdVidaSeqCargaApoliceEspecificaComis >> t_teams_start >> t_job_SsdVidaSeqCargaApoliceEspecificaComis >> t_end_SsdVidaSeqCargaApoliceEspecificaComis

    end_tasks = [t_end_SsdVidaSeqCargaApoliceEspecificaComis]

    [t_end_SsdVidaSeqCargaApoliceEspecificaComis] >> t_publish_dataset

    [t_end_SsdVidaSeqCargaApoliceEspecificaComis] >> t_teams_end

    [t_end_SsdVidaSeqCargaApoliceEspecificaComis] >> t_teams_error
