...
# Pipeline: DATASTAGE_APOLICES_ESPECIFICAS_MENSAL | Projeto: BI_VIDA | Dominio: APOLICES_ESPECIFICAS
# =========================
DAG_ID        = "DATASTAGE_APOLICES_ESPECIFICAS_MENSAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "APOLICES_ESPECIFICAS"
PIPELINE_NAME = "DATASTAGE_APOLICES_ESPECIFICAS_MENSAL"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_APOLICES_ESPECIFICAS_MENSAL - BI_VIDA / APOLICES_ESPECIFICAS",
    start_date=pendulum.datetime(2026, 7, 5, tz=LOCAL_TZ),
    schedule="3 11 5 * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'APOLICES_ESPECIFICAS', 'DATASTAGE', 'MENSAL'],
) as dag:
    ...
    t_start_SeqSsdVidaExecAPOE = PythonOperator(
        task_id="log_start_SeqSsdVidaExecAPOE",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqSsdVidaExecAPOE", "task_key": "SeqSsdVidaExecAPOE"},
    )

    t_job_SeqSsdVidaExecAPOE = DataStageOperator(
        task_id="SeqSsdVidaExecAPOE",
        project=PROJECT_NAME,
        job_name="SeqSsdVidaExecAPOE",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqSsdVidaExecAPOE = PythonOperator(
        task_id="log_end_SeqSsdVidaExecAPOE",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqSsdVidaExecAPOE", "task_key": "SeqSsdVidaExecAPOE", "upstream_task_id": "SeqSsdVidaExecAPOE"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqSsdVidaExecAPOE >> t_teams_start >> t_job_SeqSsdVidaExecAPOE >> t_end_SeqSsdVidaExecAPOE

    end_tasks = [t_end_SeqSsdVidaExecAPOE]

    [t_end_SeqSsdVidaExecAPOE] >> t_publish_dataset

    [t_end_SeqSsdVidaExecAPOE] >> t_teams_end

    [t_end_SeqSsdVidaExecAPOE] >> t_teams_error
