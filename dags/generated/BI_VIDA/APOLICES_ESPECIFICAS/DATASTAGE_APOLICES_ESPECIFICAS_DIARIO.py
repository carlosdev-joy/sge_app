...
# Pipeline: DATASTAGE_APOLICES_ESPECIFICAS_DIARIO | Projeto: BI_VIDA | Dominio: APOLICES_ESPECIFICAS
# =========================
DAG_ID        = "DATASTAGE_APOLICES_ESPECIFICAS_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "APOLICES_ESPECIFICAS"
PIPELINE_NAME = "DATASTAGE_APOLICES_ESPECIFICAS_DIARIO"
...
HORARIOS_ESPECIFICOS = ['14:05']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/DATASTAGE_APOLICES_ESPECIFICAS_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqSsdVidaExecDiariaApolicesEspecificas']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_APOLICES_ESPECIFICAS_DIARIO - BI_VIDA / APOLICES_ESPECIFICAS",
    start_date=pendulum.datetime(2026, 6, 15, tz=LOCAL_TZ),
    schedule="5 14 * * 1,2,3,4,5,6",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'APOLICES_ESPECIFICAS', 'DATASTAGE', 'DIARIO'],
) as dag:
    ...
    t_start_SeqSsdVidaExecDiariaApolicesEspecificas = PythonOperator(
        task_id="log_start_SeqSsdVidaExecDiariaApolicesEspecificas",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqSsdVidaExecDiariaApolicesEspecificas", "task_key": "SeqSsdVidaExecDiariaApolicesEspecificas"},
    )

    t_job_SeqSsdVidaExecDiariaApolicesEspecificas = DataStageOperator(
        task_id="SeqSsdVidaExecDiariaApolicesEspecificas",
        project=PROJECT_NAME,
        job_name="SeqSsdVidaExecDiariaApolicesEspecificas",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqSsdVidaExecDiariaApolicesEspecificas = PythonOperator(
        task_id="log_end_SeqSsdVidaExecDiariaApolicesEspecificas",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqSsdVidaExecDiariaApolicesEspecificas", "task_key": "SeqSsdVidaExecDiariaApolicesEspecificas", "upstream_task_id": "SeqSsdVidaExecDiariaApolicesEspecificas"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqSsdVidaExecDiariaApolicesEspecificas >> t_teams_start >> t_job_SeqSsdVidaExecDiariaApolicesEspecificas >> t_end_SeqSsdVidaExecDiariaApolicesEspecificas

    end_tasks = [t_end_SeqSsdVidaExecDiariaApolicesEspecificas]

    [t_end_SeqSsdVidaExecDiariaApolicesEspecificas] >> t_publish_dataset

    [t_end_SeqSsdVidaExecDiariaApolicesEspecificas] >> t_teams_end

    [t_end_SeqSsdVidaExecDiariaApolicesEspecificas] >> t_teams_error
