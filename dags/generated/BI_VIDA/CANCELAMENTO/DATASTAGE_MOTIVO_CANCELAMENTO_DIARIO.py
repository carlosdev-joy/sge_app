...
# Pipeline: DATASTAGE_MOTIVO_CANCELAMENTO_DIARIO | Projeto: BI_VIDA | Dominio: CANCELAMENTO
# =========================
DAG_ID        = "DATASTAGE_MOTIVO_CANCELAMENTO_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "CANCELAMENTO"
PIPELINE_NAME = "DATASTAGE_MOTIVO_CANCELAMENTO_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_MOTIVO_CANCELAMENTO_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SSDVidaSeqMotivoCancelamento']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_MOTIVO_CANCELAMENTO_DIARIO - BI_VIDA / CANCELAMENTO",
    start_date=pendulum.datetime(2026, 6, 15, tz=LOCAL_TZ),
    schedule="0 17 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'CANCELAMENTO', 'DATASTAGE', 'DIARIO'],
) as dag:
    ...
    t_start_SSDVidaSeqMotivoCancelamento = PythonOperator(
        task_id="log_start_SSDVidaSeqMotivoCancelamento",
        python_callable=log_start,
        op_kwargs={"job_name": "SSDVidaSeqMotivoCancelamento", "task_key": "SSDVidaSeqMotivoCancelamento"},
    )

    t_job_SSDVidaSeqMotivoCancelamento = DataStageOperator(
        task_id="SSDVidaSeqMotivoCancelamento",
        project=PROJECT_NAME,
        job_name="SSDVidaSeqMotivoCancelamento",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaSeqMotivoCancelamento = PythonOperator(
        task_id="log_end_SSDVidaSeqMotivoCancelamento",
        python_callable=log_end,
        op_kwargs={"job_name": "SSDVidaSeqMotivoCancelamento", "task_key": "SSDVidaSeqMotivoCancelamento", "upstream_task_id": "SSDVidaSeqMotivoCancelamento"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SSDVidaSeqMotivoCancelamento >> t_teams_start >> t_job_SSDVidaSeqMotivoCancelamento >> t_end_SSDVidaSeqMotivoCancelamento

    end_tasks = [t_end_SSDVidaSeqMotivoCancelamento]

    [t_end_SSDVidaSeqMotivoCancelamento] >> t_publish_dataset

    [t_end_SSDVidaSeqMotivoCancelamento] >> t_teams_end

    [t_end_SSDVidaSeqMotivoCancelamento] >> t_teams_error
