...
# Pipeline: SEQSSDVIDA7PEPS | Projeto: BI_VIDA | Dominio: PEPS
# =========================
DAG_ID        = "SEQSSDVIDA7PEPS"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "PEPS"
PIPELINE_NAME = "SEQSSDVIDA7PEPS"
...
DATASET_URI   = "orq://pipeline/SEQSSDVIDA7PEPS"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['Aguarda_Cargas', 'SsdVidaPeps01GetArq', 'SsdVidaPeps02DimePessoa01', 'SsdVidaPeps02DimePessoa02', 'SsdVidaPeps02DimePessoa03', 'SsdVidaPeps03ExtraiCancelamentos', 'SsdVidaPeps03ExtraiPropostas', 'SsdVidaPeps03ExtraiSinistros', 'SsdVidaPeps04FatoAcompTodosDiario']
FLOW_JOBS     = ['SsdVidaPeps01GetArq', 'SsdVidaPeps02DimePessoa01', 'SsdVidaPeps02DimePessoa02', 'SsdVidaPeps02DimePessoa03', 'SsdVidaPeps03ExtraiCancelamentos', 'SsdVidaPeps03ExtraiPropostas', 'SsdVidaPeps03ExtraiSinistros', 'SsdVidaPeps04FatoAcompTodosDiario']
RESTRICAO_DIA = None
...
with DAG(
    ...
    description="Pipeline SEQSSDVIDA7PEPS - BI_VIDA / PEPS",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule=None,  # dependente: o gatilho e o disparo dos predecessores
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'PEPS', 'VIDA', 'GERAL'],
) as dag:
    ...
    t_wait_Aguarda_Cargas = EmptyOperator(
        task_id='Aguarda_Cargas',
        trigger_rule=TriggerRule.ALL_SUCCESS,
    )

    t_start_SsdVidaPeps01GetArq = _LogStart(
        task_id='log_start_SsdVidaPeps01GetArq',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaPeps01GetArq', "task_key": 'SsdVidaPeps01GetArq'},
    )

    t_job_SsdVidaPeps01GetArq = DataStageOperator(
        task_id='SsdVidaPeps01GetArq',
        project=PROJECT_NAME,
        job_name='SsdVidaPeps01GetArq',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaPeps01GetArq = PythonOperator(
        task_id='log_end_SsdVidaPeps01GetArq',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaPeps01GetArq', "task_key": 'SsdVidaPeps01GetArq', "upstream_task_id": 'SsdVidaPeps01GetArq'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaPeps02DimePessoa01 = _LogStart(
        task_id='log_start_SsdVidaPeps02DimePessoa01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaPeps02DimePessoa01', "task_key": 'SsdVidaPeps02DimePessoa01'},
    )

    t_job_SsdVidaPeps02DimePessoa01 = DataStageOperator(
        task_id='SsdVidaPeps02DimePessoa01',
        project=PROJECT_NAME,
        job_name='SsdVidaPeps02DimePessoa01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaPeps02DimePessoa01 = PythonOperator(
        task_id='log_end_SsdVidaPeps02DimePessoa01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaPeps02DimePessoa01', "task_key": 'SsdVidaPeps02DimePessoa01', "upstream_task_id": 'SsdVidaPeps02DimePessoa01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaPeps02DimePessoa02 = _LogStart(
        task_id='log_start_SsdVidaPeps02DimePessoa02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaPeps02DimePessoa02', "task_key": 'SsdVidaPeps02DimePessoa02'},
    )

    t_job_SsdVidaPeps02DimePessoa02 = DataStageOperator(
        task_id='SsdVidaPeps02DimePessoa02',
        project=PROJECT_NAME,
        job_name='SsdVidaPeps02DimePessoa02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaPeps02DimePessoa02 = PythonOperator(
        task_id='log_end_SsdVidaPeps02DimePessoa02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaPeps02DimePessoa02', "task_key": 'SsdVidaPeps02DimePessoa02', "upstream_task_id": 'SsdVidaPeps02DimePessoa02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaPeps02DimePessoa03 = _LogStart(
        task_id='log_start_SsdVidaPeps02DimePessoa03',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaPeps02DimePessoa03', "task_key": 'SsdVidaPeps02DimePessoa03'},
    )

    t_job_SsdVidaPeps02DimePessoa03 = DataStageOperator(
        task_id='SsdVidaPeps02DimePessoa03',
        project=PROJECT_NAME,
        job_name='SsdVidaPeps02DimePessoa03',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaPeps02DimePessoa03 = PythonOperator(
        task_id='log_end_SsdVidaPeps02DimePessoa03',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaPeps02DimePessoa03', "task_key": 'SsdVidaPeps02DimePessoa03', "upstream_task_id": 'SsdVidaPeps02DimePessoa03'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaPeps03ExtraiCancelamentos = _LogStart(
        task_id='log_start_SsdVidaPeps03ExtraiCancelamentos',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaPeps03ExtraiCancelamentos', "task_key": 'SsdVidaPeps03ExtraiCancelamentos'},
    )

    t_job_SsdVidaPeps03ExtraiCancelamentos = DataStageOperator(
        task_id='SsdVidaPeps03ExtraiCancelamentos',
        project=PROJECT_NAME,
        job_name='SsdVidaPeps03ExtraiCancelamentos',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaPeps03ExtraiCancelamentos = PythonOperator(
        task_id='log_end_SsdVidaPeps03ExtraiCancelamentos',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaPeps03ExtraiCancelamentos', "task_key": 'SsdVidaPeps03ExtraiCancelamentos', "upstream_task_id": 'SsdVidaPeps03ExtraiCancelamentos'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaPeps03ExtraiPropostas = _LogStart(
        task_id='log_start_SsdVidaPeps03ExtraiPropostas',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaPeps03ExtraiPropostas', "task_key": 'SsdVidaPeps03ExtraiPropostas'},
    )

    t_job_SsdVidaPeps03ExtraiPropostas = DataStageOperator(
        task_id='SsdVidaPeps03ExtraiPropostas',
        project=PROJECT_NAME,
        job_name='SsdVidaPeps03ExtraiPropostas',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaPeps03ExtraiPropostas = PythonOperator(
        task_id='log_end_SsdVidaPeps03ExtraiPropostas',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaPeps03ExtraiPropostas', "task_key": 'SsdVidaPeps03ExtraiPropostas', "upstream_task_id": 'SsdVidaPeps03ExtraiPropostas'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaPeps03ExtraiSinistros = _LogStart(
        task_id='log_start_SsdVidaPeps03ExtraiSinistros',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaPeps03ExtraiSinistros', "task_key": 'SsdVidaPeps03ExtraiSinistros'},
    )

    t_job_SsdVidaPeps03ExtraiSinistros = DataStageOperator(
        task_id='SsdVidaPeps03ExtraiSinistros',
        project=PROJECT_NAME,
        job_name='SsdVidaPeps03ExtraiSinistros',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaPeps03ExtraiSinistros = PythonOperator(
        task_id='log_end_SsdVidaPeps03ExtraiSinistros',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaPeps03ExtraiSinistros', "task_key": 'SsdVidaPeps03ExtraiSinistros', "upstream_task_id": 'SsdVidaPeps03ExtraiSinistros'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaPeps04FatoAcompTodosDiario = _LogStart(
        task_id='log_start_SsdVidaPeps04FatoAcompTodosDiario',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaPeps04FatoAcompTodosDiario', "task_key": 'SsdVidaPeps04FatoAcompTodosDiario'},
    )

    t_job_SsdVidaPeps04FatoAcompTodosDiario = DataStageOperator(
        task_id='SsdVidaPeps04FatoAcompTodosDiario',
        project=PROJECT_NAME,
        job_name='SsdVidaPeps04FatoAcompTodosDiario',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaPeps04FatoAcompTodosDiario = PythonOperator(
        task_id='log_end_SsdVidaPeps04FatoAcompTodosDiario',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaPeps04FatoAcompTodosDiario', "task_key": 'SsdVidaPeps04FatoAcompTodosDiario', "upstream_task_id": 'SsdVidaPeps04FatoAcompTodosDiario'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    [t_end_SsdVidaPeps02DimePessoa03, t_end_SsdVidaPeps03ExtraiCancelamentos, t_end_SsdVidaPeps03ExtraiPropostas, t_end_SsdVidaPeps03ExtraiSinistros] >> t_wait_Aguarda_Cargas

    t_check_agenda >> t_start_SsdVidaPeps01GetArq >> t_job_SsdVidaPeps01GetArq >> t_end_SsdVidaPeps01GetArq

    t_end_SsdVidaPeps01GetArq >> t_start_SsdVidaPeps02DimePessoa01 >> t_job_SsdVidaPeps02DimePessoa01 >> t_end_SsdVidaPeps02DimePessoa01

    t_end_SsdVidaPeps02DimePessoa01 >> t_start_SsdVidaPeps02DimePessoa02 >> t_job_SsdVidaPeps02DimePessoa02 >> t_end_SsdVidaPeps02DimePessoa02

    t_end_SsdVidaPeps02DimePessoa02 >> t_start_SsdVidaPeps02DimePessoa03 >> t_job_SsdVidaPeps02DimePessoa03 >> t_end_SsdVidaPeps02DimePessoa03

    t_check_agenda >> t_start_SsdVidaPeps03ExtraiCancelamentos >> t_job_SsdVidaPeps03ExtraiCancelamentos >> t_end_SsdVidaPeps03ExtraiCancelamentos

    t_check_agenda >> t_start_SsdVidaPeps03ExtraiPropostas >> t_job_SsdVidaPeps03ExtraiPropostas >> t_end_SsdVidaPeps03ExtraiPropostas

    t_check_agenda >> t_start_SsdVidaPeps03ExtraiSinistros >> t_job_SsdVidaPeps03ExtraiSinistros >> t_end_SsdVidaPeps03ExtraiSinistros

    t_wait_Aguarda_Cargas >> t_start_SsdVidaPeps04FatoAcompTodosDiario >> t_job_SsdVidaPeps04FatoAcompTodosDiario >> t_end_SsdVidaPeps04FatoAcompTodosDiario

    end_tasks = [t_end_SsdVidaPeps01GetArq, t_end_SsdVidaPeps02DimePessoa01, t_end_SsdVidaPeps02DimePessoa02, t_end_SsdVidaPeps02DimePessoa03, t_end_SsdVidaPeps03ExtraiCancelamentos, t_end_SsdVidaPeps03ExtraiPropostas, t_end_SsdVidaPeps03ExtraiSinistros, t_end_SsdVidaPeps04FatoAcompTodosDiario]

    [t_end_SsdVidaPeps01GetArq, t_end_SsdVidaPeps02DimePessoa01, t_end_SsdVidaPeps02DimePessoa02, t_end_SsdVidaPeps02DimePessoa03, t_end_SsdVidaPeps03ExtraiCancelamentos, t_end_SsdVidaPeps03ExtraiPropostas, t_end_SsdVidaPeps03ExtraiSinistros, t_end_SsdVidaPeps04FatoAcompTodosDiario] >> t_publish_dataset

    [t_end_SsdVidaPeps01GetArq, t_end_SsdVidaPeps02DimePessoa01, t_end_SsdVidaPeps02DimePessoa02, t_end_SsdVidaPeps02DimePessoa03, t_end_SsdVidaPeps03ExtraiCancelamentos, t_end_SsdVidaPeps03ExtraiPropostas, t_end_SsdVidaPeps03ExtraiSinistros, t_end_SsdVidaPeps04FatoAcompTodosDiario] >> t_teams_error

    [t_end_SsdVidaPeps01GetArq, t_end_SsdVidaPeps02DimePessoa01, t_end_SsdVidaPeps02DimePessoa02, t_end_SsdVidaPeps02DimePessoa03, t_end_SsdVidaPeps03ExtraiCancelamentos, t_end_SsdVidaPeps03ExtraiPropostas, t_end_SsdVidaPeps03ExtraiSinistros, t_end_SsdVidaPeps04FatoAcompTodosDiario] >> t_reg_falha

    t_wait_Aguarda_Cargas >> t_publish_dataset

    t_wait_Aguarda_Cargas >> t_teams_error

    t_wait_Aguarda_Cargas >> t_reg_falha
