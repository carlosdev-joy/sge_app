...
# Pipeline: SEQSSDVIDA1DIMEINCREMENTALSINISTRO | Projeto: BI_VIDA | Dominio: DIMENSOES
# =========================
DAG_ID        = "SEQSSDVIDA1DIMEINCREMENTALSINISTRO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "DIMENSOES"
PIPELINE_NAME = "SEQSSDVIDA1DIMEINCREMENTALSINISTRO"
...
DATASET_URI   = "orq://pipeline/SEQSSDVIDA1DIMEINCREMENTALSINISTRO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['AGUARDE_1', 'AGUARDE_2', 'SsdVidaDimeSinistro01InfoBasicasProtocolos', 'SsdVidaDimeSinistro04ValoresPremioIsProtocolos', 'SsdVidaDimeSinistro05', 'SsdVidaDimeOcorrenciaSinistro01', 'SsdVidaDimeOcorrenciaSinistro02', 'SsdVidaDimeSinistro01InfoBasicas', 'SsdVidaDimeSinistro02ValoresAteMesAnterior', 'SsdVidaDimeSinistro03ValoresDePendente', 'SsdVidaDimeSinistro04ValoresPremioIs', 'SsdVidaDimeCobertura01Basicas', 'SsdVidaDimeCobertura02Acessorios', 'SsdVidaDimeCobertura03', 'SsdVidaDimeCausaSinistro01', 'SsdVidaDimeCausaSinistro02', 'SsdVidaDimeAgenteRegulacao01', 'SsdVidaDimeAgenteRegulacao02', 'SsdVidaDimeReclamanteSinistro', 'SsdVidaDimeOperSinistro01TD047', 'SsdVidaDimeOperSinistro02TD043', 'SsdVidaDimeOperSinistro03', 'SsdVidaDimeOperSinistro04FileSet']
FLOW_JOBS     = ['SsdVidaDimeSinistro01InfoBasicasProtocolos', 'SsdVidaDimeSinistro04ValoresPremioIsProtocolos', 'SsdVidaDimeSinistro05', 'SsdVidaDimeOcorrenciaSinistro01', 'SsdVidaDimeOcorrenciaSinistro02', 'SsdVidaDimeSinistro01InfoBasicas', 'SsdVidaDimeSinistro02ValoresAteMesAnterior', 'SsdVidaDimeSinistro03ValoresDePendente', 'SsdVidaDimeSinistro04ValoresPremioIs', 'SsdVidaDimeCobertura01Basicas', 'SsdVidaDimeCobertura02Acessorios', 'SsdVidaDimeCobertura03', 'SsdVidaDimeCausaSinistro01', 'SsdVidaDimeCausaSinistro02', 'SsdVidaDimeAgenteRegulacao01', 'SsdVidaDimeAgenteRegulacao02', 'SsdVidaDimeReclamanteSinistro', 'SsdVidaDimeOperSinistro01TD047', 'SsdVidaDimeOperSinistro02TD043', 'SsdVidaDimeOperSinistro03', 'SsdVidaDimeOperSinistro04FileSet']
...
with DAG(
    ...
    description="Pipeline SEQSSDVIDA1DIMEINCREMENTALSINISTRO - BI_VIDA / DIMENSOES",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule="10 1 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'DIMENSOES', 'SINISTRO', 'VIDA', 'GERAL'],
) as dag:
    ...
    t_start_SsdVidaDimeSinistro01InfoBasicasProtocolos = _LogStart(
        task_id='log_start_SsdVidaDimeSinistro01InfoBasicasProtocolos',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro01InfoBasicasProtocolos', "task_key": 'SsdVidaDimeSinistro01InfoBasicasProtocolos'},
    )

    t_job_SsdVidaDimeSinistro01InfoBasicasProtocolos = DataStageOperator(
        task_id='SsdVidaDimeSinistro01InfoBasicasProtocolos',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeSinistro01InfoBasicasProtocolos',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeSinistro01InfoBasicasProtocolos = PythonOperator(
        task_id='log_end_SsdVidaDimeSinistro01InfoBasicasProtocolos',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro01InfoBasicasProtocolos', "task_key": 'SsdVidaDimeSinistro01InfoBasicasProtocolos', "upstream_task_id": 'SsdVidaDimeSinistro01InfoBasicasProtocolos'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeSinistro04ValoresPremioIsProtocolos = _LogStart(
        task_id='log_start_SsdVidaDimeSinistro04ValoresPremioIsProtocolos',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro04ValoresPremioIsProtocolos', "task_key": 'SsdVidaDimeSinistro04ValoresPremioIsProtocolos'},
    )

    t_job_SsdVidaDimeSinistro04ValoresPremioIsProtocolos = DataStageOperator(
        task_id='SsdVidaDimeSinistro04ValoresPremioIsProtocolos',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeSinistro04ValoresPremioIsProtocolos',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeSinistro04ValoresPremioIsProtocolos = PythonOperator(
        task_id='log_end_SsdVidaDimeSinistro04ValoresPremioIsProtocolos',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro04ValoresPremioIsProtocolos', "task_key": 'SsdVidaDimeSinistro04ValoresPremioIsProtocolos', "upstream_task_id": 'SsdVidaDimeSinistro04ValoresPremioIsProtocolos'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeSinistro05 = _LogStart(
        task_id='log_start_SsdVidaDimeSinistro05',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro05', "task_key": 'SsdVidaDimeSinistro05'},
    )

    t_job_SsdVidaDimeSinistro05 = DataStageOperator(
        task_id='SsdVidaDimeSinistro05',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeSinistro05',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeSinistro05 = PythonOperator(
        task_id='log_end_SsdVidaDimeSinistro05',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro05', "task_key": 'SsdVidaDimeSinistro05', "upstream_task_id": 'SsdVidaDimeSinistro05'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeOcorrenciaSinistro01 = _LogStart(
        task_id='log_start_SsdVidaDimeOcorrenciaSinistro01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeOcorrenciaSinistro01', "task_key": 'SsdVidaDimeOcorrenciaSinistro01'},
    )

    t_job_SsdVidaDimeOcorrenciaSinistro01 = DataStageOperator(
        task_id='SsdVidaDimeOcorrenciaSinistro01',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeOcorrenciaSinistro01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeOcorrenciaSinistro01 = PythonOperator(
        task_id='log_end_SsdVidaDimeOcorrenciaSinistro01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeOcorrenciaSinistro01', "task_key": 'SsdVidaDimeOcorrenciaSinistro01', "upstream_task_id": 'SsdVidaDimeOcorrenciaSinistro01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeOcorrenciaSinistro02 = _LogStart(
        task_id='log_start_SsdVidaDimeOcorrenciaSinistro02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeOcorrenciaSinistro02', "task_key": 'SsdVidaDimeOcorrenciaSinistro02'},
    )

    t_job_SsdVidaDimeOcorrenciaSinistro02 = DataStageOperator(
        task_id='SsdVidaDimeOcorrenciaSinistro02',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeOcorrenciaSinistro02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeOcorrenciaSinistro02 = PythonOperator(
        task_id='log_end_SsdVidaDimeOcorrenciaSinistro02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeOcorrenciaSinistro02', "task_key": 'SsdVidaDimeOcorrenciaSinistro02', "upstream_task_id": 'SsdVidaDimeOcorrenciaSinistro02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeSinistro01InfoBasicas = _LogStart(
        task_id='log_start_SsdVidaDimeSinistro01InfoBasicas',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro01InfoBasicas', "task_key": 'SsdVidaDimeSinistro01InfoBasicas'},
    )

    t_job_SsdVidaDimeSinistro01InfoBasicas = DataStageOperator(
        task_id='SsdVidaDimeSinistro01InfoBasicas',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeSinistro01InfoBasicas',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeSinistro01InfoBasicas = PythonOperator(
        task_id='log_end_SsdVidaDimeSinistro01InfoBasicas',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro01InfoBasicas', "task_key": 'SsdVidaDimeSinistro01InfoBasicas', "upstream_task_id": 'SsdVidaDimeSinistro01InfoBasicas'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeSinistro02ValoresAteMesAnterior = _LogStart(
        task_id='log_start_SsdVidaDimeSinistro02ValoresAteMesAnterior',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro02ValoresAteMesAnterior', "task_key": 'SsdVidaDimeSinistro02ValoresAteMesAnterior'},
    )

    t_job_SsdVidaDimeSinistro02ValoresAteMesAnterior = DataStageOperator(
        task_id='SsdVidaDimeSinistro02ValoresAteMesAnterior',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeSinistro02ValoresAteMesAnterior',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeSinistro02ValoresAteMesAnterior = PythonOperator(
        task_id='log_end_SsdVidaDimeSinistro02ValoresAteMesAnterior',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro02ValoresAteMesAnterior', "task_key": 'SsdVidaDimeSinistro02ValoresAteMesAnterior', "upstream_task_id": 'SsdVidaDimeSinistro02ValoresAteMesAnterior'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeSinistro03ValoresDePendente = _LogStart(
        task_id='log_start_SsdVidaDimeSinistro03ValoresDePendente',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro03ValoresDePendente', "task_key": 'SsdVidaDimeSinistro03ValoresDePendente'},
    )

    t_job_SsdVidaDimeSinistro03ValoresDePendente = DataStageOperator(
        task_id='SsdVidaDimeSinistro03ValoresDePendente',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeSinistro03ValoresDePendente',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeSinistro03ValoresDePendente = PythonOperator(
        task_id='log_end_SsdVidaDimeSinistro03ValoresDePendente',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro03ValoresDePendente', "task_key": 'SsdVidaDimeSinistro03ValoresDePendente', "upstream_task_id": 'SsdVidaDimeSinistro03ValoresDePendente'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeSinistro04ValoresPremioIs = _LogStart(
        task_id='log_start_SsdVidaDimeSinistro04ValoresPremioIs',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro04ValoresPremioIs', "task_key": 'SsdVidaDimeSinistro04ValoresPremioIs'},
    )

    t_job_SsdVidaDimeSinistro04ValoresPremioIs = DataStageOperator(
        task_id='SsdVidaDimeSinistro04ValoresPremioIs',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeSinistro04ValoresPremioIs',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeSinistro04ValoresPremioIs = PythonOperator(
        task_id='log_end_SsdVidaDimeSinistro04ValoresPremioIs',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeSinistro04ValoresPremioIs', "task_key": 'SsdVidaDimeSinistro04ValoresPremioIs', "upstream_task_id": 'SsdVidaDimeSinistro04ValoresPremioIs'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeCobertura01Basicas = _LogStart(
        task_id='log_start_SsdVidaDimeCobertura01Basicas',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeCobertura01Basicas', "task_key": 'SsdVidaDimeCobertura01Basicas'},
    )

    t_job_SsdVidaDimeCobertura01Basicas = DataStageOperator(
        task_id='SsdVidaDimeCobertura01Basicas',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeCobertura01Basicas',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeCobertura01Basicas = PythonOperator(
        task_id='log_end_SsdVidaDimeCobertura01Basicas',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeCobertura01Basicas', "task_key": 'SsdVidaDimeCobertura01Basicas', "upstream_task_id": 'SsdVidaDimeCobertura01Basicas'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeCobertura02Acessorios = _LogStart(
        task_id='log_start_SsdVidaDimeCobertura02Acessorios',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeCobertura02Acessorios', "task_key": 'SsdVidaDimeCobertura02Acessorios'},
    )

    t_job_SsdVidaDimeCobertura02Acessorios = DataStageOperator(
        task_id='SsdVidaDimeCobertura02Acessorios',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeCobertura02Acessorios',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeCobertura02Acessorios = PythonOperator(
        task_id='log_end_SsdVidaDimeCobertura02Acessorios',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeCobertura02Acessorios', "task_key": 'SsdVidaDimeCobertura02Acessorios', "upstream_task_id": 'SsdVidaDimeCobertura02Acessorios'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeCobertura03 = _LogStart(
        task_id='log_start_SsdVidaDimeCobertura03',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeCobertura03', "task_key": 'SsdVidaDimeCobertura03'},
    )

    t_job_SsdVidaDimeCobertura03 = DataStageOperator(
        task_id='SsdVidaDimeCobertura03',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeCobertura03',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeCobertura03 = PythonOperator(
        task_id='log_end_SsdVidaDimeCobertura03',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeCobertura03', "task_key": 'SsdVidaDimeCobertura03', "upstream_task_id": 'SsdVidaDimeCobertura03'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeCausaSinistro01 = _LogStart(
        task_id='log_start_SsdVidaDimeCausaSinistro01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeCausaSinistro01', "task_key": 'SsdVidaDimeCausaSinistro01'},
    )

    t_job_SsdVidaDimeCausaSinistro01 = DataStageOperator(
        task_id='SsdVidaDimeCausaSinistro01',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeCausaSinistro01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeCausaSinistro01 = PythonOperator(
        task_id='log_end_SsdVidaDimeCausaSinistro01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeCausaSinistro01', "task_key": 'SsdVidaDimeCausaSinistro01', "upstream_task_id": 'SsdVidaDimeCausaSinistro01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeCausaSinistro02 = _LogStart(
        task_id='log_start_SsdVidaDimeCausaSinistro02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeCausaSinistro02', "task_key": 'SsdVidaDimeCausaSinistro02'},
    )

    t_job_SsdVidaDimeCausaSinistro02 = DataStageOperator(
        task_id='SsdVidaDimeCausaSinistro02',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeCausaSinistro02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeCausaSinistro02 = PythonOperator(
        task_id='log_end_SsdVidaDimeCausaSinistro02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeCausaSinistro02', "task_key": 'SsdVidaDimeCausaSinistro02', "upstream_task_id": 'SsdVidaDimeCausaSinistro02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeAgenteRegulacao01 = _LogStart(
        task_id='log_start_SsdVidaDimeAgenteRegulacao01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeAgenteRegulacao01', "task_key": 'SsdVidaDimeAgenteRegulacao01'},
    )

    t_job_SsdVidaDimeAgenteRegulacao01 = DataStageOperator(
        task_id='SsdVidaDimeAgenteRegulacao01',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeAgenteRegulacao01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeAgenteRegulacao01 = PythonOperator(
        task_id='log_end_SsdVidaDimeAgenteRegulacao01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeAgenteRegulacao01', "task_key": 'SsdVidaDimeAgenteRegulacao01', "upstream_task_id": 'SsdVidaDimeAgenteRegulacao01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeAgenteRegulacao02 = _LogStart(
        task_id='log_start_SsdVidaDimeAgenteRegulacao02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeAgenteRegulacao02', "task_key": 'SsdVidaDimeAgenteRegulacao02'},
    )

    t_job_SsdVidaDimeAgenteRegulacao02 = DataStageOperator(
        task_id='SsdVidaDimeAgenteRegulacao02',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeAgenteRegulacao02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeAgenteRegulacao02 = PythonOperator(
        task_id='log_end_SsdVidaDimeAgenteRegulacao02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeAgenteRegulacao02', "task_key": 'SsdVidaDimeAgenteRegulacao02', "upstream_task_id": 'SsdVidaDimeAgenteRegulacao02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeReclamanteSinistro = _LogStart(
        task_id='log_start_SsdVidaDimeReclamanteSinistro',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeReclamanteSinistro', "task_key": 'SsdVidaDimeReclamanteSinistro'},
    )

    t_job_SsdVidaDimeReclamanteSinistro = DataStageOperator(
        task_id='SsdVidaDimeReclamanteSinistro',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeReclamanteSinistro',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeReclamanteSinistro = PythonOperator(
        task_id='log_end_SsdVidaDimeReclamanteSinistro',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeReclamanteSinistro', "task_key": 'SsdVidaDimeReclamanteSinistro', "upstream_task_id": 'SsdVidaDimeReclamanteSinistro'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeOperSinistro01TD047 = _LogStart(
        task_id='log_start_SsdVidaDimeOperSinistro01TD047',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeOperSinistro01TD047', "task_key": 'SsdVidaDimeOperSinistro01TD047'},
    )

    t_job_SsdVidaDimeOperSinistro01TD047 = DataStageOperator(
        task_id='SsdVidaDimeOperSinistro01TD047',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeOperSinistro01TD047',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeOperSinistro01TD047 = PythonOperator(
        task_id='log_end_SsdVidaDimeOperSinistro01TD047',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeOperSinistro01TD047', "task_key": 'SsdVidaDimeOperSinistro01TD047', "upstream_task_id": 'SsdVidaDimeOperSinistro01TD047'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeOperSinistro02TD043 = _LogStart(
        task_id='log_start_SsdVidaDimeOperSinistro02TD043',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeOperSinistro02TD043', "task_key": 'SsdVidaDimeOperSinistro02TD043'},
    )

    t_job_SsdVidaDimeOperSinistro02TD043 = DataStageOperator(
        task_id='SsdVidaDimeOperSinistro02TD043',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeOperSinistro02TD043',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeOperSinistro02TD043 = PythonOperator(
        task_id='log_end_SsdVidaDimeOperSinistro02TD043',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeOperSinistro02TD043', "task_key": 'SsdVidaDimeOperSinistro02TD043', "upstream_task_id": 'SsdVidaDimeOperSinistro02TD043'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeOperSinistro03 = _LogStart(
        task_id='log_start_SsdVidaDimeOperSinistro03',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeOperSinistro03', "task_key": 'SsdVidaDimeOperSinistro03'},
    )

    t_job_SsdVidaDimeOperSinistro03 = DataStageOperator(
        task_id='SsdVidaDimeOperSinistro03',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeOperSinistro03',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeOperSinistro03 = PythonOperator(
        task_id='log_end_SsdVidaDimeOperSinistro03',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeOperSinistro03', "task_key": 'SsdVidaDimeOperSinistro03', "upstream_task_id": 'SsdVidaDimeOperSinistro03'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeOperSinistro04FileSet = _LogStart(
        task_id='log_start_SsdVidaDimeOperSinistro04FileSet',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeOperSinistro04FileSet', "task_key": 'SsdVidaDimeOperSinistro04FileSet'},
    )

    t_job_SsdVidaDimeOperSinistro04FileSet = DataStageOperator(
        task_id='SsdVidaDimeOperSinistro04FileSet',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeOperSinistro04FileSet',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeOperSinistro04FileSet = PythonOperator(
        task_id='log_end_SsdVidaDimeOperSinistro04FileSet',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeOperSinistro04FileSet', "task_key": 'SsdVidaDimeOperSinistro04FileSet', "upstream_task_id": 'SsdVidaDimeOperSinistro04FileSet'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    [t_end_SsdVidaDimeSinistro04ValoresPremioIsProtocolos, t_end_SsdVidaDimeSinistro04ValoresPremioIs] >> t_wait_AGUARDE_1

    [t_end_SsdVidaDimeSinistro05, t_end_SsdVidaDimeCobertura03, t_end_SsdVidaDimeCausaSinistro02, t_end_SsdVidaDimeReclamanteSinistro, t_end_SsdVidaDimeOperSinistro04FileSet] >> t_wait_AGUARDE_2

    t_check_agenda >> t_start_SsdVidaDimeSinistro01InfoBasicasProtocolos >> t_job_SsdVidaDimeSinistro01InfoBasicasProtocolos >> t_end_SsdVidaDimeSinistro01InfoBasicasProtocolos

    t_end_SsdVidaDimeSinistro01InfoBasicasProtocolos >> t_start_SsdVidaDimeSinistro04ValoresPremioIsProtocolos >> t_job_SsdVidaDimeSinistro04ValoresPremioIsProtocolos >> t_end_SsdVidaDimeSinistro04ValoresPremioIsProtocolos

    t_wait_AGUARDE_1 >> t_start_SsdVidaDimeSinistro05 >> t_job_SsdVidaDimeSinistro05 >> t_end_SsdVidaDimeSinistro05

    t_wait_AGUARDE_2 >> t_start_SsdVidaDimeOcorrenciaSinistro01 >> t_job_SsdVidaDimeOcorrenciaSinistro01 >> t_end_SsdVidaDimeOcorrenciaSinistro01

    t_end_SsdVidaDimeOcorrenciaSinistro01 >> t_start_SsdVidaDimeOcorrenciaSinistro02 >> t_job_SsdVidaDimeOcorrenciaSinistro02 >> t_end_SsdVidaDimeOcorrenciaSinistro02

    t_check_agenda >> t_start_SsdVidaDimeSinistro01InfoBasicas >> t_job_SsdVidaDimeSinistro01InfoBasicas >> t_end_SsdVidaDimeSinistro01InfoBasicas

    t_end_SsdVidaDimeSinistro01InfoBasicas >> t_start_SsdVidaDimeSinistro02ValoresAteMesAnterior >> t_job_SsdVidaDimeSinistro02ValoresAteMesAnterior >> t_end_SsdVidaDimeSinistro02ValoresAteMesAnterior

    t_end_SsdVidaDimeSinistro02ValoresAteMesAnterior >> t_start_SsdVidaDimeSinistro03ValoresDePendente >> t_job_SsdVidaDimeSinistro03ValoresDePendente >> t_end_SsdVidaDimeSinistro03ValoresDePendente

    t_end_SsdVidaDimeSinistro03ValoresDePendente >> t_start_SsdVidaDimeSinistro04ValoresPremioIs >> t_job_SsdVidaDimeSinistro04ValoresPremioIs >> t_end_SsdVidaDimeSinistro04ValoresPremioIs

    t_check_agenda >> t_start_SsdVidaDimeCobertura01Basicas >> t_job_SsdVidaDimeCobertura01Basicas >> t_end_SsdVidaDimeCobertura01Basicas

    t_end_SsdVidaDimeCobertura01Basicas >> t_start_SsdVidaDimeCobertura02Acessorios >> t_job_SsdVidaDimeCobertura02Acessorios >> t_end_SsdVidaDimeCobertura02Acessorios

    t_end_SsdVidaDimeCobertura02Acessorios >> t_start_SsdVidaDimeCobertura03 >> t_job_SsdVidaDimeCobertura03 >> t_end_SsdVidaDimeCobertura03

    t_check_agenda >> t_start_SsdVidaDimeCausaSinistro01 >> t_job_SsdVidaDimeCausaSinistro01 >> t_end_SsdVidaDimeCausaSinistro01

    t_end_SsdVidaDimeCausaSinistro01 >> t_start_SsdVidaDimeCausaSinistro02 >> t_job_SsdVidaDimeCausaSinistro02 >> t_end_SsdVidaDimeCausaSinistro02

    t_check_agenda >> t_start_SsdVidaDimeAgenteRegulacao01 >> t_job_SsdVidaDimeAgenteRegulacao01 >> t_end_SsdVidaDimeAgenteRegulacao01

    t_end_SsdVidaDimeAgenteRegulacao01 >> t_start_SsdVidaDimeAgenteRegulacao02 >> t_job_SsdVidaDimeAgenteRegulacao02 >> t_end_SsdVidaDimeAgenteRegulacao02

    t_end_SsdVidaDimeAgenteRegulacao02 >> t_start_SsdVidaDimeReclamanteSinistro >> t_job_SsdVidaDimeReclamanteSinistro >> t_end_SsdVidaDimeReclamanteSinistro

    t_check_agenda >> t_start_SsdVidaDimeOperSinistro01TD047 >> t_job_SsdVidaDimeOperSinistro01TD047 >> t_end_SsdVidaDimeOperSinistro01TD047

    t_end_SsdVidaDimeOperSinistro01TD047 >> t_start_SsdVidaDimeOperSinistro02TD043 >> t_job_SsdVidaDimeOperSinistro02TD043 >> t_end_SsdVidaDimeOperSinistro02TD043

    t_end_SsdVidaDimeOperSinistro02TD043 >> t_start_SsdVidaDimeOperSinistro03 >> t_job_SsdVidaDimeOperSinistro03 >> t_end_SsdVidaDimeOperSinistro03

    t_end_SsdVidaDimeOperSinistro03 >> t_start_SsdVidaDimeOperSinistro04FileSet >> t_job_SsdVidaDimeOperSinistro04FileSet >> t_end_SsdVidaDimeOperSinistro04FileSet

    end_tasks = [t_end_SsdVidaDimeSinistro01InfoBasicasProtocolos, t_end_SsdVidaDimeSinistro04ValoresPremioIsProtocolos, t_end_SsdVidaDimeSinistro05, t_end_SsdVidaDimeOcorrenciaSinistro01, t_end_SsdVidaDimeOcorrenciaSinistro02, t_end_SsdVidaDimeSinistro01InfoBasicas, t_end_SsdVidaDimeSinistro02ValoresAteMesAnterior, t_end_SsdVidaDimeSinistro03ValoresDePendente, t_end_SsdVidaDimeSinistro04ValoresPremioIs, t_end_SsdVidaDimeCobertura01Basicas, t_end_SsdVidaDimeCobertura02Acessorios, t_end_SsdVidaDimeCobertura03, t_end_SsdVidaDimeCausaSinistro01, t_end_SsdVidaDimeCausaSinistro02, t_end_SsdVidaDimeAgenteRegulacao01, t_end_SsdVidaDimeAgenteRegulacao02, t_end_SsdVidaDimeReclamanteSinistro, t_end_SsdVidaDimeOperSinistro01TD047, t_end_SsdVidaDimeOperSinistro02TD043, t_end_SsdVidaDimeOperSinistro03, t_end_SsdVidaDimeOperSinistro04FileSet]

    [t_end_SsdVidaDimeSinistro01InfoBasicasProtocolos, t_end_SsdVidaDimeSinistro04ValoresPremioIsProtocolos, t_end_SsdVidaDimeSinistro05, t_end_SsdVidaDimeOcorrenciaSinistro01, t_end_SsdVidaDimeOcorrenciaSinistro02, t_end_SsdVidaDimeSinistro01InfoBasicas, t_end_SsdVidaDimeSinistro02ValoresAteMesAnterior, t_end_SsdVidaDimeSinistro03ValoresDePendente, t_end_SsdVidaDimeSinistro04ValoresPremioIs, t_end_SsdVidaDimeCobertura01Basicas, t_end_SsdVidaDimeCobertura02Acessorios, t_end_SsdVidaDimeCobertura03, t_end_SsdVidaDimeCausaSinistro01, t_end_SsdVidaDimeCausaSinistro02, t_end_SsdVidaDimeAgenteRegulacao01, t_end_SsdVidaDimeAgenteRegulacao02, t_end_SsdVidaDimeReclamanteSinistro, t_end_SsdVidaDimeOperSinistro01TD047, t_end_SsdVidaDimeOperSinistro02TD043, t_end_SsdVidaDimeOperSinistro03, t_end_SsdVidaDimeOperSinistro04FileSet] >> t_publish_dataset

    [t_end_SsdVidaDimeSinistro01InfoBasicasProtocolos, t_end_SsdVidaDimeSinistro04ValoresPremioIsProtocolos, t_end_SsdVidaDimeSinistro05, t_end_SsdVidaDimeOcorrenciaSinistro01, t_end_SsdVidaDimeOcorrenciaSinistro02, t_end_SsdVidaDimeSinistro01InfoBasicas, t_end_SsdVidaDimeSinistro02ValoresAteMesAnterior, t_end_SsdVidaDimeSinistro03ValoresDePendente, t_end_SsdVidaDimeSinistro04ValoresPremioIs, t_end_SsdVidaDimeCobertura01Basicas, t_end_SsdVidaDimeCobertura02Acessorios, t_end_SsdVidaDimeCobertura03, t_end_SsdVidaDimeCausaSinistro01, t_end_SsdVidaDimeCausaSinistro02, t_end_SsdVidaDimeAgenteRegulacao01, t_end_SsdVidaDimeAgenteRegulacao02, t_end_SsdVidaDimeReclamanteSinistro, t_end_SsdVidaDimeOperSinistro01TD047, t_end_SsdVidaDimeOperSinistro02TD043, t_end_SsdVidaDimeOperSinistro03, t_end_SsdVidaDimeOperSinistro04FileSet] >> t_teams_error

    [t_end_SsdVidaDimeSinistro01InfoBasicasProtocolos, t_end_SsdVidaDimeSinistro04ValoresPremioIsProtocolos, t_end_SsdVidaDimeSinistro05, t_end_SsdVidaDimeOcorrenciaSinistro01, t_end_SsdVidaDimeOcorrenciaSinistro02, t_end_SsdVidaDimeSinistro01InfoBasicas, t_end_SsdVidaDimeSinistro02ValoresAteMesAnterior, t_end_SsdVidaDimeSinistro03ValoresDePendente, t_end_SsdVidaDimeSinistro04ValoresPremioIs, t_end_SsdVidaDimeCobertura01Basicas, t_end_SsdVidaDimeCobertura02Acessorios, t_end_SsdVidaDimeCobertura03, t_end_SsdVidaDimeCausaSinistro01, t_end_SsdVidaDimeCausaSinistro02, t_end_SsdVidaDimeAgenteRegulacao01, t_end_SsdVidaDimeAgenteRegulacao02, t_end_SsdVidaDimeReclamanteSinistro, t_end_SsdVidaDimeOperSinistro01TD047, t_end_SsdVidaDimeOperSinistro02TD043, t_end_SsdVidaDimeOperSinistro03, t_end_SsdVidaDimeOperSinistro04FileSet] >> t_reg_falha
