...
# Pipeline: SEQSSDVIDA2BAIXADADOS | Projeto: BI_VIDA | Dominio: DIMENSOES
# =========================
DAG_ID        = "SEQSSDVIDA2BAIXADADOS"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "DIMENSOES"
PIPELINE_NAME = "SEQSSDVIDA2BAIXADADOS"
...
DATASET_URI   = "orq://pipeline/SEQSSDVIDA2BAIXADADOS"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['Aguarda_Dim2', 'AGUARDE_1', 'Dimensao_Contrato', 'Prop_Bil', 'SsdVida01BaixaContrato', 'SsdVida02DimeContrato', 'SsdVidaBilhete01Baixa', 'SsdVidaBilhete02DimeProposta', 'SsdVidaBilhete03DimeContrato', 'SsdVidaBilhete04JuntaDados', 'SsdVida01BaixaProposta', 'SsdVida02DimeProposta', 'SsdVida01BaixaPropostaVgap', 'SsdVida02DimePropostaVgap', 'SsdVidaCobertura01BilheteBaixa', 'SsdVidaCobertura02VidaBaixa', 'SsdVidaDimeBeneficiario01', 'SsdVidaDimeErros01', 'SsdVidaCobertura04DimeBilhete', 'SsdVidaCobertura03SegVgapBaixa', 'SsdVidaDimeBeneficiario02', 'SsdVidaDimeErros02', 'SsdVidaCobertura05DimeVida', 'SsdVidaExtracaoReplicaHistCta']
FLOW_JOBS     = ['SsdVida01BaixaContrato', 'SsdVida02DimeContrato', 'SsdVidaBilhete01Baixa', 'SsdVidaBilhete02DimeProposta', 'SsdVidaBilhete03DimeContrato', 'SsdVidaBilhete04JuntaDados', 'SsdVida01BaixaProposta', 'SsdVida02DimeProposta', 'SsdVida01BaixaPropostaVgap', 'SsdVida02DimePropostaVgap', 'SsdVidaCobertura01BilheteBaixa', 'SsdVidaCobertura02VidaBaixa', 'SsdVidaDimeBeneficiario01', 'SsdVidaDimeErros01', 'SsdVidaCobertura04DimeBilhete', 'SsdVidaCobertura03SegVgapBaixa', 'SsdVidaDimeBeneficiario02', 'SsdVidaDimeErros02', 'SsdVidaCobertura05DimeVida', 'SsdVidaExtracaoReplicaHistCta']
...
with DAG(
    ...
    description="Pipeline SEQSSDVIDA2BAIXADADOS - BI_VIDA / DIMENSOES",
    ...
    t_wait_Aguarda_Dim2 = EmptyOperator(
        task_id='Aguarda_Dim2',
    ...
    t_wait_Dimensao_Contrato = EmptyOperator(
        task_id='Dimensao_Contrato',
        trigger_rule=TriggerRule.ALL_SUCCESS,
    )

    t_wait_Prop_Bil = EmptyOperator(
        task_id='Prop_Bil',
        trigger_rule=TriggerRule.ALL_SUCCESS,
    )

    t_start_SsdVida01BaixaContrato = _LogStart(
        task_id='log_start_SsdVida01BaixaContrato',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida01BaixaContrato', "task_key": 'SsdVida01BaixaContrato'},
    )

    t_job_SsdVida01BaixaContrato = DataStageOperator(
        task_id='SsdVida01BaixaContrato',
        project=PROJECT_NAME,
        job_name='SsdVida01BaixaContrato',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida01BaixaContrato = PythonOperator(
        task_id='log_end_SsdVida01BaixaContrato',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida01BaixaContrato', "task_key": 'SsdVida01BaixaContrato', "upstream_task_id": 'SsdVida01BaixaContrato'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida02DimeContrato = _LogStart(
        task_id='log_start_SsdVida02DimeContrato',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida02DimeContrato', "task_key": 'SsdVida02DimeContrato'},
    )

    t_job_SsdVida02DimeContrato = DataStageOperator(
        task_id='SsdVida02DimeContrato',
        project=PROJECT_NAME,
        job_name='SsdVida02DimeContrato',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida02DimeContrato = PythonOperator(
        task_id='log_end_SsdVida02DimeContrato',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida02DimeContrato', "task_key": 'SsdVida02DimeContrato', "upstream_task_id": 'SsdVida02DimeContrato'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete01Baixa = _LogStart(
        task_id='log_start_SsdVidaBilhete01Baixa',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete01Baixa', "task_key": 'SsdVidaBilhete01Baixa'},
    )

    t_job_SsdVidaBilhete01Baixa = DataStageOperator(
        task_id='SsdVidaBilhete01Baixa',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete01Baixa',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete01Baixa = PythonOperator(
        task_id='log_end_SsdVidaBilhete01Baixa',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete01Baixa', "task_key": 'SsdVidaBilhete01Baixa', "upstream_task_id": 'SsdVidaBilhete01Baixa'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete02DimeProposta = _LogStart(
        task_id='log_start_SsdVidaBilhete02DimeProposta',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete02DimeProposta', "task_key": 'SsdVidaBilhete02DimeProposta'},
    )

    t_job_SsdVidaBilhete02DimeProposta = DataStageOperator(
        task_id='SsdVidaBilhete02DimeProposta',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete02DimeProposta',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete02DimeProposta = PythonOperator(
        task_id='log_end_SsdVidaBilhete02DimeProposta',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete02DimeProposta', "task_key": 'SsdVidaBilhete02DimeProposta', "upstream_task_id": 'SsdVidaBilhete02DimeProposta'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete03DimeContrato = _LogStart(
        task_id='log_start_SsdVidaBilhete03DimeContrato',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete03DimeContrato', "task_key": 'SsdVidaBilhete03DimeContrato'},
    )

    t_job_SsdVidaBilhete03DimeContrato = DataStageOperator(
        task_id='SsdVidaBilhete03DimeContrato',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete03DimeContrato',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete03DimeContrato = PythonOperator(
        task_id='log_end_SsdVidaBilhete03DimeContrato',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete03DimeContrato', "task_key": 'SsdVidaBilhete03DimeContrato', "upstream_task_id": 'SsdVidaBilhete03DimeContrato'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaBilhete04JuntaDados = _LogStart(
        task_id='log_start_SsdVidaBilhete04JuntaDados',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaBilhete04JuntaDados', "task_key": 'SsdVidaBilhete04JuntaDados'},
    )

    t_job_SsdVidaBilhete04JuntaDados = DataStageOperator(
        task_id='SsdVidaBilhete04JuntaDados',
        project=PROJECT_NAME,
        job_name='SsdVidaBilhete04JuntaDados',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaBilhete04JuntaDados = PythonOperator(
        task_id='log_end_SsdVidaBilhete04JuntaDados',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaBilhete04JuntaDados', "task_key": 'SsdVidaBilhete04JuntaDados', "upstream_task_id": 'SsdVidaBilhete04JuntaDados'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida01BaixaProposta = _LogStart(
        task_id='log_start_SsdVida01BaixaProposta',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida01BaixaProposta', "task_key": 'SsdVida01BaixaProposta'},
    )

    t_job_SsdVida01BaixaProposta = DataStageOperator(
        task_id='SsdVida01BaixaProposta',
        project=PROJECT_NAME,
        job_name='SsdVida01BaixaProposta',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida01BaixaProposta = PythonOperator(
        task_id='log_end_SsdVida01BaixaProposta',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida01BaixaProposta', "task_key": 'SsdVida01BaixaProposta', "upstream_task_id": 'SsdVida01BaixaProposta'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida02DimeProposta = _LogStart(
        task_id='log_start_SsdVida02DimeProposta',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida02DimeProposta', "task_key": 'SsdVida02DimeProposta'},
    )

    t_job_SsdVida02DimeProposta = DataStageOperator(
        task_id='SsdVida02DimeProposta',
        project=PROJECT_NAME,
        job_name='SsdVida02DimeProposta',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida02DimeProposta = PythonOperator(
        task_id='log_end_SsdVida02DimeProposta',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida02DimeProposta', "task_key": 'SsdVida02DimeProposta', "upstream_task_id": 'SsdVida02DimeProposta'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida01BaixaPropostaVgap = _LogStart(
        task_id='log_start_SsdVida01BaixaPropostaVgap',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida01BaixaPropostaVgap', "task_key": 'SsdVida01BaixaPropostaVgap'},
    )

    t_job_SsdVida01BaixaPropostaVgap = DataStageOperator(
        task_id='SsdVida01BaixaPropostaVgap',
        project=PROJECT_NAME,
        job_name='SsdVida01BaixaPropostaVgap',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida01BaixaPropostaVgap = PythonOperator(
        task_id='log_end_SsdVida01BaixaPropostaVgap',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida01BaixaPropostaVgap', "task_key": 'SsdVida01BaixaPropostaVgap', "upstream_task_id": 'SsdVida01BaixaPropostaVgap'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVida02DimePropostaVgap = _LogStart(
        task_id='log_start_SsdVida02DimePropostaVgap',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVida02DimePropostaVgap', "task_key": 'SsdVida02DimePropostaVgap'},
    )

    t_job_SsdVida02DimePropostaVgap = DataStageOperator(
        task_id='SsdVida02DimePropostaVgap',
        project=PROJECT_NAME,
        job_name='SsdVida02DimePropostaVgap',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVida02DimePropostaVgap = PythonOperator(
        task_id='log_end_SsdVida02DimePropostaVgap',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVida02DimePropostaVgap', "task_key": 'SsdVida02DimePropostaVgap', "upstream_task_id": 'SsdVida02DimePropostaVgap'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaCobertura01BilheteBaixa = _LogStart(
        task_id='log_start_SsdVidaCobertura01BilheteBaixa',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaCobertura01BilheteBaixa', "task_key": 'SsdVidaCobertura01BilheteBaixa'},
    )

    t_job_SsdVidaCobertura01BilheteBaixa = DataStageOperator(
        task_id='SsdVidaCobertura01BilheteBaixa',
        project=PROJECT_NAME,
        job_name='SsdVidaCobertura01BilheteBaixa',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCobertura01BilheteBaixa = PythonOperator(
        task_id='log_end_SsdVidaCobertura01BilheteBaixa',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaCobertura01BilheteBaixa', "task_key": 'SsdVidaCobertura01BilheteBaixa', "upstream_task_id": 'SsdVidaCobertura01BilheteBaixa'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaCobertura02VidaBaixa = _LogStart(
        task_id='log_start_SsdVidaCobertura02VidaBaixa',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaCobertura02VidaBaixa', "task_key": 'SsdVidaCobertura02VidaBaixa'},
    )

    t_job_SsdVidaCobertura02VidaBaixa = DataStageOperator(
        task_id='SsdVidaCobertura02VidaBaixa',
        project=PROJECT_NAME,
        job_name='SsdVidaCobertura02VidaBaixa',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCobertura02VidaBaixa = PythonOperator(
        task_id='log_end_SsdVidaCobertura02VidaBaixa',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaCobertura02VidaBaixa', "task_key": 'SsdVidaCobertura02VidaBaixa', "upstream_task_id": 'SsdVidaCobertura02VidaBaixa'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeBeneficiario01 = _LogStart(
        task_id='log_start_SsdVidaDimeBeneficiario01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeBeneficiario01', "task_key": 'SsdVidaDimeBeneficiario01'},
    )

    t_job_SsdVidaDimeBeneficiario01 = DataStageOperator(
        task_id='SsdVidaDimeBeneficiario01',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeBeneficiario01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeBeneficiario01 = PythonOperator(
        task_id='log_end_SsdVidaDimeBeneficiario01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeBeneficiario01', "task_key": 'SsdVidaDimeBeneficiario01', "upstream_task_id": 'SsdVidaDimeBeneficiario01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeErros01 = _LogStart(
        task_id='log_start_SsdVidaDimeErros01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeErros01', "task_key": 'SsdVidaDimeErros01'},
    )

    t_job_SsdVidaDimeErros01 = DataStageOperator(
        task_id='SsdVidaDimeErros01',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeErros01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeErros01 = PythonOperator(
        task_id='log_end_SsdVidaDimeErros01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeErros01', "task_key": 'SsdVidaDimeErros01', "upstream_task_id": 'SsdVidaDimeErros01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaCobertura04DimeBilhete = _LogStart(
        task_id='log_start_SsdVidaCobertura04DimeBilhete',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaCobertura04DimeBilhete', "task_key": 'SsdVidaCobertura04DimeBilhete'},
    )

    t_job_SsdVidaCobertura04DimeBilhete = DataStageOperator(
        task_id='SsdVidaCobertura04DimeBilhete',
        project=PROJECT_NAME,
        job_name='SsdVidaCobertura04DimeBilhete',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCobertura04DimeBilhete = PythonOperator(
        task_id='log_end_SsdVidaCobertura04DimeBilhete',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaCobertura04DimeBilhete', "task_key": 'SsdVidaCobertura04DimeBilhete', "upstream_task_id": 'SsdVidaCobertura04DimeBilhete'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaCobertura03SegVgapBaixa = _LogStart(
        task_id='log_start_SsdVidaCobertura03SegVgapBaixa',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaCobertura03SegVgapBaixa', "task_key": 'SsdVidaCobertura03SegVgapBaixa'},
    )

    t_job_SsdVidaCobertura03SegVgapBaixa = DataStageOperator(
        task_id='SsdVidaCobertura03SegVgapBaixa',
        project=PROJECT_NAME,
        job_name='SsdVidaCobertura03SegVgapBaixa',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCobertura03SegVgapBaixa = PythonOperator(
        task_id='log_end_SsdVidaCobertura03SegVgapBaixa',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaCobertura03SegVgapBaixa', "task_key": 'SsdVidaCobertura03SegVgapBaixa', "upstream_task_id": 'SsdVidaCobertura03SegVgapBaixa'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeBeneficiario02 = _LogStart(
        task_id='log_start_SsdVidaDimeBeneficiario02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeBeneficiario02', "task_key": 'SsdVidaDimeBeneficiario02'},
    )

    t_job_SsdVidaDimeBeneficiario02 = DataStageOperator(
        task_id='SsdVidaDimeBeneficiario02',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeBeneficiario02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeBeneficiario02 = PythonOperator(
        task_id='log_end_SsdVidaDimeBeneficiario02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeBeneficiario02', "task_key": 'SsdVidaDimeBeneficiario02', "upstream_task_id": 'SsdVidaDimeBeneficiario02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeErros02 = _LogStart(
        task_id='log_start_SsdVidaDimeErros02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeErros02', "task_key": 'SsdVidaDimeErros02'},
    )

    t_job_SsdVidaDimeErros02 = DataStageOperator(
        task_id='SsdVidaDimeErros02',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeErros02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeErros02 = PythonOperator(
        task_id='log_end_SsdVidaDimeErros02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeErros02', "task_key": 'SsdVidaDimeErros02', "upstream_task_id": 'SsdVidaDimeErros02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaCobertura05DimeVida = _LogStart(
        task_id='log_start_SsdVidaCobertura05DimeVida',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaCobertura05DimeVida', "task_key": 'SsdVidaCobertura05DimeVida'},
    )

    t_job_SsdVidaCobertura05DimeVida = DataStageOperator(
        task_id='SsdVidaCobertura05DimeVida',
        project=PROJECT_NAME,
        job_name='SsdVidaCobertura05DimeVida',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaCobertura05DimeVida = PythonOperator(
        task_id='log_end_SsdVidaCobertura05DimeVida',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaCobertura05DimeVida', "task_key": 'SsdVidaCobertura05DimeVida', "upstream_task_id": 'SsdVidaCobertura05DimeVida'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaExtracaoReplicaHistCta = _LogStart(
        task_id='log_start_SsdVidaExtracaoReplicaHistCta',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaExtracaoReplicaHistCta', "task_key": 'SsdVidaExtracaoReplicaHistCta'},
    )

    t_job_SsdVidaExtracaoReplicaHistCta = DataStageOperator(
        task_id='SsdVidaExtracaoReplicaHistCta',
        project=PROJECT_NAME,
        job_name='SsdVidaExtracaoReplicaHistCta',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaExtracaoReplicaHistCta = PythonOperator(
        task_id='log_end_SsdVidaExtracaoReplicaHistCta',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaExtracaoReplicaHistCta', "task_key": 'SsdVidaExtracaoReplicaHistCta', "upstream_task_id": 'SsdVidaExtracaoReplicaHistCta'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    [t_end_SsdVidaDimeErros02, t_end_SsdVidaDimeBeneficiario02, t_end_SsdVidaCobertura03SegVgapBaixa, t_end_SsdVidaCobertura04DimeBilhete] >> t_wait_Aguarda_Dim2

    [t_end_SsdVida02DimeProposta, t_end_SsdVida01BaixaPropostaVgap] >> t_wait_AGUARDE_1

    [t_end_SsdVida01BaixaContrato, t_end_SsdVidaBilhete03DimeContrato] >> t_wait_Dimensao_Contrato

    [t_end_SsdVidaBilhete02DimeProposta, t_end_SsdVida01BaixaProposta] >> t_wait_Prop_Bil

    t_check_agenda >> t_start_SsdVida01BaixaContrato >> t_job_SsdVida01BaixaContrato >> t_end_SsdVida01BaixaContrato

    t_wait_Dimensao_Contrato >> t_start_SsdVida02DimeContrato >> t_job_SsdVida02DimeContrato >> t_end_SsdVida02DimeContrato

    t_check_agenda >> t_start_SsdVidaBilhete01Baixa >> t_job_SsdVidaBilhete01Baixa >> t_end_SsdVidaBilhete01Baixa

    t_end_SsdVidaBilhete01Baixa >> t_start_SsdVidaBilhete02DimeProposta >> t_job_SsdVidaBilhete02DimeProposta >> t_end_SsdVidaBilhete02DimeProposta

    t_end_SsdVidaBilhete02DimeProposta >> t_start_SsdVidaBilhete03DimeContrato >> t_job_SsdVidaBilhete03DimeContrato >> t_end_SsdVidaBilhete03DimeContrato

    t_end_SsdVidaBilhete03DimeContrato >> t_start_SsdVidaBilhete04JuntaDados >> t_job_SsdVidaBilhete04JuntaDados >> t_end_SsdVidaBilhete04JuntaDados

    t_check_agenda >> t_start_SsdVida01BaixaProposta >> t_job_SsdVida01BaixaProposta >> t_end_SsdVida01BaixaProposta

    t_wait_Prop_Bil >> t_start_SsdVida02DimeProposta >> t_job_SsdVida02DimeProposta >> t_end_SsdVida02DimeProposta

    t_check_agenda >> t_start_SsdVida01BaixaPropostaVgap >> t_job_SsdVida01BaixaPropostaVgap >> t_end_SsdVida01BaixaPropostaVgap

    t_wait_AGUARDE_1 >> t_start_SsdVida02DimePropostaVgap >> t_job_SsdVida02DimePropostaVgap >> t_end_SsdVida02DimePropostaVgap

    t_end_SsdVida02DimePropostaVgap >> t_start_SsdVidaCobertura01BilheteBaixa >> t_job_SsdVidaCobertura01BilheteBaixa >> t_end_SsdVidaCobertura01BilheteBaixa

    t_end_SsdVida02DimePropostaVgap >> t_start_SsdVidaCobertura02VidaBaixa >> t_job_SsdVidaCobertura02VidaBaixa >> t_end_SsdVidaCobertura02VidaBaixa

    t_end_SsdVida02DimePropostaVgap >> t_start_SsdVidaDimeBeneficiario01 >> t_job_SsdVidaDimeBeneficiario01 >> t_end_SsdVidaDimeBeneficiario01

    t_end_SsdVida02DimePropostaVgap >> t_start_SsdVidaDimeErros01 >> t_job_SsdVidaDimeErros01 >> t_end_SsdVidaDimeErros01

    t_end_SsdVidaCobertura01BilheteBaixa >> t_start_SsdVidaCobertura04DimeBilhete >> t_job_SsdVidaCobertura04DimeBilhete >> t_end_SsdVidaCobertura04DimeBilhete

    t_end_SsdVidaCobertura02VidaBaixa >> t_start_SsdVidaCobertura03SegVgapBaixa >> t_job_SsdVidaCobertura03SegVgapBaixa >> t_end_SsdVidaCobertura03SegVgapBaixa

    t_end_SsdVidaDimeBeneficiario01 >> t_start_SsdVidaDimeBeneficiario02 >> t_job_SsdVidaDimeBeneficiario02 >> t_end_SsdVidaDimeBeneficiario02

    t_end_SsdVidaDimeErros01 >> t_start_SsdVidaDimeErros02 >> t_job_SsdVidaDimeErros02 >> t_end_SsdVidaDimeErros02

    t_wait_Aguarda_Dim2 >> t_start_SsdVidaCobertura05DimeVida >> t_job_SsdVidaCobertura05DimeVida >> t_end_SsdVidaCobertura05DimeVida

    t_end_SsdVidaCobertura05DimeVida >> t_start_SsdVidaExtracaoReplicaHistCta >> t_job_SsdVidaExtracaoReplicaHistCta >> t_end_SsdVidaExtracaoReplicaHistCta

    end_tasks = [t_end_SsdVida01BaixaContrato, t_end_SsdVida02DimeContrato, t_end_SsdVidaBilhete01Baixa, t_end_SsdVidaBilhete02DimeProposta, t_end_SsdVidaBilhete03DimeContrato, t_end_SsdVidaBilhete04JuntaDados, t_end_SsdVida01BaixaProposta, t_end_SsdVida02DimeProposta, t_end_SsdVida01BaixaPropostaVgap, t_end_SsdVida02DimePropostaVgap, t_end_SsdVidaCobertura01BilheteBaixa, t_end_SsdVidaCobertura02VidaBaixa, t_end_SsdVidaDimeBeneficiario01, t_end_SsdVidaDimeErros01, t_end_SsdVidaCobertura04DimeBilhete, t_end_SsdVidaCobertura03SegVgapBaixa, t_end_SsdVidaDimeBeneficiario02, t_end_SsdVidaDimeErros02, t_end_SsdVidaCobertura05DimeVida, t_end_SsdVidaExtracaoReplicaHistCta]

    [t_end_SsdVida01BaixaContrato, t_end_SsdVida02DimeContrato, t_end_SsdVidaBilhete01Baixa, t_end_SsdVidaBilhete02DimeProposta, t_end_SsdVidaBilhete03DimeContrato, t_end_SsdVidaBilhete04JuntaDados, t_end_SsdVida01BaixaProposta, t_end_SsdVida02DimeProposta, t_end_SsdVida01BaixaPropostaVgap, t_end_SsdVida02DimePropostaVgap, t_end_SsdVidaCobertura01BilheteBaixa, t_end_SsdVidaCobertura02VidaBaixa, t_end_SsdVidaDimeBeneficiario01, t_end_SsdVidaDimeErros01, t_end_SsdVidaCobertura04DimeBilhete, t_end_SsdVidaCobertura03SegVgapBaixa, t_end_SsdVidaDimeBeneficiario02, t_end_SsdVidaDimeErros02, t_end_SsdVidaCobertura05DimeVida, t_end_SsdVidaExtracaoReplicaHistCta] >> t_publish_dataset

    [t_end_SsdVida01BaixaContrato, t_end_SsdVida02DimeContrato, t_end_SsdVidaBilhete01Baixa, t_end_SsdVidaBilhete02DimeProposta, t_end_SsdVidaBilhete03DimeContrato, t_end_SsdVidaBilhete04JuntaDados, t_end_SsdVida01BaixaProposta, t_end_SsdVida02DimeProposta, t_end_SsdVida01BaixaPropostaVgap, t_end_SsdVida02DimePropostaVgap, t_end_SsdVidaCobertura01BilheteBaixa, t_end_SsdVidaCobertura02VidaBaixa, t_end_SsdVidaDimeBeneficiario01, t_end_SsdVidaDimeErros01, t_end_SsdVidaCobertura04DimeBilhete, t_end_SsdVidaCobertura03SegVgapBaixa, t_end_SsdVidaDimeBeneficiario02, t_end_SsdVidaDimeErros02, t_end_SsdVidaCobertura05DimeVida, t_end_SsdVidaExtracaoReplicaHistCta] >> t_teams_error

    [t_end_SsdVida01BaixaContrato, t_end_SsdVida02DimeContrato, t_end_SsdVidaBilhete01Baixa, t_end_SsdVidaBilhete02DimeProposta, t_end_SsdVidaBilhete03DimeContrato, t_end_SsdVidaBilhete04JuntaDados, t_end_SsdVida01BaixaProposta, t_end_SsdVida02DimeProposta, t_end_SsdVida01BaixaPropostaVgap, t_end_SsdVida02DimePropostaVgap, t_end_SsdVidaCobertura01BilheteBaixa, t_end_SsdVidaCobertura02VidaBaixa, t_end_SsdVidaDimeBeneficiario01, t_end_SsdVidaDimeErros01, t_end_SsdVidaCobertura04DimeBilhete, t_end_SsdVidaCobertura03SegVgapBaixa, t_end_SsdVidaDimeBeneficiario02, t_end_SsdVidaDimeErros02, t_end_SsdVidaCobertura05DimeVida, t_end_SsdVidaExtracaoReplicaHistCta] >> t_reg_falha

    t_wait_Aguarda_Dim2 >> t_publish_dataset

    t_wait_Aguarda_Dim2 >> t_teams_error

    t_wait_Aguarda_Dim2 >> t_reg_falha
    ...
    t_wait_Dimensao_Contrato >> t_publish_dataset

    t_wait_Dimensao_Contrato >> t_teams_error

    t_wait_Dimensao_Contrato >> t_reg_falha

    t_wait_Prop_Bil >> t_publish_dataset

    t_wait_Prop_Bil >> t_teams_error

    t_wait_Prop_Bil >> t_reg_falha
