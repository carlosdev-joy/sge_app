...
# Pipeline: SEQSSDVIDA1DIMEINCREMENTAL | Projeto: BI_VIDA | Dominio: DIMENSOES
# =========================
DAG_ID        = "SEQSSDVIDA1DIMEINCREMENTAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "DIMENSOES"
PIPELINE_NAME = "SEQSSDVIDA1DIMEINCREMENTAL"
...
DATASET_URI   = "orq://pipeline/SEQSSDVIDA1DIMEINCREMENTAL"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['AGUARDE_1', 'AGUARDE_2', 'AGUARDE_3', 'SsdVidaDimeApolice01', 'SsdVidaDimeApolice02', 'SsdVidaDimeUnidadeOrganizacional', 'SsdVidaDimeGeografia01', 'SsdVidaDimeGeografia02', 'SsdVidaDimePessoa01Bilhete', 'SsdVidaDimePessoa01Estipulante', 'SsdVidaDimePessoa01Fornecedores', 'SsdVidaDimePessoa01Segurado', 'SsdVidaDimePessoa01OdsPessFisica', 'SsdVidaDimePessoa01SegVgap', 'SsdVidaDimePessoa01SubEstipulante', 'SsdVidaDimePessoa01SubEstipulanteVgap', 'SsdVidaDimePessoa02Ftp_orq', 'SsdVidaDimePessoa02Union', 'SsdVidaDimePessoa03Insert', 'SsdVidaDimePessoa03Update', 'SsdVidaDimePessoa04FileSet', 'SsdVidaDimeProduto01Vida', 'SsdVidaDimeProduto01Bilhete', 'SsdVidaDimeProduto01Sinistro', 'SsdVidaDimeProduto02', 'SsdVidaDimeProdutoFileSet', 'SsdVidaDimeAssistenciaProduto01', 'SsdVidaDimeAssistenciaProduto02', 'SsdVidaDimeRecebimento01', 'SsdVidaDimeRecebimento02', 'SsdVidaDimeResponsavelVida01', 'SsdVidaDimeResponsavelVida02', 'SsdVidaDimeSituacaoContrato01', 'SsdVidaDimeSituacaoContrato02']
FLOW_JOBS     = ['SsdVidaDimeApolice01', 'SsdVidaDimeApolice02', 'SsdVidaDimeUnidadeOrganizacional', 'SsdVidaDimeGeografia01', 'SsdVidaDimeGeografia02', 'SsdVidaDimePessoa01Bilhete', 'SsdVidaDimePessoa01Estipulante', 'SsdVidaDimePessoa01Fornecedores', 'SsdVidaDimePessoa01Segurado', 'SsdVidaDimePessoa01OdsPessFisica', 'SsdVidaDimePessoa01SegVgap', 'SsdVidaDimePessoa01SubEstipulante', 'SsdVidaDimePessoa01SubEstipulanteVgap', 'SsdVidaDimePessoa02Ftp_orq', 'SsdVidaDimePessoa02Union', 'SsdVidaDimePessoa03Insert', 'SsdVidaDimePessoa03Update', 'SsdVidaDimePessoa04FileSet', 'SsdVidaDimeProduto01Vida', 'SsdVidaDimeProduto01Bilhete', 'SsdVidaDimeProduto01Sinistro', 'SsdVidaDimeProduto02', 'SsdVidaDimeProdutoFileSet', 'SsdVidaDimeAssistenciaProduto01', 'SsdVidaDimeAssistenciaProduto02', 'SsdVidaDimeRecebimento01', 'SsdVidaDimeRecebimento02', 'SsdVidaDimeResponsavelVida01', 'SsdVidaDimeResponsavelVida02', 'SsdVidaDimeSituacaoContrato01', 'SsdVidaDimeSituacaoContrato02']
...
with DAG(
    ...
    description="Pipeline SEQSSDVIDA1DIMEINCREMENTAL - BI_VIDA / DIMENSOES",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule="10 1 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'DIMENSOES', 'VIDA', 'GERAL'],
) as dag:
    ...
    t_wait_AGUARDE_1 = EmptyOperator(
        task_id='AGUARDE_1',
        trigger_rule=TriggerRule.ALL_SUCCESS,
    )

    t_wait_AGUARDE_2 = EmptyOperator(
        task_id='AGUARDE_2',
        trigger_rule=TriggerRule.ALL_SUCCESS,
    )

    t_wait_AGUARDE_3 = EmptyOperator(
        task_id='AGUARDE_3',
        trigger_rule=TriggerRule.ALL_SUCCESS,
    )

    t_start_SsdVidaDimeApolice01 = _LogStart(
        task_id='log_start_SsdVidaDimeApolice01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeApolice01', "task_key": 'SsdVidaDimeApolice01'},
    )

    t_job_SsdVidaDimeApolice01 = DataStageOperator(
        task_id='SsdVidaDimeApolice01',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeApolice01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeApolice01 = PythonOperator(
        task_id='log_end_SsdVidaDimeApolice01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeApolice01', "task_key": 'SsdVidaDimeApolice01', "upstream_task_id": 'SsdVidaDimeApolice01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeApolice02 = _LogStart(
        task_id='log_start_SsdVidaDimeApolice02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeApolice02', "task_key": 'SsdVidaDimeApolice02'},
    )

    t_job_SsdVidaDimeApolice02 = DataStageOperator(
        task_id='SsdVidaDimeApolice02',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeApolice02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeApolice02 = PythonOperator(
        task_id='log_end_SsdVidaDimeApolice02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeApolice02', "task_key": 'SsdVidaDimeApolice02', "upstream_task_id": 'SsdVidaDimeApolice02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeUnidadeOrganizacional = _LogStart(
        task_id='log_start_SsdVidaDimeUnidadeOrganizacional',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeUnidadeOrganizacional', "task_key": 'SsdVidaDimeUnidadeOrganizacional'},
    )

    t_job_SsdVidaDimeUnidadeOrganizacional = DataStageOperator(
        task_id='SsdVidaDimeUnidadeOrganizacional',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeUnidadeOrganizacional',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeUnidadeOrganizacional = PythonOperator(
        task_id='log_end_SsdVidaDimeUnidadeOrganizacional',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeUnidadeOrganizacional', "task_key": 'SsdVidaDimeUnidadeOrganizacional', "upstream_task_id": 'SsdVidaDimeUnidadeOrganizacional'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeGeografia01 = _LogStart(
        task_id='log_start_SsdVidaDimeGeografia01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeGeografia01', "task_key": 'SsdVidaDimeGeografia01'},
    )

    t_job_SsdVidaDimeGeografia01 = DataStageOperator(
        task_id='SsdVidaDimeGeografia01',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeGeografia01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeGeografia01 = PythonOperator(
        task_id='log_end_SsdVidaDimeGeografia01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeGeografia01', "task_key": 'SsdVidaDimeGeografia01', "upstream_task_id": 'SsdVidaDimeGeografia01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeGeografia02 = _LogStart(
        task_id='log_start_SsdVidaDimeGeografia02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeGeografia02', "task_key": 'SsdVidaDimeGeografia02'},
    )

    t_job_SsdVidaDimeGeografia02 = DataStageOperator(
        task_id='SsdVidaDimeGeografia02',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeGeografia02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeGeografia02 = PythonOperator(
        task_id='log_end_SsdVidaDimeGeografia02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeGeografia02', "task_key": 'SsdVidaDimeGeografia02', "upstream_task_id": 'SsdVidaDimeGeografia02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimePessoa01Bilhete = _LogStart(
        task_id='log_start_SsdVidaDimePessoa01Bilhete',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01Bilhete', "task_key": 'SsdVidaDimePessoa01Bilhete'},
    )

    t_job_SsdVidaDimePessoa01Bilhete = DataStageOperator(
        task_id='SsdVidaDimePessoa01Bilhete',
        project=PROJECT_NAME,
        job_name='SsdVidaDimePessoa01Bilhete',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimePessoa01Bilhete = PythonOperator(
        task_id='log_end_SsdVidaDimePessoa01Bilhete',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01Bilhete', "task_key": 'SsdVidaDimePessoa01Bilhete', "upstream_task_id": 'SsdVidaDimePessoa01Bilhete'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimePessoa01Estipulante = _LogStart(
        task_id='log_start_SsdVidaDimePessoa01Estipulante',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01Estipulante', "task_key": 'SsdVidaDimePessoa01Estipulante'},
    )

    t_job_SsdVidaDimePessoa01Estipulante = DataStageOperator(
        task_id='SsdVidaDimePessoa01Estipulante',
        project=PROJECT_NAME,
        job_name='SsdVidaDimePessoa01Estipulante',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimePessoa01Estipulante = PythonOperator(
        task_id='log_end_SsdVidaDimePessoa01Estipulante',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01Estipulante', "task_key": 'SsdVidaDimePessoa01Estipulante', "upstream_task_id": 'SsdVidaDimePessoa01Estipulante'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimePessoa01Fornecedores = _LogStart(
        task_id='log_start_SsdVidaDimePessoa01Fornecedores',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01Fornecedores', "task_key": 'SsdVidaDimePessoa01Fornecedores'},
    )

    t_job_SsdVidaDimePessoa01Fornecedores = DataStageOperator(
        task_id='SsdVidaDimePessoa01Fornecedores',
        project=PROJECT_NAME,
        job_name='SsdVidaDimePessoa01Fornecedores',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimePessoa01Fornecedores = PythonOperator(
        task_id='log_end_SsdVidaDimePessoa01Fornecedores',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01Fornecedores', "task_key": 'SsdVidaDimePessoa01Fornecedores', "upstream_task_id": 'SsdVidaDimePessoa01Fornecedores'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimePessoa01Segurado = _LogStart(
        task_id='log_start_SsdVidaDimePessoa01Segurado',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01Segurado', "task_key": 'SsdVidaDimePessoa01Segurado'},
    )

    t_job_SsdVidaDimePessoa01Segurado = DataStageOperator(
        task_id='SsdVidaDimePessoa01Segurado',
        project=PROJECT_NAME,
        job_name='SsdVidaDimePessoa01Segurado',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimePessoa01Segurado = PythonOperator(
        task_id='log_end_SsdVidaDimePessoa01Segurado',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01Segurado', "task_key": 'SsdVidaDimePessoa01Segurado', "upstream_task_id": 'SsdVidaDimePessoa01Segurado'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimePessoa01OdsPessFisica = _LogStart(
        task_id='log_start_SsdVidaDimePessoa01OdsPessFisica',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01OdsPessFisica', "task_key": 'SsdVidaDimePessoa01OdsPessFisica'},
    )

    t_job_SsdVidaDimePessoa01OdsPessFisica = DataStageOperator(
        task_id='SsdVidaDimePessoa01OdsPessFisica',
        project=PROJECT_NAME,
        job_name='SsdVidaDimePessoa01OdsPessFisica',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimePessoa01OdsPessFisica = PythonOperator(
        task_id='log_end_SsdVidaDimePessoa01OdsPessFisica',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01OdsPessFisica', "task_key": 'SsdVidaDimePessoa01OdsPessFisica', "upstream_task_id": 'SsdVidaDimePessoa01OdsPessFisica'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimePessoa01SegVgap = _LogStart(
        task_id='log_start_SsdVidaDimePessoa01SegVgap',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01SegVgap', "task_key": 'SsdVidaDimePessoa01SegVgap'},
    )

    t_job_SsdVidaDimePessoa01SegVgap = DataStageOperator(
        task_id='SsdVidaDimePessoa01SegVgap',
        project=PROJECT_NAME,
        job_name='SsdVidaDimePessoa01SegVgap',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimePessoa01SegVgap = PythonOperator(
        task_id='log_end_SsdVidaDimePessoa01SegVgap',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01SegVgap', "task_key": 'SsdVidaDimePessoa01SegVgap', "upstream_task_id": 'SsdVidaDimePessoa01SegVgap'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimePessoa01SubEstipulante = _LogStart(
        task_id='log_start_SsdVidaDimePessoa01SubEstipulante',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01SubEstipulante', "task_key": 'SsdVidaDimePessoa01SubEstipulante'},
    )

    t_job_SsdVidaDimePessoa01SubEstipulante = DataStageOperator(
        task_id='SsdVidaDimePessoa01SubEstipulante',
        project=PROJECT_NAME,
        job_name='SsdVidaDimePessoa01SubEstipulante',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimePessoa01SubEstipulante = PythonOperator(
        task_id='log_end_SsdVidaDimePessoa01SubEstipulante',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01SubEstipulante', "task_key": 'SsdVidaDimePessoa01SubEstipulante', "upstream_task_id": 'SsdVidaDimePessoa01SubEstipulante'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimePessoa01SubEstipulanteVgap = _LogStart(
        task_id='log_start_SsdVidaDimePessoa01SubEstipulanteVgap',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01SubEstipulanteVgap', "task_key": 'SsdVidaDimePessoa01SubEstipulanteVgap'},
    )

    t_job_SsdVidaDimePessoa01SubEstipulanteVgap = DataStageOperator(
        task_id='SsdVidaDimePessoa01SubEstipulanteVgap',
        project=PROJECT_NAME,
        job_name='SsdVidaDimePessoa01SubEstipulanteVgap',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimePessoa01SubEstipulanteVgap = PythonOperator(
        task_id='log_end_SsdVidaDimePessoa01SubEstipulanteVgap',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimePessoa01SubEstipulanteVgap', "task_key": 'SsdVidaDimePessoa01SubEstipulanteVgap', "upstream_task_id": 'SsdVidaDimePessoa01SubEstipulanteVgap'},
        trigger_rule=TriggerRule.ALL_DONE,
    )
    ...
    t_start_SsdVidaDimePessoa02Union = _LogStart(
        task_id='log_start_SsdVidaDimePessoa02Union',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimePessoa02Union', "task_key": 'SsdVidaDimePessoa02Union'},
    )

    t_job_SsdVidaDimePessoa02Union = DataStageOperator(
        task_id='SsdVidaDimePessoa02Union',
        project=PROJECT_NAME,
        job_name='SsdVidaDimePessoa02Union',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimePessoa02Union = PythonOperator(
        task_id='log_end_SsdVidaDimePessoa02Union',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimePessoa02Union', "task_key": 'SsdVidaDimePessoa02Union', "upstream_task_id": 'SsdVidaDimePessoa02Union'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimePessoa03Insert = _LogStart(
        task_id='log_start_SsdVidaDimePessoa03Insert',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimePessoa03Insert', "task_key": 'SsdVidaDimePessoa03Insert'},
    )

    t_job_SsdVidaDimePessoa03Insert = DataStageOperator(
        task_id='SsdVidaDimePessoa03Insert',
        project=PROJECT_NAME,
        job_name='SsdVidaDimePessoa03Insert',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimePessoa03Insert = PythonOperator(
        task_id='log_end_SsdVidaDimePessoa03Insert',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimePessoa03Insert', "task_key": 'SsdVidaDimePessoa03Insert', "upstream_task_id": 'SsdVidaDimePessoa03Insert'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimePessoa03Update = _LogStart(
        task_id='log_start_SsdVidaDimePessoa03Update',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimePessoa03Update', "task_key": 'SsdVidaDimePessoa03Update'},
    )

    t_job_SsdVidaDimePessoa03Update = DataStageOperator(
        task_id='SsdVidaDimePessoa03Update',
        project=PROJECT_NAME,
        job_name='SsdVidaDimePessoa03Update',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimePessoa03Update = PythonOperator(
        task_id='log_end_SsdVidaDimePessoa03Update',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimePessoa03Update', "task_key": 'SsdVidaDimePessoa03Update', "upstream_task_id": 'SsdVidaDimePessoa03Update'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimePessoa04FileSet = _LogStart(
        task_id='log_start_SsdVidaDimePessoa04FileSet',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimePessoa04FileSet', "task_key": 'SsdVidaDimePessoa04FileSet'},
    )

    t_job_SsdVidaDimePessoa04FileSet = DataStageOperator(
        task_id='SsdVidaDimePessoa04FileSet',
        project=PROJECT_NAME,
        job_name='SsdVidaDimePessoa04FileSet',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimePessoa04FileSet = PythonOperator(
        task_id='log_end_SsdVidaDimePessoa04FileSet',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimePessoa04FileSet', "task_key": 'SsdVidaDimePessoa04FileSet', "upstream_task_id": 'SsdVidaDimePessoa04FileSet'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeProduto01Vida = _LogStart(
        task_id='log_start_SsdVidaDimeProduto01Vida',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeProduto01Vida', "task_key": 'SsdVidaDimeProduto01Vida'},
    )

    t_job_SsdVidaDimeProduto01Vida = DataStageOperator(
        task_id='SsdVidaDimeProduto01Vida',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeProduto01Vida',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeProduto01Vida = PythonOperator(
        task_id='log_end_SsdVidaDimeProduto01Vida',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeProduto01Vida', "task_key": 'SsdVidaDimeProduto01Vida', "upstream_task_id": 'SsdVidaDimeProduto01Vida'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeProduto01Bilhete = _LogStart(
        task_id='log_start_SsdVidaDimeProduto01Bilhete',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeProduto01Bilhete', "task_key": 'SsdVidaDimeProduto01Bilhete'},
    )

    t_job_SsdVidaDimeProduto01Bilhete = DataStageOperator(
        task_id='SsdVidaDimeProduto01Bilhete',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeProduto01Bilhete',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeProduto01Bilhete = PythonOperator(
        task_id='log_end_SsdVidaDimeProduto01Bilhete',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeProduto01Bilhete', "task_key": 'SsdVidaDimeProduto01Bilhete', "upstream_task_id": 'SsdVidaDimeProduto01Bilhete'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeProduto01Sinistro = _LogStart(
        task_id='log_start_SsdVidaDimeProduto01Sinistro',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeProduto01Sinistro', "task_key": 'SsdVidaDimeProduto01Sinistro'},
    )

    t_job_SsdVidaDimeProduto01Sinistro = DataStageOperator(
        task_id='SsdVidaDimeProduto01Sinistro',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeProduto01Sinistro',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeProduto01Sinistro = PythonOperator(
        task_id='log_end_SsdVidaDimeProduto01Sinistro',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeProduto01Sinistro', "task_key": 'SsdVidaDimeProduto01Sinistro', "upstream_task_id": 'SsdVidaDimeProduto01Sinistro'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeProduto02 = _LogStart(
        task_id='log_start_SsdVidaDimeProduto02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeProduto02', "task_key": 'SsdVidaDimeProduto02'},
    )

    t_job_SsdVidaDimeProduto02 = DataStageOperator(
        task_id='SsdVidaDimeProduto02',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeProduto02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeProduto02 = PythonOperator(
        task_id='log_end_SsdVidaDimeProduto02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeProduto02', "task_key": 'SsdVidaDimeProduto02', "upstream_task_id": 'SsdVidaDimeProduto02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeProdutoFileSet = _LogStart(
        task_id='log_start_SsdVidaDimeProdutoFileSet',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeProdutoFileSet', "task_key": 'SsdVidaDimeProdutoFileSet'},
    )

    t_job_SsdVidaDimeProdutoFileSet = DataStageOperator(
        task_id='SsdVidaDimeProdutoFileSet',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeProdutoFileSet',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeProdutoFileSet = PythonOperator(
        task_id='log_end_SsdVidaDimeProdutoFileSet',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeProdutoFileSet', "task_key": 'SsdVidaDimeProdutoFileSet', "upstream_task_id": 'SsdVidaDimeProdutoFileSet'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeAssistenciaProduto01 = _LogStart(
        task_id='log_start_SsdVidaDimeAssistenciaProduto01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeAssistenciaProduto01', "task_key": 'SsdVidaDimeAssistenciaProduto01'},
    )

    t_job_SsdVidaDimeAssistenciaProduto01 = DataStageOperator(
        task_id='SsdVidaDimeAssistenciaProduto01',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeAssistenciaProduto01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeAssistenciaProduto01 = PythonOperator(
        task_id='log_end_SsdVidaDimeAssistenciaProduto01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeAssistenciaProduto01', "task_key": 'SsdVidaDimeAssistenciaProduto01', "upstream_task_id": 'SsdVidaDimeAssistenciaProduto01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeAssistenciaProduto02 = _LogStart(
        task_id='log_start_SsdVidaDimeAssistenciaProduto02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeAssistenciaProduto02', "task_key": 'SsdVidaDimeAssistenciaProduto02'},
    )

    t_job_SsdVidaDimeAssistenciaProduto02 = DataStageOperator(
        task_id='SsdVidaDimeAssistenciaProduto02',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeAssistenciaProduto02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeAssistenciaProduto02 = PythonOperator(
        task_id='log_end_SsdVidaDimeAssistenciaProduto02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeAssistenciaProduto02', "task_key": 'SsdVidaDimeAssistenciaProduto02', "upstream_task_id": 'SsdVidaDimeAssistenciaProduto02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeRecebimento01 = _LogStart(
        task_id='log_start_SsdVidaDimeRecebimento01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeRecebimento01', "task_key": 'SsdVidaDimeRecebimento01'},
    )

    t_job_SsdVidaDimeRecebimento01 = DataStageOperator(
        task_id='SsdVidaDimeRecebimento01',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeRecebimento01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeRecebimento01 = PythonOperator(
        task_id='log_end_SsdVidaDimeRecebimento01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeRecebimento01', "task_key": 'SsdVidaDimeRecebimento01', "upstream_task_id": 'SsdVidaDimeRecebimento01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeRecebimento02 = _LogStart(
        task_id='log_start_SsdVidaDimeRecebimento02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeRecebimento02', "task_key": 'SsdVidaDimeRecebimento02'},
    )

    t_job_SsdVidaDimeRecebimento02 = DataStageOperator(
        task_id='SsdVidaDimeRecebimento02',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeRecebimento02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeRecebimento02 = PythonOperator(
        task_id='log_end_SsdVidaDimeRecebimento02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeRecebimento02', "task_key": 'SsdVidaDimeRecebimento02', "upstream_task_id": 'SsdVidaDimeRecebimento02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeResponsavelVida01 = _LogStart(
        task_id='log_start_SsdVidaDimeResponsavelVida01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeResponsavelVida01', "task_key": 'SsdVidaDimeResponsavelVida01'},
    )

    t_job_SsdVidaDimeResponsavelVida01 = DataStageOperator(
        task_id='SsdVidaDimeResponsavelVida01',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeResponsavelVida01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeResponsavelVida01 = PythonOperator(
        task_id='log_end_SsdVidaDimeResponsavelVida01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeResponsavelVida01', "task_key": 'SsdVidaDimeResponsavelVida01', "upstream_task_id": 'SsdVidaDimeResponsavelVida01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeResponsavelVida02 = _LogStart(
        task_id='log_start_SsdVidaDimeResponsavelVida02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeResponsavelVida02', "task_key": 'SsdVidaDimeResponsavelVida02'},
    )

    t_job_SsdVidaDimeResponsavelVida02 = DataStageOperator(
        task_id='SsdVidaDimeResponsavelVida02',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeResponsavelVida02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeResponsavelVida02 = PythonOperator(
        task_id='log_end_SsdVidaDimeResponsavelVida02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeResponsavelVida02', "task_key": 'SsdVidaDimeResponsavelVida02', "upstream_task_id": 'SsdVidaDimeResponsavelVida02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeSituacaoContrato01 = _LogStart(
        task_id='log_start_SsdVidaDimeSituacaoContrato01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeSituacaoContrato01', "task_key": 'SsdVidaDimeSituacaoContrato01'},
    )

    t_job_SsdVidaDimeSituacaoContrato01 = DataStageOperator(
        task_id='SsdVidaDimeSituacaoContrato01',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeSituacaoContrato01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeSituacaoContrato01 = PythonOperator(
        task_id='log_end_SsdVidaDimeSituacaoContrato01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeSituacaoContrato01', "task_key": 'SsdVidaDimeSituacaoContrato01', "upstream_task_id": 'SsdVidaDimeSituacaoContrato01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaDimeSituacaoContrato02 = _LogStart(
        task_id='log_start_SsdVidaDimeSituacaoContrato02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaDimeSituacaoContrato02', "task_key": 'SsdVidaDimeSituacaoContrato02'},
    )

    t_job_SsdVidaDimeSituacaoContrato02 = DataStageOperator(
        task_id='SsdVidaDimeSituacaoContrato02',
        project=PROJECT_NAME,
        job_name='SsdVidaDimeSituacaoContrato02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaDimeSituacaoContrato02 = PythonOperator(
        task_id='log_end_SsdVidaDimeSituacaoContrato02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaDimeSituacaoContrato02', "task_key": 'SsdVidaDimeSituacaoContrato02', "upstream_task_id": 'SsdVidaDimeSituacaoContrato02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    [t_end_SsdVidaDimePessoa01Estipulante, t_end_SsdVidaDimePessoa01Segurado, t_end_SsdVidaDimePessoa01SegVgap, t_end_SsdVidaDimePessoa01SubEstipulanteVgap] >> t_wait_AGUARDE_1

    [t_end_SsdVidaDimeResponsavelVida02, t_end_SsdVidaDimeSituacaoContrato02] >> t_wait_AGUARDE_2

    [t_end_SsdVidaDimeUnidadeOrganizacional, t_end_SsdVidaDimeGeografia02, t_end_SsdVidaDimePessoa04FileSet, t_end_SsdVidaDimeAssistenciaProduto02, t_end_SsdVidaDimeRecebimento02, t_wait_AGUARDE_2] >> t_wait_AGUARDE_3

    t_check_agenda >> t_start_SsdVidaDimeApolice01 >> t_job_SsdVidaDimeApolice01 >> t_end_SsdVidaDimeApolice01

    t_end_SsdVidaDimeApolice01 >> t_start_SsdVidaDimeApolice02 >> t_job_SsdVidaDimeApolice02 >> t_end_SsdVidaDimeApolice02

    t_end_SsdVidaDimeApolice02 >> t_start_SsdVidaDimeUnidadeOrganizacional >> t_job_SsdVidaDimeUnidadeOrganizacional >> t_end_SsdVidaDimeUnidadeOrganizacional

    t_check_agenda >> t_start_SsdVidaDimeGeografia01 >> t_job_SsdVidaDimeGeografia01 >> t_end_SsdVidaDimeGeografia01

    t_end_SsdVidaDimeGeografia01 >> t_start_SsdVidaDimeGeografia02 >> t_job_SsdVidaDimeGeografia02 >> t_end_SsdVidaDimeGeografia02

    t_check_agenda >> t_start_SsdVidaDimePessoa01Bilhete >> t_job_SsdVidaDimePessoa01Bilhete >> t_end_SsdVidaDimePessoa01Bilhete

    t_end_SsdVidaDimePessoa01Bilhete >> t_start_SsdVidaDimePessoa01Estipulante >> t_job_SsdVidaDimePessoa01Estipulante >> t_end_SsdVidaDimePessoa01Estipulante

    t_check_agenda >> t_start_SsdVidaDimePessoa01Fornecedores >> t_job_SsdVidaDimePessoa01Fornecedores >> t_end_SsdVidaDimePessoa01Fornecedores

    t_end_SsdVidaDimePessoa01Fornecedores >> t_start_SsdVidaDimePessoa01Segurado >> t_job_SsdVidaDimePessoa01Segurado >> t_end_SsdVidaDimePessoa01Segurado

    t_check_agenda >> t_start_SsdVidaDimePessoa01OdsPessFisica >> t_job_SsdVidaDimePessoa01OdsPessFisica >> t_end_SsdVidaDimePessoa01OdsPessFisica

    t_end_SsdVidaDimePessoa01OdsPessFisica >> t_start_SsdVidaDimePessoa01SegVgap >> t_job_SsdVidaDimePessoa01SegVgap >> t_end_SsdVidaDimePessoa01SegVgap

    t_check_agenda >> t_start_SsdVidaDimePessoa01SubEstipulante >> t_job_SsdVidaDimePessoa01SubEstipulante >> t_end_SsdVidaDimePessoa01SubEstipulante

    t_end_SsdVidaDimePessoa01SubEstipulante >> t_start_SsdVidaDimePessoa01SubEstipulanteVgap >> t_job_SsdVidaDimePessoa01SubEstipulanteVgap >> t_end_SsdVidaDimePessoa01SubEstipulanteVgap

    t_wait_AGUARDE_1 >> t_start_SsdVidaDimePessoa02Ftp_orq >> t_job_SsdVidaDimePessoa02Ftp_orq >> t_end_SsdVidaDimePessoa02Ftp_orq

    t_end_SsdVidaDimePessoa02Ftp_orq >> t_start_SsdVidaDimePessoa02Union >> t_job_SsdVidaDimePessoa02Union >> t_end_SsdVidaDimePessoa02Union

    t_end_SsdVidaDimePessoa02Union >> t_start_SsdVidaDimePessoa03Insert >> t_job_SsdVidaDimePessoa03Insert >> t_end_SsdVidaDimePessoa03Insert

    t_end_SsdVidaDimePessoa03Insert >> t_start_SsdVidaDimePessoa03Update >> t_job_SsdVidaDimePessoa03Update >> t_end_SsdVidaDimePessoa03Update

    t_end_SsdVidaDimePessoa03Update >> t_start_SsdVidaDimePessoa04FileSet >> t_job_SsdVidaDimePessoa04FileSet >> t_end_SsdVidaDimePessoa04FileSet

    t_check_agenda >> t_start_SsdVidaDimeProduto01Vida >> t_job_SsdVidaDimeProduto01Vida >> t_end_SsdVidaDimeProduto01Vida

    t_end_SsdVidaDimeProduto01Vida >> t_start_SsdVidaDimeProduto01Bilhete >> t_job_SsdVidaDimeProduto01Bilhete >> t_end_SsdVidaDimeProduto01Bilhete

    t_end_SsdVidaDimeProduto01Bilhete >> t_start_SsdVidaDimeProduto01Sinistro >> t_job_SsdVidaDimeProduto01Sinistro >> t_end_SsdVidaDimeProduto01Sinistro

    t_end_SsdVidaDimeProduto01Sinistro >> t_start_SsdVidaDimeProduto02 >> t_job_SsdVidaDimeProduto02 >> t_end_SsdVidaDimeProduto02

    t_end_SsdVidaDimeProduto02 >> t_start_SsdVidaDimeProdutoFileSet >> t_job_SsdVidaDimeProdutoFileSet >> t_end_SsdVidaDimeProdutoFileSet

    t_end_SsdVidaDimeProdutoFileSet >> t_start_SsdVidaDimeAssistenciaProduto01 >> t_job_SsdVidaDimeAssistenciaProduto01 >> t_end_SsdVidaDimeAssistenciaProduto01

    t_end_SsdVidaDimeAssistenciaProduto01 >> t_start_SsdVidaDimeAssistenciaProduto02 >> t_job_SsdVidaDimeAssistenciaProduto02 >> t_end_SsdVidaDimeAssistenciaProduto02

    t_check_agenda >> t_start_SsdVidaDimeRecebimento01 >> t_job_SsdVidaDimeRecebimento01 >> t_end_SsdVidaDimeRecebimento01

    t_end_SsdVidaDimeRecebimento01 >> t_start_SsdVidaDimeRecebimento02 >> t_job_SsdVidaDimeRecebimento02 >> t_end_SsdVidaDimeRecebimento02

    t_check_agenda >> t_start_SsdVidaDimeResponsavelVida01 >> t_job_SsdVidaDimeResponsavelVida01 >> t_end_SsdVidaDimeResponsavelVida01

    t_end_SsdVidaDimeResponsavelVida01 >> t_start_SsdVidaDimeResponsavelVida02 >> t_job_SsdVidaDimeResponsavelVida02 >> t_end_SsdVidaDimeResponsavelVida02

    t_check_agenda >> t_start_SsdVidaDimeSituacaoContrato01 >> t_job_SsdVidaDimeSituacaoContrato01 >> t_end_SsdVidaDimeSituacaoContrato01

    t_end_SsdVidaDimeSituacaoContrato01 >> t_start_SsdVidaDimeSituacaoContrato02 >> t_job_SsdVidaDimeSituacaoContrato02 >> t_end_SsdVidaDimeSituacaoContrato02

    end_tasks = [t_end_SsdVidaDimeApolice01, t_end_SsdVidaDimeApolice02, t_end_SsdVidaDimeUnidadeOrganizacional, t_end_SsdVidaDimeGeografia01, t_end_SsdVidaDimeGeografia02, t_end_SsdVidaDimePessoa01Bilhete, t_end_SsdVidaDimePessoa01Estipulante, t_end_SsdVidaDimePessoa01Fornecedores, t_end_SsdVidaDimePessoa01Segurado, t_end_SsdVidaDimePessoa01OdsPessFisica, t_end_SsdVidaDimePessoa01SegVgap, t_end_SsdVidaDimePessoa01SubEstipulante, t_end_SsdVidaDimePessoa01SubEstipulanteVgap, t_end_SsdVidaDimePessoa02Ftp_orq, t_end_SsdVidaDimePessoa02Union, t_end_SsdVidaDimePessoa03Insert, t_end_SsdVidaDimePessoa03Update, t_end_SsdVidaDimePessoa04FileSet, t_end_SsdVidaDimeProduto01Vida, t_end_SsdVidaDimeProduto01Bilhete, t_end_SsdVidaDimeProduto01Sinistro, t_end_SsdVidaDimeProduto02, t_end_SsdVidaDimeProdutoFileSet, t_end_SsdVidaDimeAssistenciaProduto01, t_end_SsdVidaDimeAssistenciaProduto02, t_end_SsdVidaDimeRecebimento01, t_end_SsdVidaDimeRecebimento02, t_end_SsdVidaDimeResponsavelVida01, t_end_SsdVidaDimeResponsavelVida02, t_end_SsdVidaDimeSituacaoContrato01, t_end_SsdVidaDimeSituacaoContrato02]

    [t_end_SsdVidaDimeApolice01, t_end_SsdVidaDimeApolice02, t_end_SsdVidaDimeUnidadeOrganizacional, t_end_SsdVidaDimeGeografia01, t_end_SsdVidaDimeGeografia02, t_end_SsdVidaDimePessoa01Bilhete, t_end_SsdVidaDimePessoa01Estipulante, t_end_SsdVidaDimePessoa01Fornecedores, t_end_SsdVidaDimePessoa01Segurado, t_end_SsdVidaDimePessoa01OdsPessFisica, t_end_SsdVidaDimePessoa01SegVgap, t_end_SsdVidaDimePessoa01SubEstipulante, t_end_SsdVidaDimePessoa01SubEstipulanteVgap, t_end_SsdVidaDimePessoa02Ftp_orq, t_end_SsdVidaDimePessoa02Union, t_end_SsdVidaDimePessoa03Insert, t_end_SsdVidaDimePessoa03Update, t_end_SsdVidaDimePessoa04FileSet, t_end_SsdVidaDimeProduto01Vida, t_end_SsdVidaDimeProduto01Bilhete, t_end_SsdVidaDimeProduto01Sinistro, t_end_SsdVidaDimeProduto02, t_end_SsdVidaDimeProdutoFileSet, t_end_SsdVidaDimeAssistenciaProduto01, t_end_SsdVidaDimeAssistenciaProduto02, t_end_SsdVidaDimeRecebimento01, t_end_SsdVidaDimeRecebimento02, t_end_SsdVidaDimeResponsavelVida01, t_end_SsdVidaDimeResponsavelVida02, t_end_SsdVidaDimeSituacaoContrato01, t_end_SsdVidaDimeSituacaoContrato02] >> t_publish_dataset

    [t_end_SsdVidaDimeApolice01, t_end_SsdVidaDimeApolice02, t_end_SsdVidaDimeUnidadeOrganizacional, t_end_SsdVidaDimeGeografia01, t_end_SsdVidaDimeGeografia02, t_end_SsdVidaDimePessoa01Bilhete, t_end_SsdVidaDimePessoa01Estipulante, t_end_SsdVidaDimePessoa01Fornecedores, t_end_SsdVidaDimePessoa01Segurado, t_end_SsdVidaDimePessoa01OdsPessFisica, t_end_SsdVidaDimePessoa01SegVgap, t_end_SsdVidaDimePessoa01SubEstipulante, t_end_SsdVidaDimePessoa01SubEstipulanteVgap, t_end_SsdVidaDimePessoa02Ftp_orq, t_end_SsdVidaDimePessoa02Union, t_end_SsdVidaDimePessoa03Insert, t_end_SsdVidaDimePessoa03Update, t_end_SsdVidaDimePessoa04FileSet, t_end_SsdVidaDimeProduto01Vida, t_end_SsdVidaDimeProduto01Bilhete, t_end_SsdVidaDimeProduto01Sinistro, t_end_SsdVidaDimeProduto02, t_end_SsdVidaDimeProdutoFileSet, t_end_SsdVidaDimeAssistenciaProduto01, t_end_SsdVidaDimeAssistenciaProduto02, t_end_SsdVidaDimeRecebimento01, t_end_SsdVidaDimeRecebimento02, t_end_SsdVidaDimeResponsavelVida01, t_end_SsdVidaDimeResponsavelVida02, t_end_SsdVidaDimeSituacaoContrato01, t_end_SsdVidaDimeSituacaoContrato02] >> t_teams_error

    [t_end_SsdVidaDimeApolice01, t_end_SsdVidaDimeApolice02, t_end_SsdVidaDimeUnidadeOrganizacional, t_end_SsdVidaDimeGeografia01, t_end_SsdVidaDimeGeografia02, t_end_SsdVidaDimePessoa01Bilhete, t_end_SsdVidaDimePessoa01Estipulante, t_end_SsdVidaDimePessoa01Fornecedores, t_end_SsdVidaDimePessoa01Segurado, t_end_SsdVidaDimePessoa01OdsPessFisica, t_end_SsdVidaDimePessoa01SegVgap, t_end_SsdVidaDimePessoa01SubEstipulante, t_end_SsdVidaDimePessoa01SubEstipulanteVgap, t_end_SsdVidaDimePessoa02Ftp_orq, t_end_SsdVidaDimePessoa02Union, t_end_SsdVidaDimePessoa03Insert, t_end_SsdVidaDimePessoa03Update, t_end_SsdVidaDimePessoa04FileSet, t_end_SsdVidaDimeProduto01Vida, t_end_SsdVidaDimeProduto01Bilhete, t_end_SsdVidaDimeProduto01Sinistro, t_end_SsdVidaDimeProduto02, t_end_SsdVidaDimeProdutoFileSet, t_end_SsdVidaDimeAssistenciaProduto01, t_end_SsdVidaDimeAssistenciaProduto02, t_end_SsdVidaDimeRecebimento01, t_end_SsdVidaDimeRecebimento02, t_end_SsdVidaDimeResponsavelVida01, t_end_SsdVidaDimeResponsavelVida02, t_end_SsdVidaDimeSituacaoContrato01, t_end_SsdVidaDimeSituacaoContrato02] >> t_reg_falha

    t_wait_AGUARDE_1 >> t_publish_dataset

    t_wait_AGUARDE_1 >> t_teams_error

    t_wait_AGUARDE_1 >> t_reg_falha

    t_wait_AGUARDE_2 >> t_publish_dataset

    t_wait_AGUARDE_2 >> t_teams_error

    t_wait_AGUARDE_2 >> t_reg_falha

    t_wait_AGUARDE_3 >> t_publish_dataset

    t_wait_AGUARDE_3 >> t_teams_error

    t_wait_AGUARDE_3 >> t_reg_falha
