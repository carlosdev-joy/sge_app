...
# Pipeline: DATASTAGE_PAINEL_SQF_SINISTRO_MENSAL | Projeto: BI_VIDA | Dominio: SINISTRO
# =========================
DAG_ID        = "DATASTAGE_PAINEL_SQF_SINISTRO_MENSAL"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "SINISTRO"
PIPELINE_NAME = "DATASTAGE_PAINEL_SQF_SINISTRO_MENSAL"
...
HORARIOS_ESPECIFICOS = ['15:00']
DIAS_HORARIOS_MES = None
DATASET_URI   = "orq://pipeline/DATASTAGE_PAINEL_SQF_SINISTRO_MENSAL"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqSsdVidaPainelSQFSinistro_Carga']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_PAINEL_SQF_SINISTRO_MENSAL - BI_VIDA / SINISTRO",
    start_date=pendulum.datetime(2026, 6, 14, tz=LOCAL_TZ),
    schedule="0 15 * * 1",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'SINISTRO', 'DATASTAGE', 'MENSAL'],
) as dag:
    ...
    t_start_SeqSsdVidaPainelSQFSinistro_Carga = PythonOperator(
        task_id='log_start_SeqSsdVidaPainelSQFSinistro_Carga',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqSsdVidaPainelSQFSinistro_Carga', "task_key": 'SeqSsdVidaPainelSQFSinistro_Carga'},
    )

    t_job_SeqSsdVidaPainelSQFSinistro_Carga = DataStageOperator(
        task_id='SeqSsdVidaPainelSQFSinistro_Carga',
        project=PROJECT_NAME,
        job_name='SeqSsdVidaPainelSQFSinistro_Carga',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqSsdVidaPainelSQFSinistro_Carga = PythonOperator(
        task_id='log_end_SeqSsdVidaPainelSQFSinistro_Carga',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqSsdVidaPainelSQFSinistro_Carga', "task_key": 'SeqSsdVidaPainelSQFSinistro_Carga', "upstream_task_id": 'SeqSsdVidaPainelSQFSinistro_Carga'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqSsdVidaPainelSQFSinistro_Carga >> t_teams_start >> t_job_SeqSsdVidaPainelSQFSinistro_Carga >> t_end_SeqSsdVidaPainelSQFSinistro_Carga

    end_tasks = [t_end_SeqSsdVidaPainelSQFSinistro_Carga]

    [t_end_SeqSsdVidaPainelSQFSinistro_Carga] >> t_publish_dataset

    [t_end_SeqSsdVidaPainelSQFSinistro_Carga] >> t_teams_end

    [t_end_SeqSsdVidaPainelSQFSinistro_Carga] >> t_teams_error
