...
# Pipeline: DATASTAGE_SINISTRO_PSL_DIARIO | Projeto: BI_VIDA | Dominio: SINISTRO
# =========================
DAG_ID        = "DATASTAGE_SINISTRO_PSL_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "SINISTRO"
PIPELINE_NAME = "DATASTAGE_SINISTRO_PSL_DIARIO"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_SINISTRO_PSL_DIARIO - BI_VIDA / SINISTRO",
    start_date=pendulum.datetime(2026, 6, 15, tz=LOCAL_TZ),
    schedule="0 14 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'SINISTRO', 'DIARIO'],
) as dag:
    ...
    t_start_SsdVidaSeqCargaSinistroPSL = PythonOperator(
        task_id="log_start_SsdVidaSeqCargaSinistroPSL",
        python_callable=log_start,
        op_kwargs={"job_name": "SsdVidaSeqCargaSinistroPSL", "task_key": "SsdVidaSeqCargaSinistroPSL"},
    )

    t_job_SsdVidaSeqCargaSinistroPSL = DataStageOperator(
        task_id="SsdVidaSeqCargaSinistroPSL",
        project=PROJECT_NAME,
        job_name="SsdVidaSeqCargaSinistroPSL",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaSeqCargaSinistroPSL = PythonOperator(
        task_id="log_end_SsdVidaSeqCargaSinistroPSL",
        python_callable=log_end,
        op_kwargs={"job_name": "SsdVidaSeqCargaSinistroPSL", "task_key": "SsdVidaSeqCargaSinistroPSL", "upstream_task_id": "SsdVidaSeqCargaSinistroPSL"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SsdVidaSeqCargaSinistroPSL >> t_teams_start >> t_job_SsdVidaSeqCargaSinistroPSL >> t_end_SsdVidaSeqCargaSinistroPSL

    end_tasks = [t_end_SsdVidaSeqCargaSinistroPSL]

    [t_end_SsdVidaSeqCargaSinistroPSL] >> t_publish_dataset

    [t_end_SsdVidaSeqCargaSinistroPSL] >> t_teams_end

    [t_end_SsdVidaSeqCargaSinistroPSL] >> t_teams_error
