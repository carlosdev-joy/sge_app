...
# Pipeline: DATASTAGE_BENEFICIARIOS_SINISTRO_DIARIO | Projeto: BI_VIDA | Dominio: SINISTRO
# =========================
DAG_ID        = "DATASTAGE_BENEFICIARIOS_SINISTRO_DIARIO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "SINISTRO"
PIPELINE_NAME = "DATASTAGE_BENEFICIARIOS_SINISTRO_DIARIO"
...
DATASET_URI   = "orq://pipeline/DATASTAGE_BENEFICIARIOS_SINISTRO_DIARIO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 3, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SSDVidaSeqBeneficiariosSinistro']
...
with DAG(
    ...
    description="Pipeline DATASTAGE_BENEFICIARIOS_SINISTRO_DIARIO - BI_VIDA / SINISTRO",
    start_date=pendulum.datetime(2026, 6, 15, tz=LOCAL_TZ),
    schedule="30 13 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'SINISTRO', 'DATASTAGE', 'BENEFICIARIOS', 'DIARIO'],
) as dag:
    ...
    t_start_SSDVidaSeqBeneficiariosSinistro = PythonOperator(
        task_id="log_start_SSDVidaSeqBeneficiariosSinistro",
        python_callable=log_start,
        op_kwargs={"job_name": "SSDVidaSeqBeneficiariosSinistro", "task_key": "SSDVidaSeqBeneficiariosSinistro"},
    )

    t_job_SSDVidaSeqBeneficiariosSinistro = DataStageOperator(
        task_id="SSDVidaSeqBeneficiariosSinistro",
        project=PROJECT_NAME,
        job_name="SSDVidaSeqBeneficiariosSinistro",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SSDVidaSeqBeneficiariosSinistro = PythonOperator(
        task_id="log_end_SSDVidaSeqBeneficiariosSinistro",
        python_callable=log_end,
        op_kwargs={"job_name": "SSDVidaSeqBeneficiariosSinistro", "task_key": "SSDVidaSeqBeneficiariosSinistro", "upstream_task_id": "SSDVidaSeqBeneficiariosSinistro"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SSDVidaSeqBeneficiariosSinistro >> t_teams_start >> t_job_SSDVidaSeqBeneficiariosSinistro >> t_end_SSDVidaSeqBeneficiariosSinistro

    end_tasks = [t_end_SSDVidaSeqBeneficiariosSinistro]

    [t_end_SSDVidaSeqBeneficiariosSinistro] >> t_publish_dataset

    [t_end_SSDVidaSeqBeneficiariosSinistro] >> t_teams_end

    [t_end_SSDVidaSeqBeneficiariosSinistro] >> t_teams_error
