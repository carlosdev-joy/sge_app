...
# Pipeline: SEQSSDVIDA6SINISTRO | Projeto: BI_VIDA | Dominio: SINISTRO
# =========================
DAG_ID        = "SEQSSDVIDA6SINISTRO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "SINISTRO"
PIPELINE_NAME = "SEQSSDVIDA6SINISTRO"
...
DATASET_URI   = "orq://pipeline/SEQSSDVIDA6SINISTRO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['AGUARDE_1', 'SsdVidaSinistro03DadosDimes01', 'SsdVidaSinistro04DadosDimes02', 'SsdVidaSinistro05DadosDimes03', 'SsdVidaSinistro05FatoMovimentacao', 'SsdVidaSinistro08AtualizaDataOperacaoSinistro', 'SsdVidaSinistro06FatoSituacao']
FLOW_JOBS     = ['SsdVidaSinistro03DadosDimes01', 'SsdVidaSinistro04DadosDimes02', 'SsdVidaSinistro05DadosDimes03', 'SsdVidaSinistro05FatoMovimentacao', 'SsdVidaSinistro08AtualizaDataOperacaoSinistro', 'SsdVidaSinistro06FatoSituacao']
RESTRICAO_DIA = None
...
with DAG(
    ...
    description="Pipeline SEQSSDVIDA6SINISTRO - BI_VIDA / SINISTRO",
    start_date=pendulum.datetime(2026, 7, 31, tz=LOCAL_TZ),
    schedule=None,  # dependente: o gatilho e o disparo dos predecessores
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'SINISTRO', 'VIDA', 'GERAL'],
) as dag:
    ...
    t_start_SsdVidaSinistro03DadosDimes01 = _LogStart(
        task_id='log_start_SsdVidaSinistro03DadosDimes01',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaSinistro03DadosDimes01', "task_key": 'SsdVidaSinistro03DadosDimes01'},
    )

    t_job_SsdVidaSinistro03DadosDimes01 = DataStageOperator(
        task_id='SsdVidaSinistro03DadosDimes01',
        project=PROJECT_NAME,
        job_name='SsdVidaSinistro03DadosDimes01',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaSinistro03DadosDimes01 = PythonOperator(
        task_id='log_end_SsdVidaSinistro03DadosDimes01',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaSinistro03DadosDimes01', "task_key": 'SsdVidaSinistro03DadosDimes01', "upstream_task_id": 'SsdVidaSinistro03DadosDimes01'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaSinistro04DadosDimes02 = _LogStart(
        task_id='log_start_SsdVidaSinistro04DadosDimes02',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaSinistro04DadosDimes02', "task_key": 'SsdVidaSinistro04DadosDimes02'},
    )

    t_job_SsdVidaSinistro04DadosDimes02 = DataStageOperator(
        task_id='SsdVidaSinistro04DadosDimes02',
        project=PROJECT_NAME,
        job_name='SsdVidaSinistro04DadosDimes02',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaSinistro04DadosDimes02 = PythonOperator(
        task_id='log_end_SsdVidaSinistro04DadosDimes02',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaSinistro04DadosDimes02', "task_key": 'SsdVidaSinistro04DadosDimes02', "upstream_task_id": 'SsdVidaSinistro04DadosDimes02'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaSinistro05DadosDimes03 = _LogStart(
        task_id='log_start_SsdVidaSinistro05DadosDimes03',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaSinistro05DadosDimes03', "task_key": 'SsdVidaSinistro05DadosDimes03'},
    )

    t_job_SsdVidaSinistro05DadosDimes03 = DataStageOperator(
        task_id='SsdVidaSinistro05DadosDimes03',
        project=PROJECT_NAME,
        job_name='SsdVidaSinistro05DadosDimes03',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaSinistro05DadosDimes03 = PythonOperator(
        task_id='log_end_SsdVidaSinistro05DadosDimes03',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaSinistro05DadosDimes03', "task_key": 'SsdVidaSinistro05DadosDimes03', "upstream_task_id": 'SsdVidaSinistro05DadosDimes03'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaSinistro05FatoMovimentacao = _LogStart(
        task_id='log_start_SsdVidaSinistro05FatoMovimentacao',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaSinistro05FatoMovimentacao', "task_key": 'SsdVidaSinistro05FatoMovimentacao'},
    )

    t_job_SsdVidaSinistro05FatoMovimentacao = DataStageOperator(
        task_id='SsdVidaSinistro05FatoMovimentacao',
        project=PROJECT_NAME,
        job_name='SsdVidaSinistro05FatoMovimentacao',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaSinistro05FatoMovimentacao = PythonOperator(
        task_id='log_end_SsdVidaSinistro05FatoMovimentacao',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaSinistro05FatoMovimentacao', "task_key": 'SsdVidaSinistro05FatoMovimentacao', "upstream_task_id": 'SsdVidaSinistro05FatoMovimentacao'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaSinistro08AtualizaDataOperacaoSinistro = _LogStart(
        task_id='log_start_SsdVidaSinistro08AtualizaDataOperacaoSinistro',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaSinistro08AtualizaDataOperacaoSinistro', "task_key": 'SsdVidaSinistro08AtualizaDataOperacaoSinistro'},
    )

    t_job_SsdVidaSinistro08AtualizaDataOperacaoSinistro = DataStageOperator(
        task_id='SsdVidaSinistro08AtualizaDataOperacaoSinistro',
        project=PROJECT_NAME,
        job_name='SsdVidaSinistro08AtualizaDataOperacaoSinistro',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaSinistro08AtualizaDataOperacaoSinistro = PythonOperator(
        task_id='log_end_SsdVidaSinistro08AtualizaDataOperacaoSinistro',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaSinistro08AtualizaDataOperacaoSinistro', "task_key": 'SsdVidaSinistro08AtualizaDataOperacaoSinistro', "upstream_task_id": 'SsdVidaSinistro08AtualizaDataOperacaoSinistro'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaSinistro06FatoSituacao = _LogStart(
        task_id='log_start_SsdVidaSinistro06FatoSituacao',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaSinistro06FatoSituacao', "task_key": 'SsdVidaSinistro06FatoSituacao'},
    )

    t_job_SsdVidaSinistro06FatoSituacao = DataStageOperator(
        task_id='SsdVidaSinistro06FatoSituacao',
        project=PROJECT_NAME,
        job_name='SsdVidaSinistro06FatoSituacao',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaSinistro06FatoSituacao = PythonOperator(
        task_id='log_end_SsdVidaSinistro06FatoSituacao',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaSinistro06FatoSituacao', "task_key": 'SsdVidaSinistro06FatoSituacao', "upstream_task_id": 'SsdVidaSinistro06FatoSituacao'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    [t_end_SsdVidaSinistro08AtualizaDataOperacaoSinistro, t_end_SsdVidaSinistro06FatoSituacao] >> t_wait_AGUARDE_1

    t_check_agenda >> t_start_SsdVidaSinistro03DadosDimes01 >> t_job_SsdVidaSinistro03DadosDimes01 >> t_end_SsdVidaSinistro03DadosDimes01

    t_end_SsdVidaSinistro03DadosDimes01 >> t_start_SsdVidaSinistro04DadosDimes02 >> t_job_SsdVidaSinistro04DadosDimes02 >> t_end_SsdVidaSinistro04DadosDimes02

    t_end_SsdVidaSinistro04DadosDimes02 >> t_start_SsdVidaSinistro05DadosDimes03 >> t_job_SsdVidaSinistro05DadosDimes03 >> t_end_SsdVidaSinistro05DadosDimes03

    t_end_SsdVidaSinistro04DadosDimes02 >> t_start_SsdVidaSinistro05FatoMovimentacao >> t_job_SsdVidaSinistro05FatoMovimentacao >> t_end_SsdVidaSinistro05FatoMovimentacao

    t_end_SsdVidaSinistro05FatoMovimentacao >> t_start_SsdVidaSinistro08AtualizaDataOperacaoSinistro >> t_job_SsdVidaSinistro08AtualizaDataOperacaoSinistro >> t_end_SsdVidaSinistro08AtualizaDataOperacaoSinistro

    t_end_SsdVidaSinistro05DadosDimes03 >> t_start_SsdVidaSinistro06FatoSituacao >> t_job_SsdVidaSinistro06FatoSituacao >> t_end_SsdVidaSinistro06FatoSituacao

    end_tasks = [t_end_SsdVidaSinistro03DadosDimes01, t_end_SsdVidaSinistro04DadosDimes02, t_end_SsdVidaSinistro05DadosDimes03, t_end_SsdVidaSinistro05FatoMovimentacao, t_end_SsdVidaSinistro08AtualizaDataOperacaoSinistro, t_end_SsdVidaSinistro06FatoSituacao]

    [t_end_SsdVidaSinistro03DadosDimes01, t_end_SsdVidaSinistro04DadosDimes02, t_end_SsdVidaSinistro05DadosDimes03, t_end_SsdVidaSinistro05FatoMovimentacao, t_end_SsdVidaSinistro08AtualizaDataOperacaoSinistro, t_end_SsdVidaSinistro06FatoSituacao] >> t_publish_dataset

    [t_end_SsdVidaSinistro03DadosDimes01, t_end_SsdVidaSinistro04DadosDimes02, t_end_SsdVidaSinistro05DadosDimes03, t_end_SsdVidaSinistro05FatoMovimentacao, t_end_SsdVidaSinistro08AtualizaDataOperacaoSinistro, t_end_SsdVidaSinistro06FatoSituacao] >> t_teams_error

    [t_end_SsdVidaSinistro03DadosDimes01, t_end_SsdVidaSinistro04DadosDimes02, t_end_SsdVidaSinistro05DadosDimes03, t_end_SsdVidaSinistro05FatoMovimentacao, t_end_SsdVidaSinistro08AtualizaDataOperacaoSinistro, t_end_SsdVidaSinistro06FatoSituacao] >> t_reg_falha
