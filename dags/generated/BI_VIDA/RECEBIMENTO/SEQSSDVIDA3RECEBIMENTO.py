...
# Pipeline: SEQSSDVIDA3RECEBIMENTO | Projeto: BI_VIDA | Dominio: RECEBIMENTO
# =========================
DAG_ID        = "SEQSSDVIDA3RECEBIMENTO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_VIDA"
DOMAIN        = "RECEBIMENTO"
PIPELINE_NAME = "SEQSSDVIDA3RECEBIMENTO"
...
DATASET_URI   = "orq://pipeline/SEQSSDVIDA3RECEBIMENTO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SsdVidaFatoRecebimento1', 'SsdVidaFatoRecebimento2']
FLOW_JOBS     = ['SsdVidaFatoRecebimento1', 'SsdVidaFatoRecebimento2']
RESTRICAO_DIA = None
...
with DAG(
    ...
    description="Pipeline SEQSSDVIDA3RECEBIMENTO - BI_VIDA / RECEBIMENTO",
    start_date=pendulum.datetime(2026, 1, 1, tz=LOCAL_TZ),
    schedule=None,  # dependente: o gatilho e o disparo dos predecessores
    catchup=False,
    max_active_runs=1,
    tags=['BI_VIDA', 'RECEBIMENTO', 'VIDA', 'GERAL'],
) as dag:
    ...
    t_start_SsdVidaFatoRecebimento1 = _LogStart(
        task_id='log_start_SsdVidaFatoRecebimento1',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaFatoRecebimento1', "task_key": 'SsdVidaFatoRecebimento1'},
    )

    t_job_SsdVidaFatoRecebimento1 = DataStageOperator(
        task_id='SsdVidaFatoRecebimento1',
        project=PROJECT_NAME,
        job_name='SsdVidaFatoRecebimento1',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaFatoRecebimento1 = PythonOperator(
        task_id='log_end_SsdVidaFatoRecebimento1',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaFatoRecebimento1', "task_key": 'SsdVidaFatoRecebimento1', "upstream_task_id": 'SsdVidaFatoRecebimento1'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_start_SsdVidaFatoRecebimento2 = _LogStart(
        task_id='log_start_SsdVidaFatoRecebimento2',
        python_callable=log_start,
        op_kwargs={"job_name": 'SsdVidaFatoRecebimento2', "task_key": 'SsdVidaFatoRecebimento2'},
    )

    t_job_SsdVidaFatoRecebimento2 = DataStageOperator(
        task_id='SsdVidaFatoRecebimento2',
        project=PROJECT_NAME,
        job_name='SsdVidaFatoRecebimento2',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SsdVidaFatoRecebimento2 = PythonOperator(
        task_id='log_end_SsdVidaFatoRecebimento2',
        python_callable=log_end,
        op_kwargs={"job_name": 'SsdVidaFatoRecebimento2', "task_key": 'SsdVidaFatoRecebimento2', "upstream_task_id": 'SsdVidaFatoRecebimento2'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SsdVidaFatoRecebimento1 >> t_job_SsdVidaFatoRecebimento1 >> t_end_SsdVidaFatoRecebimento1

    t_end_SsdVidaFatoRecebimento1 >> t_start_SsdVidaFatoRecebimento2 >> t_job_SsdVidaFatoRecebimento2 >> t_end_SsdVidaFatoRecebimento2

    end_tasks = [t_end_SsdVidaFatoRecebimento1, t_end_SsdVidaFatoRecebimento2]

    [t_end_SsdVidaFatoRecebimento1, t_end_SsdVidaFatoRecebimento2] >> t_publish_dataset

    [t_end_SsdVidaFatoRecebimento1, t_end_SsdVidaFatoRecebimento2] >> t_teams_error

    [t_end_SsdVidaFatoRecebimento1, t_end_SsdVidaFatoRecebimento2] >> t_reg_falha
