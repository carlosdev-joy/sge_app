...
# Pipeline: SINISTROS_PENDENTES_XS5 | Projeto: BI_PRESTAMISTA | Dominio: SINISTRO
# =========================
DAG_ID        = "SINISTROS_PENDENTES_XS5"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_PRESTAMISTA"
DOMAIN        = "SINISTRO"
PIPELINE_NAME = "SINISTROS_PENDENTES_XS5"
...
DATASET_URI   = "orq://pipeline/SINISTROS_PENDENTES_XS5"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqSsdPrs_Sinistro_XS5']
FLOW_JOBS     = ['SeqSsdPrs_Sinistro_XS5']
...
with DAG(
    ...
    description="Pipeline SINISTROS_PENDENTES_XS5 - BI_PRESTAMISTA / SINISTRO",
    start_date=pendulum.datetime(2026, 8, 27, tz=LOCAL_TZ),
    schedule="0 8 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_PRESTAMISTA', 'SINISTRO', 'XS5', 'PENDENTES', 'SINISTROS'],
) as dag:
    ...
    t_start_SeqSsdPrs_Sinistro_XS5 = _LogStart(
        task_id='log_start_SeqSsdPrs_Sinistro_XS5',
        python_callable=log_start,
        op_kwargs={"job_name": 'SeqSsdPrs_Sinistro_XS5', "task_key": 'SeqSsdPrs_Sinistro_XS5'},
    )

    t_job_SeqSsdPrs_Sinistro_XS5 = DataStageOperator(
        task_id='SeqSsdPrs_Sinistro_XS5',
        project=PROJECT_NAME,
        job_name='SeqSsdPrs_Sinistro_XS5',
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqSsdPrs_Sinistro_XS5 = PythonOperator(
        task_id='log_end_SeqSsdPrs_Sinistro_XS5',
        python_callable=log_end,
        op_kwargs={"job_name": 'SeqSsdPrs_Sinistro_XS5', "task_key": 'SeqSsdPrs_Sinistro_XS5', "upstream_task_id": 'SeqSsdPrs_Sinistro_XS5'},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqSsdPrs_Sinistro_XS5 >> t_job_SeqSsdPrs_Sinistro_XS5 >> t_end_SeqSsdPrs_Sinistro_XS5

    end_tasks = [t_end_SeqSsdPrs_Sinistro_XS5]

    [t_end_SeqSsdPrs_Sinistro_XS5] >> t_publish_dataset

    [t_end_SeqSsdPrs_Sinistro_XS5] >> t_teams_error

    [t_end_SeqSsdPrs_Sinistro_XS5] >> t_reg_falha
