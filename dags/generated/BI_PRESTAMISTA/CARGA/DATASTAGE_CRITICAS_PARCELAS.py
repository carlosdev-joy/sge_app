...
# Pipeline: DATASTAGE_CRITICAS_PARCELAS | Projeto: BI_PRESTAMISTA | Dominio: CARGA
# =========================
DAG_ID        = "DATASTAGE_CRITICAS_PARCELAS"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_PRESTAMISTA"
DOMAIN        = "CARGA"
PIPELINE_NAME = "DATASTAGE_CRITICAS_PARCELAS"
...
with DAG(
    ...
    description="Pipeline DATASTAGE_CRITICAS_PARCELAS - BI_PRESTAMISTA / CARGA",
    start_date=pendulum.datetime(2026, 6, 17, tz=LOCAL_TZ),
    schedule="30 14 * * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_PRESTAMISTA', 'CARGA', 'DATASTAGE', 'CRITICAS', 'PARCELAS'],
) as dag:
    ...
    t_start_SeqSsdPrs_CriticasParcelas = PythonOperator(
        task_id="log_start_SeqSsdPrs_CriticasParcelas",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqSsdPrs_CriticasParcelas", "task_key": "SeqSsdPrs_CriticasParcelas"},
    )

    t_job_SeqSsdPrs_CriticasParcelas = DataStageOperator(
        task_id="SeqSsdPrs_CriticasParcelas",
        project=PROJECT_NAME,
        job_name="SeqSsdPrs_CriticasParcelas",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
    )

    t_end_SeqSsdPrs_CriticasParcelas = PythonOperator(
        task_id="log_end_SeqSsdPrs_CriticasParcelas",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqSsdPrs_CriticasParcelas", "task_key": "SeqSsdPrs_CriticasParcelas", "upstream_task_id": "SeqSsdPrs_CriticasParcelas"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqSsdPrs_CriticasParcelas >> t_teams_start >> t_job_SeqSsdPrs_CriticasParcelas >> t_end_SeqSsdPrs_CriticasParcelas

    end_tasks = [t_end_SeqSsdPrs_CriticasParcelas]

    [t_end_SeqSsdPrs_CriticasParcelas] >> t_publish_dataset

    [t_end_SeqSsdPrs_CriticasParcelas] >> t_teams_end

    [t_end_SeqSsdPrs_CriticasParcelas] >> t_teams_error
