...
# Pipeline: AUXILIOS_ESG_AUTO_PREST | Projeto: BI_PRESTAMISTA | Dominio: AUXILIOS_ASSISTENCIAS
# =========================
DAG_ID        = "AUXILIOS_ESG_AUTO_PREST"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_PRESTAMISTA"
DOMAIN        = "AUXILIOS_ASSISTENCIAS"
PIPELINE_NAME = "AUXILIOS_ESG_AUTO_PREST"
...
DIAS_HORARIOS_MES = {2: ['08:00'], 3: ['08:00'], 4: ['08:00'], 5: ['08:00']}
DATASET_URI   = "orq://pipeline/AUXILIOS_ESG_AUTO_PREST"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqSsdPrs_Auxilios_ESG_01_auto']
...
with DAG(
    ...
    description="Pipeline AUXILIOS_ESG_AUTO_PREST - BI_PRESTAMISTA / AUXILIOS_ASSISTENCIAS",
    start_date=pendulum.datetime(2026, 6, 18, tz=LOCAL_TZ),
    schedule="0 8 2,3,4,5 * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_PRESTAMISTA', 'AUXILIOS_ASSISTENCIAS', 'AUXILIOS', 'ESG', 'PRESTAMISTA'],
) as dag:
    ...
    t_start_SeqSsdPrs_Auxilios_ESG_01_auto = PythonOperator(
        task_id="log_start_SeqSsdPrs_Auxilios_ESG_01_auto",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqSsdPrs_Auxilios_ESG_01_auto", "task_key": "SeqSsdPrs_Auxilios_ESG_01_auto"},
    )

    t_job_SeqSsdPrs_Auxilios_ESG_01_auto = DataStageOperator(
        task_id="SeqSsdPrs_Auxilios_ESG_01_auto",
        project=PROJECT_NAME,
        job_name="SeqSsdPrs_Auxilios_ESG_01_auto",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
        verbose_log=True,
    )

    t_end_SeqSsdPrs_Auxilios_ESG_01_auto = PythonOperator(
        task_id="log_end_SeqSsdPrs_Auxilios_ESG_01_auto",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqSsdPrs_Auxilios_ESG_01_auto", "task_key": "SeqSsdPrs_Auxilios_ESG_01_auto", "upstream_task_id": "SeqSsdPrs_Auxilios_ESG_01_auto"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqSsdPrs_Auxilios_ESG_01_auto >> t_teams_start >> t_job_SeqSsdPrs_Auxilios_ESG_01_auto >> t_end_SeqSsdPrs_Auxilios_ESG_01_auto

    end_tasks = [t_end_SeqSsdPrs_Auxilios_ESG_01_auto]

    [t_end_SeqSsdPrs_Auxilios_ESG_01_auto] >> t_publish_dataset

    [t_end_SeqSsdPrs_Auxilios_ESG_01_auto] >> t_teams_end

    [t_end_SeqSsdPrs_Auxilios_ESG_01_auto] >> t_teams_error
