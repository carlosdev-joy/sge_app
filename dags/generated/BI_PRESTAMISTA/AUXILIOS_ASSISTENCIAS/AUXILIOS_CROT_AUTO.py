...
# Pipeline: AUXILIOS_CROT_AUTO | Projeto: BI_PRESTAMISTA | Dominio: AUXILIOS_ASSISTENCIAS
# =========================
DAG_ID        = "AUXILIOS_CROT_AUTO"
SSH_CONN_ID   = "ssh_lnxprd021"
MSSQL_CONN_ID = "SQL14_DMDB41"
PROJECT_NAME  = "BI_PRESTAMISTA"
DOMAIN        = "AUXILIOS_ASSISTENCIAS"
PIPELINE_NAME = "AUXILIOS_CROT_AUTO"
...
DIAS_HORARIOS_MES = {3: ['17:00'], 4: ['17:00'], 5: ['17:00']}
DATASET_URI   = "orq://pipeline/AUXILIOS_CROT_AUTO"
default_args  = {"owner": "airflow", "depends_on_past": False, "retries": 1, "retry_delay": timedelta(seconds=300)}
JOBS          = ['SeqSsdPrs_Auxilios_Crot_01_auto']
...
with DAG(
    ...
    description="Pipeline AUXILIOS_CROT_AUTO - BI_PRESTAMISTA / AUXILIOS_ASSISTENCIAS",
    start_date=pendulum.datetime(2026, 6, 18, tz=LOCAL_TZ),
    schedule="0 17 3,4,5 * *",
    catchup=False,
    max_active_runs=1,
    tags=['BI_PRESTAMISTA', 'AUXILIOS_ASSISTENCIAS', 'AUXILIO', 'CROT', 'PRESTAMISTA'],
) as dag:
    ...
    t_start_SeqSsdPrs_Auxilios_Crot_01_auto = PythonOperator(
        task_id="log_start_SeqSsdPrs_Auxilios_Crot_01_auto",
        python_callable=log_start,
        op_kwargs={"job_name": "SeqSsdPrs_Auxilios_Crot_01_auto", "task_key": "SeqSsdPrs_Auxilios_Crot_01_auto"},
    )

    t_job_SeqSsdPrs_Auxilios_Crot_01_auto = DataStageOperator(
        task_id="SeqSsdPrs_Auxilios_Crot_01_auto",
        project=PROJECT_NAME,
        job_name="SeqSsdPrs_Auxilios_Crot_01_auto",
        ssh_conn_id=SSH_CONN_ID,
        queue_name=DS_QUEUE,
        verbose_log=True,
    )

    t_end_SeqSsdPrs_Auxilios_Crot_01_auto = PythonOperator(
        task_id="log_end_SeqSsdPrs_Auxilios_Crot_01_auto",
        python_callable=log_end,
        op_kwargs={"job_name": "SeqSsdPrs_Auxilios_Crot_01_auto", "task_key": "SeqSsdPrs_Auxilios_Crot_01_auto", "upstream_task_id": "SeqSsdPrs_Auxilios_Crot_01_auto"},
        trigger_rule=TriggerRule.ALL_DONE,
    )

    t_check_agenda >> t_start_SeqSsdPrs_Auxilios_Crot_01_auto >> t_teams_start >> t_job_SeqSsdPrs_Auxilios_Crot_01_auto >> t_end_SeqSsdPrs_Auxilios_Crot_01_auto

    end_tasks = [t_end_SeqSsdPrs_Auxilios_Crot_01_auto]

    [t_end_SeqSsdPrs_Auxilios_Crot_01_auto] >> t_publish_dataset

    [t_end_SeqSsdPrs_Auxilios_Crot_01_auto] >> t_teams_end
