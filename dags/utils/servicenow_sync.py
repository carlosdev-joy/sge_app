...
CAMPOS = ("sys_id,number,short_description,state,priority,assigned_to,"
          ...
          # migration 093: email do analista para filtro exato no dashboard
          "assigned_to.email")
...
ESTADOS = {
    ...
    "sc_req_item": {
        ...
        # ⚠️ cru=3 é "Closed Complete" em sc_req_item — concluído, não outros.
        # Confirmado em 2026-08-21: RITMs encerrados caíam em 'outros' e
...
# ── Funções de delta, notas, anexos e snapshot ──────────────────────────────
